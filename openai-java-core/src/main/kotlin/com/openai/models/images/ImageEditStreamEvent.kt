...
private constructor(
     ...
     * import java.util.Optional;
     *
     * Optional<String> result = imageEditStreamEvent.accept(new ImageEditStreamEvent.Visitor<Optional<String>>() {
     *     @Override
     *     public Optional<String> visitPartialImage(ImageEditPartialImageEvent partialImage) {
     *         return Optional.of(partialImage.toString());
     *     }
     *
     *     // ...
     *
