...
private constructor(
    ...
    private constructor(
        ...
        override fun hashCode(): Int = Objects.hash(fileContent, fileId, storedCompletions)
        ...
        interface Visitor<out T> {
            ...
            fun visitFileContent(fileContent: FileContent): T = unknown(JsonValue.from(fileContent))
    ...
    private constructor(
        ...
        private constructor(
            ...
            private constructor(
                ...
                override fun hashCode(): Int = Objects.hash(easyInputMessage, evalItem)
                ...
                interface Visitor<out T> {
                    ...
                    fun visitEasyInputMessage(easyInputMessage: EasyInputMessage): T =
                        unknown(JsonValue.from(easyInputMessage))
    ...
    private constructor(
        ...
        private constructor(
            ...
            interface Visitor<out T> {
                ...
                /** Default response format. Used to generate text responses. */
                fun visitText(text: ResponseFormatText): T = unknown(JsonValue.from(text))
                ...
                fun visitJsonObject(jsonObject: ResponseFormatJsonObject): T =
                    unknown(JsonValue.from(jsonObject))
    ...
    private val hashCode: Int by lazy {
        Objects.hash(source, type, inputMessages, model, samplingParams, additionalProperties)
    }
