...
private constructor(
    ...
    private constructor(
         ...
         * import java.util.Optional;
         *
         * Optional<String> result = dataSource.accept(new DataSource.Visitor<Optional<String>>() {
         *     @Override
         *     public Optional<String> visitJsonl(CreateEvalJsonlRunDataSource jsonl) {
         *         return Optional.of(jsonl.toString());
         *     }
         *
         *     // ...
         *
        ...
        override fun hashCode(): Int = Objects.hash(jsonl, completions, responses)
        ...
        interface Visitor<out T> {
             ...
             * A JsonlRunDataSource object with that specifies a JSONL file that matches the eval
             */
            fun visitJsonl(jsonl: CreateEvalJsonlRunDataSource): T = unknown(JsonValue.from(jsonl))

            /** A CompletionsRunDataSource object describing a model sampling configuration. */
            fun visitCompletions(completions: CreateEvalCompletionsRunDataSource): T =
                unknown(JsonValue.from(completions))
        ...
        private constructor(
            ...
            private constructor(
                 ...
                 *     @Override
                 *     public Optional<String> visitFileContent(FileContent fileContent) {
                 *         return Optional.of(fileContent.toString());
                 *     }
                 *
                 *     // ...
                 *
                ...
                interface Visitor<out T> {
                    ...
                    fun visitResponses(responses: InnerResponses): T =
                        unknown(JsonValue.from(responses))
                ...
                private constructor(
                    ...
                    override fun equals(other: Any?): Boolean {
                        ...
                        return other is InnerResponses &&
                            type == other.type &&
            ...
            private constructor(
                 ...
                 * import java.util.Optional;
                 *
                 * Optional<String> result = inputMessages.accept(new InputMessages.Visitor<Optional<String>>() {
                 *     @Override
                 *     public Optional<String> visitTemplate(Template template) {
                 *         return Optional.of(template.toString());
                 *     }
                 *
                 *     // ...
                 *
                ...
                private constructor(
                    ...
                    private constructor(
                         ...
                         * import java.util.Optional;
                         *
                         * Optional<String> result = innerTemplate.accept(new InnerTemplate.Visitor<Optional<String>>() {
                         *     @Override
                         *     public Optional<String> visitChatMessage(ChatMessage chatMessage) {
                         *         return Optional.of(chatMessage.toString());
                         *     }
                         *
                         *     // ...
                         *
            ...
            private constructor(
                ...
                override fun toString() =
                    "SamplingParams{maxCompletionTokens=$maxCompletionTokens, reasoningEffort=$reasoningEffort, seed=$seed, temperature=$temperature, text=$text, tools=$tools, topP=$topP, additionalProperties=$additionalProperties}"
            }
    ...
    private constructor(
        ...
        override fun equals(other: Any?): Boolean {
            ...
            return other is PerTestingCriteriaResult &&
                failed == other.failed &&
                passed == other.passed &&
        ...
        private val hashCode: Int by lazy {
            Objects.hash(failed, passed, testingCriteria, additionalProperties)
        }
    ...
    private constructor(
        ...
        private val hashCode: Int by lazy {
            Objects.hash(errored, failed, passed, total, additionalProperties)
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is RunCancelResponse &&
            id == other.id &&
