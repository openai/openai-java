...
private constructor(
    ...
    class Builder internal constructor() {
        ...
        fun dataSource(responses: CreateEvalResponsesRunDataSource) =
         ...
         * ```
         */
        fun responsesDataSource(source: CreateEvalResponsesRunDataSource.Source) =
            dataSource(
                CreateEvalResponsesRunDataSource.builder()
                    .type(CreateEvalResponsesRunDataSource.Type.RESPONSES)
                    .source(source)
        ...
        /**
         * Alias for calling [responsesDataSource] with
         * `CreateEvalResponsesRunDataSource.Source.ofResponses(responses)`.
         */
        fun responsesDataSource(responses: CreateEvalResponsesRunDataSource.Source.Responses) =
            responsesDataSource(CreateEvalResponsesRunDataSource.Source.ofResponses(responses))
    ...
    private constructor(
        ...
        private val responses: CreateEvalResponsesRunDataSource? = null,
        ...
        fun responses(): Optional<CreateEvalResponsesRunDataSource> = Optional.ofNullable(responses)
        ...
        /** A ResponsesRunDataSource object describing a model sampling configuration. */
        fun asResponses(): CreateEvalResponsesRunDataSource = responses.getOrThrow("responses")
        ...
        fun validate(): DataSource = apply {
            ...
            accept(
                object : Visitor<Unit> {
                    ...
                    override fun visitResponses(responses: CreateEvalResponsesRunDataSource) {
                        responses.validate()
                    }
                }
            )
        ...
        companion object {
            ...
            /** A ResponsesRunDataSource object describing a model sampling configuration. */
            @JvmStatic
            fun ofResponses(responses: CreateEvalResponsesRunDataSource) =
        ...
        interface Visitor<out T> {
            ...
            /** A ResponsesRunDataSource object describing a model sampling configuration. */
            fun visitResponses(responses: CreateEvalResponsesRunDataSource): T
                ...
                when (type) {
                    ...
                    "responses" -> {
                        return tryDeserialize(
                            ...
                            ?.let { DataSource(responses = it, _json = json) }
                            ?: DataSource(_json = json)
                    }
                }
