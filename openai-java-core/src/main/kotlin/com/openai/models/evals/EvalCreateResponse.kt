...
private constructor(
    ...
    private constructor(
         ...
         *     @Override
         *     public Optional<String> visitCustom(EvalCustomDataSourceConfig custom) {
    ...
    private constructor(
         ...
         *     @Override
         *     public Optional<String> visitLabelModelGrader(LabelModelGrader labelModelGrader) {
         *         return Optional.of(labelModelGrader.toString());
         *     }
         *
         *     // ...
         *
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is EvalCreateResponse &&
            id == other.id &&
