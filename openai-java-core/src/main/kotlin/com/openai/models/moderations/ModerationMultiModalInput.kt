...
private constructor(
     ...
     * import java.util.Optional;
     *
     * Optional<String> result = moderationMultiModalInput.accept(new ModerationMultiModalInput.Visitor<Optional<String>>() {
     *     @Override
     *     public Optional<String> visitImageUrl(ModerationImageUrlInput imageUrl) {
     *         return Optional.of(imageUrl.toString());
     *     }
     *
     *     // ...
     *
    ...
    interface Visitor<out T> {
        ...
        /** An object describing an image to classify. */
        fun visitImageUrl(imageUrl: ModerationImageUrlInput): T = unknown(JsonValue.from(imageUrl))

        /** An object describing text to classify. */
        fun visitText(text: ModerationTextInput): T = unknown(JsonValue.from(text))
