...
private constructor(
    ...
    class Builder internal constructor() {
        ...
        internal fun from(computerScreenshotContent: ComputerScreenshotContent) = apply {
            ...
            promptCacheBreakpoint = computerScreenshotContent.promptCacheBreakpoint
    ...
    private val hashCode: Int by lazy {
        Objects.hash(detail, fileId, imageUrl, type, promptCacheBreakpoint, additionalProperties)
    }

    override fun hashCode(): Int = hashCode

    override fun toString() =
        "ComputerScreenshotContent{detail=$detail, fileId=$fileId, imageUrl=$imageUrl, type=$type, promptCacheBreakpoint=$promptCacheBreakpoint, additionalProperties=$additionalProperties}"
}
