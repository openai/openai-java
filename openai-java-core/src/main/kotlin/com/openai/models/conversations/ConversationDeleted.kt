...
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [ConversationDeleted].
         *
    ...
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(conversationDeleted: ConversationDeleted) = apply {
            id = conversationDeleted.id
            deleted = conversationDeleted.deleted
            object_ = conversationDeleted.object_
            additionalProperties = conversationDeleted.additionalProperties.toMutableMap()
        }
    ...
    fun validate(): ConversationDeleted = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is ConversationDeleted &&
            id == other.id &&
    ...
    override fun toString() =
        "ConversationDeleted{id=$id, deleted=$deleted, object_=$object_, additionalProperties=$additionalProperties}"
}
