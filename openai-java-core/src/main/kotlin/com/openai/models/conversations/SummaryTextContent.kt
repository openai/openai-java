...
private constructor(
    ...
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(summaryTextContent: SummaryTextContent) = apply {
            text = summaryTextContent.text
            type = summaryTextContent.type
        ...
        /**
         * Returns an immutable instance of [SummaryTextContent].
         *
    ...
    fun validate(): SummaryTextContent = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun toString() =
        "SummaryTextContent{text=$text, type=$type, additionalProperties=$additionalProperties}"
}
