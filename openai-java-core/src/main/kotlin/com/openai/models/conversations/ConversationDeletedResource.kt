...
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [ConversationDeletedResource].
         *
    ...
    /** A builder for [ConversationDeletedResource]. */
    class Builder internal constructor() {

        private var id: JsonField<String>? = null
        private var deleted: JsonField<Boolean>? = null
        private var object_: JsonValue = JsonValue.from("conversation.deleted")
        private var additionalProperties: MutableMap<String, JsonValue> = mutableMapOf()

        @JvmSynthetic
        internal fun from(conversationDeletedResource: ConversationDeletedResource) = apply {
            id = conversationDeletedResource.id
            deleted = conversationDeletedResource.deleted
            object_ = conversationDeletedResource.object_
            additionalProperties = conversationDeletedResource.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [ConversationDeletedResource].
         *
         ...
         */
        fun build(): ConversationDeletedResource =
    ...
    fun validate(): ConversationDeletedResource = apply {
        if (validated) {
            return@apply
        }
        ...
        deleted()
        _object_().let {
            if (it != JsonValue.from("conversation.deleted")) {
    ...
    internal fun validity(): Int =
        (if (id.asKnown().isPresent) 1 else 0) +
            ...
            object_.let { if (it == JsonValue.from("conversation.deleted")) 1 else 0 }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is ConversationDeletedResource &&
            id == other.id &&
    ...
    override fun toString() =
        "ConversationDeletedResource{id=$id, deleted=$deleted, object_=$object_, additionalProperties=$additionalProperties}"
}
