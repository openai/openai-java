...
private constructor(
    ...
    private constructor(
         ...
         * import java.util.Optional;
         *
         * Optional<String> result = graders.accept(new Graders.Visitor<Optional<String>>() {
         *     @Override
         *     public Optional<String> visitStringCheckGrader(StringCheckGrader stringCheckGrader) {
         *         return Optional.of(stringCheckGrader.toString());
         *     }
         *
         *     // ...
         *
        ...
        interface Visitor<out T> {
            ...
            fun unknown(json: JsonValue?): T {
                throw OpenAIInvalidDataException("Unknown Graders")
            }
        }
