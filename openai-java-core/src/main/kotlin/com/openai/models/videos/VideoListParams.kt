...
private constructor(
    ...
    class Builder internal constructor() {
        ...
        internal fun from(videoListParams: VideoListParams) = apply {
            after = videoListParams.after
            limit = videoListParams.limit
            order = videoListParams.order
    ...
    override fun toString() =
        "VideoListParams{after=$after, limit=$limit, order=$order, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
