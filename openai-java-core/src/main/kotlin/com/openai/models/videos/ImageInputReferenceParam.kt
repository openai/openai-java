...
private constructor(
    ...
    /** A builder for [ImageInputReferenceParam]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(imageInputReferenceParam: ImageInputReferenceParam) = apply {
            fileId = imageInputReferenceParam.fileId
            imageUrl = imageInputReferenceParam.imageUrl
            additionalProperties = imageInputReferenceParam.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [ImageInputReferenceParam].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): ImageInputReferenceParam =
            ImageInputReferenceParam(fileId, imageUrl, additionalProperties.toMutableMap())
    }

    private var validated: Boolean = false

    fun validate(): ImageInputReferenceParam = apply {
        if (validated) {
            return@apply
        }
    ...
    internal fun validity(): Int =
        (if (fileId.asKnown().isPresent) 1 else 0) + (if (imageUrl.asKnown().isPresent) 1 else 0)
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is ImageInputReferenceParam &&
            fileId == other.fileId &&
    ...
    override fun toString() =
        "ImageInputReferenceParam{fileId=$fileId, imageUrl=$imageUrl, additionalProperties=$additionalProperties}"
}
