...
class VideoListPageResponse
@JsonCreator(mode = JsonCreator.Mode.DISABLED)
private constructor(
    private val data: JsonField<List<Video>>,
    ...
    @JsonCreator
    private constructor(
        @JsonProperty("data") @ExcludeMissing data: JsonField<List<Video>> = JsonMissing.of(),
     ...
     */
    fun data(): List<Video> = data.getRequired("data")
     ...
     */
    @JsonProperty("data") @ExcludeMissing fun _data(): JsonField<List<Video>> = data
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [VideoListPageResponse].
         *
    ...
    /** A builder for [VideoListPageResponse]. */
    class Builder internal constructor() {

        private var data: JsonField<MutableList<Video>>? = null
        ...
        @JvmSynthetic
        internal fun from(videoListPageResponse: VideoListPageResponse) = apply {
            data = videoListPageResponse.data.map { it.toMutableList() }
            firstId = videoListPageResponse.firstId
            hasMore = videoListPageResponse.hasMore
            lastId = videoListPageResponse.lastId
            object_ = videoListPageResponse.object_
            additionalProperties = videoListPageResponse.additionalProperties.toMutableMap()
        }

        /** A list of items */
        fun data(data: List<Video>) = data(JsonField.of(data))

        /**
         * Sets [Builder.data] to an arbitrary JSON value.
         *
         * You should usually call [Builder.data] with a well-typed `List<Video>` value instead.
         * This method is primarily for setting the field to an undocumented or not yet supported
         * value.
         */
        fun data(data: JsonField<List<Video>>) = apply {
            this.data = data.map { it.toMutableList() }
        }

        /**
         * Adds a single [Video] to [Builder.data].
         *
         * @throws IllegalStateException if the field was previously set to a non-list.
         */
        fun addData(data: Video) = apply {
            this.data =
        ...
        /**
         * Returns an immutable instance of [VideoListPageResponse].
         *
         ...
         */
        fun build(): VideoListPageResponse =
    ...
    fun validate(): VideoListPageResponse = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is VideoListPageResponse &&
            data == other.data &&
    ...
    override fun toString() =
        "VideoListPageResponse{data=$data, firstId=$firstId, hasMore=$hasMore, lastId=$lastId, object_=$object_, additionalProperties=$additionalProperties}"
}
