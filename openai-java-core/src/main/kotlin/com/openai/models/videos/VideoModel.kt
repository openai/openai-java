...
class VideoModel @JsonCreator private constructor(private val value: JsonField<String>) : Enum {
    ...
    /** An enum containing [VideoModel]'s known values. */
    enum class Known {
        SORA_2,
        SORA_2_PRO,
    }
    ...
    /**
     * An enum containing [VideoModel]'s known values, as well as an [_UNKNOWN] member.
     *
     * An instance of [VideoModel] can contain an unknown value in a couple of cases:
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is VideoModel && value == other.value
    }
