...
private constructor(
    ...
    /** A builder for [VideoDeleteResponse]. */
    class Builder internal constructor() {

        private var id: JsonField<String>? = null
        private var deleted: JsonField<Boolean>? = null
        private var object_: JsonValue = JsonValue.from("video.deleted")
        private var additionalProperties: MutableMap<String, JsonValue> = mutableMapOf()

        @JvmSynthetic
        internal fun from(videoDeleteResponse: VideoDeleteResponse) = apply {
            id = videoDeleteResponse.id
            deleted = videoDeleteResponse.deleted
            object_ = videoDeleteResponse.object_
            additionalProperties = videoDeleteResponse.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [VideoDeleteResponse].
         *
    ...
    fun validate(): VideoDeleteResponse = apply {
        if (validated) {
            return@apply
        }
        ...
        deleted()
        _object_().let {
            if (it != JsonValue.from("video.deleted")) {
    ...
    internal fun validity(): Int =
        (if (id.asKnown().isPresent) 1 else 0) +
            ...
            object_.let { if (it == JsonValue.from("video.deleted")) 1 else 0 }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is VideoDeleteResponse &&
            id == other.id &&
    ...
    override fun toString() =
        "VideoDeleteResponse{id=$id, deleted=$deleted, object_=$object_, additionalProperties=$additionalProperties}"
}
