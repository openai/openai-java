...
private constructor(
    ...
    class Builder internal constructor() {
        ...
        internal fun from(versionListParams: VersionListParams) = apply {
            ...
            after = versionListParams.after
            limit = versionListParams.limit
            order = versionListParams.order
    ...
    override fun hashCode(): Int =
        Objects.hash(skillId, after, limit, order, additionalHeaders, additionalQueryParams)

    override fun toString() =
        "VersionListParams{skillId=$skillId, after=$after, limit=$limit, order=$order, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
