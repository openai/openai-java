...
private constructor(
    ...
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(skillList: SkillList) = apply {
            data = skillList.data.map { it.toMutableList() }
            firstId = skillList.firstId
            hasMore = skillList.hasMore
            lastId = skillList.lastId
            object_ = skillList.object_
            additionalProperties = skillList.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [SkillList].
         *
    ...
    override fun toString() =
        "SkillList{data=$data, firstId=$firstId, hasMore=$hasMore, lastId=$lastId, object_=$object_, additionalProperties=$additionalProperties}"
}
