...
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [SkillVersionList].
         *
    ...
    /** A builder for [SkillVersionList]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(skillVersionList: SkillVersionList) = apply {
            data = skillVersionList.data.map { it.toMutableList() }
            firstId = skillVersionList.firstId
            hasMore = skillVersionList.hasMore
            lastId = skillVersionList.lastId
            object_ = skillVersionList.object_
            additionalProperties = skillVersionList.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [SkillVersionList].
         *
    ...
    fun validate(): SkillVersionList = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is SkillVersionList &&
            data == other.data &&
    ...
    override fun toString() =
        "SkillVersionList{data=$data, firstId=$firstId, hasMore=$hasMore, lastId=$lastId, object_=$object_, additionalProperties=$additionalProperties}"
}
