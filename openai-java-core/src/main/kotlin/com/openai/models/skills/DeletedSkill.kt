...
private constructor(
    ...
    class Builder internal constructor() {
        ...
        private var object_: JsonValue = JsonValue.from("skill.deleted")
        private var additionalProperties: MutableMap<String, JsonValue> = mutableMapOf()

        @JvmSynthetic
        internal fun from(deletedSkill: DeletedSkill) = apply {
            id = deletedSkill.id
            deleted = deletedSkill.deleted
            object_ = deletedSkill.object_
    ...
    fun validate(): DeletedSkill = apply {
        ...
        deleted()
        _object_().let {
            if (it != JsonValue.from("skill.deleted")) {
    ...
    internal fun validity(): Int =
        (if (id.asKnown().isPresent) 1 else 0) +
            ...
            object_.let { if (it == JsonValue.from("skill.deleted")) 1 else 0 }
    ...
    override fun toString() =
        "DeletedSkill{id=$id, deleted=$deleted, object_=$object_, additionalProperties=$additionalProperties}"
}
