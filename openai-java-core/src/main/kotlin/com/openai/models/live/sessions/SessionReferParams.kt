...
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [SessionReferParams].
         *
    ...
    /** A builder for [SessionReferParams]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(sessionReferParams: SessionReferParams) = apply {
            sessionId = sessionReferParams.sessionId
            body = sessionReferParams.body.toBuilder()
            additionalHeaders = sessionReferParams.additionalHeaders.toBuilder()
            additionalQueryParams = sessionReferParams.additionalQueryParams.toBuilder()
        }
        ...
        /**
         * Returns an immutable instance of [SessionReferParams].
         *
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is SessionReferParams &&
    ...
    override fun toString() =
        "SessionReferParams{sessionId=$sessionId, body=$body, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
