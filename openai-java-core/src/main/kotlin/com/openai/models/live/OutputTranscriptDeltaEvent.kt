...
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [OutputTranscriptDeltaEvent].
         *
    ...
    /** A builder for [OutputTranscriptDeltaEvent]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(outputTranscriptDeltaEvent: OutputTranscriptDeltaEvent) = apply {
            delta = outputTranscriptDeltaEvent.delta
            endMs = outputTranscriptDeltaEvent.endMs
            eventId = outputTranscriptDeltaEvent.eventId
            startMs = outputTranscriptDeltaEvent.startMs
            type = outputTranscriptDeltaEvent.type
            clientEventId = outputTranscriptDeltaEvent.clientEventId
            additionalProperties = outputTranscriptDeltaEvent.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [OutputTranscriptDeltaEvent].
         *
         ...
         */
        fun build(): OutputTranscriptDeltaEvent =
     ...
     *   expected type.
     */
    fun validate(): OutputTranscriptDeltaEvent = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is OutputTranscriptDeltaEvent &&
            delta == other.delta &&
            endMs == other.endMs &&
    ...
    override fun toString() =
        "OutputTranscriptDeltaEvent{delta=$delta, endMs=$endMs, eventId=$eventId, startMs=$startMs, type=$type, clientEventId=$clientEventId, additionalProperties=$additionalProperties}"
}
