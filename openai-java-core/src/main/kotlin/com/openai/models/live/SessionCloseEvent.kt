...
private constructor(
    ...
    companion object {
        ...
        /** Returns a mutable builder for constructing an instance of [SessionCloseEvent]. */
        @JvmStatic fun builder() = Builder()
    }

    /** A builder for [SessionCloseEvent]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(sessionCloseEvent: SessionCloseEvent) = apply {
            type = sessionCloseEvent.type
            eventId = sessionCloseEvent.eventId
            additionalProperties = sessionCloseEvent.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [SessionCloseEvent].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): SessionCloseEvent =
            SessionCloseEvent(type, eventId, additionalProperties.toMutableMap())
    }
     ...
     *   expected type.
     */
    fun validate(): SessionCloseEvent = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is SessionCloseEvent &&
            type == other.type &&
    ...
    override fun toString() =
        "SessionCloseEvent{type=$type, eventId=$eventId, additionalProperties=$additionalProperties}"
}
