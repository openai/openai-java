...
private constructor(
     ...
     * ```java
     * JsonValue.from("session.thinking.appended")
     * ```
     *
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [ThinkingAppendedEvent].
         *
    ...
    /** A builder for [ThinkingAppendedEvent]. */
    class Builder internal constructor() {

        private var endMs: JsonField<Long>? = null
        private var eventId: JsonField<String>? = null
        private var startMs: JsonField<Long>? = null
        private var type: JsonValue = JsonValue.from("session.thinking.appended")
        private var clientEventId: JsonField<String> = JsonMissing.of()
        private var additionalProperties: MutableMap<String, JsonValue> = mutableMapOf()

        @JvmSynthetic
        internal fun from(thinkingAppendedEvent: ThinkingAppendedEvent) = apply {
            endMs = thinkingAppendedEvent.endMs
            eventId = thinkingAppendedEvent.eventId
            startMs = thinkingAppendedEvent.startMs
            type = thinkingAppendedEvent.type
            clientEventId = thinkingAppendedEvent.clientEventId
            additionalProperties = thinkingAppendedEvent.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [ThinkingAppendedEvent].
         *
         ...
         */
        fun build(): ThinkingAppendedEvent =
     ...
     *   expected type.
     */
    fun validate(): ThinkingAppendedEvent = apply {
        if (validated) {
            return@apply
        }
        ...
        startMs()
        _type().let {
            if (it != JsonValue.from("session.thinking.appended")) {
    ...
    internal fun validity(): Int =
        (if (endMs.asKnown().isPresent) 1 else 0) +
            ...
            type.let { if (it == JsonValue.from("session.thinking.appended")) 1 else 0 } +
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is ThinkingAppendedEvent &&
            endMs == other.endMs &&
    ...
    override fun toString() =
        "ThinkingAppendedEvent{endMs=$endMs, eventId=$eventId, startMs=$startMs, type=$type, clientEventId=$clientEventId, additionalProperties=$additionalProperties}"
}
