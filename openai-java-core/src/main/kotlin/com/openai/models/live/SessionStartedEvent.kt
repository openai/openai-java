...
/**
 * Returned when a Live session has started. Contains the resolved session configuration, including
 * server defaults.
 */
...
private constructor(
     ...
     * ```java
     * JsonValue.from("session.started")
     * ```
     *
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [SessionStartedEvent].
         *
    ...
    /** A builder for [SessionStartedEvent]. */
    class Builder internal constructor() {

        private var eventId: JsonField<String>? = null
        private var session: JsonField<SessionResource>? = null
        private var type: JsonValue = JsonValue.from("session.started")
        private var clientEventId: JsonField<String> = JsonMissing.of()
        private var additionalProperties: MutableMap<String, JsonValue> = mutableMapOf()

        @JvmSynthetic
        internal fun from(sessionStartedEvent: SessionStartedEvent) = apply {
            eventId = sessionStartedEvent.eventId
            session = sessionStartedEvent.session
            type = sessionStartedEvent.type
            clientEventId = sessionStartedEvent.clientEventId
            additionalProperties = sessionStartedEvent.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [SessionStartedEvent].
         *
     ...
     *   expected type.
     */
    fun validate(): SessionStartedEvent = apply {
        if (validated) {
            return@apply
        }
        ...
        session().validate()
        _type().let {
            if (it != JsonValue.from("session.started")) {
    ...
    internal fun validity(): Int =
        (if (eventId.asKnown().isPresent) 1 else 0) +
            ...
            type.let { if (it == JsonValue.from("session.started")) 1 else 0 } +
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is SessionStartedEvent &&
    ...
    override fun toString() =
        "SessionStartedEvent{eventId=$eventId, session=$session, type=$type, clientEventId=$clientEventId, additionalProperties=$additionalProperties}"
}
