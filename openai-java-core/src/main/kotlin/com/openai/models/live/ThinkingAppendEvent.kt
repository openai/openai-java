...
/**
 * Provide silent reasoning or progress context to the Live model, optionally for an existing client
 * delegation.
 */
...
private constructor(
    ...
    /**
     * Silent reasoning or progress context, limited to 500 tokens. It does not directly request
     * speech, but can influence later speech and is not a secrecy boundary.
     *
     ...
     * ```java
     * JsonValue.from("session.thinking.append")
     * ```
     *
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [ThinkingAppendEvent].
         *
    ...
    /** A builder for [ThinkingAppendEvent]. */
    class Builder internal constructor() {

        private var content: JsonField<String>? = null
        private var delegationId: JsonField<String>? = null
        private var type: JsonValue = JsonValue.from("session.thinking.append")
        private var eventId: JsonField<String> = JsonMissing.of()
        private var additionalProperties: MutableMap<String, JsonValue> = mutableMapOf()

        @JvmSynthetic
        internal fun from(thinkingAppendEvent: ThinkingAppendEvent) = apply {
            content = thinkingAppendEvent.content
            delegationId = thinkingAppendEvent.delegationId
            type = thinkingAppendEvent.type
            eventId = thinkingAppendEvent.eventId
            additionalProperties = thinkingAppendEvent.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [ThinkingAppendEvent].
         *
     ...
     *   expected type.
     */
    fun validate(): ThinkingAppendEvent = apply {
        if (validated) {
            return@apply
        }
        ...
        delegationId()
        _type().let {
            if (it != JsonValue.from("session.thinking.append")) {
    ...
    internal fun validity(): Int =
        (if (content.asKnown().isPresent) 1 else 0) +
            ...
            type.let { if (it == JsonValue.from("session.thinking.append")) 1 else 0 } +
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is ThinkingAppendEvent &&
    ...
    override fun toString() =
        "ThinkingAppendEvent{content=$content, delegationId=$delegationId, type=$type, eventId=$eventId, additionalProperties=$additionalProperties}"
}
