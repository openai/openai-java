...
private constructor(
    ...
    ) : this(code, eventId, message, type, clientEventId, mutableMapOf())
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [InfoEvent].
         *
    ...
    /** A builder for [InfoEvent]. */
    class Builder internal constructor() {

        private var code: JsonField<String>? = null
        private var eventId: JsonField<String>? = null
        private var message: JsonField<String>? = null
        private var type: JsonValue = JsonValue.from("info")
        private var clientEventId: JsonField<String> = JsonMissing.of()
        private var additionalProperties: MutableMap<String, JsonValue> = mutableMapOf()

        @JvmSynthetic
        internal fun from(infoEvent: InfoEvent) = apply {
            code = infoEvent.code
            eventId = infoEvent.eventId
            message = infoEvent.message
            type = infoEvent.type
            clientEventId = infoEvent.clientEventId
            additionalProperties = infoEvent.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [InfoEvent].
         *
    ...
    internal fun validity(): Int =
        (if (code.asKnown().isPresent) 1 else 0) +
            ...
            type.let { if (it == JsonValue.from("info")) 1 else 0 } +
    ...
    private val hashCode: Int by lazy {
        Objects.hash(code, eventId, message, type, clientEventId, additionalProperties)
    }

    override fun hashCode(): Int = hashCode

    override fun toString() =
        "InfoEvent{code=$code, eventId=$eventId, message=$message, type=$type, clientEventId=$clientEventId, additionalProperties=$additionalProperties}"
}
