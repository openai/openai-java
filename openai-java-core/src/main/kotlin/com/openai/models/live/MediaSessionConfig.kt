 ...
 * [Live prompting guide](https://developers.openai.com/api/docs/guides/live-prompting) when writing
 * frontend instructions and the backend prompt under delegation.responses.instructions.
 */
...
private constructor(
    ...
    /**
     * Startup audio configuration. WebRTC and SIP negotiate their audio format on the media
     * transport.
     *
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [MediaSessionConfig].
         *
    ...
    /** A builder for [MediaSessionConfig]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(mediaSessionConfig: MediaSessionConfig) = apply {
            model = mediaSessionConfig.model
            audio = mediaSessionConfig.audio
            client = mediaSessionConfig.client
            delegation = mediaSessionConfig.delegation
            input = mediaSessionConfig.input.map { it.toMutableList() }
            instructions = mediaSessionConfig.instructions
            store = mediaSessionConfig.store
            additionalProperties = mediaSessionConfig.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [MediaSessionConfig].
         *
     ...
     *   expected type.
     */
    fun validate(): MediaSessionConfig = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is MediaSessionConfig &&
            model == other.model &&
            audio == other.audio &&
            client == other.client &&
    ...
    override fun toString() =
        "MediaSessionConfig{model=$model, audio=$audio, client=$client, delegation=$delegation, input=$input, instructions=$instructions, store=$store, additionalProperties=$additionalProperties}"
}
