...
/**
 * Returned when a session.instructions.append command is accepted into the Live session timeline.
 * Acknowledges the appended instructions without guaranteeing that the model has acted on them.
 */
...
private constructor(
     ...
     * ```java
     * JsonValue.from("session.instructions.appended")
     * ```
     *
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [InstructionsAppendedEvent].
         *
    ...
    /** A builder for [InstructionsAppendedEvent]. */
    class Builder internal constructor() {

        private var endMs: JsonField<Long>? = null
        private var eventId: JsonField<String>? = null
        private var startMs: JsonField<Long>? = null
        private var type: JsonValue = JsonValue.from("session.instructions.appended")
        private var clientEventId: JsonField<String> = JsonMissing.of()
        private var additionalProperties: MutableMap<String, JsonValue> = mutableMapOf()

        @JvmSynthetic
        internal fun from(instructionsAppendedEvent: InstructionsAppendedEvent) = apply {
            endMs = instructionsAppendedEvent.endMs
            eventId = instructionsAppendedEvent.eventId
            startMs = instructionsAppendedEvent.startMs
            type = instructionsAppendedEvent.type
            clientEventId = instructionsAppendedEvent.clientEventId
            additionalProperties = instructionsAppendedEvent.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [InstructionsAppendedEvent].
         *
         ...
         */
        fun build(): InstructionsAppendedEvent =
     ...
     *   expected type.
     */
    fun validate(): InstructionsAppendedEvent = apply {
        if (validated) {
            return@apply
        }
        ...
        startMs()
        _type().let {
            if (it != JsonValue.from("session.instructions.appended")) {
    ...
    internal fun validity(): Int =
        (if (endMs.asKnown().isPresent) 1 else 0) +
            ...
            type.let { if (it == JsonValue.from("session.instructions.appended")) 1 else 0 } +
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is InstructionsAppendedEvent &&
            endMs == other.endMs &&
    ...
    override fun toString() =
        "InstructionsAppendedEvent{endMs=$endMs, eventId=$eventId, startMs=$startMs, type=$type, clientEventId=$clientEventId, additionalProperties=$additionalProperties}"
}
