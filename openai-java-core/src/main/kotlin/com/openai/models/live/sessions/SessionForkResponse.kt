...
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [SessionForkResponse].
         *
    ...
    /** A builder for [SessionForkResponse]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(sessionForkResponse: SessionForkResponse) = apply {
            session = sessionForkResponse.session
            transport = sessionForkResponse.transport
            additionalProperties = sessionForkResponse.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [SessionForkResponse].
         *
     ...
     *   expected type.
     */
    fun validate(): SessionForkResponse = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is SessionForkResponse &&
    ...
    override fun toString() =
        "SessionForkResponse{session=$session, transport=$transport, additionalProperties=$additionalProperties}"
}
