...
/**
 * Request a response from the Live session’s Responses backend, or continue a delegated response
 * waiting for tool results. Requires Responses delegation.
 */
...
private constructor(
    ...
    class Builder internal constructor() {
        ...
        fun build(): ResponseCreateEvent =
            ResponseCreateEvent(type, eventId, additionalProperties.toMutableMap())
    }
    ...
    override fun toString() =
        "ResponseCreateEvent{type=$type, eventId=$eventId, additionalProperties=$additionalProperties}"
}
