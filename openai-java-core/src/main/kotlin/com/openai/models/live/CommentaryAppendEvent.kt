...
private constructor(
    ...
    /**
     * Speakable context for the Live model, limited to 500 tokens. Use this for a result the model
     * should communicate; use session.thinking.append for silent context.
     *
     ...
     * ```java
     * JsonValue.from("session.commentary.append")
     * ```
     *
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [CommentaryAppendEvent].
         *
    ...
    /** A builder for [CommentaryAppendEvent]. */
    class Builder internal constructor() {

        private var content: JsonField<String>? = null
        private var delegationId: JsonField<String>? = null
        private var type: JsonValue = JsonValue.from("session.commentary.append")
        private var eventId: JsonField<String> = JsonMissing.of()
        private var additionalProperties: MutableMap<String, JsonValue> = mutableMapOf()

        @JvmSynthetic
        internal fun from(commentaryAppendEvent: CommentaryAppendEvent) = apply {
            content = commentaryAppendEvent.content
            delegationId = commentaryAppendEvent.delegationId
            type = commentaryAppendEvent.type
            eventId = commentaryAppendEvent.eventId
            additionalProperties = commentaryAppendEvent.additionalProperties.toMutableMap()
        }

        /**
         * Speakable context for the Live model, limited to 500 tokens. Use this for a result the
         * model should communicate; use session.thinking.append for silent context.
         */
        ...
        /**
         * Returns an immutable instance of [CommentaryAppendEvent].
         *
         ...
         */
        fun build(): CommentaryAppendEvent =
     ...
     *   expected type.
     */
    fun validate(): CommentaryAppendEvent = apply {
        if (validated) {
            return@apply
        }
        ...
        delegationId()
        _type().let {
            if (it != JsonValue.from("session.commentary.append")) {
    ...
    internal fun validity(): Int =
        (if (content.asKnown().isPresent) 1 else 0) +
            ...
            type.let { if (it == JsonValue.from("session.commentary.append")) 1 else 0 } +
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is CommentaryAppendEvent &&
    ...
    override fun toString() =
        "CommentaryAppendEvent{content=$content, delegationId=$delegationId, type=$type, eventId=$eventId, additionalProperties=$additionalProperties}"
}
