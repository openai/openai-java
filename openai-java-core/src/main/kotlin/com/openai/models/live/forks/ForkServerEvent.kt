 ...
 */
@JsonDeserialize(using = ForkServerEvent.Deserializer::class)
@JsonSerialize(using = ForkServerEvent.Serializer::class)
class ForkServerEvent
private constructor(
     ...
     * import java.util.Optional;
     *
     * Optional<String> result = forkServerEvent.accept(new ForkServerEvent.Visitor<Optional<String>>() {
     *     @Override
     ...
     *   expected type.
     */
    fun validate(): ForkServerEvent = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is ForkServerEvent &&
    ...
    override fun toString(): String =
        when {
            sessionStarted != null -> "ForkServerEvent{sessionStarted=$sessionStarted}"
            sessionUpdated != null -> "ForkServerEvent{sessionUpdated=$sessionUpdated}"
            sessionInputAudioMuted != null ->
                "ForkServerEvent{sessionInputAudioMuted=$sessionInputAudioMuted}"
            sessionInputAudioUnmuted != null ->
                "ForkServerEvent{sessionInputAudioUnmuted=$sessionInputAudioUnmuted}"
            sessionInstructionsAppended != null ->
                "ForkServerEvent{sessionInstructionsAppended=$sessionInstructionsAppended}"
            sessionThinkingAppended != null ->
                "ForkServerEvent{sessionThinkingAppended=$sessionThinkingAppended}"
            sessionCommentaryAppended != null ->
                "ForkServerEvent{sessionCommentaryAppended=$sessionCommentaryAppended}"
            sessionInputAudioAppend != null ->
                "ForkServerEvent{sessionInputAudioAppend=$sessionInputAudioAppend}"
            sessionOutputAudioDelta != null ->
                "ForkServerEvent{sessionOutputAudioDelta=$sessionOutputAudioDelta}"
            sessionInputTranscriptDelta != null ->
                "ForkServerEvent{sessionInputTranscriptDelta=$sessionInputTranscriptDelta}"
            sessionOutputTranscriptDelta != null ->
                "ForkServerEvent{sessionOutputTranscriptDelta=$sessionOutputTranscriptDelta}"
            sessionDelegationCreated != null ->
                "ForkServerEvent{sessionDelegationCreated=$sessionDelegationCreated}"
            responseEvent != null -> "ForkServerEvent{responseEvent=$responseEvent}"
            sessionUsageUpdated != null ->
                "ForkServerEvent{sessionUsageUpdated=$sessionUsageUpdated}"
            sessionClosed != null -> "ForkServerEvent{sessionClosed=$sessionClosed}"
            errorEvent != null -> "ForkServerEvent{errorEvent=$errorEvent}"
            infoEvent != null -> "ForkServerEvent{infoEvent=$infoEvent}"
            transportDtmfReceived != null ->
                "ForkServerEvent{transportDtmfReceived=$transportDtmfReceived}"
            transportDtmfSend != null -> "ForkServerEvent{transportDtmfSend=$transportDtmfSend}"
            transportRinging != null -> "ForkServerEvent{transportRinging=$transportRinging}"
            transportAnswered != null -> "ForkServerEvent{transportAnswered=$transportAnswered}"
            transportFailed != null -> "ForkServerEvent{transportFailed=$transportFailed}"
            _json != null -> "ForkServerEvent{_unknown=$_json}"
            else -> throw IllegalStateException("Invalid ForkServerEvent")
        }
    ...
    companion object {
        ...
        fun ofSessionStarted(sessionStarted: SessionStartedEvent) =
            ForkServerEvent(sessionStarted = sessionStarted)
        ...
        fun ofSessionUpdated(sessionUpdated: SessionUpdatedEvent) =
            ForkServerEvent(sessionUpdated = sessionUpdated)
        ...
        fun ofResponseEvent(responseEvent: ResponseEvent) =
            ForkServerEvent(responseEvent = responseEvent)
        ...
        fun ofSessionClosed(sessionClosed: SessionClosedEvent) =
            ForkServerEvent(sessionClosed = sessionClosed)
         ...
         */
        @JvmStatic
        fun ofErrorEvent(errorEvent: ErrorEvent) = ForkServerEvent(errorEvent = errorEvent)

        /**
         * An informational notice about the Live session, such as the event permissions applied to
         * a frontend data channel.
         */
        @JvmStatic fun ofInfoEvent(infoEvent: InfoEvent) = ForkServerEvent(infoEvent = infoEvent)
        ...
        fun ofTransportDtmfSend(transportDtmfSend: TransportDtmfSend) =
            ForkServerEvent(transportDtmfSend = transportDtmfSend)
        ...
        fun ofTransportRinging(transportRinging: TransportRinging) =
            ForkServerEvent(transportRinging = transportRinging)
        ...
        fun ofTransportAnswered(transportAnswered: TransportAnswered) =
            ForkServerEvent(transportAnswered = transportAnswered)

        /** An asynchronous outbound SIP setup failure. Delivered only to sideband observers. */
        @JvmStatic
        fun ofTransportFailed(transportFailed: TransportFailed) =
            ForkServerEvent(transportFailed = transportFailed)
    }

    /**
     * An interface that defines how to map each variant of [ForkServerEvent] to a value of type
     * [T].
     */
    interface Visitor<out T> {
        ...
        fun visitSessionStarted(sessionStarted: SessionStartedEvent): T =
            unknown(JsonValue.from(sessionStarted))
        ...
        fun visitSessionInputAudioMuted(sessionInputAudioMuted: InputAudioMutedEvent): T =
            unknown(JsonValue.from(sessionInputAudioMuted))
        ...
        fun visitSessionInputAudioUnmuted(sessionInputAudioUnmuted: InputAudioUnmutedEvent): T =
            unknown(JsonValue.from(sessionInputAudioUnmuted))
        ...
        fun visitSessionInstructionsAppended(
            sessionInstructionsAppended: InstructionsAppendedEvent
        ): T = unknown(JsonValue.from(sessionInstructionsAppended))
        ...
        fun visitSessionThinkingAppended(sessionThinkingAppended: ThinkingAppendedEvent): T =
            unknown(JsonValue.from(sessionThinkingAppended))
        ...
        fun visitSessionCommentaryAppended(sessionCommentaryAppended: CommentaryAppendedEvent): T =
            unknown(JsonValue.from(sessionCommentaryAppended))
        ...
        fun visitSessionOutputAudioDelta(sessionOutputAudioDelta: OutputAudioDeltaEvent): T =
            unknown(JsonValue.from(sessionOutputAudioDelta))
        ...
        fun visitSessionDelegationCreated(sessionDelegationCreated: DelegationCreatedEvent): T =
            unknown(JsonValue.from(sessionDelegationCreated))
        ...
        fun visitResponseEvent(responseEvent: ResponseEvent): T =
            unknown(JsonValue.from(responseEvent))
        ...
        fun visitSessionUsageUpdated(sessionUsageUpdated: SessionUsageUpdatedEvent): T =
            unknown(JsonValue.from(sessionUsageUpdated))
         ...
         * a frontend data channel.
         */
        fun visitInfoEvent(infoEvent: InfoEvent): T = unknown(JsonValue.from(infoEvent))
        ...
        fun visitTransportDtmfSend(transportDtmfSend: TransportDtmfSend): T =
            unknown(JsonValue.from(transportDtmfSend))
        ...
        fun visitTransportRinging(transportRinging: TransportRinging): T =
            unknown(JsonValue.from(transportRinging))
        ...
        fun visitTransportAnswered(transportAnswered: TransportAnswered): T =
            unknown(JsonValue.from(transportAnswered))

        /** An asynchronous outbound SIP setup failure. Delivered only to sideband observers. */
        fun visitTransportFailed(transportFailed: TransportFailed): T =
            unknown(JsonValue.from(transportFailed))

        /**
         * Maps an unknown variant of [ForkServerEvent] to a value of type [T].
         *
         * An instance of [ForkServerEvent] can contain an unknown variant if it was deserialized
        ...
        fun unknown(json: JsonValue?): T {
            throw OpenAIInvalidDataException("Unknown ForkServerEvent: $json")
        }
    }

    internal class Deserializer : BaseDeserializer<ForkServerEvent>(ForkServerEvent::class) {

        override fun ObjectCodec.deserialize(node: JsonNode): ForkServerEvent {
