...
private constructor(
    ...
    private constructor(
        ...
        @ExcludeMissing
        hyperparameters: JsonField<ReinforcementHyperparameters> = JsonMissing.of(),
    ) : this(grader, hyperparameters, mutableMapOf())
     ...
     */
    fun hyperparameters(): Optional<ReinforcementHyperparameters> =
    ...
    @JsonProperty("hyperparameters")
    @ExcludeMissing
    fun _hyperparameters(): JsonField<ReinforcementHyperparameters> = hyperparameters
    ...
    /** A builder for [ReinforcementMethod]. */
    class Builder internal constructor() {

        private var grader: JsonField<Grader>? = null
        private var hyperparameters: JsonField<ReinforcementHyperparameters> = JsonMissing.of()
        private var additionalProperties: MutableMap<String, JsonValue> = mutableMapOf()

        @JvmSynthetic
        internal fun from(reinforcementMethod: ReinforcementMethod) = apply {
            grader = reinforcementMethod.grader
            hyperparameters = reinforcementMethod.hyperparameters
            additionalProperties = reinforcementMethod.additionalProperties.toMutableMap()
        }
        ...
        /** The hyperparameters used for the reinforcement fine-tuning job. */
        fun hyperparameters(hyperparameters: ReinforcementHyperparameters) =
         ...
         * [ReinforcementHyperparameters] value instead. This method is primarily for setting the
         * field to an undocumented or not yet supported value.
         */
        fun hyperparameters(hyperparameters: JsonField<ReinforcementHyperparameters>) = apply {
        ...
        /**
         * Returns an immutable instance of [ReinforcementMethod].
         *
     ...
     *   expected type.
     */
    fun validate(): ReinforcementMethod = apply {
        if (validated) {
            return@apply
        }
    ...
    private constructor(
         ...
         * import java.util.Optional;
         *
         * Optional<String> result = grader.accept(new Grader.Visitor<Optional<String>>() {
         *     @Override
         *     public Optional<String> visitStringCheck(StringCheckGrader stringCheck) {
         *         return Optional.of(stringCheck.toString());
         *     }
         *
         *     // ...
         *
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is ReinforcementMethod &&
            grader == other.grader &&
    ...
    private val hashCode: Int by lazy {
        Objects.hash(grader, hyperparameters, additionalProperties)
    }

    override fun hashCode(): Int = hashCode

    override fun toString() =
        "ReinforcementMethod{grader=$grader, hyperparameters=$hyperparameters, additionalProperties=$additionalProperties}"
}
