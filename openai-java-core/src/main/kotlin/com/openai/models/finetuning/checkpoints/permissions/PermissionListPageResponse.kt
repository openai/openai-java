...
class PermissionListPageResponse
@JsonCreator(mode = JsonCreator.Mode.DISABLED)
private constructor(
    private val data: JsonField<List<PermissionListResponse>>,
    ...
    private constructor(
        @JsonProperty("data")
        @ExcludeMissing
        data: JsonField<List<PermissionListResponse>> = JsonMissing.of(),
     ...
     */
    fun data(): List<PermissionListResponse> = data.getRequired("data")
    ...
    @JsonProperty("data")
    @ExcludeMissing
    fun _data(): JsonField<List<PermissionListResponse>> = data
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [PermissionListPageResponse].
         *
    ...
    /** A builder for [PermissionListPageResponse]. */
    class Builder internal constructor() {

        private var data: JsonField<MutableList<PermissionListResponse>>? = null
        ...
        @JvmSynthetic
        internal fun from(permissionListPageResponse: PermissionListPageResponse) = apply {
            data = permissionListPageResponse.data.map { it.toMutableList() }
            hasMore = permissionListPageResponse.hasMore
            object_ = permissionListPageResponse.object_
            firstId = permissionListPageResponse.firstId
            lastId = permissionListPageResponse.lastId
            additionalProperties = permissionListPageResponse.additionalProperties.toMutableMap()
        }

        fun data(data: List<PermissionListResponse>) = data(JsonField.of(data))

        /**
         * Sets [Builder.data] to an arbitrary JSON value.
         *
         * You should usually call [Builder.data] with a well-typed `List<PermissionListResponse>`
         * value instead. This method is primarily for setting the field to an undocumented or not
         * yet supported value.
         */
        fun data(data: JsonField<List<PermissionListResponse>>) = apply {
            this.data = data.map { it.toMutableList() }
        }

        /**
         * Adds a single [PermissionListResponse] to [Builder.data].
         *
         * @throws IllegalStateException if the field was previously set to a non-list.
         */
        fun addData(data: PermissionListResponse) = apply {
            this.data =
        ...
        /**
         * Returns an immutable instance of [PermissionListPageResponse].
         *
         ...
         */
        fun build(): PermissionListPageResponse =
            PermissionListPageResponse(
     ...
     *   expected type.
     */
    fun validate(): PermissionListPageResponse = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is PermissionListPageResponse &&
            data == other.data &&
    ...
    override fun toString() =
        "PermissionListPageResponse{data=$data, hasMore=$hasMore, object_=$object_, firstId=$firstId, lastId=$lastId, additionalProperties=$additionalProperties}"
}
