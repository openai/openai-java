...
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [SupervisedHyperparameters].
         */
    ...
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(supervisedHyperparameters: SupervisedHyperparameters) = apply {
            batchSize = supervisedHyperparameters.batchSize
            learningRateMultiplier = supervisedHyperparameters.learningRateMultiplier
            nEpochs = supervisedHyperparameters.nEpochs
            additionalProperties = supervisedHyperparameters.additionalProperties.toMutableMap()
        }
         ...
         */
        fun build(): SupervisedHyperparameters =
     ...
     *   expected type.
     */
    fun validate(): SupervisedHyperparameters = apply {
        if (validated) {
            return@apply
        }
    ...
    private constructor(
         ...
         * import java.util.Optional;
         *
         * Optional<String> result = batchSize.accept(new BatchSize.Visitor<Optional<String>>() {
         *     @Override
         *     public Optional<String> visitAuto(JsonValue auto) {
    ...
    private constructor(
         ...
         * import java.util.Optional;
         *
         * Optional<String> result = learningRateMultiplier.accept(new LearningRateMultiplier.Visitor<Optional<String>>() {
         *     @Override
         *     public Optional<String> visitAuto(JsonValue auto) {
         *         return Optional.of(auto.toString());
         *     }
    ...
    private constructor(
         ...
         * import java.util.Optional;
         *
         * Optional<String> result = nEpochs.accept(new NEpochs.Visitor<Optional<String>>() {
         *     @Override
         *     public Optional<String> visitAuto(JsonValue auto) {
         *         return Optional.of(auto.toString());
         *     }
    ...
    override fun toString() =
        "SupervisedHyperparameters{batchSize=$batchSize, learningRateMultiplier=$learningRateMultiplier, nEpochs=$nEpochs, additionalProperties=$additionalProperties}"
}
