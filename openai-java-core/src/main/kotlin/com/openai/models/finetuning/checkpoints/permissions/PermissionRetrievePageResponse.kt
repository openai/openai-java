...
class PermissionRetrievePageResponse
private constructor(
    private val data: JsonField<List<PermissionRetrieveResponse>>,
    ...
    private constructor(
        @JsonProperty("data")
        @ExcludeMissing
        data: JsonField<List<PermissionRetrieveResponse>> = JsonMissing.of(),
     ...
     */
    fun data(): List<PermissionRetrieveResponse> = data.getRequired("data")
    ...
    @JsonProperty("data")
    @ExcludeMissing
    fun _data(): JsonField<List<PermissionRetrieveResponse>> = data
    ...
    companion object {
         ...
         * [PermissionRetrievePageResponse].
         *
    ...
    /** A builder for [PermissionRetrievePageResponse]. */
    class Builder internal constructor() {

        private var data: JsonField<MutableList<PermissionRetrieveResponse>>? = null
        ...
        @JvmSynthetic
        internal fun from(permissionRetrievePageResponse: PermissionRetrievePageResponse) = apply {
            data = permissionRetrievePageResponse.data.map { it.toMutableList() }
            hasMore = permissionRetrievePageResponse.hasMore
            object_ = permissionRetrievePageResponse.object_
            firstId = permissionRetrievePageResponse.firstId
            lastId = permissionRetrievePageResponse.lastId
            additionalProperties =
                permissionRetrievePageResponse.additionalProperties.toMutableMap()
        }

        fun data(data: List<PermissionRetrieveResponse>) = data(JsonField.of(data))

        /**
         * Sets [Builder.data] to an arbitrary JSON value.
         *
         * You should usually call [Builder.data] with a well-typed
         * `List<PermissionRetrieveResponse>` value instead. This method is primarily for setting
         * the field to an undocumented or not yet supported value.
         */
        fun data(data: JsonField<List<PermissionRetrieveResponse>>) = apply {
            this.data = data.map { it.toMutableList() }
        }

        /**
         * Adds a single [PermissionRetrieveResponse] to [Builder.data].
         *
         * @throws IllegalStateException if the field was previously set to a non-list.
         */
        fun addData(data: PermissionRetrieveResponse) = apply {
            this.data =
        ...
        /**
         * Returns an immutable instance of [PermissionRetrievePageResponse].
         *
         ...
         */
        fun build(): PermissionRetrievePageResponse =
            PermissionRetrievePageResponse(
    ...
    fun validate(): PermissionRetrievePageResponse = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return /* spotless:off */ other is PermissionRetrievePageResponse && data == other.data && hasMore == other.hasMore && object_ == other.object_ && firstId == other.firstId && lastId == other.lastId && additionalProperties == other.additionalProperties /* spotless:on */
    }
    ...
    override fun toString() =
        "PermissionRetrievePageResponse{data=$data, hasMore=$hasMore, object_=$object_, firstId=$firstId, lastId=$lastId, additionalProperties=$additionalProperties}"
}
