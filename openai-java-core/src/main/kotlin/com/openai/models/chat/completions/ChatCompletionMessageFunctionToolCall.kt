...
private constructor(
    ...
    /** A builder for [ChatCompletionMessageFunctionToolCall]. */
    class Builder internal constructor() {
        ...
        internal fun from(
            ...
            id = chatCompletionMessageFunctionToolCall.id
            function = chatCompletionMessageFunctionToolCall.function
            type = chatCompletionMessageFunctionToolCall.type
            additionalProperties =
                chatCompletionMessageFunctionToolCall.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [ChatCompletionMessageFunctionToolCall].
         *
         ...
         */
        fun build(): ChatCompletionMessageFunctionToolCall =
            ChatCompletionMessageFunctionToolCall(
                checkRequired("id", id),
    ...
    fun validate(): ChatCompletionMessageFunctionToolCall = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return /* spotless:off */ other is ChatCompletionMessageFunctionToolCall && id == other.id && function == other.function && type == other.type && additionalProperties == other.additionalProperties /* spotless:on */
    }
    ...
    override fun toString() =
        "ChatCompletionMessageFunctionToolCall{id=$id, function=$function, type=$type, additionalProperties=$additionalProperties}"
}
