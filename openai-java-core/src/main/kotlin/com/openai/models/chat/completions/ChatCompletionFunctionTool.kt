...
private constructor(
    ...
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(chatCompletionFunctionTool: ChatCompletionFunctionTool) = apply {
            function = chatCompletionFunctionTool.function
            type = chatCompletionFunctionTool.type
            additionalProperties = chatCompletionFunctionTool.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [ChatCompletionFunctionTool].
         *
         ...
         */
        fun build(): ChatCompletionFunctionTool =
    ...
    fun validate(): ChatCompletionFunctionTool = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return /* spotless:off */ other is ChatCompletionFunctionTool && function == other.function && type == other.type && additionalProperties == other.additionalProperties /* spotless:on */
    }
    ...
    override fun toString() =
        "ChatCompletionFunctionTool{function=$function, type=$type, additionalProperties=$additionalProperties}"
}
