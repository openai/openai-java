...
private constructor(
    ...
    private constructor(
        ...
        private constructor(
             ...
             * import java.util.Optional;
             *
             * Optional<String> result = chatCompletionRequestAssistantMessageContentPart.accept(new ChatCompletionRequestAssistantMessageContentPart.Visitor<Optional<String>>() {
             *     @Override
            ...
            interface Visitor<out T> {
                ...
                fun unknown(json: JsonValue?): T {
                    throw OpenAIInvalidDataException(
                        "Unknown ChatCompletionRequestAssistantMessageContentPart"
                    )
                }
            }
