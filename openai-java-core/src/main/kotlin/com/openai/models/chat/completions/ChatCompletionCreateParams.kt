...
private constructor(
    ...
    class Builder internal constructor() {
        ...
        /**
         * Sets response format to a JSON schema derived from the structure of the given class. This
         * changes the builder to a type-safe [StructuredChatCompletionCreateParams.Builder] that
         * will build a [StructuredChatCompletionCreateParams] instance when `build()` is called.
         *
