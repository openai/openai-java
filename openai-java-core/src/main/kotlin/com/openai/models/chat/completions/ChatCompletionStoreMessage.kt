...
private constructor(
    ...
    private constructor(
         ...
         * import java.util.Optional;
         *
         * Optional<String> result = contentPart.accept(new ContentPart.Visitor<Optional<String>>() {
         *     @Override
         *     public Optional<String> visitChatCompletionContentPartText(ChatCompletionContentPartText chatCompletionContentPartText) {
         *         return Optional.of(chatCompletionContentPartText.toString());
         *     }
         *
         *     // ...
         *
        ...
        interface Visitor<out T> {
            ...
            fun visitChatCompletionContentPartText(
                chatCompletionContentPartText: ChatCompletionContentPartText
            ): T = unknown(JsonValue.from(chatCompletionContentPartText))
            ...
            fun visitChatCompletionContentPartImage(
                chatCompletionContentPartImage: ChatCompletionContentPartImage
            ): T = unknown(JsonValue.from(chatCompletionContentPartImage))
