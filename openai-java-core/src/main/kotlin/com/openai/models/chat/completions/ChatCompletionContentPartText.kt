...
private constructor(
    ...
    class Builder internal constructor() {
        ...
        internal fun from(chatCompletionContentPartText: ChatCompletionContentPartText) = apply {
            ...
            promptCacheBreakpoint = chatCompletionContentPartText.promptCacheBreakpoint
    ...
    override fun toString() =
        "ChatCompletionContentPartText{text=$text, type=$type, promptCacheBreakpoint=$promptCacheBreakpoint, additionalProperties=$additionalProperties}"
}
