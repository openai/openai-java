...
private constructor(
     ...
     * import java.util.Optional;
     *
     * Optional<String> result = chatCompletionToolChoiceOption.accept(new ChatCompletionToolChoiceOption.Visitor<Optional<String>>() {
     *     @Override
    ...
    interface Visitor<out T> {
        ...
        fun unknown(json: JsonValue?): T {
            throw OpenAIInvalidDataException("Unknown ChatCompletionToolChoiceOption")
        }
    }
