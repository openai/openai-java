...
private constructor(
    ...
    ) : this(inputAudio, type, promptCacheBreakpoint, mutableMapOf())
    ...
    class Builder internal constructor() {
        ...
        internal fun from(
            ...
            promptCacheBreakpoint = chatCompletionContentPartInputAudio.promptCacheBreakpoint
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is ChatCompletionContentPartInputAudio &&
    ...
    private val hashCode: Int by lazy {
        Objects.hash(inputAudio, type, promptCacheBreakpoint, additionalProperties)
    }

    override fun hashCode(): Int = hashCode

    override fun toString() =
        "ChatCompletionContentPartInputAudio{inputAudio=$inputAudio, type=$type, promptCacheBreakpoint=$promptCacheBreakpoint, additionalProperties=$additionalProperties}"
}
