...
private constructor(
     ...
     * import java.util.Optional;
     *
     * Optional<String> result = chatCompletionMessageToolCall.accept(new ChatCompletionMessageToolCall.Visitor<Optional<String>>() {
     *     @Override
     *     public Optional<String> visitFunction(ChatCompletionMessageFunctionToolCall function) {
    ...
    interface Visitor<out T> {
        ...
        fun unknown(json: JsonValue?): T {
            throw OpenAIInvalidDataException("Unknown ChatCompletionMessageToolCall")
        }
    }
