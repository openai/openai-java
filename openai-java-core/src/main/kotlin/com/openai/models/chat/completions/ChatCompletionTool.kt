...
private constructor(
     ...
     * import java.util.Optional;
     *
     * Optional<String> result = chatCompletionTool.accept(new ChatCompletionTool.Visitor<Optional<String>>() {
     *     @Override
     *     public Optional<String> visitFunction(ChatCompletionFunctionTool function) {
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is ChatCompletionTool && function == other.function && custom == other.custom
    }
    ...
    interface Visitor<out T> {
        ...
        /** A custom tool that processes input using a specified format. */
        fun visitCustom(custom: ChatCompletionCustomTool): T = unknown(JsonValue.from(custom))
