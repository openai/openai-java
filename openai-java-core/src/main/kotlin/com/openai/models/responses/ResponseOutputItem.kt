...
private constructor(
     ...
     * import java.util.Optional;
     *
     * Optional<String> result = responseOutputItem.accept(new ResponseOutputItem.Visitor<Optional<String>>() {
     *     @Override
     *     public Optional<String> visitMessage(ResponseOutputMessage message) {
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is ResponseOutputItem &&
    ...
    override fun toString(): String =
        when {
            ...
            program != null -> "ResponseOutputItem{program=$program}"
            programOutput != null -> "ResponseOutputItem{programOutput=$programOutput}"
            ...
            additionalTools != null -> "ResponseOutputItem{additionalTools=$additionalTools}"
            compaction != null -> "ResponseOutputItem{compaction=$compaction}"
    ...
    companion object {
        ...
        @JvmStatic fun ofProgram(program: Program) = ResponseOutputItem(program = program)

        @JvmStatic
        fun ofProgramOutput(programOutput: ProgramOutput) =
            ResponseOutputItem(programOutput = programOutput)

        @JvmStatic
        fun ofToolSearchCall(toolSearchCall: ResponseToolSearchCall) =
            ResponseOutputItem(toolSearchCall = toolSearchCall)

        @JvmStatic
        fun ofToolSearchOutput(toolSearchOutput: ResponseToolSearchOutputItem) =
            ResponseOutputItem(toolSearchOutput = toolSearchOutput)

        @JvmStatic
        fun ofAdditionalTools(additionalTools: AdditionalTools) =
            ResponseOutputItem(additionalTools = additionalTools)
