...
private constructor(
    ...
    interface Visitor<out T> {
        ...
        fun unknown(json: JsonValue?): T {
            throw OpenAIInvalidDataException("Unknown ComputerAction")
        }
    }

    internal class Deserializer : BaseDeserializer<ComputerAction>(ComputerAction::class) {
    ...
    internal class Serializer : BaseSerializer<ComputerAction>(ComputerAction::class) {
