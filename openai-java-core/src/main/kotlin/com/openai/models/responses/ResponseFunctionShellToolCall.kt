...
private constructor(
    ...
    ) : this(id, action, callId, environment, status, type, caller, createdBy, mutableMapOf())
    ...
    class Builder internal constructor() {
        ...
        internal fun from(responseFunctionShellToolCall: ResponseFunctionShellToolCall) = apply {
            ...
            caller = responseFunctionShellToolCall.caller
    ...
    private constructor(
         ...
         *     @Override
         *     public Optional<String> visitLocal(ResponseLocalEnvironment local) {
        ...
        interface Visitor<out T> {
            ...
            /** Represents the use of a local environment to perform shell actions. */
            fun visitLocal(local: ResponseLocalEnvironment): T = unknown(JsonValue.from(local))
    ...
    override fun toString() =
        "ResponseFunctionShellToolCall{id=$id, action=$action, callId=$callId, environment=$environment, status=$status, type=$type, caller=$caller, createdBy=$createdBy, additionalProperties=$additionalProperties}"
}
