...
private constructor(
    ...
    /** A builder for [ResponseQueuedEvent]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(responseQueuedEvent: ResponseQueuedEvent) = apply {
            response = responseQueuedEvent.response
            sequenceNumber = responseQueuedEvent.sequenceNumber
            type = responseQueuedEvent.type
            additionalProperties = responseQueuedEvent.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [ResponseQueuedEvent].
         *
    ...
    fun validate(): ResponseQueuedEvent = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return /* spotless:off */ other is ResponseQueuedEvent && response == other.response && sequenceNumber == other.sequenceNumber && type == other.type && additionalProperties == other.additionalProperties /* spotless:on */
    }
    ...
    override fun toString() =
        "ResponseQueuedEvent{response=$response, sequenceNumber=$sequenceNumber, type=$type, additionalProperties=$additionalProperties}"
}
