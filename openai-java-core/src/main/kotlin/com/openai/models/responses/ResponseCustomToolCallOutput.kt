...
private constructor(
    ...
    ) : this(callId, output, type, id, caller, mutableMapOf())
    ...
    class Builder internal constructor() {
        ...
        internal fun from(responseCustomToolCallOutput: ResponseCustomToolCallOutput) = apply {
            ...
            caller = responseCustomToolCallOutput.caller
    ...
    private val hashCode: Int by lazy {
        Objects.hash(callId, output, type, id, caller, additionalProperties)
    }

    override fun hashCode(): Int = hashCode

    override fun toString() =
        "ResponseCustomToolCallOutput{callId=$callId, output=$output, type=$type, id=$id, caller=$caller, additionalProperties=$additionalProperties}"
}
