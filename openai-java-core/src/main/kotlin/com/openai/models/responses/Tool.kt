...
private constructor(
    ...
    private val webSearchTool: WebSearchTool? = null,
     ...
     */
    fun webSearchTool(): Optional<WebSearchTool> = Optional.ofNullable(webSearchTool)
    ...
    fun isWebSearchTool(): Boolean = webSearchTool != null
     ...
     * [web search tool](https://platform.openai.com/docs/guides/tools-web-search).
     */
    fun asWebSearchTool(): WebSearchTool = webSearchTool.getOrThrow("webSearchTool")
    ...
    fun <T> accept(visitor: Visitor<T>): T =
        when {
            ...
            webSearchTool != null -> visitor.visitWebSearchTool(webSearchTool)
    ...
    fun validate(): Tool = apply {
        ...
        accept(
            object : Visitor<Unit> {
                ...
                override fun visitWebSearchTool(webSearchTool: WebSearchTool) {
                    webSearchTool.validate()
                }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is Tool &&
            ...
            webSearchTool == other.webSearchTool &&
            mcp == other.mcp &&
    ...
    override fun toString(): String =
        when {
            ...
            webSearchTool != null -> "Tool{webSearchTool=$webSearchTool}"
    ...
    companion object {
         ...
         */
        @JvmStatic
        fun ofWebSearchTool(webSearchTool: WebSearchTool) = Tool(webSearchTool = webSearchTool)
    ...
    interface Visitor<out T> {
         ...
         * [web search tool](https://platform.openai.com/docs/guides/tools-web-search).
         */
        fun visitWebSearchTool(webSearchTool: WebSearchTool): T
            ...
            val bestMatches =
                sequenceOf(
                        tryDeserialize(node, jacksonTypeRef<WebSearchTool>())?.let {
                            Tool(webSearchTool = it, _json = json)
                        },
                        tryDeserialize(node, jacksonTypeRef<WebSearchTool>())?.let {
                            Tool(webSearchTool = it, _json = json)
                        },
    ...
    internal class Serializer : BaseSerializer<Tool>(Tool::class) {
        ...
        override fun serialize(
            ...
            when {
                ...
                value.webSearchTool != null -> generator.writeObject(value.webSearchTool)
