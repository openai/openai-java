...
private constructor(
     ...
     * ```java
     * JsonValue.from("response.mcp_call.arguments_done")
     * ```
     *
    ...
    class Builder internal constructor() {
        ...
        private var type: JsonValue = JsonValue.from("response.mcp_call.arguments_done")
        private var additionalProperties: MutableMap<String, JsonValue> = mutableMapOf()

        @JvmSynthetic
        internal fun from(responseMcpCallArgumentsDoneEvent: ResponseMcpCallArgumentsDoneEvent) =
            apply {
                arguments = responseMcpCallArgumentsDoneEvent.arguments
                itemId = responseMcpCallArgumentsDoneEvent.itemId
                outputIndex = responseMcpCallArgumentsDoneEvent.outputIndex
                sequenceNumber = responseMcpCallArgumentsDoneEvent.sequenceNumber
                type = responseMcpCallArgumentsDoneEvent.type
        ...
        /**
         * Returns an immutable instance of [ResponseMcpCallArgumentsDoneEvent].
         *
         ...
         */
        fun build(): ResponseMcpCallArgumentsDoneEvent =
            ResponseMcpCallArgumentsDoneEvent(
    ...
    fun validate(): ResponseMcpCallArgumentsDoneEvent = apply {
        if (validated) {
            return@apply
        }
        ...
        sequenceNumber()
        _type().let {
            if (it != JsonValue.from("response.mcp_call.arguments_done")) {
    ...
    internal fun validity(): Int =
        (if (itemId.asKnown().isPresent) 1 else 0) +
            ...
            type.let { if (it == JsonValue.from("response.mcp_call.arguments_done")) 1 else 0 }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return /* spotless:off */ other is ResponseMcpCallArgumentsDoneEvent && arguments == other.arguments && itemId == other.itemId && outputIndex == other.outputIndex && sequenceNumber == other.sequenceNumber && type == other.type && additionalProperties == other.additionalProperties /* spotless:on */
    }
    ...
    override fun toString() =
        "ResponseMcpCallArgumentsDoneEvent{arguments=$arguments, itemId=$itemId, outputIndex=$outputIndex, sequenceNumber=$sequenceNumber, type=$type, additionalProperties=$additionalProperties}"
}
