...
private constructor(
    ...
    ) : this(type, detail, fileId, imageUrl, mutableMapOf())
    ...
    private val hashCode: Int by lazy {
        Objects.hash(type, detail, fileId, imageUrl, additionalProperties)
    }

    override fun hashCode(): Int = hashCode

    override fun toString() =
        "ResponseInputImageContent{type=$type, detail=$detail, fileId=$fileId, imageUrl=$imageUrl, additionalProperties=$additionalProperties}"
}
