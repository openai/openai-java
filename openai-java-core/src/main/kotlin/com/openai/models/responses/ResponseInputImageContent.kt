...
private constructor(
    ...
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(responseInputImageContent: ResponseInputImageContent) = apply {
            type = responseInputImageContent.type
            detail = responseInputImageContent.detail
            fileId = responseInputImageContent.fileId
            imageUrl = responseInputImageContent.imageUrl
            promptCacheBreakpoint = responseInputImageContent.promptCacheBreakpoint
            additionalProperties = responseInputImageContent.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [ResponseInputImageContent].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): ResponseInputImageContent =
     ...
     *   expected type.
     */
    fun validate(): ResponseInputImageContent = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is ResponseInputImageContent &&
            type == other.type &&
            detail == other.detail &&
            fileId == other.fileId &&
    ...
    override fun toString() =
        "ResponseInputImageContent{type=$type, detail=$detail, fileId=$fileId, imageUrl=$imageUrl, promptCacheBreakpoint=$promptCacheBreakpoint, additionalProperties=$additionalProperties}"
}
