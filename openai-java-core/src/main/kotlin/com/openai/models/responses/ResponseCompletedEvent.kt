...
private constructor(
    ...
    class Builder internal constructor() {
        ...
        internal fun from(responseCompletedEvent: ResponseCompletedEvent) = apply {
            ...
            sequenceNumber = responseCompletedEvent.sequenceNumber
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return /* spotless:off */ other is ResponseCompletedEvent && response == other.response && sequenceNumber == other.sequenceNumber && type == other.type && additionalProperties == other.additionalProperties /* spotless:on */
    }
    ...
    override fun toString() =
        "ResponseCompletedEvent{response=$response, sequenceNumber=$sequenceNumber, type=$type, additionalProperties=$additionalProperties}"
}
