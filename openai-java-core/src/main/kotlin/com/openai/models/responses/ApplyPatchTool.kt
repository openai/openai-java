...
private constructor(
    ...
    class Builder internal constructor() {
        ...
        internal fun from(applyPatchTool: ApplyPatchTool) = apply {
            ...
            allowedCallers = applyPatchTool.allowedCallers.map { it.toMutableList() }
    ...
    override fun toString() =
        "ApplyPatchTool{type=$type, allowedCallers=$allowedCallers, additionalProperties=$additionalProperties}"
}
