...
private constructor(
    ...
    private constructor(
        ...
        ) : this(context, effort, summary, generateSummary, mutableMapOf())
        ...
        private val hashCode: Int by lazy {
            Objects.hash(context, effort, summary, generateSummary, additionalProperties)
        }

        override fun hashCode(): Int = hashCode

        override fun toString() =
            "Reasoning{context=$context, effort=$effort, summary=$summary, generateSummary=$generateSummary, additionalProperties=$additionalProperties}"
    }
