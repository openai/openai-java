...
private constructor(
    ...
    class Builder internal constructor() {
        ...
        internal fun from(responseInputText: ResponseInputText) = apply {
            ...
            promptCacheBreakpoint = responseInputText.promptCacheBreakpoint
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is ResponseInputText &&
            text == other.text &&
            type == other.type &&
    ...
    override fun toString() =
        "ResponseInputText{text=$text, type=$type, promptCacheBreakpoint=$promptCacheBreakpoint, additionalProperties=$additionalProperties}"
}
