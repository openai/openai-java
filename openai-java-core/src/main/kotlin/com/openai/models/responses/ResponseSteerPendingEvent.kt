 ...
 * continuation.
 */
class ResponseSteerPendingEvent
@JsonCreator(mode = JsonCreator.Mode.DISABLED)
private constructor(
    private val reason: JsonField<ResponseSteerPendingReason>,
    private val requiredInput: JsonField<List<ResponseSteerRequiredInput>>,
    ...
    private constructor(
        @JsonProperty("reason")
        @ExcludeMissing
        reason: JsonField<ResponseSteerPendingReason> = JsonMissing.of(),
        @JsonProperty("required_input")
        @ExcludeMissing
        requiredInput: JsonField<List<ResponseSteerRequiredInput>> = JsonMissing.of(),
     ...
     */
    fun reason(): ResponseSteerPendingReason = reason.getRequired("reason")
     ...
     *   unexpectedly missing or null (e.g. if the server responded with an unexpected value).
     */
    fun requiredInput(): List<ResponseSteerRequiredInput> =
    ...
    @JsonProperty("reason")
    @ExcludeMissing
    fun _reason(): JsonField<ResponseSteerPendingReason> = reason
    ...
    @JsonProperty("required_input")
    @ExcludeMissing
    fun _requiredInput(): JsonField<List<ResponseSteerRequiredInput>> = requiredInput
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [ResponseSteerPendingEvent].
         *
    ...
    /** A builder for [ResponseSteerPendingEvent]. */
    class Builder internal constructor() {

        private var reason: JsonField<ResponseSteerPendingReason>? = null
        private var requiredInput: JsonField<MutableList<ResponseSteerRequiredInput>>? = null
        ...
        @JvmSynthetic
        internal fun from(responseSteerPendingEvent: ResponseSteerPendingEvent) = apply {
            reason = responseSteerPendingEvent.reason
            requiredInput = responseSteerPendingEvent.requiredInput.map { it.toMutableList() }
            sequenceNumber = responseSteerPendingEvent.sequenceNumber
            steer = responseSteerPendingEvent.steer
            type = responseSteerPendingEvent.type
            streamId = responseSteerPendingEvent.streamId
            additionalProperties = responseSteerPendingEvent.additionalProperties.toMutableMap()
        }
         ...
         *   decisions identified by `required_input`.
         */
        fun reason(reason: ResponseSteerPendingReason) = reason(JsonField.of(reason))

        /**
         * Sets [Builder.reason] to an arbitrary JSON value.
         *
         * You should usually call [Builder.reason] with a well-typed [ResponseSteerPendingReason]
         * value instead. This method is primarily for setting the field to an undocumented or not
         * yet supported value.
         */
        fun reason(reason: JsonField<ResponseSteerPendingReason>) = apply { this.reason = reason }

        /**
         * Sets [reason] to an arbitrary [String].
         *
         * You should usually call [reason] with a well-typed [ResponseSteerPendingReason] constant
         * instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun reason(value: String) = reason(ResponseSteerPendingReason.of(value))
         ...
         * in `response.create`.
         */
        fun requiredInput(requiredInput: List<ResponseSteerRequiredInput>) =
         ...
         * `List<ResponseSteerRequiredInput>` value instead. This method is primarily for setting
         * the field to an undocumented or not yet supported value.
         */
        fun requiredInput(requiredInput: JsonField<List<ResponseSteerRequiredInput>>) = apply {
            this.requiredInput = requiredInput.map { it.toMutableList() }
        }

        /**
         * Adds a single [ResponseSteerRequiredInput] to [Builder.requiredInput].
         *
         * @throws IllegalStateException if the field was previously set to a non-list.
         */
        fun addRequiredInput(requiredInput: ResponseSteerRequiredInput) = apply {
            this.requiredInput =
         ...
         */
        fun addRequiredInput(functionCallOutput: ResponseSteerRequiredInput.FunctionCallOutput) =
            addRequiredInput(ResponseSteerRequiredInput.ofFunctionCallOutput(functionCallOutput))
        ...
        fun addRequiredInput(
            customToolCallOutput: ResponseSteerRequiredInput.CustomToolCallOutput
        ) =
            addRequiredInput(
                ResponseSteerRequiredInput.ofCustomToolCallOutput(customToolCallOutput)
            )
         ...
         * ```java
         * ResponseSteerRequiredInput.CustomToolCallOutput.builder()
         *     .callId(callId)
         *     .build()
         * ```
         */
        fun addCustomToolCallOutputRequiredInput(callId: String) =
            addRequiredInput(
                ResponseSteerRequiredInput.CustomToolCallOutput.builder().callId(callId).build()
            )
         ...
         */
        fun addRequiredInput(computerCallOutput: ResponseSteerRequiredInput.ComputerCallOutput) =
            addRequiredInput(ResponseSteerRequiredInput.ofComputerCallOutput(computerCallOutput))

        /**
         * Alias for calling [addRequiredInput] with the following:
         * ```java
         * ResponseSteerRequiredInput.ComputerCallOutput.builder()
         *     .callId(callId)
         *     .build()
         * ```
         */
        fun addComputerCallOutputRequiredInput(callId: String) =
            addRequiredInput(
                ResponseSteerRequiredInput.ComputerCallOutput.builder().callId(callId).build()
            )
         ...
         */
        fun addRequiredInput(shellCallOutput: ResponseSteerRequiredInput.ShellCallOutput) =
            addRequiredInput(ResponseSteerRequiredInput.ofShellCallOutput(shellCallOutput))

        /**
         * Alias for calling [addRequiredInput] with the following:
         * ```java
         * ResponseSteerRequiredInput.ShellCallOutput.builder()
         *     .callId(callId)
         *     .build()
         * ```
         */
        fun addShellCallOutputRequiredInput(callId: String) =
            addRequiredInput(
                ResponseSteerRequiredInput.ShellCallOutput.builder().callId(callId).build()
            )
         ...
         */
        fun addRequiredInput(
            applyPatchCallOutput: ResponseSteerRequiredInput.ApplyPatchCallOutput
        ) =
            addRequiredInput(
                ResponseSteerRequiredInput.ofApplyPatchCallOutput(applyPatchCallOutput)
            )
         ...
         * Alias for calling [addRequiredInput] with the following:
         * ```java
         * ResponseSteerRequiredInput.ApplyPatchCallOutput.builder()
         *     .callId(callId)
         *     .build()
         * ```
         */
        fun addApplyPatchCallOutputRequiredInput(callId: String) =
            addRequiredInput(
                ResponseSteerRequiredInput.ApplyPatchCallOutput.builder().callId(callId).build()
            )
         ...
         */
        fun addRequiredInput(toolSearchOutput: ResponseSteerRequiredInput.ToolSearchOutput) =
            addRequiredInput(ResponseSteerRequiredInput.ofToolSearchOutput(toolSearchOutput))

        /**
         * Alias for calling [addRequiredInput] with the following:
         * ```java
         * ResponseSteerRequiredInput.ToolSearchOutput.builder()
         *     .callId(callId)
         *     .build()
         * ```
         */
        fun addToolSearchOutputRequiredInput(callId: String) =
            addRequiredInput(
                ResponseSteerRequiredInput.ToolSearchOutput.builder().callId(callId).build()
            )
         ...
         */
        fun addRequiredInput(mcpApprovalResponse: ResponseSteerRequiredInput.McpApprovalResponse) =
            addRequiredInput(ResponseSteerRequiredInput.ofMcpApprovalResponse(mcpApprovalResponse))
        ...
        /**
         * Returns an immutable instance of [ResponseSteerPendingEvent].
         *
         ...
         */
        fun build(): ResponseSteerPendingEvent =
     ...
     *   expected type.
     */
    fun validate(): ResponseSteerPendingEvent = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is ResponseSteerPendingEvent &&
            reason == other.reason &&
    ...
    override fun toString() =
        "ResponseSteerPendingEvent{reason=$reason, requiredInput=$requiredInput, sequenceNumber=$sequenceNumber, steer=$steer, type=$type, streamId=$streamId, additionalProperties=$additionalProperties}"
}
