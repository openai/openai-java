...
private constructor(
    ...
    class Builder internal constructor() {
        ...
        internal fun from(
            ...
            itemId = responseCodeInterpreterCallCompletedEvent.itemId
            outputIndex = responseCodeInterpreterCallCompletedEvent.outputIndex
            sequenceNumber = responseCodeInterpreterCallCompletedEvent.sequenceNumber
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return /* spotless:off */ other is ResponseCodeInterpreterCallCompletedEvent && itemId == other.itemId && outputIndex == other.outputIndex && sequenceNumber == other.sequenceNumber && type == other.type && additionalProperties == other.additionalProperties /* spotless:on */
    }
    ...
    override fun toString() =
        "ResponseCodeInterpreterCallCompletedEvent{itemId=$itemId, outputIndex=$outputIndex, sequenceNumber=$sequenceNumber, type=$type, additionalProperties=$additionalProperties}"
}
