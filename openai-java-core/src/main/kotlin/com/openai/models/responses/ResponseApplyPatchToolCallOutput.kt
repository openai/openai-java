...
private constructor(
    ...
    ) : this(id, callId, status, type, caller, createdBy, output, mutableMapOf())
    ...
    class Builder internal constructor() {
        ...
        internal fun from(responseApplyPatchToolCallOutput: ResponseApplyPatchToolCallOutput) =
            apply {
                ...
                caller = responseApplyPatchToolCallOutput.caller
    ...
    private val hashCode: Int by lazy {
        Objects.hash(id, callId, status, type, caller, createdBy, output, additionalProperties)
    }

    override fun hashCode(): Int = hashCode

    override fun toString() =
        "ResponseApplyPatchToolCallOutput{id=$id, callId=$callId, status=$status, type=$type, caller=$caller, createdBy=$createdBy, output=$output, additionalProperties=$additionalProperties}"
}
