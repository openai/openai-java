...
private constructor(
    ...
    class Builder internal constructor() {
        ...
        internal fun from(functionShellTool: FunctionShellTool) = apply {
            ...
            allowedCallers = functionShellTool.allowedCallers.map { it.toMutableList() }
    ...
    private constructor(
        ...
        interface Visitor<out T> {
            ...
            fun visitContainerAuto(containerAuto: ContainerAuto): T =
                unknown(JsonValue.from(containerAuto))

            fun visitLocal(local: LocalEnvironment): T = unknown(JsonValue.from(local))
    ...
    override fun toString() =
        "FunctionShellTool{type=$type, allowedCallers=$allowedCallers, environment=$environment, additionalProperties=$additionalProperties}"
}
