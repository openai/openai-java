...
private constructor(
    ...
    ) : this(commandIndex, itemId, output, outputIndex, sequenceNumber, type, mutableMapOf())
    ...
    /** A builder for [ResponseShellCallOutputContentDoneEvent]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(
            responseShellCallOutputContentDoneEvent: ResponseShellCallOutputContentDoneEvent
        ) = apply {
            commandIndex = responseShellCallOutputContentDoneEvent.commandIndex
            itemId = responseShellCallOutputContentDoneEvent.itemId
            output = responseShellCallOutputContentDoneEvent.output.map { it.toMutableList() }
            outputIndex = responseShellCallOutputContentDoneEvent.outputIndex
            sequenceNumber = responseShellCallOutputContentDoneEvent.sequenceNumber
            type = responseShellCallOutputContentDoneEvent.type
            additionalProperties =
                responseShellCallOutputContentDoneEvent.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [ResponseShellCallOutputContentDoneEvent].
         *
         ...
         */
        fun build(): ResponseShellCallOutputContentDoneEvent =
            ResponseShellCallOutputContentDoneEvent(
     ...
     *   expected type.
     */
    fun validate(): ResponseShellCallOutputContentDoneEvent = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is ResponseShellCallOutputContentDoneEvent &&
    ...
    override fun toString() =
        "ResponseShellCallOutputContentDoneEvent{commandIndex=$commandIndex, itemId=$itemId, output=$output, outputIndex=$outputIndex, sequenceNumber=$sequenceNumber, type=$type, additionalProperties=$additionalProperties}"
}
