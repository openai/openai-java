...
private constructor(
    ...
    ) : this(contentIndex, itemId, outputIndex, refusal, sequenceNumber, type, mutableMapOf())
    ...
    class Builder internal constructor() {
        ...
        internal fun from(responseRefusalDoneEvent: ResponseRefusalDoneEvent) = apply {
            ...
            sequenceNumber = responseRefusalDoneEvent.sequenceNumber
    ...
    override fun toString() =
        "ResponseRefusalDoneEvent{contentIndex=$contentIndex, itemId=$itemId, outputIndex=$outputIndex, refusal=$refusal, sequenceNumber=$sequenceNumber, type=$type, additionalProperties=$additionalProperties}"
}
