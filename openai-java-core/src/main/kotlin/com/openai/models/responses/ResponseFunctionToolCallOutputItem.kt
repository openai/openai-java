...
private constructor(
    ...
    ) : this(id, output, status, type, callId, caller, createdBy, name, namespace, mutableMapOf())
    ...
    override fun toString() =
        "ResponseFunctionToolCallOutputItem{id=$id, output=$output, status=$status, type=$type, callId=$callId, caller=$caller, createdBy=$createdBy, name=$name, namespace=$namespace, additionalProperties=$additionalProperties}"
}
