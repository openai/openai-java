...
private constructor(
     ...
     * import java.util.Optional;
     *
     * Optional<String> result = responseInputContent.accept(new ResponseInputContent.Visitor<Optional<String>>() {
     *     @Override
    ...
    interface Visitor<out T> {
        ...
        fun unknown(json: JsonValue?): T {
            throw OpenAIInvalidDataException("Unknown ResponseInputContent")
        }
    }
