...
private constructor(
    ...
    /** A builder for [ResponseCustomToolCallInputDeltaEvent]. */
    class Builder internal constructor() {
        ...
        internal fun from(
            ...
            delta = responseCustomToolCallInputDeltaEvent.delta
            itemId = responseCustomToolCallInputDeltaEvent.itemId
            outputIndex = responseCustomToolCallInputDeltaEvent.outputIndex
            sequenceNumber = responseCustomToolCallInputDeltaEvent.sequenceNumber
            type = responseCustomToolCallInputDeltaEvent.type
            additionalProperties =
                responseCustomToolCallInputDeltaEvent.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [ResponseCustomToolCallInputDeltaEvent].
         *
         ...
         */
        fun build(): ResponseCustomToolCallInputDeltaEvent =
            ResponseCustomToolCallInputDeltaEvent(
    ...
    fun validate(): ResponseCustomToolCallInputDeltaEvent = apply {
        if (validated) {
            return@apply
        }
    ...
    internal fun validity(): Int =
        (if (delta.asKnown().isPresent) 1 else 0) +
            ...
            type.let { if (it == JsonValue.from("response.custom_tool_call_input.delta")) 1 else 0 }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return /* spotless:off */ other is ResponseCustomToolCallInputDeltaEvent && delta == other.delta && itemId == other.itemId && outputIndex == other.outputIndex && sequenceNumber == other.sequenceNumber && type == other.type && additionalProperties == other.additionalProperties /* spotless:on */
    }
    ...
    override fun toString() =
        "ResponseCustomToolCallInputDeltaEvent{delta=$delta, itemId=$itemId, outputIndex=$outputIndex, sequenceNumber=$sequenceNumber, type=$type, additionalProperties=$additionalProperties}"
}
