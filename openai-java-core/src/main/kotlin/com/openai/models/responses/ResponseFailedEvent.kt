...
private constructor(
    ...
    class Builder internal constructor() {
        ...
        internal fun from(responseFailedEvent: ResponseFailedEvent) = apply {
            ...
            sequenceNumber = responseFailedEvent.sequenceNumber
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return /* spotless:off */ other is ResponseFailedEvent && response == other.response && sequenceNumber == other.sequenceNumber && type == other.type && additionalProperties == other.additionalProperties /* spotless:on */
    }
    ...
    override fun toString() =
        "ResponseFailedEvent{response=$response, sequenceNumber=$sequenceNumber, type=$type, additionalProperties=$additionalProperties}"
}
