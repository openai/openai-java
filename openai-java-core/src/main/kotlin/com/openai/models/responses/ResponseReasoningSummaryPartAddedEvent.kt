...
private constructor(
    ...
    class Builder internal constructor() {
        ...
        internal fun from(
            ...
            sequenceNumber = responseReasoningSummaryPartAddedEvent.sequenceNumber
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return /* spotless:off */ other is ResponseReasoningSummaryPartAddedEvent && itemId == other.itemId && outputIndex == other.outputIndex && part == other.part && sequenceNumber == other.sequenceNumber && summaryIndex == other.summaryIndex && type == other.type && additionalProperties == other.additionalProperties /* spotless:on */
    }
    ...
    override fun toString() =
        "ResponseReasoningSummaryPartAddedEvent{itemId=$itemId, outputIndex=$outputIndex, part=$part, sequenceNumber=$sequenceNumber, summaryIndex=$summaryIndex, type=$type, additionalProperties=$additionalProperties}"
}
