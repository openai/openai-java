...
private constructor(
    ...
    /** A builder for [ResponseShellCallCommandAddedEvent]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(responseShellCallCommandAddedEvent: ResponseShellCallCommandAddedEvent) =
            apply {
                command = responseShellCallCommandAddedEvent.command
                commandIndex = responseShellCallCommandAddedEvent.commandIndex
                outputIndex = responseShellCallCommandAddedEvent.outputIndex
                sequenceNumber = responseShellCallCommandAddedEvent.sequenceNumber
                type = responseShellCallCommandAddedEvent.type
                additionalProperties =
                    responseShellCallCommandAddedEvent.additionalProperties.toMutableMap()
            }
        ...
        /**
         * Returns an immutable instance of [ResponseShellCallCommandAddedEvent].
         *
         ...
         */
        fun build(): ResponseShellCallCommandAddedEvent =
            ResponseShellCallCommandAddedEvent(
     ...
     *   expected type.
     */
    fun validate(): ResponseShellCallCommandAddedEvent = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is ResponseShellCallCommandAddedEvent &&
    ...
    override fun toString() =
        "ResponseShellCallCommandAddedEvent{command=$command, commandIndex=$commandIndex, outputIndex=$outputIndex, sequenceNumber=$sequenceNumber, type=$type, additionalProperties=$additionalProperties}"
}
