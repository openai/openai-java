...
private constructor(
    ...
    /** A builder for [ResponseImageGenCallInProgressEvent]. */
    class Builder internal constructor() {
        ...
        internal fun from(
            ...
            itemId = responseImageGenCallInProgressEvent.itemId
            outputIndex = responseImageGenCallInProgressEvent.outputIndex
            sequenceNumber = responseImageGenCallInProgressEvent.sequenceNumber
            type = responseImageGenCallInProgressEvent.type
            additionalProperties =
                responseImageGenCallInProgressEvent.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [ResponseImageGenCallInProgressEvent].
         *
         ...
         */
        fun build(): ResponseImageGenCallInProgressEvent =
            ResponseImageGenCallInProgressEvent(
    ...
    fun validate(): ResponseImageGenCallInProgressEvent = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return /* spotless:off */ other is ResponseImageGenCallInProgressEvent && itemId == other.itemId && outputIndex == other.outputIndex && sequenceNumber == other.sequenceNumber && type == other.type && additionalProperties == other.additionalProperties /* spotless:on */
    }
    ...
    override fun toString() =
        "ResponseImageGenCallInProgressEvent{itemId=$itemId, outputIndex=$outputIndex, sequenceNumber=$sequenceNumber, type=$type, additionalProperties=$additionalProperties}"
}
