...
@JsonDeserialize(using = ResponsesClientEvent.Deserializer::class)
@JsonSerialize(using = ResponsesClientEvent.Serializer::class)
...
private constructor(
     ...
     */
    fun responseSteer(): Optional<ResponseSteerEvent> = Optional.ofNullable(responseSteer)
     ...
     * the target response determines the WebSocket lane.
     */
    fun asResponseSteer(): ResponseSteerEvent = responseSteer.getOrThrow("responseSteer")
     ...
     * import java.util.Optional;
     *
     * Optional<String> result = responsesClientEvent.accept(new ResponsesClientEvent.Visitor<Optional<String>>() {
     *     @Override
    ...
    fun validate(): ResponsesClientEvent = apply {
        ...
        accept(
            object : Visitor<Unit> {
                ...
                override fun visitResponseSteer(responseSteer: ResponseSteerEvent) {
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is ResponsesClientEvent &&
            responseCreate == other.responseCreate &&
            responseSteer == other.responseSteer
    }

    override fun hashCode(): Int = Objects.hash(responseCreate, responseSteer)

    override fun toString(): String =
        when {
            responseCreate != null -> "ResponsesClientEvent{responseCreate=$responseCreate}"
            responseSteer != null -> "ResponsesClientEvent{responseSteer=$responseSteer}"
            _json != null -> "ResponsesClientEvent{_unknown=$_json}"
            else -> throw IllegalStateException("Invalid ResponsesClientEvent")
        }
    ...
    companion object {
        ...
        fun ofResponseCreate(responseCreate: ResponseCreate) =
            ResponsesClientEvent(responseCreate = responseCreate)
         ...
         */
        @JvmStatic
        fun ofResponseSteer(responseSteer: ResponseSteerEvent) =
            ResponsesClientEvent(responseSteer = responseSteer)
    }

    /**
     * An interface that defines how to map each variant of [ResponsesClientEvent] to a value of
     * type [T].
     */
    interface Visitor<out T> {
         ...
         * `stream_id`; the target response determines the WebSocket lane.
         */
        fun visitResponseSteer(responseSteer: ResponseSteerEvent): T =
            unknown(JsonValue.from(responseSteer))

        /**
         * Maps an unknown variant of [ResponsesClientEvent] to a value of type [T].
         *
         * An instance of [ResponsesClientEvent] can contain an unknown variant if it was
        ...
        fun unknown(json: JsonValue?): T {
            throw OpenAIInvalidDataException("Unknown ResponsesClientEvent: $json")
        }
    }

    internal class Deserializer :
        BaseDeserializer<ResponsesClientEvent>(ResponsesClientEvent::class) {

        override fun ObjectCodec.deserialize(node: JsonNode): ResponsesClientEvent {
            ...
            when (type) {
                "response.create" -> {
                    return tryDeserialize(node, jacksonTypeRef<ResponseCreate>())?.let {
                        ResponsesClientEvent(responseCreate = it, _json = json)
                    } ?: ResponsesClientEvent(_json = json)
                }
                "response.steer" -> {
                    return tryDeserialize(node, jacksonTypeRef<ResponseSteerEvent>())?.let {
                        ResponsesClientEvent(responseSteer = it, _json = json)
                    } ?: ResponsesClientEvent(_json = json)
                }
            }

            return ResponsesClientEvent(_json = json)
        }
    }

    internal class Serializer : BaseSerializer<ResponsesClientEvent>(ResponsesClientEvent::class) {

        override fun serialize(
            value: ResponsesClientEvent,
    ...
    private constructor(
        ...
        private constructor(
            ...
            companion object {
                ...
                /** The conversation that this response belongs to. */
                @JvmStatic
                fun ofResponseConversationParam(
                    responseConversationParam: ResponseConversationParam
                ) = Conversation(responseConversationParam = responseConversationParam)
            }
            ...
            interface Visitor<out T> {
                ...
                fun visitResponseConversationParam(
                    responseConversationParam: ResponseConversationParam
                ): T = unknown(JsonValue.from(responseConversationParam))
            ...
            internal class Deserializer : BaseDeserializer<Conversation>(Conversation::class) {
                ...
                override fun ObjectCodec.deserialize(node: JsonNode): Conversation {
                    ...
                    val bestMatches =
                        sequenceOf(
                                tryDeserialize(node, jacksonTypeRef<ResponseConversationParam>())
                                    ?.let {
        ...
        private constructor(
            ...
            interface Visitor<out T> {
                ...
                fun visitResponse(response: List<ResponseInputItem>): T =
                    unknown(JsonValue.from(response))
                    ...
                    val bestMatches =
                        sequenceOf(
                                ...
                                tryDeserialize(node, jacksonTypeRef<List<ResponseInputItem>>())
                                    ?.let { Input(response = it, _json = json) },
                            )
                            .filterNotNull()
                            .allMaxBy { it.validity() }
                            .toList()
        ...
        private constructor(
            ...
            fun asSpecificProgrammaticToolCallingParam(): JsonValue =
                specificProgrammaticToolCallingParam.getOrThrow(
            ...
            companion object {
                ...
                /** Forces the model to call the apply_patch tool when executing a tool call. */
                @JvmStatic
                fun ofApplyPatch(applyPatch: ToolChoiceApplyPatch) =
                    ToolChoice(applyPatch = applyPatch)
