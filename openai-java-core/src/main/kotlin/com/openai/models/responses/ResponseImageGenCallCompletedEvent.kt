...
private constructor(
    ...
    /** A builder for [ResponseImageGenCallCompletedEvent]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(responseImageGenCallCompletedEvent: ResponseImageGenCallCompletedEvent) =
            apply {
                itemId = responseImageGenCallCompletedEvent.itemId
                outputIndex = responseImageGenCallCompletedEvent.outputIndex
                sequenceNumber = responseImageGenCallCompletedEvent.sequenceNumber
                type = responseImageGenCallCompletedEvent.type
                additionalProperties =
                    responseImageGenCallCompletedEvent.additionalProperties.toMutableMap()
            }
        ...
        /**
         * Returns an immutable instance of [ResponseImageGenCallCompletedEvent].
         *
         ...
         */
        fun build(): ResponseImageGenCallCompletedEvent =
            ResponseImageGenCallCompletedEvent(
    ...
    fun validate(): ResponseImageGenCallCompletedEvent = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return /* spotless:off */ other is ResponseImageGenCallCompletedEvent && itemId == other.itemId && outputIndex == other.outputIndex && sequenceNumber == other.sequenceNumber && type == other.type && additionalProperties == other.additionalProperties /* spotless:on */
    }
    ...
    override fun toString() =
        "ResponseImageGenCallCompletedEvent{itemId=$itemId, outputIndex=$outputIndex, sequenceNumber=$sequenceNumber, type=$type, additionalProperties=$additionalProperties}"
}
