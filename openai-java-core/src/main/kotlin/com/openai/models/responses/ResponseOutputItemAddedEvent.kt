...
private constructor(
    ...
    class Builder internal constructor() {
        ...
        internal fun from(responseOutputItemAddedEvent: ResponseOutputItemAddedEvent) = apply {
            ...
            sequenceNumber = responseOutputItemAddedEvent.sequenceNumber
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return /* spotless:off */ other is ResponseOutputItemAddedEvent && item == other.item && outputIndex == other.outputIndex && sequenceNumber == other.sequenceNumber && type == other.type && additionalProperties == other.additionalProperties /* spotless:on */
    }
    ...
    override fun toString() =
        "ResponseOutputItemAddedEvent{item=$item, outputIndex=$outputIndex, sequenceNumber=$sequenceNumber, type=$type, additionalProperties=$additionalProperties}"
}
