...
private constructor(
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is ResponseFunctionToolCallItem &&
    ...
    override fun toString() =
        "ResponseFunctionToolCallItem{arguments=$arguments, callId=$callId, name=$name, type=$type, id=$id, namespace=$namespace, status=$status, additionalProperties=$additionalProperties}"
}
