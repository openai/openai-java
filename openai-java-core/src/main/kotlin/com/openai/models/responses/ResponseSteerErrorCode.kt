...
private constructor(private val value: JsonField<String>) : Enum {
    ...
    companion object {
        ...
        @JvmStatic fun of(value: String) = ResponseSteerErrorCode(JsonField.of(value))
    }

    /** An enum containing [ResponseSteerErrorCode]'s known values. */
    enum class Known {
        RESPONSE_NOT_FOUND,
        INVALID_INPUT,
    ...
    /**
     * An enum containing [ResponseSteerErrorCode]'s known values, as well as an [_UNKNOWN] member.
     *
     * An instance of [ResponseSteerErrorCode] can contain an unknown value in a couple of cases:
    ...
    enum class Value {
        ...
        SUCCESSOR_CREATION_FAILED,
        /**
         * An enum member indicating that [ResponseSteerErrorCode] was instantiated with an unknown
         * value.
         */
        _UNKNOWN,
    }
    ...
    fun known(): Known =
        when (this) {
            ...
            else -> throw OpenAIInvalidDataException("Unknown ResponseSteerErrorCode: $value")
        }
     ...
     *   expected type.
     */
    fun validate(): ResponseSteerErrorCode = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is ResponseSteerErrorCode && value == other.value
    }
