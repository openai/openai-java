...
private constructor(
    ...
    companion object {
        ...
        /** Returns a mutable builder for constructing an instance of [ResponseInputFileContent]. */
        @JvmStatic fun builder() = Builder()
    }

    /** A builder for [ResponseInputFileContent]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(responseInputFileContent: ResponseInputFileContent) = apply {
            type = responseInputFileContent.type
            detail = responseInputFileContent.detail
            fileData = responseInputFileContent.fileData
            fileId = responseInputFileContent.fileId
            fileUrl = responseInputFileContent.fileUrl
            filename = responseInputFileContent.filename
            promptCacheBreakpoint = responseInputFileContent.promptCacheBreakpoint
            additionalProperties = responseInputFileContent.additionalProperties.toMutableMap()
        }
         ...
         */
        fun build(): ResponseInputFileContent =
     ...
     *   expected type.
     */
    fun validate(): ResponseInputFileContent = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is ResponseInputFileContent &&
            type == other.type &&
            detail == other.detail &&
    ...
    override fun toString() =
        "ResponseInputFileContent{type=$type, detail=$detail, fileData=$fileData, fileId=$fileId, fileUrl=$fileUrl, filename=$filename, promptCacheBreakpoint=$promptCacheBreakpoint, additionalProperties=$additionalProperties}"
}
