...
private constructor(
    ...
    /** A builder for [ResponseImageGenCallGeneratingEvent]. */
    class Builder internal constructor() {
        ...
        internal fun from(
            ...
            itemId = responseImageGenCallGeneratingEvent.itemId
            outputIndex = responseImageGenCallGeneratingEvent.outputIndex
            sequenceNumber = responseImageGenCallGeneratingEvent.sequenceNumber
            type = responseImageGenCallGeneratingEvent.type
            additionalProperties =
                responseImageGenCallGeneratingEvent.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [ResponseImageGenCallGeneratingEvent].
         *
         ...
         */
        fun build(): ResponseImageGenCallGeneratingEvent =
            ResponseImageGenCallGeneratingEvent(
    ...
    fun validate(): ResponseImageGenCallGeneratingEvent = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return /* spotless:off */ other is ResponseImageGenCallGeneratingEvent && itemId == other.itemId && outputIndex == other.outputIndex && sequenceNumber == other.sequenceNumber && type == other.type && additionalProperties == other.additionalProperties /* spotless:on */
    }
    ...
    override fun toString() =
        "ResponseImageGenCallGeneratingEvent{itemId=$itemId, outputIndex=$outputIndex, sequenceNumber=$sequenceNumber, type=$type, additionalProperties=$additionalProperties}"
}
