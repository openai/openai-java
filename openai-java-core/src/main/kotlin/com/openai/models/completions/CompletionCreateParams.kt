...
private constructor(
     ...
     * penalties.](https://developers.openai.com/api/docs/guides/text)
     *
     * @throws OpenAIInvalidDataException if the JSON field has an unexpected type (e.g. if the
     *   server responded with an unexpected value).
     */
     ...
     * [tokenizer tool](https://platform.openai.com/tokenizer?view=bpe) to convert text to token
    ...
    private constructor(
        ...
        class Builder internal constructor() {
             ...
             * [tokenizer tool](https://platform.openai.com/tokenizer?view=bpe) to convert text to
             * token IDs. Mathematically, the bias is added to the logits generated by the model
    ...
    private constructor(
         ...
         * import java.util.Optional;
         *
         * Optional<String> result = prompt.accept(new Prompt.Visitor<Optional<String>>() {
         *     @Override
