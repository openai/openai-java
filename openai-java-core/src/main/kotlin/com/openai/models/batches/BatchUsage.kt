...
private constructor(
    ...
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(batchUsage: BatchUsage) = apply {
            inputTokens = batchUsage.inputTokens
            inputTokensDetails = batchUsage.inputTokensDetails
            outputTokens = batchUsage.outputTokens
            outputTokensDetails = batchUsage.outputTokensDetails
            totalTokens = batchUsage.totalTokens
            additionalProperties = batchUsage.additionalProperties.toMutableMap()
        }
    ...
    override fun toString() =
        "BatchUsage{inputTokens=$inputTokens, inputTokensDetails=$inputTokensDetails, outputTokens=$outputTokens, outputTokensDetails=$outputTokensDetails, totalTokens=$totalTokens, additionalProperties=$additionalProperties}"
}
