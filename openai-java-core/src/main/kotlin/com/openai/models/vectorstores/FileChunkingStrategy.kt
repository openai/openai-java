...
private constructor(
     ...
     * import java.util.Optional;
     *
     * Optional<String> result = fileChunkingStrategy.accept(new FileChunkingStrategy.Visitor<Optional<String>>() {
     *     @Override
     *     public Optional<String> visitStatic(StaticFileChunkingStrategyObject static_) {
     *         return Optional.of(static_.toString());
     *     }
     *
     *     // ...
     *
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is FileChunkingStrategy &&
            static_ == other.static_ &&
            this.other == other.other
    }

    override fun hashCode(): Int = Objects.hash(static_, other)
    ...
    interface Visitor<out T> {
        ...
        fun unknown(json: JsonValue?): T {
            throw OpenAIInvalidDataException("Unknown FileChunkingStrategy")
        }
    }
