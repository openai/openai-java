...
private constructor(
    ...
    class Builder internal constructor() {
        ...
        fun build(): AlertRetrieveParams =
            AlertRetrieveParams(id, additionalHeaders.build(), additionalQueryParams.build())
    }
    ...
    override fun toString() =
        "AlertRetrieveParams{id=$id, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
