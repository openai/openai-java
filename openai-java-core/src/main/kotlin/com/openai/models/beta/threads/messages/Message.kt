        ...
        private constructor(
            ...
            override fun equals(other: Any?): Boolean {
                ...
                return other is Tool &&
                    ...
                    assistantToolsFileSearchTypeOnly == other.assistantToolsFileSearchTypeOnly
            }

            override fun hashCode(): Int =
                Objects.hash(codeInterpreter, assistantToolsFileSearchTypeOnly)
            ...
            interface Visitor<out T> {
                ...
                fun visitAssistantToolsFileSearchTypeOnly(
                    assistantToolsFileSearchTypeOnly: JsonValue
                ): T = unknown(JsonValue.from(assistantToolsFileSearchTypeOnly))
                    ...
                    val bestMatches =
                        sequenceOf(
                                tryDeserialize(node, jacksonTypeRef<JsonValue>())
                                    ?.let {
                                        Tool(assistantToolsFileSearchTypeOnly = it, _json = json)
                                    }
                                    ?.takeIf { it.isValid() },
