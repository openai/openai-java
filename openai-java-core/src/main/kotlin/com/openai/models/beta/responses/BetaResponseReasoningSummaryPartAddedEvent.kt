...
private constructor(
    ...
    ) : this(itemId, outputIndex, part, sequenceNumber, summaryIndex, type, agent, mutableMapOf())
    ...
    /** A builder for [BetaResponseReasoningSummaryPartAddedEvent]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(
            betaResponseReasoningSummaryPartAddedEvent: BetaResponseReasoningSummaryPartAddedEvent
        ) = apply {
            itemId = betaResponseReasoningSummaryPartAddedEvent.itemId
            outputIndex = betaResponseReasoningSummaryPartAddedEvent.outputIndex
            part = betaResponseReasoningSummaryPartAddedEvent.part
            sequenceNumber = betaResponseReasoningSummaryPartAddedEvent.sequenceNumber
            summaryIndex = betaResponseReasoningSummaryPartAddedEvent.summaryIndex
            type = betaResponseReasoningSummaryPartAddedEvent.type
            agent = betaResponseReasoningSummaryPartAddedEvent.agent
            additionalProperties =
                betaResponseReasoningSummaryPartAddedEvent.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [BetaResponseReasoningSummaryPartAddedEvent].
         *
         ...
         */
        fun build(): BetaResponseReasoningSummaryPartAddedEvent =
            BetaResponseReasoningSummaryPartAddedEvent(
     ...
     *   expected type.
     */
    fun validate(): BetaResponseReasoningSummaryPartAddedEvent = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is BetaResponseReasoningSummaryPartAddedEvent &&
            itemId == other.itemId &&
    ...
    override fun toString() =
        "BetaResponseReasoningSummaryPartAddedEvent{itemId=$itemId, outputIndex=$outputIndex, part=$part, sequenceNumber=$sequenceNumber, summaryIndex=$summaryIndex, type=$type, agent=$agent, additionalProperties=$additionalProperties}"
}
