...
private constructor(
    ...
    ) : this(id, arguments, callId, execution, status, type, agent, createdBy, mutableMapOf())
     ...
     * ```java
     * MyClass myObject = betaResponseToolSearchCall.arguments().convert(MyClass.class);
     * ```
     */
    ...
    /** A builder for [BetaResponseToolSearchCall]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(betaResponseToolSearchCall: BetaResponseToolSearchCall) = apply {
            id = betaResponseToolSearchCall.id
            arguments = betaResponseToolSearchCall.arguments
            callId = betaResponseToolSearchCall.callId
            execution = betaResponseToolSearchCall.execution
            status = betaResponseToolSearchCall.status
            type = betaResponseToolSearchCall.type
            agent = betaResponseToolSearchCall.agent
            createdBy = betaResponseToolSearchCall.createdBy
            additionalProperties = betaResponseToolSearchCall.additionalProperties.toMutableMap()
        }
         ...
         */
        fun build(): BetaResponseToolSearchCall =
     ...
     *   expected type.
     */
    fun validate(): BetaResponseToolSearchCall = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is BetaResponseToolSearchCall &&
            id == other.id &&
    ...
    override fun toString() =
        "BetaResponseToolSearchCall{id=$id, arguments=$arguments, callId=$callId, execution=$execution, status=$status, type=$type, agent=$agent, createdBy=$createdBy, additionalProperties=$additionalProperties}"
}
