...
private constructor(
    ...
    /** A builder for [BetaResponseCustomToolCallInputDeltaEvent]. */
    class Builder internal constructor() {
        ...
        internal fun from(
            ...
            delta = betaResponseCustomToolCallInputDeltaEvent.delta
            itemId = betaResponseCustomToolCallInputDeltaEvent.itemId
            outputIndex = betaResponseCustomToolCallInputDeltaEvent.outputIndex
            sequenceNumber = betaResponseCustomToolCallInputDeltaEvent.sequenceNumber
            type = betaResponseCustomToolCallInputDeltaEvent.type
            agent = betaResponseCustomToolCallInputDeltaEvent.agent
            additionalProperties =
                betaResponseCustomToolCallInputDeltaEvent.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [BetaResponseCustomToolCallInputDeltaEvent].
         *
         ...
         */
        fun build(): BetaResponseCustomToolCallInputDeltaEvent =
            BetaResponseCustomToolCallInputDeltaEvent(
     ...
     *   expected type.
     */
    fun validate(): BetaResponseCustomToolCallInputDeltaEvent = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is BetaResponseCustomToolCallInputDeltaEvent &&
            delta == other.delta &&
            itemId == other.itemId &&
    ...
    override fun toString() =
        "BetaResponseCustomToolCallInputDeltaEvent{delta=$delta, itemId=$itemId, outputIndex=$outputIndex, sequenceNumber=$sequenceNumber, type=$type, agent=$agent, additionalProperties=$additionalProperties}"
}
