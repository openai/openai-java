...
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [AgentDeleted].
         *
    ...
    /** A builder for [AgentDeleted]. */
    class Builder internal constructor() {

        private var id: JsonField<String>? = null
        private var deleted: JsonField<Boolean>? = null
        private var object_: JsonValue = JsonValue.from("agent.deleted")
        private var additionalProperties: MutableMap<String, JsonValue> = mutableMapOf()

        @JvmSynthetic
        internal fun from(agentDeleted: AgentDeleted) = apply {
            id = agentDeleted.id
            deleted = agentDeleted.deleted
            object_ = agentDeleted.object_
            additionalProperties = agentDeleted.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [AgentDeleted].
         *
     ...
     *   expected type.
     */
    fun validate(): AgentDeleted = apply {
        if (validated) {
            return@apply
        }
    ...
    internal fun validity(): Int =
        (if (id.asKnown().isPresent) 1 else 0) +
            ...
            object_.let { if (it == JsonValue.from("agent.deleted")) 1 else 0 }
    ...
    override fun toString() =
        "AgentDeleted{id=$id, deleted=$deleted, object_=$object_, additionalProperties=$additionalProperties}"
}
