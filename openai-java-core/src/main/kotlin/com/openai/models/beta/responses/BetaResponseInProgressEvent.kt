...
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [BetaResponseInProgressEvent].
         *
    ...
    /** A builder for [BetaResponseInProgressEvent]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(betaResponseInProgressEvent: BetaResponseInProgressEvent) = apply {
            response = betaResponseInProgressEvent.response
            sequenceNumber = betaResponseInProgressEvent.sequenceNumber
            type = betaResponseInProgressEvent.type
            agent = betaResponseInProgressEvent.agent
            additionalProperties = betaResponseInProgressEvent.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [BetaResponseInProgressEvent].
         *
         ...
         */
        fun build(): BetaResponseInProgressEvent =
     ...
     *   expected type.
     */
    fun validate(): BetaResponseInProgressEvent = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is BetaResponseInProgressEvent &&
    ...
    override fun toString() =
        "BetaResponseInProgressEvent{response=$response, sequenceNumber=$sequenceNumber, type=$type, agent=$agent, additionalProperties=$additionalProperties}"
}
