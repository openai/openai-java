...
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [BetaResponseAudioDeltaEvent].
         *
    ...
    /** A builder for [BetaResponseAudioDeltaEvent]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(betaResponseAudioDeltaEvent: BetaResponseAudioDeltaEvent) = apply {
            delta = betaResponseAudioDeltaEvent.delta
            sequenceNumber = betaResponseAudioDeltaEvent.sequenceNumber
            type = betaResponseAudioDeltaEvent.type
            agent = betaResponseAudioDeltaEvent.agent
            additionalProperties = betaResponseAudioDeltaEvent.additionalProperties.toMutableMap()
        }
         ...
         */
        fun build(): BetaResponseAudioDeltaEvent =
     ...
     *   expected type.
     */
    fun validate(): BetaResponseAudioDeltaEvent = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is BetaResponseAudioDeltaEvent &&
            delta == other.delta &&
    ...
    override fun toString() =
        "BetaResponseAudioDeltaEvent{delta=$delta, sequenceNumber=$sequenceNumber, type=$type, agent=$agent, additionalProperties=$additionalProperties}"
}
