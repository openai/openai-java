...
private constructor(
    ...
    fun toBetaResponseCustomToolCall(): BetaResponseCustomToolCall =
     ...
     *   server responded with an unexpected value).
     */
    fun caller(): Optional<BetaResponseCustomToolCall.Caller> = caller.getOptional("caller")
    ...
    @JsonProperty("caller")
    @ExcludeMissing
    fun _caller(): JsonField<BetaResponseCustomToolCall.Caller> = caller
    ...
    /** A builder for [BetaResponseCustomToolCallItem]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(betaResponseCustomToolCallItem: BetaResponseCustomToolCallItem) = apply {
            callId = betaResponseCustomToolCallItem.callId
            input = betaResponseCustomToolCallItem.input
            name = betaResponseCustomToolCallItem.name
            ...
            createdBy = betaResponseCustomToolCallItem.createdBy
            additionalProperties =
                betaResponseCustomToolCallItem.additionalProperties.toMutableMap()
        }
        ...
        /** The agent that produced this item. */
        fun agent(agent: BetaResponseCustomToolCall.Agent?) = agent(JsonField.ofNullable(agent))

        /** Alias for calling [Builder.agent] with `agent.orElse(null)`. */
        fun agent(agent: Optional<BetaResponseCustomToolCall.Agent>) = agent(agent.getOrNull())

        /**
         * Sets [Builder.agent] to an arbitrary JSON value.
         *
         * You should usually call [Builder.agent] with a well-typed
         * [BetaResponseCustomToolCall.Agent] value instead. This method is primarily for setting
        ...
        fun caller(caller: Optional<BetaResponseCustomToolCall.Caller>) = caller(caller.getOrNull())

        /**
         * Sets [Builder.caller] to an arbitrary JSON value.
         *
         * You should usually call [Builder.caller] with a well-typed
         * [BetaResponseCustomToolCall.Caller] value instead. This method is primarily for setting
         * the field to an undocumented or not yet supported value.
         */
        fun caller(caller: JsonField<BetaResponseCustomToolCall.Caller>) = apply {
            this.caller = caller
        }

        /** Alias for calling [caller] with `BetaResponseCustomToolCall.Caller.ofDirect()`. */
        fun callerDirect() = caller(BetaResponseCustomToolCall.Caller.ofDirect())

        /**
         * Alias for calling [caller] with `BetaResponseCustomToolCall.Caller.ofProgram(program)`.
         */
        fun caller(program: BetaResponseCustomToolCall.Caller.Program) =
            caller(BetaResponseCustomToolCall.Caller.ofProgram(program))

        /**
         * Alias for calling [caller] with the following:
         * ```java
         * BetaResponseCustomToolCall.Caller.Program.builder()
         *     .callerId(callerId)
         *     .build()
         * ```
         */
        fun programCaller(callerId: String) =
            caller(BetaResponseCustomToolCall.Caller.Program.builder().callerId(callerId).build())
        ...
        /**
         * Returns an immutable instance of [BetaResponseCustomToolCallItem].
         *
         ...
         */
        fun build(): BetaResponseCustomToolCallItem =
            BetaResponseCustomToolCallItem(
     ...
     *   expected type.
     */
    fun validate(): BetaResponseCustomToolCallItem = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is BetaResponseCustomToolCallItem &&
            callId == other.callId &&
            input == other.input &&
            name == other.name &&
            type == other.type &&
