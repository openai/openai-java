...
private constructor(
    private val data: JsonField<List<ChatKitThread>>,
    ...
    private constructor(
        @JsonProperty("data")
        @ExcludeMissing
        data: JsonField<List<ChatKitThread>> = JsonMissing.of(),
     ...
     */
    fun data(): List<ChatKitThread> = data.getRequired("data")
     ...
     */
    @JsonProperty("data") @ExcludeMissing fun _data(): JsonField<List<ChatKitThread>> = data
    ...
    class Builder internal constructor() {
        ...
        private var data: JsonField<MutableList<ChatKitThread>>? = null
        ...
        internal fun from(threadListPageResponse: ThreadListPageResponse) = apply {
            ...
            firstId = threadListPageResponse.firstId
            hasMore = threadListPageResponse.hasMore
            lastId = threadListPageResponse.lastId
            object_ = threadListPageResponse.object_
            additionalProperties = threadListPageResponse.additionalProperties.toMutableMap()
        }

        /** A list of items */
        fun data(data: List<ChatKitThread>) = data(JsonField.of(data))

        /**
         * Sets [Builder.data] to an arbitrary JSON value.
         *
         * You should usually call [Builder.data] with a well-typed `List<ChatKitThread>` value
         * instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun data(data: JsonField<List<ChatKitThread>>) = apply {
         ...
         */
        fun addData(data: ChatKitThread) = apply {
            this.data =
    ...
    override fun toString() =
        "ThreadListPageResponse{data=$data, firstId=$firstId, hasMore=$hasMore, lastId=$lastId, object_=$object_, additionalProperties=$additionalProperties}"
}
