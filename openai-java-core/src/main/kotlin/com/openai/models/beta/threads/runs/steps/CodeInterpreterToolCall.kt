...
private constructor(
    ...
    private constructor(
        ...
        private constructor(
             ...
             *     @Override
             *     public Optional<String> visitLogs(LogsOutput logs) {
             *         return Optional.of(logs.toString());
             *     }
             *
             *     // ...
             *
            ...
            interface Visitor<out T> {
                ...
                /** Text output from the Code Interpreter tool call as part of a run step. */
                fun visitLogs(logs: LogsOutput): T = unknown(JsonValue.from(logs))

                fun visitImage(image: ImageOutput): T = unknown(JsonValue.from(image))
            ...
            private constructor(
                ...
                private val hashCode: Int by lazy {
                    Objects.hash(image, type, additionalProperties)
                }
    ...
    private val hashCode: Int by lazy {
        Objects.hash(id, codeInterpreter, type, additionalProperties)
    }
