...
private constructor(
    ...
    /** A builder for [BetaResponseMcpListToolsCompletedEvent]. */
    class Builder internal constructor() {
        ...
        internal fun from(
            ...
            itemId = betaResponseMcpListToolsCompletedEvent.itemId
            outputIndex = betaResponseMcpListToolsCompletedEvent.outputIndex
            sequenceNumber = betaResponseMcpListToolsCompletedEvent.sequenceNumber
            type = betaResponseMcpListToolsCompletedEvent.type
            agent = betaResponseMcpListToolsCompletedEvent.agent
            additionalProperties =
                betaResponseMcpListToolsCompletedEvent.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [BetaResponseMcpListToolsCompletedEvent].
         *
         ...
         */
        fun build(): BetaResponseMcpListToolsCompletedEvent =
            BetaResponseMcpListToolsCompletedEvent(
     ...
     *   expected type.
     */
    fun validate(): BetaResponseMcpListToolsCompletedEvent = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is BetaResponseMcpListToolsCompletedEvent &&
            itemId == other.itemId &&
    ...
    override fun toString() =
        "BetaResponseMcpListToolsCompletedEvent{itemId=$itemId, outputIndex=$outputIndex, sequenceNumber=$sequenceNumber, type=$type, agent=$agent, additionalProperties=$additionalProperties}"
}
