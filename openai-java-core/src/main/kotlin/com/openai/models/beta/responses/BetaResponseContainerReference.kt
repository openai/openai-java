...
private constructor(
    ...
    /** A builder for [BetaResponseContainerReference]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(betaResponseContainerReference: BetaResponseContainerReference) = apply {
            containerId = betaResponseContainerReference.containerId
            type = betaResponseContainerReference.type
            additionalProperties =
                betaResponseContainerReference.additionalProperties.toMutableMap()
        }
         ...
         */
        fun build(): BetaResponseContainerReference =
            BetaResponseContainerReference(
     ...
     *   expected type.
     */
    fun validate(): BetaResponseContainerReference = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is BetaResponseContainerReference &&
    ...
    override fun toString() =
        "BetaResponseContainerReference{containerId=$containerId, type=$type, additionalProperties=$additionalProperties}"
}
