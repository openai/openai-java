...
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [BetaWebSearchPreviewTool].
         *
    ...
    /** A builder for [BetaWebSearchPreviewTool]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(betaWebSearchPreviewTool: BetaWebSearchPreviewTool) = apply {
            type = betaWebSearchPreviewTool.type
            searchContentTypes =
                betaWebSearchPreviewTool.searchContentTypes.map { it.toMutableList() }
            searchContextSize = betaWebSearchPreviewTool.searchContextSize
            userLocation = betaWebSearchPreviewTool.userLocation
            additionalProperties = betaWebSearchPreviewTool.additionalProperties.toMutableMap()
        }
         ...
         */
        fun build(): BetaWebSearchPreviewTool =
     ...
     *   expected type.
     */
    fun validate(): BetaWebSearchPreviewTool = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is BetaWebSearchPreviewTool &&
            type == other.type &&
    ...
    override fun toString() =
        "BetaWebSearchPreviewTool{type=$type, searchContentTypes=$searchContentTypes, searchContextSize=$searchContextSize, userLocation=$userLocation, additionalProperties=$additionalProperties}"
}
