...
private constructor(
     ...
     * import java.util.Optional;
     *
     * Optional<String> result = messageStreamEvent.accept(new MessageStreamEvent.Visitor<Optional<String>>() {
     *     @Override
     *     public Optional<String> visitThreadMessageCreated(ThreadMessageCreated threadMessageCreated) {
     *         return Optional.of(threadMessageCreated.toString());
     *     }
     *
     *     // ...
     *
