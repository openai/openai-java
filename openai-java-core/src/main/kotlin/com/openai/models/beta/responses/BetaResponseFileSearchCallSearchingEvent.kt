...
private constructor(
    ...
    /** A builder for [BetaResponseFileSearchCallSearchingEvent]. */
    class Builder internal constructor() {
        ...
        internal fun from(
            ...
            itemId = betaResponseFileSearchCallSearchingEvent.itemId
            outputIndex = betaResponseFileSearchCallSearchingEvent.outputIndex
            sequenceNumber = betaResponseFileSearchCallSearchingEvent.sequenceNumber
            type = betaResponseFileSearchCallSearchingEvent.type
            agent = betaResponseFileSearchCallSearchingEvent.agent
            additionalProperties =
                betaResponseFileSearchCallSearchingEvent.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [BetaResponseFileSearchCallSearchingEvent].
         *
         ...
         */
        fun build(): BetaResponseFileSearchCallSearchingEvent =
            BetaResponseFileSearchCallSearchingEvent(
     ...
     *   expected type.
     */
    fun validate(): BetaResponseFileSearchCallSearchingEvent = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is BetaResponseFileSearchCallSearchingEvent &&
            itemId == other.itemId &&
    ...
    override fun toString() =
        "BetaResponseFileSearchCallSearchingEvent{itemId=$itemId, outputIndex=$outputIndex, sequenceNumber=$sequenceNumber, type=$type, agent=$agent, additionalProperties=$additionalProperties}"
}
