...
private constructor(
    ...
    ) : this(code, itemId, outputIndex, sequenceNumber, type, agent, mutableMapOf())
    ...
    /** A builder for [BetaResponseCodeInterpreterCallCodeDoneEvent]. */
    class Builder internal constructor() {
        ...
        internal fun from(
            ...
            code = betaResponseCodeInterpreterCallCodeDoneEvent.code
            itemId = betaResponseCodeInterpreterCallCodeDoneEvent.itemId
            outputIndex = betaResponseCodeInterpreterCallCodeDoneEvent.outputIndex
            sequenceNumber = betaResponseCodeInterpreterCallCodeDoneEvent.sequenceNumber
            type = betaResponseCodeInterpreterCallCodeDoneEvent.type
            agent = betaResponseCodeInterpreterCallCodeDoneEvent.agent
            additionalProperties =
                betaResponseCodeInterpreterCallCodeDoneEvent.additionalProperties.toMutableMap()
        }
         ...
         */
        fun build(): BetaResponseCodeInterpreterCallCodeDoneEvent =
            BetaResponseCodeInterpreterCallCodeDoneEvent(
     ...
     *   expected type.
     */
    fun validate(): BetaResponseCodeInterpreterCallCodeDoneEvent = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is BetaResponseCodeInterpreterCallCodeDoneEvent &&
            code == other.code &&
            itemId == other.itemId &&
    ...
    private val hashCode: Int by lazy {
        Objects.hash(code, itemId, outputIndex, sequenceNumber, type, agent, additionalProperties)
    }

    override fun hashCode(): Int = hashCode

    override fun toString() =
        "BetaResponseCodeInterpreterCallCodeDoneEvent{code=$code, itemId=$itemId, outputIndex=$outputIndex, sequenceNumber=$sequenceNumber, type=$type, agent=$agent, additionalProperties=$additionalProperties}"
}
