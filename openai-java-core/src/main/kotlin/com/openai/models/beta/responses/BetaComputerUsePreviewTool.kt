...
private constructor(
    ...
    /** A builder for [BetaComputerUsePreviewTool]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(betaComputerUsePreviewTool: BetaComputerUsePreviewTool) = apply {
            displayHeight = betaComputerUsePreviewTool.displayHeight
            displayWidth = betaComputerUsePreviewTool.displayWidth
            environment = betaComputerUsePreviewTool.environment
            type = betaComputerUsePreviewTool.type
            additionalProperties = betaComputerUsePreviewTool.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [BetaComputerUsePreviewTool].
         *
         ...
         */
        fun build(): BetaComputerUsePreviewTool =
     ...
     *   expected type.
     */
    fun validate(): BetaComputerUsePreviewTool = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is BetaComputerUsePreviewTool &&
    ...
    override fun toString() =
        "BetaComputerUsePreviewTool{displayHeight=$displayHeight, displayWidth=$displayWidth, environment=$environment, type=$type, additionalProperties=$additionalProperties}"
}
