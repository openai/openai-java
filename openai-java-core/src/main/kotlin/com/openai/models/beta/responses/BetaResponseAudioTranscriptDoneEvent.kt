...
private constructor(
    ...
    ) : this(sequenceNumber, type, agent, mutableMapOf())
    ...
    /** A builder for [BetaResponseAudioTranscriptDoneEvent]. */
    class Builder internal constructor() {
        ...
        internal fun from(
            ...
            sequenceNumber = betaResponseAudioTranscriptDoneEvent.sequenceNumber
            type = betaResponseAudioTranscriptDoneEvent.type
            agent = betaResponseAudioTranscriptDoneEvent.agent
            additionalProperties =
                betaResponseAudioTranscriptDoneEvent.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [BetaResponseAudioTranscriptDoneEvent].
         *
         ...
         */
        fun build(): BetaResponseAudioTranscriptDoneEvent =
            BetaResponseAudioTranscriptDoneEvent(
     ...
     *   expected type.
     */
    fun validate(): BetaResponseAudioTranscriptDoneEvent = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is BetaResponseAudioTranscriptDoneEvent &&
    ...
    private val hashCode: Int by lazy {
        Objects.hash(sequenceNumber, type, agent, additionalProperties)
    }

    override fun hashCode(): Int = hashCode

    override fun toString() =
        "BetaResponseAudioTranscriptDoneEvent{sequenceNumber=$sequenceNumber, type=$type, agent=$agent, additionalProperties=$additionalProperties}"
}
