...
private constructor(
    ...
    /** A builder for [BetaResponseError]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(betaResponseError: BetaResponseError) = apply {
            code = betaResponseError.code
            message = betaResponseError.message
            misalignment = betaResponseError.misalignment
            additionalProperties = betaResponseError.additionalProperties.toMutableMap()
        }
     ...
     *   expected type.
     */
    fun validate(): BetaResponseError = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is BetaResponseError &&
            code == other.code &&
            message == other.message &&
    ...
    override fun toString() =
        "BetaResponseError{code=$code, message=$message, misalignment=$misalignment, additionalProperties=$additionalProperties}"
}
