...
private constructor(
    ...
    /** A builder for [BetaResponseSteerAcceptedEvent]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(betaResponseSteerAcceptedEvent: BetaResponseSteerAcceptedEvent) = apply {
            sequenceNumber = betaResponseSteerAcceptedEvent.sequenceNumber
            steer = betaResponseSteerAcceptedEvent.steer
            type = betaResponseSteerAcceptedEvent.type
            streamId = betaResponseSteerAcceptedEvent.streamId
            additionalProperties =
                betaResponseSteerAcceptedEvent.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [BetaResponseSteerAcceptedEvent].
         *
         ...
         */
        fun build(): BetaResponseSteerAcceptedEvent =
            BetaResponseSteerAcceptedEvent(
     ...
     *   expected type.
     */
    fun validate(): BetaResponseSteerAcceptedEvent = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is BetaResponseSteerAcceptedEvent &&
    ...
    override fun toString() =
        "BetaResponseSteerAcceptedEvent{sequenceNumber=$sequenceNumber, steer=$steer, type=$type, streamId=$streamId, additionalProperties=$additionalProperties}"
}
