...
private constructor(
    ...
    /** A builder for [BetaEasyInputMessage]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(betaEasyInputMessage: BetaEasyInputMessage) = apply {
            content = betaEasyInputMessage.content
            role = betaEasyInputMessage.role
            phase = betaEasyInputMessage.phase
            type = betaEasyInputMessage.type
            additionalProperties = betaEasyInputMessage.additionalProperties.toMutableMap()
        }
         ...
         */
        fun contentOfBetaResponseInputMessageContentList(
            betaResponseInputMessageContentList: List<BetaResponseInputContent>
        ) =
            content(
                Content.ofBetaResponseInputMessageContentList(betaResponseInputMessageContentList)
            )
         ...
         */
        fun build(): BetaEasyInputMessage =
     ...
     *   expected type.
     */
    fun validate(): BetaEasyInputMessage = apply {
        if (validated) {
            return@apply
        }
    ...
    private constructor(
        ...
        private val betaResponseInputMessageContentList: List<BetaResponseInputContent>? = null,
        ...
        fun betaResponseInputMessageContentList(): Optional<List<BetaResponseInputContent>> =
            Optional.ofNullable(betaResponseInputMessageContentList)

        fun isTextInput(): Boolean = textInput != null

        fun isBetaResponseInputMessageContentList(): Boolean =
            betaResponseInputMessageContentList != null

        /** A text input to the model. */
        fun asTextInput(): String = textInput.getOrThrow("textInput")

        /** A list of one or many input items to the model, containing different content types. */
        fun asBetaResponseInputMessageContentList(): List<BetaResponseInputContent> =
            betaResponseInputMessageContentList.getOrThrow("betaResponseInputMessageContentList")
        ...
        fun <T> accept(visitor: Visitor<T>): T =
            when {
                ...
                betaResponseInputMessageContentList != null ->
                    visitor.visitBetaResponseInputMessageContentList(
        ...
        fun validate(): Content = apply {
            ...
            accept(
                object : Visitor<Unit> {
                    ...
                    override fun visitBetaResponseInputMessageContentList(
                        betaResponseInputMessageContentList: List<BetaResponseInputContent>
                    ) {
                        betaResponseInputMessageContentList.forEach { it.validate() }
                    }
                }
            )
            validated = true
        ...
        internal fun validity(): Int =
            accept(
                object : Visitor<Int> {
                    ...
                    override fun visitBetaResponseInputMessageContentList(
                        betaResponseInputMessageContentList: List<BetaResponseInputContent>
                    ) = betaResponseInputMessageContentList.sumOf { it.validity().toInt() }
        ...
        override fun equals(other: Any?): Boolean {
            ...
            return other is Content &&
                ...
                betaResponseInputMessageContentList == other.betaResponseInputMessageContentList
        }

        override fun hashCode(): Int = Objects.hash(textInput, betaResponseInputMessageContentList)

        override fun toString(): String =
            when {
                textInput != null -> "Content{textInput=$textInput}"
                betaResponseInputMessageContentList != null ->
                    "Content{betaResponseInputMessageContentList=$betaResponseInputMessageContentList}"
        ...
        companion object {
             ...
             */
            @JvmStatic
            fun ofBetaResponseInputMessageContentList(
                betaResponseInputMessageContentList: List<BetaResponseInputContent>
            ) =
                Content(
                    betaResponseInputMessageContentList =
                        betaResponseInputMessageContentList.toImmutable()
                )
        }
        ...
        interface Visitor<out T> {
             ...
             * A list of one or many input items to the model, containing different content types.
             */
            fun visitBetaResponseInputMessageContentList(
                betaResponseInputMessageContentList: List<BetaResponseInputContent>
            ): T = unknown(JsonValue.from(betaResponseInputMessageContentList))
            ...
            override fun ObjectCodec.deserialize(node: JsonNode): Content {
                ...
                val bestMatches =
                    sequenceOf(
                            ...
                            tryDeserialize(node, jacksonTypeRef<List<BetaResponseInputContent>>())
                                ?.let {
                                    Content(betaResponseInputMessageContentList = it, _json = json)
                                },
                        )
                        .filterNotNull()
        ...
        internal class Serializer : BaseSerializer<Content>(Content::class) {
            ...
            override fun serialize(
                ...
                when {
                    ...
                    value.betaResponseInputMessageContentList != null ->
                        generator.writeObject(value.betaResponseInputMessageContentList)
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is BetaEasyInputMessage &&
    ...
    override fun toString() =
        "BetaEasyInputMessage{content=$content, role=$role, phase=$phase, type=$type, additionalProperties=$additionalProperties}"
}
