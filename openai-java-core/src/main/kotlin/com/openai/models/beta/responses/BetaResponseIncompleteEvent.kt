...
private constructor(
    private val response: JsonField<BetaResponse>,
    ...
    private constructor(
        ...
        @ExcludeMissing
        response: JsonField<BetaResponse> = JsonMissing.of(),
    ...
    ) : this(response, sequenceNumber, type, agent, mutableMapOf())
     ...
     */
    fun response(): BetaResponse = response.getRequired("response")
     ...
     */
    @JsonProperty("response") @ExcludeMissing fun _response(): JsonField<BetaResponse> = response
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [BetaResponseIncompleteEvent].
         *
    ...
    /** A builder for [BetaResponseIncompleteEvent]. */
    class Builder internal constructor() {

        private var response: JsonField<BetaResponse>? = null
        ...
        @JvmSynthetic
        internal fun from(betaResponseIncompleteEvent: BetaResponseIncompleteEvent) = apply {
            response = betaResponseIncompleteEvent.response
            sequenceNumber = betaResponseIncompleteEvent.sequenceNumber
            type = betaResponseIncompleteEvent.type
            agent = betaResponseIncompleteEvent.agent
            additionalProperties = betaResponseIncompleteEvent.additionalProperties.toMutableMap()
        }

        /** The response that was incomplete. */
        fun response(response: BetaResponse) = response(JsonField.of(response))

        /**
         * Sets [Builder.response] to an arbitrary JSON value.
         *
         * You should usually call [Builder.response] with a well-typed [BetaResponse] value
         * instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun response(response: JsonField<BetaResponse>) = apply { this.response = response }
        ...
        /**
         * Returns an immutable instance of [BetaResponseIncompleteEvent].
         *
         ...
         */
        fun build(): BetaResponseIncompleteEvent =
     ...
     *   expected type.
     */
    fun validate(): BetaResponseIncompleteEvent = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is BetaResponseIncompleteEvent &&
    ...
    private val hashCode: Int by lazy {
        Objects.hash(response, sequenceNumber, type, agent, additionalProperties)
    }

    override fun hashCode(): Int = hashCode

    override fun toString() =
        "BetaResponseIncompleteEvent{response=$response, sequenceNumber=$sequenceNumber, type=$type, agent=$agent, additionalProperties=$additionalProperties}"
}
