...
private constructor(
    ...
    /** A builder for [BetaResponseFormatTextJsonSchemaConfig]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(
            betaResponseFormatTextJsonSchemaConfig: BetaResponseFormatTextJsonSchemaConfig
        ) = apply {
            name = betaResponseFormatTextJsonSchemaConfig.name
            schema = betaResponseFormatTextJsonSchemaConfig.schema
            type = betaResponseFormatTextJsonSchemaConfig.type
            description = betaResponseFormatTextJsonSchemaConfig.description
            strict = betaResponseFormatTextJsonSchemaConfig.strict
            additionalProperties =
                betaResponseFormatTextJsonSchemaConfig.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [BetaResponseFormatTextJsonSchemaConfig].
         *
         ...
         */
        fun build(): BetaResponseFormatTextJsonSchemaConfig =
            BetaResponseFormatTextJsonSchemaConfig(
     ...
     *   expected type.
     */
    fun validate(): BetaResponseFormatTextJsonSchemaConfig = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is BetaResponseFormatTextJsonSchemaConfig &&
            name == other.name &&
            schema == other.schema &&
            type == other.type &&
    ...
    override fun toString() =
        "BetaResponseFormatTextJsonSchemaConfig{name=$name, schema=$schema, type=$type, description=$description, strict=$strict, additionalProperties=$additionalProperties}"
}
