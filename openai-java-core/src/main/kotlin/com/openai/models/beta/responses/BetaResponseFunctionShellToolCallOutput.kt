...
private constructor(
    ...
    /** A builder for [BetaResponseFunctionShellToolCallOutput]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(
            betaResponseFunctionShellToolCallOutput: BetaResponseFunctionShellToolCallOutput
        ) = apply {
            id = betaResponseFunctionShellToolCallOutput.id
            callId = betaResponseFunctionShellToolCallOutput.callId
            maxOutputLength = betaResponseFunctionShellToolCallOutput.maxOutputLength
            output = betaResponseFunctionShellToolCallOutput.output.map { it.toMutableList() }
            status = betaResponseFunctionShellToolCallOutput.status
            type = betaResponseFunctionShellToolCallOutput.type
            agent = betaResponseFunctionShellToolCallOutput.agent
            caller = betaResponseFunctionShellToolCallOutput.caller
            createdBy = betaResponseFunctionShellToolCallOutput.createdBy
            additionalProperties =
                betaResponseFunctionShellToolCallOutput.additionalProperties.toMutableMap()
        }
         ...
         */
        fun build(): BetaResponseFunctionShellToolCallOutput =
            BetaResponseFunctionShellToolCallOutput(
                checkRequired("id", id),
     ...
     *   expected type.
     */
    fun validate(): BetaResponseFunctionShellToolCallOutput = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is BetaResponseFunctionShellToolCallOutput &&
            id == other.id &&
            callId == other.callId &&
    ...
    override fun toString() =
        "BetaResponseFunctionShellToolCallOutput{id=$id, callId=$callId, maxOutputLength=$maxOutputLength, output=$output, status=$status, type=$type, agent=$agent, caller=$caller, createdBy=$createdBy, additionalProperties=$additionalProperties}"
}
