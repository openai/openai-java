...
private constructor(
    private val data: JsonField<List<AgentSession>>,
    ...
    private constructor(
        @JsonProperty("data")
        @ExcludeMissing
        data: JsonField<List<AgentSession>> = JsonMissing.of(),
     ...
     */
    fun data(): List<AgentSession> = data.getRequired("data")
     ...
     */
    @JsonProperty("data") @ExcludeMissing fun _data(): JsonField<List<AgentSession>> = data
    ...
    class Builder internal constructor() {
        ...
        private var data: JsonField<MutableList<AgentSession>>? = null
        ...
        internal fun from(sessionListPageResponse: SessionListPageResponse) = apply {
            ...
            firstId = sessionListPageResponse.firstId
            hasMore = sessionListPageResponse.hasMore
            lastId = sessionListPageResponse.lastId
            object_ = sessionListPageResponse.object_
            additionalProperties = sessionListPageResponse.additionalProperties.toMutableMap()
        }

        /** The resources returned in this page, in the requested sort order. */
        fun data(data: List<AgentSession>) = data(JsonField.of(data))

        /**
         * Sets [Builder.data] to an arbitrary JSON value.
         *
         * You should usually call [Builder.data] with a well-typed `List<AgentSession>` value
         * instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun data(data: JsonField<List<AgentSession>>) = apply {
            this.data = data.map { it.toMutableList() }
        }

        /**
         * Adds a single [AgentSession] to [Builder.data].
         *
         * @throws IllegalStateException if the field was previously set to a non-list.
         */
        fun addData(data: AgentSession) = apply {
            this.data =
    ...
    override fun toString() =
        "SessionListPageResponse{data=$data, firstId=$firstId, hasMore=$hasMore, lastId=$lastId, object_=$object_, additionalProperties=$additionalProperties}"
}
