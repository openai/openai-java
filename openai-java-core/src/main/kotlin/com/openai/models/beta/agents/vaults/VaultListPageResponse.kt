...
private constructor(
    private val data: JsonField<List<Vault>>,
    ...
    @JsonCreator
    private constructor(
        @JsonProperty("data") @ExcludeMissing data: JsonField<List<Vault>> = JsonMissing.of(),
     ...
     */
    fun data(): List<Vault> = data.getRequired("data")
     ...
     */
    @JsonProperty("data") @ExcludeMissing fun _data(): JsonField<List<Vault>> = data
    ...
    class Builder internal constructor() {
        ...
        private var data: JsonField<MutableList<Vault>>? = null
        ...
        internal fun from(vaultListPageResponse: VaultListPageResponse) = apply {
            ...
            firstId = vaultListPageResponse.firstId
            hasMore = vaultListPageResponse.hasMore
            lastId = vaultListPageResponse.lastId
            object_ = vaultListPageResponse.object_
            additionalProperties = vaultListPageResponse.additionalProperties.toMutableMap()
        }

        /** The resources returned in this page, in the requested sort order. */
        fun data(data: List<Vault>) = data(JsonField.of(data))

        /**
         * Sets [Builder.data] to an arbitrary JSON value.
         *
         * You should usually call [Builder.data] with a well-typed `List<Vault>` value instead.
         * This method is primarily for setting the field to an undocumented or not yet supported
         * value.
         */
        fun data(data: JsonField<List<Vault>>) = apply {
            this.data = data.map { it.toMutableList() }
        }

        /**
         * Adds a single [Vault] to [Builder.data].
         *
         * @throws IllegalStateException if the field was previously set to a non-list.
         */
        fun addData(data: Vault) = apply {
            this.data =
    ...
    override fun toString() =
        "VaultListPageResponse{data=$data, firstId=$firstId, hasMore=$hasMore, lastId=$lastId, object_=$object_, additionalProperties=$additionalProperties}"
}
