...
private constructor(
    private val data: JsonField<List<EnvironmentFile>>,
    ...
    private constructor(
        @JsonProperty("data")
        @ExcludeMissing
        data: JsonField<List<EnvironmentFile>> = JsonMissing.of(),
     ...
     */
    fun data(): List<EnvironmentFile> = data.getRequired("data")
     ...
     */
    @JsonProperty("data") @ExcludeMissing fun _data(): JsonField<List<EnvironmentFile>> = data
    ...
    class Builder internal constructor() {
        ...
        private var data: JsonField<MutableList<EnvironmentFile>>? = null
        ...
        internal fun from(fileListPageResponse: FileListPageResponse) = apply {
            ...
            next = fileListPageResponse.next
            object_ = fileListPageResponse.object_
            additionalProperties = fileListPageResponse.additionalProperties.toMutableMap()
        }

        /** Files available on the current page. */
        fun data(data: List<EnvironmentFile>) = data(JsonField.of(data))

        /**
         * Sets [Builder.data] to an arbitrary JSON value.
         *
         * You should usually call [Builder.data] with a well-typed `List<EnvironmentFile>` value
         * instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun data(data: JsonField<List<EnvironmentFile>>) = apply {
            this.data = data.map { it.toMutableList() }
        }

        /**
         * Adds a single [EnvironmentFile] to [Builder.data].
         *
         * @throws IllegalStateException if the field was previously set to a non-list.
         */
        fun addData(data: EnvironmentFile) = apply {
            this.data =
    ...
    override fun toString() =
        "FileListPageResponse{data=$data, hasMore=$hasMore, next=$next, object_=$object_, additionalProperties=$additionalProperties}"
}
