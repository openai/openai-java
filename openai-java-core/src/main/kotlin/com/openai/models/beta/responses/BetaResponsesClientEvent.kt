...
@JsonDeserialize(using = BetaResponsesClientEvent.Deserializer::class)
@JsonSerialize(using = BetaResponsesClientEvent.Serializer::class)
...
private constructor(
     ...
     * that resume a waiting agent.
     */
    fun asResponseInject(): BetaResponseInjectEvent = responseInject.getOrThrow("responseInject")
     ...
     *   expected type.
     */
    fun validate(): BetaResponsesClientEvent = apply {
        if (validated) {
            return@apply
        }
    ...
    companion object {
         ...
         */
        @JvmStatic
        fun ofResponseInject(responseInject: BetaResponseInjectEvent) =
            BetaResponsesClientEvent(responseInject = responseInject)
    }

    /**
     * An interface that defines how to map each variant of [BetaResponsesClientEvent] to a value of
     * type [T].
     */
    interface Visitor<out T> {
        ...
        fun visitResponseSteer(responseSteer: BetaResponseSteerEvent): T =
            unknown(JsonValue.from(responseSteer))
         ...
         * outputs that resume a waiting agent.
         */
        fun visitResponseInject(responseInject: BetaResponseInjectEvent): T =
            unknown(JsonValue.from(responseInject))

        /**
         * Maps an unknown variant of [BetaResponsesClientEvent] to a value of type [T].
         *
         * An instance of [BetaResponsesClientEvent] can contain an unknown variant if it was
    ...
    internal class Deserializer :
        BaseDeserializer<BetaResponsesClientEvent>(BetaResponsesClientEvent::class) {

        override fun ObjectCodec.deserialize(node: JsonNode): BetaResponsesClientEvent {
            ...
            return BetaResponsesClientEvent(_json = json)
        }
    }

    internal class Serializer :
        BaseSerializer<BetaResponsesClientEvent>(BetaResponsesClientEvent::class) {

        override fun serialize(
            value: BetaResponsesClientEvent,
    ...
    private constructor(
        ...
        companion object {
            ...
            /** Returns a mutable builder for constructing an instance of [ResponseCreate]. */
            @JvmStatic fun builder() = Builder()
        }

        /** A builder for [ResponseCreate]. */
        class Builder internal constructor() {
            ...
            internal fun from(responseCreate: ResponseCreate) = apply {
                ...
                include = responseCreate.include.map { it.toMutableList() }
                input = responseCreate.input
                instructions = responseCreate.instructions
                maxOutputTokens = responseCreate.maxOutputTokens
                maxToolCalls = responseCreate.maxToolCalls
                metadata = responseCreate.metadata
                model = responseCreate.model
                moderation = responseCreate.moderation
                multiAgent = responseCreate.multiAgent
                parallelToolCalls = responseCreate.parallelToolCalls
                previousResponseId = responseCreate.previousResponseId
                prompt = responseCreate.prompt
                promptCacheKey = responseCreate.promptCacheKey
                promptCacheOptions = responseCreate.promptCacheOptions
                promptCacheRetention = responseCreate.promptCacheRetention
                reasoning = responseCreate.reasoning
                safetyIdentifier = responseCreate.safetyIdentifier
                ...
                toolChoice = responseCreate.toolChoice
                tools = responseCreate.tools.map { it.toMutableList() }
                topLogprobs = responseCreate.topLogprobs
                topP = responseCreate.topP
                truncation = responseCreate.truncation
                user = responseCreate.user
                additionalProperties = responseCreate.additionalProperties.toMutableMap()
            }
            ...
            /**
             * Returns an immutable instance of [ResponseCreate].
             *
         ...
         *   expected type.
         */
        fun validate(): ResponseCreate = apply {
            if (validated) {
                return@apply
            }
        ...
        private constructor(
             ...
             */
            fun compactThreshold(): Optional<Long> =
                compactThreshold.getOptional("compact_threshold")
             ...
             *
             * Unlike [compactThreshold], this method doesn't throw if the JSON field has an
             * unexpected type.
             */
            @JsonProperty("compact_threshold")
            @ExcludeMissing
        ...
        private constructor(
            ...
            /**
             * An interface that defines how to map each variant of [Conversation] to a value of
             * type [T].
             */
            interface Visitor<out T> {

                /** The unique ID of the conversation. */
                fun visitId(id: String): T = unknown(JsonValue.from(id))

                /** The conversation that this response belongs to. */
                fun visitBetaResponseConversationParam(
                    betaResponseConversationParam: BetaResponseConversationParam
                ): T = unknown(JsonValue.from(betaResponseConversationParam))

                /**
                 * Maps an unknown variant of [Conversation] to a value of type [T].
                 *
                 * An instance of [Conversation] can contain an unknown variant if it was
                    ...
                    val bestMatches =
                        sequenceOf(
                                tryDeserialize(
                                    ...
                                    ?.let {
                                        Conversation(
                                            betaResponseConversationParam = it,
                                            _json = json,
                                        )
                                    },
        ...
        private constructor(
             ...
             * A list of one or many input items to the model, containing different content types.
             */
            fun asBetaResponse(): List<BetaResponseInputItem> =
                betaResponse.getOrThrow("betaResponse")
            ...
            interface Visitor<out T> {
                ...
                fun visitBetaResponse(betaResponse: List<BetaResponseInputItem>): T =
                    unknown(JsonValue.from(betaResponse))
        ...
        class Model @JsonCreator private constructor(private val value: JsonField<String>) : Enum {
            ...
            fun value(): Value =
                when (this) {
                    ...
                    GPT_4O_MINI_AUDIO_PREVIEW_2024_12_17 ->
                        Value.GPT_4O_MINI_AUDIO_PREVIEW_2024_12_17
                    ...
                    GPT_4O_MINI_SEARCH_PREVIEW_2025_03_11 ->
                        Value.GPT_4O_MINI_SEARCH_PREVIEW_2025_03_11
            ...
            fun known(): Known =
                when (this) {
                    ...
                    GPT_4O_MINI_SEARCH_PREVIEW_2025_03_11 ->
                        Known.GPT_4O_MINI_SEARCH_PREVIEW_2025_03_11
        ...
        private constructor(
            ...
            class Builder internal constructor() {
                 ...
                 *
                 * You should usually call [Builder.policy] with a well-typed [Policy] value
                 * instead. This method is primarily for setting the field to an undocumented or not
                 * yet supported value.
                 */
            ...
            private constructor(
                ...
                private constructor(
                    @JsonProperty("input")
                    @ExcludeMissing
                    input: JsonField<Input> = JsonMissing.of(),
                    @JsonProperty("output")
                    @ExcludeMissing
                 ...
                 * Returns the raw JSON value of [input].
                 *
                 * Unlike [input], this method doesn't throw if the JSON field has an unexpected
                 * type.
                 */
                @JsonProperty("input") @ExcludeMissing fun _input(): JsonField<Input> = input
                ...
                class Builder internal constructor() {
                     ...
                     * Sets [Builder.input] to an arbitrary JSON value.
                     *
                     * You should usually call [Builder.input] with a well-typed [Input] value
                ...
                private val hashCode: Int by lazy {
                    Objects.hash(input, output, additionalProperties)
                }
        ...
        private constructor(
             ...
             * backend may retain cache entries for longer.
             */
            class Ttl @JsonCreator private constructor(private val value: JsonField<String>) :
                Enum {
        ...
        private constructor(private val value: JsonField<String>) : Enum {
             ...
             * member.
             *
             * An instance of [PromptCacheRetention] can contain an unknown value in a couple of
             * cases:
             * - It was deserialized from data that doesn't match any known member. For example, if
             *   the SDK is on an older version than the API, then the API may respond with new
             *   members that the SDK is unaware of.
        ...
        private constructor(
            ...
            private constructor(
                ...
                @JsonProperty("effort")
                @ExcludeMissing
                effort: JsonField<Effort> = JsonMissing.of(),
                ...
                @ExcludeMissing
                summary: JsonField<Summary> = JsonMissing.of(),
             ...
             *
             * Unlike [generateSummary], this method doesn't throw if the JSON field has an
             * unexpected type.
             */
            @Deprecated("deprecated")
            @JsonProperty("generate_summary")
            ...
            class Builder internal constructor() {
                 ...
                 *
                 * You should usually call [Builder.generateSummary] with a well-typed
                 * [GenerateSummary] value instead. This method is primarily for setting the field
                 * to an undocumented or not yet supported value.
                 */
                @Deprecated("deprecated")
                 ...
                 *
                 * You should usually call [mode] with a well-typed [Mode] constant instead. This
                 * method is primarily for setting the field to an undocumented or not yet supported
                 * value.
                 */
                 ...
                 *
                 * You should usually call [Builder.summary] with a well-typed [Summary] value
                 * instead. This method is primarily for setting the field to an undocumented or not
                 * yet supported value.
                 */
            ...
            private constructor(private val value: JsonField<String>) : Enum {
                ...
                /**
                 * An enum containing [GenerateSummary]'s known values, as well as an [_UNKNOWN]
                 * member.
                 *
                 * An instance of [GenerateSummary] can contain an unknown value in a couple of
                 * cases:
                 * - It was deserialized from data that doesn't match any known member. For example,
                 *   if the SDK is on an older version than the API, then the API may respond with
                 *   new members that the SDK is unaware of.
                ...
                enum class Value {
                    ...
                    DETAILED,
                    /**
                     * An enum member indicating that [GenerateSummary] was instantiated with an
                     * unknown value.
                     */
                    _UNKNOWN,
                }
            ...
            class Summary @JsonCreator private constructor(private val value: JsonField<String>) :
                ...
                enum class Value {
                    ...
                    DETAILED,
                    /**
                     * An enum member indicating that [Summary] was instantiated with an unknown
                     * value.
                     */
                    _UNKNOWN,
                }
        ...
        private constructor(
            ...
            private val hashCode: Int by lazy {
                Objects.hash(includeObfuscation, additionalProperties)
            }
        ...
        private constructor(
            ...
            fun <T> accept(visitor: Visitor<T>): T =
                when {
                    ...
                    betaToolChoiceTypes != null ->
                        visitor.visitBetaToolChoiceTypes(betaToolChoiceTypes)
                    ...
                    betaToolChoiceShell != null ->
                        visitor.visitBetaToolChoiceShell(betaToolChoiceShell)
                    else -> visitor.unknown(_json)
                }
            ...
            interface Visitor<out T> {
                ...
                fun visitBetaToolChoiceOptions(betaToolChoiceOptions: BetaToolChoiceOptions): T =
                    unknown(JsonValue.from(betaToolChoiceOptions))

                /** Constrains the tools available to the model to a pre-defined set. */
                fun visitBetaToolChoiceAllowed(betaToolChoiceAllowed: BetaToolChoiceAllowed): T =
                    unknown(JsonValue.from(betaToolChoiceAllowed))
                ...
                fun visitBetaToolChoiceTypes(betaToolChoiceTypes: BetaToolChoiceTypes): T =
                    unknown(JsonValue.from(betaToolChoiceTypes))

                /** Use this option to force the model to call a specific function. */
                fun visitBetaToolChoiceFunction(betaToolChoiceFunction: BetaToolChoiceFunction): T =
                    unknown(JsonValue.from(betaToolChoiceFunction))
                ...
                fun visitBetaToolChoiceMcp(betaToolChoiceMcp: BetaToolChoiceMcp): T =
                    unknown(JsonValue.from(betaToolChoiceMcp))

                /** Use this option to force the model to call a specific custom tool. */
                fun visitBetaToolChoiceCustom(betaToolChoiceCustom: BetaToolChoiceCustom): T =
                    unknown(JsonValue.from(betaToolChoiceCustom))

                fun visitBetaSpecificProgrammaticToolCallingParam(
                    betaSpecificProgrammaticToolCallingParam: JsonValue
                ): T = unknown(JsonValue.from(betaSpecificProgrammaticToolCallingParam))

                /** Forces the model to call the apply_patch tool when executing a tool call. */
                fun visitBetaToolChoiceApplyPatch(
                    betaToolChoiceApplyPatch: BetaToolChoiceApplyPatch
                ): T = unknown(JsonValue.from(betaToolChoiceApplyPatch))

                /** Forces the model to call the shell tool when a tool call is required. */
                fun visitBetaToolChoiceShell(betaToolChoiceShell: BetaToolChoiceShell): T =
                    unknown(JsonValue.from(betaToolChoiceShell))
                ...
                override fun ObjectCodec.deserialize(node: JsonNode): ToolChoice {
                    ...
                    val bestMatches =
                        sequenceOf(
                                ...
                                tryDeserialize(node, jacksonTypeRef<BetaToolChoiceFunction>())
                                    ?.let { ToolChoice(betaToolChoiceFunction = it, _json = json) },
                                ...
                                tryDeserialize(node, jacksonTypeRef<BetaToolChoiceApplyPatch>())
                                    ?.let {
         ...
         */
        @Deprecated("deprecated")
        class Truncation @JsonCreator private constructor(private val value: JsonField<String>) :
            Enum {
            ...
            enum class Value {
                ...
                DISABLED,
                /**
                 * An enum member indicating that [Truncation] was instantiated with an unknown
                 * value.
                 */
                _UNKNOWN,
            }
