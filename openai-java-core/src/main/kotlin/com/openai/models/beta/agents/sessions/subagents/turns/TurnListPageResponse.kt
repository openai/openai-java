...
class TurnListPageResponse
@JsonCreator(mode = JsonCreator.Mode.DISABLED)
private constructor(
    private val data: JsonField<List<Turn>>,
    ...
    @JsonCreator
    private constructor(
        @JsonProperty("data") @ExcludeMissing data: JsonField<List<Turn>> = JsonMissing.of(),
     ...
     */
    fun data(): List<Turn> = data.getRequired("data")
     ...
     */
    @JsonProperty("data") @ExcludeMissing fun _data(): JsonField<List<Turn>> = data
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [TurnListPageResponse].
         *
    ...
    /** A builder for [TurnListPageResponse]. */
    class Builder internal constructor() {

        private var data: JsonField<MutableList<Turn>>? = null
        ...
        @JvmSynthetic
        internal fun from(turnListPageResponse: TurnListPageResponse) = apply {
            data = turnListPageResponse.data.map { it.toMutableList() }
            firstId = turnListPageResponse.firstId
            hasMore = turnListPageResponse.hasMore
            lastId = turnListPageResponse.lastId
            object_ = turnListPageResponse.object_
            additionalProperties = turnListPageResponse.additionalProperties.toMutableMap()
        }

        /** The resources returned in this page, in the requested sort order. */
        fun data(data: List<Turn>) = data(JsonField.of(data))

        /**
         * Sets [Builder.data] to an arbitrary JSON value.
         *
         * You should usually call [Builder.data] with a well-typed `List<Turn>` value instead. This
         * method is primarily for setting the field to an undocumented or not yet supported value.
         */
        fun data(data: JsonField<List<Turn>>) = apply {
            this.data = data.map { it.toMutableList() }
        }

        /**
         * Adds a single [Turn] to [Builder.data].
         *
         * @throws IllegalStateException if the field was previously set to a non-list.
         */
        fun addData(data: Turn) = apply {
            this.data =
        ...
        /**
         * Returns an immutable instance of [TurnListPageResponse].
         *
         ...
         */
        fun build(): TurnListPageResponse =
     ...
     *   expected type.
     */
    fun validate(): TurnListPageResponse = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is TurnListPageResponse &&
            data == other.data &&
    ...
    override fun toString() =
        "TurnListPageResponse{data=$data, firstId=$firstId, hasMore=$hasMore, lastId=$lastId, object_=$object_, additionalProperties=$additionalProperties}"
}
