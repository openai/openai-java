...
private constructor(
    ...
    class Builder internal constructor() {
        ...
        internal fun from(threadListParams: ThreadListParams) = apply {
            ...
            before = threadListParams.before
            limit = threadListParams.limit
            order = threadListParams.order
            user = threadListParams.user
    ...
    override fun hashCode(): Int =
        Objects.hash(after, before, limit, order, user, additionalHeaders, additionalQueryParams)

    override fun toString() =
        "ThreadListParams{after=$after, before=$before, limit=$limit, order=$order, user=$user, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
