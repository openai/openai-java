 ...
 * subsequent responses until it is replaced by another configuration update.
 */
...
private constructor(
    ...
    ) : this(type, id, agent, reasoning, mutableMapOf())
    ...
    /** A builder for [BetaResponseConfigurationUpdateItemParam]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(
            betaResponseConfigurationUpdateItemParam: BetaResponseConfigurationUpdateItemParam
        ) = apply {
            type = betaResponseConfigurationUpdateItemParam.type
            id = betaResponseConfigurationUpdateItemParam.id
            agent = betaResponseConfigurationUpdateItemParam.agent
            reasoning = betaResponseConfigurationUpdateItemParam.reasoning
            additionalProperties =
                betaResponseConfigurationUpdateItemParam.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [BetaResponseConfigurationUpdateItemParam].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): BetaResponseConfigurationUpdateItemParam =
            BetaResponseConfigurationUpdateItemParam(
                type,
                id,
                agent,
     ...
     *   expected type.
     */
    fun validate(): BetaResponseConfigurationUpdateItemParam = apply {
        if (validated) {
            return@apply
        }
    ...
    private constructor(
        ...
        /**
         * The reasoning effort to use for subsequent responses until another configuration update
         * replaces it.
         *
         * @throws OpenAIInvalidDataException if the JSON field has an unexpected type (e.g. if the
         *   server responded with an unexpected value).
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is BetaResponseConfigurationUpdateItemParam &&
            type == other.type &&
            id == other.id &&
            agent == other.agent &&
    ...
    private val hashCode: Int by lazy {
        Objects.hash(type, id, agent, reasoning, additionalProperties)
    }

    override fun hashCode(): Int = hashCode

    override fun toString() =
        "BetaResponseConfigurationUpdateItemParam{type=$type, id=$id, agent=$agent, reasoning=$reasoning, additionalProperties=$additionalProperties}"
}
