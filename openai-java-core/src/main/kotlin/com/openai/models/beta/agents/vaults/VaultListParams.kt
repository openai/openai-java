...
private constructor(
    ...
    class Builder internal constructor() {
        ...
        internal fun from(vaultListParams: VaultListParams) = apply {
            after = vaultListParams.after
            limit = vaultListParams.limit
            order = vaultListParams.order
    ...
    override fun toString() =
        "VaultListParams{after=$after, limit=$limit, order=$order, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
