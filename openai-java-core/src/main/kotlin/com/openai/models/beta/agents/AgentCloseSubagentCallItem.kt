...
private constructor(
     ...
     * ```java
     * JsonValue.from("close_subagent_call")
     * ```
     *
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [AgentCloseSubagentCallItem].
         *
    ...
    /** A builder for [AgentCloseSubagentCallItem]. */
    class Builder internal constructor() {
        ...
        private var type: JsonValue = JsonValue.from("close_subagent_call")
        private var additionalProperties: MutableMap<String, JsonValue> = mutableMapOf()

        @JvmSynthetic
        internal fun from(agentCloseSubagentCallItem: AgentCloseSubagentCallItem) = apply {
            id = agentCloseSubagentCallItem.id
            recipientAgentId = agentCloseSubagentCallItem.recipientAgentId
            senderAgentId = agentCloseSubagentCallItem.senderAgentId
            status = agentCloseSubagentCallItem.status
            turnId = agentCloseSubagentCallItem.turnId
            type = agentCloseSubagentCallItem.type
            additionalProperties = agentCloseSubagentCallItem.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [AgentCloseSubagentCallItem].
         *
         ...
         */
        fun build(): AgentCloseSubagentCallItem =
     ...
     *   expected type.
     */
    fun validate(): AgentCloseSubagentCallItem = apply {
        if (validated) {
            return@apply
        }
        ...
        turnId()
        _type().let {
            if (it != JsonValue.from("close_subagent_call")) {
    ...
    internal fun validity(): Int =
        (if (id.asKnown().isPresent) 1 else 0) +
            ...
            type.let { if (it == JsonValue.from("close_subagent_call")) 1 else 0 }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is AgentCloseSubagentCallItem &&
            id == other.id &&
    ...
    override fun toString() =
        "AgentCloseSubagentCallItem{id=$id, recipientAgentId=$recipientAgentId, senderAgentId=$senderAgentId, status=$status, turnId=$turnId, type=$type, additionalProperties=$additionalProperties}"
}
