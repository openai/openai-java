...
private constructor(
    ...
    /** A builder for [BetaSkillReference]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(betaSkillReference: BetaSkillReference) = apply {
            skillId = betaSkillReference.skillId
            type = betaSkillReference.type
            version = betaSkillReference.version
            additionalProperties = betaSkillReference.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [BetaSkillReference].
         *
     ...
     *   expected type.
     */
    fun validate(): BetaSkillReference = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is BetaSkillReference &&
    ...
    override fun toString() =
        "BetaSkillReference{skillId=$skillId, type=$type, version=$version, additionalProperties=$additionalProperties}"
}
