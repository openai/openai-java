...
private constructor(
     ...
     * ```java
     * JsonValue.from("vault.credential.deleted")
     * ```
     *
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [CredentialDeleted].
         *
    ...
    /** A builder for [CredentialDeleted]. */
    class Builder internal constructor() {

        private var id: JsonField<String>? = null
        private var deleted: JsonField<Boolean>? = null
        private var object_: JsonValue = JsonValue.from("vault.credential.deleted")
        private var additionalProperties: MutableMap<String, JsonValue> = mutableMapOf()

        @JvmSynthetic
        internal fun from(credentialDeleted: CredentialDeleted) = apply {
            id = credentialDeleted.id
            deleted = credentialDeleted.deleted
            object_ = credentialDeleted.object_
            additionalProperties = credentialDeleted.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [CredentialDeleted].
         *
     ...
     *   expected type.
     */
    fun validate(): CredentialDeleted = apply {
        if (validated) {
            return@apply
        }
        ...
        deleted()
        _object_().let {
            if (it != JsonValue.from("vault.credential.deleted")) {
    ...
    internal fun validity(): Int =
        (if (id.asKnown().isPresent) 1 else 0) +
            ...
            object_.let { if (it == JsonValue.from("vault.credential.deleted")) 1 else 0 }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is CredentialDeleted &&
            id == other.id &&
    ...
    override fun toString() =
        "CredentialDeleted{id=$id, deleted=$deleted, object_=$object_, additionalProperties=$additionalProperties}"
}
