...
private constructor(
     ...
     * import java.util.Optional;
     *
     * Optional<String> result = messageContentPartParam.accept(new MessageContentPartParam.Visitor<Optional<String>>() {
     *     @Override
     *     public Optional<String> visitImageFile(ImageFileContentBlock imageFile) {
    ...
    interface Visitor<out T> {
        ...
        fun unknown(json: JsonValue?): T {
            throw OpenAIInvalidDataException("Unknown MessageContentPartParam")
        }
    }
