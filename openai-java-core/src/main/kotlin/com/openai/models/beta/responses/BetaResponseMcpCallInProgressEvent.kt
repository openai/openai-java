...
private constructor(
    ...
    /** A builder for [BetaResponseMcpCallInProgressEvent]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(betaResponseMcpCallInProgressEvent: BetaResponseMcpCallInProgressEvent) =
            apply {
                itemId = betaResponseMcpCallInProgressEvent.itemId
                outputIndex = betaResponseMcpCallInProgressEvent.outputIndex
                sequenceNumber = betaResponseMcpCallInProgressEvent.sequenceNumber
                type = betaResponseMcpCallInProgressEvent.type
                agent = betaResponseMcpCallInProgressEvent.agent
                additionalProperties =
                    betaResponseMcpCallInProgressEvent.additionalProperties.toMutableMap()
            }
        ...
        /**
         * Returns an immutable instance of [BetaResponseMcpCallInProgressEvent].
         *
         ...
         */
        fun build(): BetaResponseMcpCallInProgressEvent =
            BetaResponseMcpCallInProgressEvent(
     ...
     *   expected type.
     */
    fun validate(): BetaResponseMcpCallInProgressEvent = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is BetaResponseMcpCallInProgressEvent &&
            itemId == other.itemId &&
    ...
    override fun toString() =
        "BetaResponseMcpCallInProgressEvent{itemId=$itemId, outputIndex=$outputIndex, sequenceNumber=$sequenceNumber, type=$type, agent=$agent, additionalProperties=$additionalProperties}"
}
