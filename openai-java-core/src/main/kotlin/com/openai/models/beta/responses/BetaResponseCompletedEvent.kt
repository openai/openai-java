...
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [BetaResponseCompletedEvent].
         *
    ...
    /** A builder for [BetaResponseCompletedEvent]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(betaResponseCompletedEvent: BetaResponseCompletedEvent) = apply {
            response = betaResponseCompletedEvent.response
            sequenceNumber = betaResponseCompletedEvent.sequenceNumber
            type = betaResponseCompletedEvent.type
            agent = betaResponseCompletedEvent.agent
            additionalProperties = betaResponseCompletedEvent.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [BetaResponseCompletedEvent].
         *
         ...
         */
        fun build(): BetaResponseCompletedEvent =
     ...
     *   expected type.
     */
    fun validate(): BetaResponseCompletedEvent = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is BetaResponseCompletedEvent &&
    ...
    override fun toString() =
        "BetaResponseCompletedEvent{response=$response, sequenceNumber=$sequenceNumber, type=$type, agent=$agent, additionalProperties=$additionalProperties}"
}
