...
private constructor(
    ...
    /** A builder for [BetaContainerNetworkPolicyDomainSecret]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(
            betaContainerNetworkPolicyDomainSecret: BetaContainerNetworkPolicyDomainSecret
        ) = apply {
            domain = betaContainerNetworkPolicyDomainSecret.domain
            name = betaContainerNetworkPolicyDomainSecret.name
            value = betaContainerNetworkPolicyDomainSecret.value
            additionalProperties =
                betaContainerNetworkPolicyDomainSecret.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [BetaContainerNetworkPolicyDomainSecret].
         *
         ...
         */
        fun build(): BetaContainerNetworkPolicyDomainSecret =
            BetaContainerNetworkPolicyDomainSecret(
     ...
     *   expected type.
     */
    fun validate(): BetaContainerNetworkPolicyDomainSecret = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is BetaContainerNetworkPolicyDomainSecret &&
            domain == other.domain &&
            name == other.name &&
            value == other.value &&
    ...
    override fun toString() =
        "BetaContainerNetworkPolicyDomainSecret{domain=$domain, name=$name, value=$value, additionalProperties=$additionalProperties}"
}
