...
private constructor(
    ...
    /** A builder for [BetaContainerReference]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(betaContainerReference: BetaContainerReference) = apply {
            containerId = betaContainerReference.containerId
            type = betaContainerReference.type
            additionalProperties = betaContainerReference.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [BetaContainerReference].
         *
         ...
         */
        fun build(): BetaContainerReference =
     ...
     *   expected type.
     */
    fun validate(): BetaContainerReference = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is BetaContainerReference &&
    ...
    override fun toString() =
        "BetaContainerReference{containerId=$containerId, type=$type, additionalProperties=$additionalProperties}"
}
