...
private constructor(
    ...
    ) : this(contentIndex, itemId, outputIndex, sequenceNumber, text, type, agent, mutableMapOf())
    ...
    /** A builder for [BetaResponseReasoningTextDoneEvent]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(betaResponseReasoningTextDoneEvent: BetaResponseReasoningTextDoneEvent) =
            apply {
                contentIndex = betaResponseReasoningTextDoneEvent.contentIndex
                itemId = betaResponseReasoningTextDoneEvent.itemId
                outputIndex = betaResponseReasoningTextDoneEvent.outputIndex
                sequenceNumber = betaResponseReasoningTextDoneEvent.sequenceNumber
                text = betaResponseReasoningTextDoneEvent.text
                type = betaResponseReasoningTextDoneEvent.type
                agent = betaResponseReasoningTextDoneEvent.agent
                additionalProperties =
                    betaResponseReasoningTextDoneEvent.additionalProperties.toMutableMap()
            }
        ...
        /**
         * Returns an immutable instance of [BetaResponseReasoningTextDoneEvent].
         *
         ...
         */
        fun build(): BetaResponseReasoningTextDoneEvent =
            BetaResponseReasoningTextDoneEvent(
     ...
     *   expected type.
     */
    fun validate(): BetaResponseReasoningTextDoneEvent = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is BetaResponseReasoningTextDoneEvent &&
    ...
    override fun toString() =
        "BetaResponseReasoningTextDoneEvent{contentIndex=$contentIndex, itemId=$itemId, outputIndex=$outputIndex, sequenceNumber=$sequenceNumber, text=$text, type=$type, agent=$agent, additionalProperties=$additionalProperties}"
}
