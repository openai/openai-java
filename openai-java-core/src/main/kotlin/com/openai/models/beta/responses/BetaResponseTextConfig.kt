...
private constructor(
    ...
    companion object {
        ...
        /** Returns a mutable builder for constructing an instance of [BetaResponseTextConfig]. */
        @JvmStatic fun builder() = Builder()
    }

    /** A builder for [BetaResponseTextConfig]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(betaResponseTextConfig: BetaResponseTextConfig) = apply {
            format = betaResponseTextConfig.format
            verbosity = betaResponseTextConfig.verbosity
            additionalProperties = betaResponseTextConfig.additionalProperties.toMutableMap()
        }
         ...
         *
         * You should usually call [Builder.format] with a well-typed [BetaResponseFormatTextConfig]
         * value instead. This method is primarily for setting the field to an undocumented or not
         * yet supported value.
         */
        fun format(format: JsonField<BetaResponseFormatTextConfig>) = apply { this.format = format }
        ...
        /**
         * Alias for calling [format] with `BetaResponseFormatTextConfig.ofJsonSchema(jsonSchema)`.
         */
         ...
         */
        fun build(): BetaResponseTextConfig =
            BetaResponseTextConfig(format, verbosity, additionalProperties.toMutableMap())
    }
     ...
     *   expected type.
     */
    fun validate(): BetaResponseTextConfig = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is BetaResponseTextConfig &&
            format == other.format &&
    ...
    override fun toString() =
        "BetaResponseTextConfig{format=$format, verbosity=$verbosity, additionalProperties=$additionalProperties}"
}
