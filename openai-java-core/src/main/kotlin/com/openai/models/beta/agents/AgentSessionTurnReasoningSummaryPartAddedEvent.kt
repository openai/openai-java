...
private constructor(
     ...
     * ```java
     * JsonValue.from("agent.session.turn.reasoning_summary_part.added")
     * ```
     *
    ...
    /** A builder for [AgentSessionTurnReasoningSummaryPartAddedEvent]. */
    class Builder internal constructor() {
        ...
        internal fun from(
            ...
            eventId = agentSessionTurnReasoningSummaryPartAddedEvent.eventId
            itemId = agentSessionTurnReasoningSummaryPartAddedEvent.itemId
            outputIndex = agentSessionTurnReasoningSummaryPartAddedEvent.outputIndex
            part = agentSessionTurnReasoningSummaryPartAddedEvent.part
            sessionId = agentSessionTurnReasoningSummaryPartAddedEvent.sessionId
            summaryIndex = agentSessionTurnReasoningSummaryPartAddedEvent.summaryIndex
            turnId = agentSessionTurnReasoningSummaryPartAddedEvent.turnId
            type = agentSessionTurnReasoningSummaryPartAddedEvent.type
            additionalProperties =
                agentSessionTurnReasoningSummaryPartAddedEvent.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [AgentSessionTurnReasoningSummaryPartAddedEvent].
         *
         ...
         */
        fun build(): AgentSessionTurnReasoningSummaryPartAddedEvent =
            AgentSessionTurnReasoningSummaryPartAddedEvent(
     ...
     *   expected type.
     */
    fun validate(): AgentSessionTurnReasoningSummaryPartAddedEvent = apply {
        if (validated) {
            return@apply
        }
        ...
        turnId()
        _type().let {
            if (it != JsonValue.from("agent.session.turn.reasoning_summary_part.added")) {
    ...
    internal fun validity(): Int =
        (if (eventId.asKnown().isPresent) 1 else 0) +
            ...
            type.let {
                if (it == JsonValue.from("agent.session.turn.reasoning_summary_part.added")) 1
                else 0
            }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is AgentSessionTurnReasoningSummaryPartAddedEvent &&
    ...
    override fun toString() =
        "AgentSessionTurnReasoningSummaryPartAddedEvent{eventId=$eventId, itemId=$itemId, outputIndex=$outputIndex, part=$part, sessionId=$sessionId, summaryIndex=$summaryIndex, turnId=$turnId, type=$type, additionalProperties=$additionalProperties}"
}
