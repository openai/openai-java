...
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [InlineCapabilitySourceParam].
         *
    ...
    /** A builder for [InlineCapabilitySourceParam]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(inlineCapabilitySourceParam: InlineCapabilitySourceParam) = apply {
            data = inlineCapabilitySourceParam.data
            mediaType = inlineCapabilitySourceParam.mediaType
            type = inlineCapabilitySourceParam.type
            additionalProperties = inlineCapabilitySourceParam.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [InlineCapabilitySourceParam].
         *
         ...
         */
        fun build(): InlineCapabilitySourceParam =
     ...
     *   expected type.
     */
    fun validate(): InlineCapabilitySourceParam = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is InlineCapabilitySourceParam &&
            data == other.data &&
    ...
    override fun toString() =
        "InlineCapabilitySourceParam{data=$data, mediaType=$mediaType, type=$type, additionalProperties=$additionalProperties}"
}
