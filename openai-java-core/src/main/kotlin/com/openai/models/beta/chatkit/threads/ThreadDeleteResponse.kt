...
private constructor(
     ...
     * ```java
     * JsonValue.from("chatkit.thread.deleted")
     * ```
     *
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [ThreadDeleteResponse].
         *
    ...
    /** A builder for [ThreadDeleteResponse]. */
    class Builder internal constructor() {

        private var id: JsonField<String>? = null
        private var deleted: JsonField<Boolean>? = null
        private var object_: JsonValue = JsonValue.from("chatkit.thread.deleted")
        private var additionalProperties: MutableMap<String, JsonValue> = mutableMapOf()

        @JvmSynthetic
        internal fun from(threadDeleteResponse: ThreadDeleteResponse) = apply {
            id = threadDeleteResponse.id
            deleted = threadDeleteResponse.deleted
            object_ = threadDeleteResponse.object_
            additionalProperties = threadDeleteResponse.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [ThreadDeleteResponse].
         *
         ...
         */
        fun build(): ThreadDeleteResponse =
    ...
    fun validate(): ThreadDeleteResponse = apply {
        if (validated) {
            return@apply
        }
        ...
        deleted()
        _object_().let {
            if (it != JsonValue.from("chatkit.thread.deleted")) {
    ...
    internal fun validity(): Int =
        (if (id.asKnown().isPresent) 1 else 0) +
            ...
            object_.let { if (it == JsonValue.from("chatkit.thread.deleted")) 1 else 0 }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is ThreadDeleteResponse &&
            id == other.id &&
    ...
    override fun toString() =
        "ThreadDeleteResponse{id=$id, deleted=$deleted, object_=$object_, additionalProperties=$additionalProperties}"
}
