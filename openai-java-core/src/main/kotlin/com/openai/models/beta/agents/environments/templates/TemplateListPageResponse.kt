...
private constructor(
    private val data: JsonField<List<EnvironmentTemplate>>,
    ...
    private constructor(
        @JsonProperty("data")
        @ExcludeMissing
        data: JsonField<List<EnvironmentTemplate>> = JsonMissing.of(),
     ...
     */
    fun data(): List<EnvironmentTemplate> = data.getRequired("data")
     ...
     */
    @JsonProperty("data") @ExcludeMissing fun _data(): JsonField<List<EnvironmentTemplate>> = data
    ...
    class Builder internal constructor() {
        ...
        private var data: JsonField<MutableList<EnvironmentTemplate>>? = null
        ...
        internal fun from(templateListPageResponse: TemplateListPageResponse) = apply {
            ...
            firstId = templateListPageResponse.firstId
            hasMore = templateListPageResponse.hasMore
            lastId = templateListPageResponse.lastId
            object_ = templateListPageResponse.object_
            additionalProperties = templateListPageResponse.additionalProperties.toMutableMap()
        }

        /** The resources returned in this page, in the requested sort order. */
        fun data(data: List<EnvironmentTemplate>) = data(JsonField.of(data))

        /**
         * Sets [Builder.data] to an arbitrary JSON value.
         *
         * You should usually call [Builder.data] with a well-typed `List<EnvironmentTemplate>`
         * value instead. This method is primarily for setting the field to an undocumented or not
         * yet supported value.
         */
        fun data(data: JsonField<List<EnvironmentTemplate>>) = apply {
            this.data = data.map { it.toMutableList() }
        }

        /**
         * Adds a single [EnvironmentTemplate] to [Builder.data].
         *
         * @throws IllegalStateException if the field was previously set to a non-list.
         */
        fun addData(data: EnvironmentTemplate) = apply {
            this.data =
    ...
    override fun toString() =
        "TemplateListPageResponse{data=$data, firstId=$firstId, hasMore=$hasMore, lastId=$lastId, object_=$object_, additionalProperties=$additionalProperties}"
}
