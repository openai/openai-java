...
private constructor(
    ...
    ) : this(eventId, sessionId, turn, turnId, type, usage, mutableMapOf())
     ...
     * ```java
     * JsonValue.from("agent.session.turn.failed")
     * ```
     *
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [AgentSessionTurnFailedEvent].
         *
    ...
    /** A builder for [AgentSessionTurnFailedEvent]. */
    class Builder internal constructor() {
        ...
        private var type: JsonValue = JsonValue.from("agent.session.turn.failed")
        private var usage: JsonField<TokenUsage>? = null
        private var additionalProperties: MutableMap<String, JsonValue> = mutableMapOf()

        @JvmSynthetic
        internal fun from(agentSessionTurnFailedEvent: AgentSessionTurnFailedEvent) = apply {
            eventId = agentSessionTurnFailedEvent.eventId
            sessionId = agentSessionTurnFailedEvent.sessionId
            turn = agentSessionTurnFailedEvent.turn
            turnId = agentSessionTurnFailedEvent.turnId
            type = agentSessionTurnFailedEvent.type
            usage = agentSessionTurnFailedEvent.usage
            additionalProperties = agentSessionTurnFailedEvent.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [AgentSessionTurnFailedEvent].
         *
         ...
         */
        fun build(): AgentSessionTurnFailedEvent =
     ...
     *   expected type.
     */
    fun validate(): AgentSessionTurnFailedEvent = apply {
        if (validated) {
            return@apply
        }
        ...
        turnId()
        _type().let {
            if (it != JsonValue.from("agent.session.turn.failed")) {
    ...
    internal fun validity(): Int =
        (if (eventId.asKnown().isPresent) 1 else 0) +
            ...
            type.let { if (it == JsonValue.from("agent.session.turn.failed")) 1 else 0 } +
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is AgentSessionTurnFailedEvent &&
    ...
    private val hashCode: Int by lazy {
        Objects.hash(eventId, sessionId, turn, turnId, type, usage, additionalProperties)
    }

    override fun hashCode(): Int = hashCode

    override fun toString() =
        "AgentSessionTurnFailedEvent{eventId=$eventId, sessionId=$sessionId, turn=$turn, turnId=$turnId, type=$type, usage=$usage, additionalProperties=$additionalProperties}"
}
