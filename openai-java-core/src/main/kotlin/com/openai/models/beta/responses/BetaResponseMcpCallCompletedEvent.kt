...
private constructor(
    ...
    /** A builder for [BetaResponseMcpCallCompletedEvent]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(betaResponseMcpCallCompletedEvent: BetaResponseMcpCallCompletedEvent) =
            apply {
                itemId = betaResponseMcpCallCompletedEvent.itemId
                outputIndex = betaResponseMcpCallCompletedEvent.outputIndex
                sequenceNumber = betaResponseMcpCallCompletedEvent.sequenceNumber
                type = betaResponseMcpCallCompletedEvent.type
                agent = betaResponseMcpCallCompletedEvent.agent
                additionalProperties =
                    betaResponseMcpCallCompletedEvent.additionalProperties.toMutableMap()
            }
        ...
        /**
         * Returns an immutable instance of [BetaResponseMcpCallCompletedEvent].
         *
         ...
         */
        fun build(): BetaResponseMcpCallCompletedEvent =
            BetaResponseMcpCallCompletedEvent(
     ...
     *   expected type.
     */
    fun validate(): BetaResponseMcpCallCompletedEvent = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is BetaResponseMcpCallCompletedEvent &&
            itemId == other.itemId &&
    ...
    override fun toString() =
        "BetaResponseMcpCallCompletedEvent{itemId=$itemId, outputIndex=$outputIndex, sequenceNumber=$sequenceNumber, type=$type, agent=$agent, additionalProperties=$additionalProperties}"
}
