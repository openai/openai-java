...
private constructor(
    ...
    ) : this(delta, itemId, outputIndex, sequenceNumber, summaryIndex, type, agent, mutableMapOf())
    ...
    /** A builder for [BetaResponseReasoningSummaryTextDeltaEvent]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(
            betaResponseReasoningSummaryTextDeltaEvent: BetaResponseReasoningSummaryTextDeltaEvent
        ) = apply {
            delta = betaResponseReasoningSummaryTextDeltaEvent.delta
            itemId = betaResponseReasoningSummaryTextDeltaEvent.itemId
            outputIndex = betaResponseReasoningSummaryTextDeltaEvent.outputIndex
            sequenceNumber = betaResponseReasoningSummaryTextDeltaEvent.sequenceNumber
            summaryIndex = betaResponseReasoningSummaryTextDeltaEvent.summaryIndex
            type = betaResponseReasoningSummaryTextDeltaEvent.type
            agent = betaResponseReasoningSummaryTextDeltaEvent.agent
            additionalProperties =
                betaResponseReasoningSummaryTextDeltaEvent.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [BetaResponseReasoningSummaryTextDeltaEvent].
         *
         ...
         */
        fun build(): BetaResponseReasoningSummaryTextDeltaEvent =
            BetaResponseReasoningSummaryTextDeltaEvent(
     ...
     *   expected type.
     */
    fun validate(): BetaResponseReasoningSummaryTextDeltaEvent = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is BetaResponseReasoningSummaryTextDeltaEvent &&
            delta == other.delta &&
            itemId == other.itemId &&
    ...
    override fun toString() =
        "BetaResponseReasoningSummaryTextDeltaEvent{delta=$delta, itemId=$itemId, outputIndex=$outputIndex, sequenceNumber=$sequenceNumber, summaryIndex=$summaryIndex, type=$type, agent=$agent, additionalProperties=$additionalProperties}"
}
