...
private constructor(
    private val data: JsonField<List<Credential>>,
    ...
    @JsonCreator
    private constructor(
        @JsonProperty("data") @ExcludeMissing data: JsonField<List<Credential>> = JsonMissing.of(),
     ...
     */
    fun data(): List<Credential> = data.getRequired("data")
     ...
     */
    @JsonProperty("data") @ExcludeMissing fun _data(): JsonField<List<Credential>> = data
    ...
    class Builder internal constructor() {
        ...
        private var data: JsonField<MutableList<Credential>>? = null
        ...
        internal fun from(credentialListPageResponse: CredentialListPageResponse) = apply {
            ...
            firstId = credentialListPageResponse.firstId
            hasMore = credentialListPageResponse.hasMore
            lastId = credentialListPageResponse.lastId
            object_ = credentialListPageResponse.object_
            additionalProperties = credentialListPageResponse.additionalProperties.toMutableMap()
        }

        /** The resources returned in this page, in the requested sort order. */
        fun data(data: List<Credential>) = data(JsonField.of(data))

        /**
         * Sets [Builder.data] to an arbitrary JSON value.
         *
         * You should usually call [Builder.data] with a well-typed `List<Credential>` value
         * instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun data(data: JsonField<List<Credential>>) = apply {
            this.data = data.map { it.toMutableList() }
        }

        /**
         * Adds a single [Credential] to [Builder.data].
         *
         * @throws IllegalStateException if the field was previously set to a non-list.
         */
        fun addData(data: Credential) = apply {
            this.data =
    ...
    override fun toString() =
        "CredentialListPageResponse{data=$data, firstId=$firstId, hasMore=$hasMore, lastId=$lastId, object_=$object_, additionalProperties=$additionalProperties}"
}
