...
private constructor(
    ...
    /** A builder for [BetaResponseFunctionShellCallOutputContent]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(
            betaResponseFunctionShellCallOutputContent: BetaResponseFunctionShellCallOutputContent
        ) = apply {
            outcome = betaResponseFunctionShellCallOutputContent.outcome
            stderr = betaResponseFunctionShellCallOutputContent.stderr
            stdout = betaResponseFunctionShellCallOutputContent.stdout
            additionalProperties =
                betaResponseFunctionShellCallOutputContent.additionalProperties.toMutableMap()
        }
         ...
         */
        fun build(): BetaResponseFunctionShellCallOutputContent =
            BetaResponseFunctionShellCallOutputContent(
     ...
     *   expected type.
     */
    fun validate(): BetaResponseFunctionShellCallOutputContent = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is BetaResponseFunctionShellCallOutputContent &&
    ...
    override fun toString() =
        "BetaResponseFunctionShellCallOutputContent{outcome=$outcome, stderr=$stderr, stdout=$stdout, additionalProperties=$additionalProperties}"
}
