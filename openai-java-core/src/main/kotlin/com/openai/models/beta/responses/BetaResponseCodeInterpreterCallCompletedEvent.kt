...
private constructor(
    ...
    /** A builder for [BetaResponseCodeInterpreterCallCompletedEvent]. */
    class Builder internal constructor() {
        ...
        internal fun from(
            ...
            itemId = betaResponseCodeInterpreterCallCompletedEvent.itemId
            outputIndex = betaResponseCodeInterpreterCallCompletedEvent.outputIndex
            sequenceNumber = betaResponseCodeInterpreterCallCompletedEvent.sequenceNumber
            type = betaResponseCodeInterpreterCallCompletedEvent.type
            agent = betaResponseCodeInterpreterCallCompletedEvent.agent
            additionalProperties =
                betaResponseCodeInterpreterCallCompletedEvent.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [BetaResponseCodeInterpreterCallCompletedEvent].
         *
         ...
         */
        fun build(): BetaResponseCodeInterpreterCallCompletedEvent =
            BetaResponseCodeInterpreterCallCompletedEvent(
     ...
     *   expected type.
     */
    fun validate(): BetaResponseCodeInterpreterCallCompletedEvent = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is BetaResponseCodeInterpreterCallCompletedEvent &&
            itemId == other.itemId &&
    ...
    override fun toString() =
        "BetaResponseCodeInterpreterCallCompletedEvent{itemId=$itemId, outputIndex=$outputIndex, sequenceNumber=$sequenceNumber, type=$type, agent=$agent, additionalProperties=$additionalProperties}"
}
