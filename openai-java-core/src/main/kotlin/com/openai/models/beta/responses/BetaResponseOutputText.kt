...
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [BetaResponseOutputText].
         *
    ...
    /** A builder for [BetaResponseOutputText]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(betaResponseOutputText: BetaResponseOutputText) = apply {
            annotations = betaResponseOutputText.annotations.map { it.toMutableList() }
            text = betaResponseOutputText.text
            type = betaResponseOutputText.type
            logprobs = betaResponseOutputText.logprobs.map { it.toMutableList() }
            additionalProperties = betaResponseOutputText.additionalProperties.toMutableMap()
        }
         ...
         */
        fun build(): BetaResponseOutputText =
     ...
     *   expected type.
     */
    fun validate(): BetaResponseOutputText = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is BetaResponseOutputText &&
    ...
    override fun toString() =
        "BetaResponseOutputText{annotations=$annotations, text=$text, type=$type, logprobs=$logprobs, additionalProperties=$additionalProperties}"
}
