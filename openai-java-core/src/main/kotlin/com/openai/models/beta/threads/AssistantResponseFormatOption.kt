 ...
 * Turbo](https://developers.openai.com/api/docs/models/gpt-4-turbo), and all GPT-3.5 Turbo models
...
private constructor(
     ...
     * import java.util.Optional;
     *
     * Optional<String> result = assistantResponseFormatOption.accept(new AssistantResponseFormatOption.Visitor<Optional<String>>() {
     *     @Override
    ...
    interface Visitor<out T> {
        ...
        fun unknown(json: JsonValue?): T {
            throw OpenAIInvalidDataException("Unknown AssistantResponseFormatOption")
        }
    }
