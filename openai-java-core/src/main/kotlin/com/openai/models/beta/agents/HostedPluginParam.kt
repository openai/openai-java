...
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [HostedPluginParam].
         *
    ...
    /** A builder for [HostedPluginParam]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(hostedPluginParam: HostedPluginParam) = apply {
            description = hostedPluginParam.description
            name = hostedPluginParam.name
            source = hostedPluginParam.source
            type = hostedPluginParam.type
            additionalProperties = hostedPluginParam.additionalProperties.toMutableMap()
        }
         ...
         *
         * You should usually call [Builder.source] with a well-typed [InlineCapabilitySourceParam]
         * value instead. This method is primarily for setting the field to an undocumented or not
         * yet supported value.
         */
        fun source(source: JsonField<InlineCapabilitySourceParam>) = apply { this.source = source }
        ...
        /**
         * Returns an immutable instance of [HostedPluginParam].
         *
     ...
     *   expected type.
     */
    fun validate(): HostedPluginParam = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is HostedPluginParam &&
    ...
    override fun toString() =
        "HostedPluginParam{description=$description, name=$name, source=$source, type=$type, additionalProperties=$additionalProperties}"
}
