...
private constructor(
    ...
    ) : this(input, itemId, outputIndex, sequenceNumber, type, agent, mutableMapOf())
    ...
    /** A builder for [BetaResponseCustomToolCallInputDoneEvent]. */
    class Builder internal constructor() {
        ...
        internal fun from(
            ...
            input = betaResponseCustomToolCallInputDoneEvent.input
            itemId = betaResponseCustomToolCallInputDoneEvent.itemId
            outputIndex = betaResponseCustomToolCallInputDoneEvent.outputIndex
            sequenceNumber = betaResponseCustomToolCallInputDoneEvent.sequenceNumber
            type = betaResponseCustomToolCallInputDoneEvent.type
            agent = betaResponseCustomToolCallInputDoneEvent.agent
            additionalProperties =
                betaResponseCustomToolCallInputDoneEvent.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [BetaResponseCustomToolCallInputDoneEvent].
         *
         ...
         */
        fun build(): BetaResponseCustomToolCallInputDoneEvent =
            BetaResponseCustomToolCallInputDoneEvent(
     ...
     *   expected type.
     */
    fun validate(): BetaResponseCustomToolCallInputDoneEvent = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is BetaResponseCustomToolCallInputDoneEvent &&
            input == other.input &&
            itemId == other.itemId &&
    ...
    private val hashCode: Int by lazy {
        Objects.hash(input, itemId, outputIndex, sequenceNumber, type, agent, additionalProperties)
    }

    override fun hashCode(): Int = hashCode

    override fun toString() =
        "BetaResponseCustomToolCallInputDoneEvent{input=$input, itemId=$itemId, outputIndex=$outputIndex, sequenceNumber=$sequenceNumber, type=$type, agent=$agent, additionalProperties=$additionalProperties}"
}
