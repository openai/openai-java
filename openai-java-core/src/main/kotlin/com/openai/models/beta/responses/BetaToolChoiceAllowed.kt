...
private constructor(
    ...
    /** A builder for [BetaToolChoiceAllowed]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(betaToolChoiceAllowed: BetaToolChoiceAllowed) = apply {
            mode = betaToolChoiceAllowed.mode
            tools = betaToolChoiceAllowed.tools.map { it.toMutableList() }
            type = betaToolChoiceAllowed.type
            additionalProperties = betaToolChoiceAllowed.additionalProperties.toMutableMap()
        }
         ...
         */
        fun build(): BetaToolChoiceAllowed =
     ...
     *   expected type.
     */
    fun validate(): BetaToolChoiceAllowed = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is BetaToolChoiceAllowed &&
            mode == other.mode &&
            tools == other.tools &&
            type == other.type &&
    ...
    override fun toString() =
        "BetaToolChoiceAllowed{mode=$mode, tools=$tools, type=$type, additionalProperties=$additionalProperties}"
}
