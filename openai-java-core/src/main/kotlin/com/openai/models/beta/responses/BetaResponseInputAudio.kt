...
private constructor(
    ...
    /** A builder for [BetaResponseInputAudio]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(betaResponseInputAudio: BetaResponseInputAudio) = apply {
            inputAudio = betaResponseInputAudio.inputAudio
            type = betaResponseInputAudio.type
            additionalProperties = betaResponseInputAudio.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [BetaResponseInputAudio].
         *
         ...
         */
        fun build(): BetaResponseInputAudio =
     ...
     *   expected type.
     */
    fun validate(): BetaResponseInputAudio = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is BetaResponseInputAudio &&
    ...
    override fun toString() =
        "BetaResponseInputAudio{inputAudio=$inputAudio, type=$type, additionalProperties=$additionalProperties}"
}
