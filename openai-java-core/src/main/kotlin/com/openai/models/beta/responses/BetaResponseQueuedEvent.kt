...
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [BetaResponseQueuedEvent].
         *
    ...
    /** A builder for [BetaResponseQueuedEvent]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(betaResponseQueuedEvent: BetaResponseQueuedEvent) = apply {
            response = betaResponseQueuedEvent.response
            sequenceNumber = betaResponseQueuedEvent.sequenceNumber
            type = betaResponseQueuedEvent.type
            agent = betaResponseQueuedEvent.agent
            additionalProperties = betaResponseQueuedEvent.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [BetaResponseQueuedEvent].
         *
         ...
         */
        fun build(): BetaResponseQueuedEvent =
     ...
     *   expected type.
     */
    fun validate(): BetaResponseQueuedEvent = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is BetaResponseQueuedEvent &&
    ...
    override fun toString() =
        "BetaResponseQueuedEvent{response=$response, sequenceNumber=$sequenceNumber, type=$type, agent=$agent, additionalProperties=$additionalProperties}"
}
