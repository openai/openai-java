...
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [SetupCommandParam].
         *
    ...
    /** A builder for [SetupCommandParam]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(setupCommandParam: SetupCommandParam) = apply {
            command = setupCommandParam.command
            cwd = setupCommandParam.cwd
            additionalProperties = setupCommandParam.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [SetupCommandParam].
         *
     ...
     *   expected type.
     */
    fun validate(): SetupCommandParam = apply {
        if (validated) {
            return@apply
        }
    ...
    internal fun validity(): Int =
        (if (command.asKnown().isPresent) 1 else 0) + (if (cwd.asKnown().isPresent) 1 else 0)
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is SetupCommandParam &&
            command == other.command &&
            cwd == other.cwd &&
            additionalProperties == other.additionalProperties
    }

    private val hashCode: Int by lazy { Objects.hash(command, cwd, additionalProperties) }

    override fun hashCode(): Int = hashCode

    override fun toString() =
        "SetupCommandParam{command=$command, cwd=$cwd, additionalProperties=$additionalProperties}"
}
