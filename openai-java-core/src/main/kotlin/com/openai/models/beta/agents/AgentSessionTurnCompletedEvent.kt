...
private constructor(
     ...
     * ```java
     * JsonValue.from("agent.session.turn.completed")
     * ```
     *
    ...
    /** A builder for [AgentSessionTurnCompletedEvent]. */
    class Builder internal constructor() {
        ...
        private var type: JsonValue = JsonValue.from("agent.session.turn.completed")
        private var usage: JsonField<TokenUsage>? = null
        private var additionalProperties: MutableMap<String, JsonValue> = mutableMapOf()

        @JvmSynthetic
        internal fun from(agentSessionTurnCompletedEvent: AgentSessionTurnCompletedEvent) = apply {
            eventId = agentSessionTurnCompletedEvent.eventId
            sessionId = agentSessionTurnCompletedEvent.sessionId
            turn = agentSessionTurnCompletedEvent.turn
            turnId = agentSessionTurnCompletedEvent.turnId
            type = agentSessionTurnCompletedEvent.type
            usage = agentSessionTurnCompletedEvent.usage
            additionalProperties =
                agentSessionTurnCompletedEvent.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [AgentSessionTurnCompletedEvent].
         *
         ...
         */
        fun build(): AgentSessionTurnCompletedEvent =
            AgentSessionTurnCompletedEvent(
     ...
     *   expected type.
     */
    fun validate(): AgentSessionTurnCompletedEvent = apply {
        if (validated) {
            return@apply
        }
        ...
        turnId()
        _type().let {
            if (it != JsonValue.from("agent.session.turn.completed")) {
    ...
    internal fun validity(): Int =
        (if (eventId.asKnown().isPresent) 1 else 0) +
            ...
            type.let { if (it == JsonValue.from("agent.session.turn.completed")) 1 else 0 } +
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is AgentSessionTurnCompletedEvent &&
    ...
    override fun toString() =
        "AgentSessionTurnCompletedEvent{eventId=$eventId, sessionId=$sessionId, turn=$turn, turnId=$turnId, type=$type, usage=$usage, additionalProperties=$additionalProperties}"
}
