...
private constructor(
    ...
    /** A builder for [BetaInlineSkillSource]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(betaInlineSkillSource: BetaInlineSkillSource) = apply {
            data = betaInlineSkillSource.data
            mediaType = betaInlineSkillSource.mediaType
            type = betaInlineSkillSource.type
            additionalProperties = betaInlineSkillSource.additionalProperties.toMutableMap()
        }
         ...
         */
        fun build(): BetaInlineSkillSource =
     ...
     *   expected type.
     */
    fun validate(): BetaInlineSkillSource = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is BetaInlineSkillSource &&
            data == other.data &&
    ...
    override fun toString() =
        "BetaInlineSkillSource{data=$data, mediaType=$mediaType, type=$type, additionalProperties=$additionalProperties}"
}
