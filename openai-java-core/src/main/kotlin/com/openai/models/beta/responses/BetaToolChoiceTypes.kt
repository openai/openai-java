...
private constructor(
    ...
    /** A builder for [BetaToolChoiceTypes]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(betaToolChoiceTypes: BetaToolChoiceTypes) = apply {
            type = betaToolChoiceTypes.type
            additionalProperties = betaToolChoiceTypes.additionalProperties.toMutableMap()
        }
         ...
         */
        fun build(): BetaToolChoiceTypes =
            BetaToolChoiceTypes(checkRequired("type", type), additionalProperties.toMutableMap())
    }
     ...
     *   expected type.
     */
    fun validate(): BetaToolChoiceTypes = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is BetaToolChoiceTypes &&
            type == other.type &&
    ...
    override fun toString() =
        "BetaToolChoiceTypes{type=$type, additionalProperties=$additionalProperties}"
}
