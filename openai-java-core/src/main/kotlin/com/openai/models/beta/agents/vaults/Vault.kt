...
private constructor(
    ...
    ) : this(id, createdAt, metadata, name, object_, mutableMapOf())
    ...
    class Builder internal constructor() {
        ...
        private var object_: JsonValue = JsonValue.from("vault")
    ...
    internal fun validity(): Int =
        (if (id.asKnown().isPresent) 1 else 0) +
            ...
            object_.let { if (it == JsonValue.from("vault")) 1 else 0 }
    ...
    private val hashCode: Int by lazy {
        Objects.hash(id, createdAt, metadata, name, object_, additionalProperties)
    }

    override fun hashCode(): Int = hashCode

    override fun toString() =
        "Vault{id=$id, createdAt=$createdAt, metadata=$metadata, name=$name, object_=$object_, additionalProperties=$additionalProperties}"
}
