...
private constructor(
    ...
    private val include: List<BetaResponseIncludable>?,
     ...
     */
    fun include(): Optional<List<BetaResponseIncludable>> = Optional.ofNullable(include)
    ...
    class Builder internal constructor() {
        ...
        private var include: MutableList<BetaResponseIncludable>? = null
        ...
        internal fun from(responseRetrieveParams: ResponseRetrieveParams) = apply {
            ...
            betas = responseRetrieveParams.betas?.toMutableList()
         ...
         * creation above for more information.
         */
        fun include(include: List<BetaResponseIncludable>?) = apply {
    ...
    override fun toString() =
        "ResponseRetrieveParams{responseId=$responseId, include=$include, includeObfuscation=$includeObfuscation, startingAfter=$startingAfter, betas=$betas, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
