...
private constructor(
    ...
    private constructor(
         ...
         * import java.util.Optional;
         *
         * Optional<String> result = stepDetails.accept(new StepDetails.Visitor<Optional<String>>() {
         *     @Override
         *     public Optional<String> visitMessageCreation(MessageCreationStepDetails messageCreation) {
         *         return Optional.of(messageCreation.toString());
         *     }
         *
         *     // ...
         *
        ...
        interface Visitor<out T> {
            ...
            fun unknown(json: JsonValue?): T {
                throw OpenAIInvalidDataException("Unknown StepDetails")
            }
        }
