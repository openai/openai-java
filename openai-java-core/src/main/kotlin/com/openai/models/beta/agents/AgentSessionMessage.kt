...
private constructor(
    ...
    private val content: JsonField<List<AgentSessionMessageContent>>,
    ...
    private constructor(
        ...
        @ExcludeMissing
        content: JsonField<List<AgentSessionMessageContent>> = JsonMissing.of(),
    ...
    /**
     * The content of the message. User messages contain input text or images; assistant messages
     * contain output text.
     *
    ...
    @JsonProperty("content")
    @ExcludeMissing
    fun _content(): JsonField<List<AgentSessionMessageContent>> = content
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [AgentSessionMessage].
         *
    ...
    /** A builder for [AgentSessionMessage]. */
    class Builder internal constructor() {

        private var id: JsonField<String>? = null
        private var content: JsonField<MutableList<AgentSessionMessageContent>>? = null
        ...
        @JvmSynthetic
        internal fun from(agentSessionMessage: AgentSessionMessage) = apply {
            id = agentSessionMessage.id
            content = agentSessionMessage.content.map { it.toMutableList() }
            phase = agentSessionMessage.phase
            role = agentSessionMessage.role
            status = agentSessionMessage.status
            turnId = agentSessionMessage.turnId
            type = agentSessionMessage.type
            additionalProperties = agentSessionMessage.additionalProperties.toMutableMap()
        }
        ...
        /**
         * The content of the message. User messages contain input text or images; assistant
         * messages contain output text.
         */
        fun content(content: List<AgentSessionMessageContent>) = content(JsonField.of(content))

        /**
         * Sets [Builder.content] to an arbitrary JSON value.
         *
         * You should usually call [Builder.content] with a well-typed
         * `List<AgentSessionMessageContent>` value instead. This method is primarily for setting
         * the field to an undocumented or not yet supported value.
         */
        fun content(content: JsonField<List<AgentSessionMessageContent>>) = apply {
            this.content = content.map { it.toMutableList() }
        }

        /**
         * Adds a single [AgentSessionMessageContent] to [Builder.content].
         *
         * @throws IllegalStateException if the field was previously set to a non-list.
         */
        fun addContent(content: AgentSessionMessageContent) = apply {
            this.content =
        ...
        /**
         * Alias for calling [addContent] with `AgentSessionMessageContent.ofInputText(inputText)`.
         */
        fun addContent(inputText: AgentSessionMessageContent.InputText) =
            addContent(AgentSessionMessageContent.ofInputText(inputText))

        /**
         * Alias for calling [addContent] with the following:
         * ```java
         * AgentSessionMessageContent.InputText.builder()
         *     .text(text)
         *     .build()
         * ```
         */
        fun addInputTextContent(text: String) =
            addContent(AgentSessionMessageContent.InputText.builder().text(text).build())

        /**
         * Alias for calling [addContent] with
         * `AgentSessionMessageContent.ofInputImage(inputImage)`.
         */
        fun addContent(inputImage: AgentSessionMessageContent.InputImage) =
            addContent(AgentSessionMessageContent.ofInputImage(inputImage))

        /**
         * Alias for calling [addContent] with the following:
         * ```java
         * AgentSessionMessageContent.InputImage.builder()
         *     .imageUrl(imageUrl)
         *     .build()
         * ```
         */
        fun addInputImageContent(imageUrl: String) =
            addContent(AgentSessionMessageContent.InputImage.builder().imageUrl(imageUrl).build())

        /**
         * Alias for calling [addContent] with
         * `AgentSessionMessageContent.ofOutputText(outputText)`.
         */
        fun addContent(outputText: AgentSessionMessageContent.OutputText) =
            addContent(AgentSessionMessageContent.ofOutputText(outputText))
        ...
        /**
         * Returns an immutable instance of [AgentSessionMessage].
         *
     ...
     *   expected type.
     */
    fun validate(): AgentSessionMessage = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is AgentSessionMessage &&
            id == other.id &&
    ...
    override fun toString() =
        "AgentSessionMessage{id=$id, content=$content, phase=$phase, role=$role, status=$status, turnId=$turnId, type=$type, additionalProperties=$additionalProperties}"
}
