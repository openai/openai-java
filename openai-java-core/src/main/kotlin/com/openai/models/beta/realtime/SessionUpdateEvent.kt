...
private constructor(
    ...
    private constructor(
        ...
        class Builder internal constructor() {
            ...
            internal fun from(session: Session) = apply {
                ...
                maxResponseOutputTokens = session.maxResponseOutputTokens
                ...
                tools = session.tools.map { it.toMutableList() }
        ...
        private constructor(
            ...
            class Builder internal constructor() {
                 ...
                 *
                 * You should usually call [Builder.expiresAfter] with a well-typed [ExpiresAfter]
            ...
            private constructor(
                 ...
                 *
                 * Unlike [anchor], this method doesn't throw if the JSON field has an unexpected
                 * type.
                 */
        ...
        private constructor(
            ...
            class Builder internal constructor() {
                ...
                internal fun from(inputAudioTranscription: InputAudioTranscription) = apply {
                    ...
                    additionalProperties =
                        inputAudioTranscription.additionalProperties.toMutableMap()
                }
        ...
        private constructor(
            ...
            /**
             * An interface that defines how to map each variant of [Tracing] to a value of type
             * [T].
             */
            interface Visitor<out T> {
                 ...
                 *
                 * An instance of [Tracing] can contain an unknown variant if it was deserialized
            ...
            private constructor(
                 ...
                 *
                 * Unlike [groupId], this method doesn't throw if the JSON field has an unexpected
                 * type.
                 */
                @JsonProperty("group_id")
                @ExcludeMissing
                 ...
                 *
                 * Unlike [workflowName], this method doesn't throw if the JSON field has an
                 * unexpected type.
                 */
                @JsonProperty("workflow_name")
                @ExcludeMissing
                ...
                class Builder internal constructor() {
                    ...
                    internal fun from(tracingConfiguration: TracingConfiguration) = apply {
                        ...
                        additionalProperties =
                            tracingConfiguration.additionalProperties.toMutableMap()
                    }
                    ...
                    /**
                     * The arbitrary metadata to attach to this trace to enable filtering in the
                     * traces dashboard.
                     */
                    fun metadata(metadata: JsonValue) = apply { this.metadata = metadata }

                    /**
                     * The name of the workflow to attach to this trace. This is used to name the
                     * trace in the traces dashboard.
                     */
                    fun workflowName(workflowName: String) =
                        workflowName(JsonField.of(workflowName))

                    /**
                     * Sets [Builder.workflowName] to an arbitrary JSON value.
                     *
                     * You should usually call [Builder.workflowName] with a well-typed [String]
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return /* spotless:off */ other is SessionUpdateEvent && session == other.session && type == other.type && eventId == other.eventId && additionalProperties == other.additionalProperties /* spotless:on */
    }
