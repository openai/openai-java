...
private constructor(
    ...
    companion object {
        ...
        /** Returns a mutable builder for constructing an instance of [AgentReasoningParam]. */
        @JvmStatic fun builder() = Builder()
    }

    /** A builder for [AgentReasoningParam]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(agentReasoningParam: AgentReasoningParam) = apply {
            effort = agentReasoningParam.effort
            summary = agentReasoningParam.summary
        ...
        /**
         * Returns an immutable instance of [AgentReasoningParam].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): AgentReasoningParam =
            AgentReasoningParam(effort, summary, additionalProperties.toMutableMap())
    }
     ...
     *   expected type.
     */
    fun validate(): AgentReasoningParam = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is AgentReasoningParam &&
            effort == other.effort &&
    ...
    override fun toString() =
        "AgentReasoningParam{effort=$effort, summary=$summary, additionalProperties=$additionalProperties}"
}
