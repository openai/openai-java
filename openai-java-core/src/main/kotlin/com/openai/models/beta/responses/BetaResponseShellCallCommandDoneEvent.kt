...
private constructor(
    ...
    /** A builder for [BetaResponseShellCallCommandDoneEvent]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(
            betaResponseShellCallCommandDoneEvent: BetaResponseShellCallCommandDoneEvent
        ) = apply {
            command = betaResponseShellCallCommandDoneEvent.command
            commandIndex = betaResponseShellCallCommandDoneEvent.commandIndex
            outputIndex = betaResponseShellCallCommandDoneEvent.outputIndex
            sequenceNumber = betaResponseShellCallCommandDoneEvent.sequenceNumber
            type = betaResponseShellCallCommandDoneEvent.type
            agent = betaResponseShellCallCommandDoneEvent.agent
            additionalProperties =
                betaResponseShellCallCommandDoneEvent.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [BetaResponseShellCallCommandDoneEvent].
         *
         ...
         */
        fun build(): BetaResponseShellCallCommandDoneEvent =
            BetaResponseShellCallCommandDoneEvent(
     ...
     *   expected type.
     */
    fun validate(): BetaResponseShellCallCommandDoneEvent = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is BetaResponseShellCallCommandDoneEvent &&
    ...
    override fun toString() =
        "BetaResponseShellCallCommandDoneEvent{command=$command, commandIndex=$commandIndex, outputIndex=$outputIndex, sequenceNumber=$sequenceNumber, type=$type, agent=$agent, additionalProperties=$additionalProperties}"
}
