...
private constructor(
    ...
    /** A builder for [BetaResponseImageGenCallInProgressEvent]. */
    class Builder internal constructor() {

        private var itemId: JsonField<String>? = null
        private var outputIndex: JsonField<Long>? = null
        private var sequenceNumber: JsonField<Long>? = null
        private var type: JsonValue = JsonValue.from("response.image_generation_call.in_progress")
        ...
        internal fun from(
            ...
            itemId = betaResponseImageGenCallInProgressEvent.itemId
            outputIndex = betaResponseImageGenCallInProgressEvent.outputIndex
            sequenceNumber = betaResponseImageGenCallInProgressEvent.sequenceNumber
            type = betaResponseImageGenCallInProgressEvent.type
            agent = betaResponseImageGenCallInProgressEvent.agent
            additionalProperties =
                betaResponseImageGenCallInProgressEvent.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [BetaResponseImageGenCallInProgressEvent].
         *
         ...
         */
        fun build(): BetaResponseImageGenCallInProgressEvent =
            BetaResponseImageGenCallInProgressEvent(
     ...
     *   expected type.
     */
    fun validate(): BetaResponseImageGenCallInProgressEvent = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is BetaResponseImageGenCallInProgressEvent &&
            itemId == other.itemId &&
    ...
    override fun toString() =
        "BetaResponseImageGenCallInProgressEvent{itemId=$itemId, outputIndex=$outputIndex, sequenceNumber=$sequenceNumber, type=$type, agent=$agent, additionalProperties=$additionalProperties}"
}
