...
private constructor(
    ...
    /** A builder for [BetaResponseOutputAudio]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(betaResponseOutputAudio: BetaResponseOutputAudio) = apply {
            data = betaResponseOutputAudio.data
            transcript = betaResponseOutputAudio.transcript
            type = betaResponseOutputAudio.type
            additionalProperties = betaResponseOutputAudio.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [BetaResponseOutputAudio].
         *
         ...
         */
        fun build(): BetaResponseOutputAudio =
     ...
     *   expected type.
     */
    fun validate(): BetaResponseOutputAudio = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is BetaResponseOutputAudio &&
            data == other.data &&
    ...
    override fun toString() =
        "BetaResponseOutputAudio{data=$data, transcript=$transcript, type=$type, additionalProperties=$additionalProperties}"
}
