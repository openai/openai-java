...
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [VaultDeleted].
         *
    ...
    /** A builder for [VaultDeleted]. */
    class Builder internal constructor() {

        private var id: JsonField<String>? = null
        private var deleted: JsonField<Boolean>? = null
        private var object_: JsonValue = JsonValue.from("vault.deleted")
        private var additionalProperties: MutableMap<String, JsonValue> = mutableMapOf()

        @JvmSynthetic
        internal fun from(vaultDeleted: VaultDeleted) = apply {
            id = vaultDeleted.id
            deleted = vaultDeleted.deleted
            object_ = vaultDeleted.object_
            additionalProperties = vaultDeleted.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [VaultDeleted].
         *
     ...
     *   expected type.
     */
    fun validate(): VaultDeleted = apply {
        if (validated) {
            return@apply
        }
    ...
    internal fun validity(): Int =
        (if (id.asKnown().isPresent) 1 else 0) +
            ...
            object_.let { if (it == JsonValue.from("vault.deleted")) 1 else 0 }
    ...
    override fun toString() =
        "VaultDeleted{id=$id, deleted=$deleted, object_=$object_, additionalProperties=$additionalProperties}"
}
