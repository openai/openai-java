...
/**
 * Lists turns by creation time and turn ID. The after cursor is exclusive in the selected order.
 * See
 * [session turns](https://developers.openai.com/api/docs/guides/agents-api/sessions/manage#inspect-session-turns).
 */
class TurnListParams
private constructor(
    ...
    companion object {
        ...
        @JvmStatic fun none(): TurnListParams = builder().build()

        /** Returns a mutable builder for constructing an instance of [TurnListParams]. */
        @JvmStatic fun builder() = Builder()
    }

    /** A builder for [TurnListParams]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(turnListParams: TurnListParams) = apply {
            sessionId = turnListParams.sessionId
            after = turnListParams.after
            limit = turnListParams.limit
            order = turnListParams.order
            additionalHeaders = turnListParams.additionalHeaders.toBuilder()
            additionalQueryParams = turnListParams.additionalQueryParams.toBuilder()
        }
        ...
        /**
         * Returns an immutable instance of [TurnListParams].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): TurnListParams =
            TurnListParams(
                sessionId,
                after,
                limit,
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is TurnListParams &&
    ...
    override fun hashCode(): Int =
        Objects.hash(sessionId, after, limit, order, additionalHeaders, additionalQueryParams)

    override fun toString() =
        "TurnListParams{sessionId=$sessionId, after=$after, limit=$limit, order=$order, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
