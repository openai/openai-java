...
private constructor(
    ...
    /** A builder for [BetaResponseWebSearchCallInProgressEvent]. */
    class Builder internal constructor() {
        ...
        internal fun from(
            ...
            itemId = betaResponseWebSearchCallInProgressEvent.itemId
            outputIndex = betaResponseWebSearchCallInProgressEvent.outputIndex
            sequenceNumber = betaResponseWebSearchCallInProgressEvent.sequenceNumber
            type = betaResponseWebSearchCallInProgressEvent.type
            agent = betaResponseWebSearchCallInProgressEvent.agent
            additionalProperties =
                betaResponseWebSearchCallInProgressEvent.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [BetaResponseWebSearchCallInProgressEvent].
         *
         ...
         */
        fun build(): BetaResponseWebSearchCallInProgressEvent =
            BetaResponseWebSearchCallInProgressEvent(
     ...
     *   expected type.
     */
    fun validate(): BetaResponseWebSearchCallInProgressEvent = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is BetaResponseWebSearchCallInProgressEvent &&
            itemId == other.itemId &&
    ...
    override fun toString() =
        "BetaResponseWebSearchCallInProgressEvent{itemId=$itemId, outputIndex=$outputIndex, sequenceNumber=$sequenceNumber, type=$type, agent=$agent, additionalProperties=$additionalProperties}"
}
