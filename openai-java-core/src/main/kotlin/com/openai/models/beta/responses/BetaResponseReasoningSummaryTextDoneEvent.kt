...
private constructor(
    ...
    ) : this(itemId, outputIndex, sequenceNumber, summaryIndex, text, type, agent, mutableMapOf())
    ...
    /** A builder for [BetaResponseReasoningSummaryTextDoneEvent]. */
    class Builder internal constructor() {
        ...
        internal fun from(
            ...
            itemId = betaResponseReasoningSummaryTextDoneEvent.itemId
            outputIndex = betaResponseReasoningSummaryTextDoneEvent.outputIndex
            sequenceNumber = betaResponseReasoningSummaryTextDoneEvent.sequenceNumber
            summaryIndex = betaResponseReasoningSummaryTextDoneEvent.summaryIndex
            text = betaResponseReasoningSummaryTextDoneEvent.text
            type = betaResponseReasoningSummaryTextDoneEvent.type
            agent = betaResponseReasoningSummaryTextDoneEvent.agent
            additionalProperties =
                betaResponseReasoningSummaryTextDoneEvent.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [BetaResponseReasoningSummaryTextDoneEvent].
         *
         ...
         */
        fun build(): BetaResponseReasoningSummaryTextDoneEvent =
            BetaResponseReasoningSummaryTextDoneEvent(
     ...
     *   expected type.
     */
    fun validate(): BetaResponseReasoningSummaryTextDoneEvent = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is BetaResponseReasoningSummaryTextDoneEvent &&
            itemId == other.itemId &&
    ...
    override fun toString() =
        "BetaResponseReasoningSummaryTextDoneEvent{itemId=$itemId, outputIndex=$outputIndex, sequenceNumber=$sequenceNumber, summaryIndex=$summaryIndex, text=$text, type=$type, agent=$agent, additionalProperties=$additionalProperties}"
}
