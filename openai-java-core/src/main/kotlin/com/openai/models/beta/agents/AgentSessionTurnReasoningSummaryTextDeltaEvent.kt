...
private constructor(
     ...
     * ```java
     * JsonValue.from("agent.session.turn.reasoning_summary_text.delta")
     * ```
     *
    ...
    /** A builder for [AgentSessionTurnReasoningSummaryTextDeltaEvent]. */
    class Builder internal constructor() {
        ...
        internal fun from(
            ...
            delta = agentSessionTurnReasoningSummaryTextDeltaEvent.delta
            eventId = agentSessionTurnReasoningSummaryTextDeltaEvent.eventId
            itemId = agentSessionTurnReasoningSummaryTextDeltaEvent.itemId
            outputIndex = agentSessionTurnReasoningSummaryTextDeltaEvent.outputIndex
            sessionId = agentSessionTurnReasoningSummaryTextDeltaEvent.sessionId
            summaryIndex = agentSessionTurnReasoningSummaryTextDeltaEvent.summaryIndex
            turnId = agentSessionTurnReasoningSummaryTextDeltaEvent.turnId
            type = agentSessionTurnReasoningSummaryTextDeltaEvent.type
            additionalProperties =
                agentSessionTurnReasoningSummaryTextDeltaEvent.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [AgentSessionTurnReasoningSummaryTextDeltaEvent].
         *
         ...
         */
        fun build(): AgentSessionTurnReasoningSummaryTextDeltaEvent =
            AgentSessionTurnReasoningSummaryTextDeltaEvent(
     ...
     *   expected type.
     */
    fun validate(): AgentSessionTurnReasoningSummaryTextDeltaEvent = apply {
        if (validated) {
            return@apply
        }
        ...
        turnId()
        _type().let {
            if (it != JsonValue.from("agent.session.turn.reasoning_summary_text.delta")) {
    ...
    internal fun validity(): Int =
        (if (delta.asKnown().isPresent) 1 else 0) +
            ...
            type.let {
                if (it == JsonValue.from("agent.session.turn.reasoning_summary_text.delta")) 1
                else 0
            }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is AgentSessionTurnReasoningSummaryTextDeltaEvent &&
            delta == other.delta &&
    ...
    override fun toString() =
        "AgentSessionTurnReasoningSummaryTextDeltaEvent{delta=$delta, eventId=$eventId, itemId=$itemId, outputIndex=$outputIndex, sessionId=$sessionId, summaryIndex=$summaryIndex, turnId=$turnId, type=$type, additionalProperties=$additionalProperties}"
}
