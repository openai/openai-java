...
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [BetaResponseInputFileContent].
         */
        @JvmStatic fun builder() = Builder()
    }

    /** A builder for [BetaResponseInputFileContent]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(betaResponseInputFileContent: BetaResponseInputFileContent) = apply {
            type = betaResponseInputFileContent.type
            detail = betaResponseInputFileContent.detail
            fileData = betaResponseInputFileContent.fileData
            fileId = betaResponseInputFileContent.fileId
            fileUrl = betaResponseInputFileContent.fileUrl
            filename = betaResponseInputFileContent.filename
            promptCacheBreakpoint = betaResponseInputFileContent.promptCacheBreakpoint
            additionalProperties = betaResponseInputFileContent.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [BetaResponseInputFileContent].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): BetaResponseInputFileContent =
     ...
     *   expected type.
     */
    fun validate(): BetaResponseInputFileContent = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is BetaResponseInputFileContent &&
            type == other.type &&
            detail == other.detail &&
    ...
    override fun toString() =
        "BetaResponseInputFileContent{type=$type, detail=$detail, fileData=$fileData, fileId=$fileId, fileUrl=$fileUrl, filename=$filename, promptCacheBreakpoint=$promptCacheBreakpoint, additionalProperties=$additionalProperties}"
}
