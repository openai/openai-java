...
private constructor(
    ...
    /** A builder for [BetaResponseAudioDoneEvent]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(betaResponseAudioDoneEvent: BetaResponseAudioDoneEvent) = apply {
            sequenceNumber = betaResponseAudioDoneEvent.sequenceNumber
            type = betaResponseAudioDoneEvent.type
            agent = betaResponseAudioDoneEvent.agent
            additionalProperties = betaResponseAudioDoneEvent.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [BetaResponseAudioDoneEvent].
         *
         ...
         */
        fun build(): BetaResponseAudioDoneEvent =
     ...
     *   expected type.
     */
    fun validate(): BetaResponseAudioDoneEvent = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is BetaResponseAudioDoneEvent &&
    ...
    override fun toString() =
        "BetaResponseAudioDoneEvent{sequenceNumber=$sequenceNumber, type=$type, agent=$agent, additionalProperties=$additionalProperties}"
}
