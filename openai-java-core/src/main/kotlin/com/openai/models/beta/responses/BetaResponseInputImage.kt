...
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [BetaResponseInputImage].
         *
    ...
    /** A builder for [BetaResponseInputImage]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(betaResponseInputImage: BetaResponseInputImage) = apply {
            detail = betaResponseInputImage.detail
            type = betaResponseInputImage.type
            fileId = betaResponseInputImage.fileId
            imageUrl = betaResponseInputImage.imageUrl
            promptCacheBreakpoint = betaResponseInputImage.promptCacheBreakpoint
            additionalProperties = betaResponseInputImage.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [BetaResponseInputImage].
         *
         ...
         */
        fun build(): BetaResponseInputImage =
     ...
     *   expected type.
     */
    fun validate(): BetaResponseInputImage = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is BetaResponseInputImage &&
            detail == other.detail &&
            type == other.type &&
            fileId == other.fileId &&
    ...
    override fun toString() =
        "BetaResponseInputImage{detail=$detail, type=$type, fileId=$fileId, imageUrl=$imageUrl, promptCacheBreakpoint=$promptCacheBreakpoint, additionalProperties=$additionalProperties}"
}
