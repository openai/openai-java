...
private constructor(
    ...
    class Builder internal constructor() {
        ...
        internal fun from(artifactListParams: ArtifactListParams) = apply {
            sessionId = artifactListParams.sessionId
            after = artifactListParams.after
            environmentId = artifactListParams.environmentId
            limit = artifactListParams.limit
            order = artifactListParams.order
    ...
    override fun _queryParams(): QueryParams =
        QueryParams.builder()
            .apply {
                ...
                environmentId?.let { put("environment_id", it) }
    ...
    override fun toString() =
        "ArtifactListParams{sessionId=$sessionId, after=$after, environmentId=$environmentId, limit=$limit, order=$order, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
