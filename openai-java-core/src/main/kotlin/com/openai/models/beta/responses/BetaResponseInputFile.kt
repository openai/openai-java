...
private constructor(
    ...
    /** A builder for [BetaResponseInputFile]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(betaResponseInputFile: BetaResponseInputFile) = apply {
            type = betaResponseInputFile.type
            detail = betaResponseInputFile.detail
            fileData = betaResponseInputFile.fileData
            fileId = betaResponseInputFile.fileId
            fileUrl = betaResponseInputFile.fileUrl
            filename = betaResponseInputFile.filename
            promptCacheBreakpoint = betaResponseInputFile.promptCacheBreakpoint
            additionalProperties = betaResponseInputFile.additionalProperties.toMutableMap()
        }
         ...
         */
        fun build(): BetaResponseInputFile =
     ...
     *   expected type.
     */
    fun validate(): BetaResponseInputFile = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is BetaResponseInputFile &&
            type == other.type &&
            detail == other.detail &&
    ...
    override fun toString() =
        "BetaResponseInputFile{type=$type, detail=$detail, fileData=$fileData, fileId=$fileId, fileUrl=$fileUrl, filename=$filename, promptCacheBreakpoint=$promptCacheBreakpoint, additionalProperties=$additionalProperties}"
}
