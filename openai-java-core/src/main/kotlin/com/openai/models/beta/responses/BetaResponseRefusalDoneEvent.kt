...
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [BetaResponseRefusalDoneEvent].
         *
    ...
    /** A builder for [BetaResponseRefusalDoneEvent]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(betaResponseRefusalDoneEvent: BetaResponseRefusalDoneEvent) = apply {
            contentIndex = betaResponseRefusalDoneEvent.contentIndex
            itemId = betaResponseRefusalDoneEvent.itemId
            outputIndex = betaResponseRefusalDoneEvent.outputIndex
            refusal = betaResponseRefusalDoneEvent.refusal
            sequenceNumber = betaResponseRefusalDoneEvent.sequenceNumber
            type = betaResponseRefusalDoneEvent.type
            agent = betaResponseRefusalDoneEvent.agent
            additionalProperties = betaResponseRefusalDoneEvent.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [BetaResponseRefusalDoneEvent].
         *
         ...
         */
        fun build(): BetaResponseRefusalDoneEvent =
     ...
     *   expected type.
     */
    fun validate(): BetaResponseRefusalDoneEvent = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is BetaResponseRefusalDoneEvent &&
    ...
    override fun toString() =
        "BetaResponseRefusalDoneEvent{contentIndex=$contentIndex, itemId=$itemId, outputIndex=$outputIndex, refusal=$refusal, sequenceNumber=$sequenceNumber, type=$type, agent=$agent, additionalProperties=$additionalProperties}"
}
