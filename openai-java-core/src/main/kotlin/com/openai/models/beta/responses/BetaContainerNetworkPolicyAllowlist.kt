...
private constructor(
    ...
    private val domainSecrets: JsonField<List<BetaContainerNetworkPolicyDomainSecret>>,
    ...
    private constructor(
        ...
        @ExcludeMissing
        domainSecrets: JsonField<List<BetaContainerNetworkPolicyDomainSecret>> = JsonMissing.of(),
     ...
     */
    fun domainSecrets(): Optional<List<BetaContainerNetworkPolicyDomainSecret>> =
    ...
    @JsonProperty("domain_secrets")
    @ExcludeMissing
    fun _domainSecrets(): JsonField<List<BetaContainerNetworkPolicyDomainSecret>> = domainSecrets
    ...
    /** A builder for [BetaContainerNetworkPolicyAllowlist]. */
    class Builder internal constructor() {

        private var allowedDomains: JsonField<MutableList<String>>? = null
        private var type: JsonValue = JsonValue.from("allowlist")
        private var domainSecrets: JsonField<MutableList<BetaContainerNetworkPolicyDomainSecret>>? =
            null
        private var additionalProperties: MutableMap<String, JsonValue> = mutableMapOf()

        @JvmSynthetic
        internal fun from(
            betaContainerNetworkPolicyAllowlist: BetaContainerNetworkPolicyAllowlist
        ) = apply {
            allowedDomains =
                betaContainerNetworkPolicyAllowlist.allowedDomains.map { it.toMutableList() }
            type = betaContainerNetworkPolicyAllowlist.type
            domainSecrets =
                betaContainerNetworkPolicyAllowlist.domainSecrets.map { it.toMutableList() }
            additionalProperties =
                betaContainerNetworkPolicyAllowlist.additionalProperties.toMutableMap()
        }
        ...
        /** Optional domain-scoped secrets for allowlisted domains. */
        fun domainSecrets(domainSecrets: List<BetaContainerNetworkPolicyDomainSecret>) =
         ...
         * `List<BetaContainerNetworkPolicyDomainSecret>` value instead. This method is primarily
         * for setting the field to an undocumented or not yet supported value.
         */
        fun domainSecrets(domainSecrets: JsonField<List<BetaContainerNetworkPolicyDomainSecret>>) =
            apply {
                this.domainSecrets = domainSecrets.map { it.toMutableList() }
            }

        /**
         * Adds a single [BetaContainerNetworkPolicyDomainSecret] to [domainSecrets].
         *
         * @throws IllegalStateException if the field was previously set to a non-list.
         */
        fun addDomainSecret(domainSecret: BetaContainerNetworkPolicyDomainSecret) = apply {
            domainSecrets =
        ...
        /**
         * Returns an immutable instance of [BetaContainerNetworkPolicyAllowlist].
         *
         ...
         */
        fun build(): BetaContainerNetworkPolicyAllowlist =
            BetaContainerNetworkPolicyAllowlist(
     ...
     *   expected type.
     */
    fun validate(): BetaContainerNetworkPolicyAllowlist = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is BetaContainerNetworkPolicyAllowlist &&
    ...
    override fun toString() =
        "BetaContainerNetworkPolicyAllowlist{allowedDomains=$allowedDomains, type=$type, domainSecrets=$domainSecrets, additionalProperties=$additionalProperties}"
}
