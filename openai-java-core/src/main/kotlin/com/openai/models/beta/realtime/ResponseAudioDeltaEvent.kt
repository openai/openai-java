...
private constructor(
    ...
    class Builder internal constructor() {
        ...
        internal fun from(responseAudioDeltaEvent: ResponseAudioDeltaEvent) = apply {
            contentIndex = responseAudioDeltaEvent.contentIndex
            delta = responseAudioDeltaEvent.delta
            eventId = responseAudioDeltaEvent.eventId
            itemId = responseAudioDeltaEvent.itemId
            outputIndex = responseAudioDeltaEvent.outputIndex
            responseId = responseAudioDeltaEvent.responseId
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return /* spotless:off */ other is ResponseAudioDeltaEvent && contentIndex == other.contentIndex && delta == other.delta && eventId == other.eventId && itemId == other.itemId && outputIndex == other.outputIndex && responseId == other.responseId && type == other.type && additionalProperties == other.additionalProperties /* spotless:on */
    }
    ...
    override fun toString() =
        "ResponseAudioDeltaEvent{contentIndex=$contentIndex, delta=$delta, eventId=$eventId, itemId=$itemId, outputIndex=$outputIndex, responseId=$responseId, type=$type, additionalProperties=$additionalProperties}"
}
