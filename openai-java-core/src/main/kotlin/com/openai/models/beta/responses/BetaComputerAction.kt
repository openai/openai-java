...
private constructor(
     ...
     * import java.util.Optional;
     *
     * Optional<String> result = betaComputerAction.accept(new BetaComputerAction.Visitor<Optional<String>>() {
     *     @Override
    ...
    internal class Deserializer : BaseDeserializer<BetaComputerAction>(BetaComputerAction::class) {
    ...
    internal class Serializer : BaseSerializer<BetaComputerAction>(BetaComputerAction::class) {
    ...
    private constructor(
        ...
        @JsonCreator
        private constructor(
            @JsonProperty("button") @ExcludeMissing button: JsonField<Button> = JsonMissing.of(),
        ...
        class Builder internal constructor() {
             ...
             *
             * You should usually call [Builder.button] with a well-typed [Button] value instead.
         ...
         * `wheel`, `back`, or `forward`.
         */
        class Button @JsonCreator private constructor(private val value: JsonField<String>) : Enum {
            ...
            enum class Value {
                ...
                FORWARD,
                /**
                 * An enum member indicating that [Button] was instantiated with an unknown value.
                 */
                _UNKNOWN,
            }
    ...
    private constructor(
        ...
        class Builder internal constructor() {
             ...
             *
             * You should usually call [Builder.path] with a well-typed `List<Path>` value instead.
             * This method is primarily for setting the field to an undocumented or not yet
             * supported value.
             */
        ...
        private constructor(
            ...
            override fun toString() = "Path{x=$x, y=$y, additionalProperties=$additionalProperties}"
        }
    ...
    private constructor(
        ...
        @JsonCreator
        private constructor(
            @JsonProperty("scroll_x") @ExcludeMissing scrollX: JsonField<Long> = JsonMissing.of(),
            @JsonProperty("scroll_y") @ExcludeMissing scrollY: JsonField<Long> = JsonMissing.of(),
            @JsonProperty("type") @ExcludeMissing type: JsonValue = JsonMissing.of(),
            @JsonProperty("x") @ExcludeMissing x: JsonField<Long> = JsonMissing.of(),
            @JsonProperty("y") @ExcludeMissing y: JsonField<Long> = JsonMissing.of(),
            @JsonProperty("keys") @ExcludeMissing keys: JsonField<List<String>> = JsonMissing.of(),
