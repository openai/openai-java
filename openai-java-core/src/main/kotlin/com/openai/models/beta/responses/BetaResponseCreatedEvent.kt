...
private constructor(
    ...
    /** A builder for [BetaResponseCreatedEvent]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(betaResponseCreatedEvent: BetaResponseCreatedEvent) = apply {
            response = betaResponseCreatedEvent.response
            sequenceNumber = betaResponseCreatedEvent.sequenceNumber
            type = betaResponseCreatedEvent.type
            agent = betaResponseCreatedEvent.agent
            additionalProperties = betaResponseCreatedEvent.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [BetaResponseCreatedEvent].
         *
         ...
         */
        fun build(): BetaResponseCreatedEvent =
     ...
     *   expected type.
     */
    fun validate(): BetaResponseCreatedEvent = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is BetaResponseCreatedEvent &&
    ...
    override fun toString() =
        "BetaResponseCreatedEvent{response=$response, sequenceNumber=$sequenceNumber, type=$type, agent=$agent, additionalProperties=$additionalProperties}"
}
