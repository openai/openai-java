...
private constructor(
    ...
    class Builder internal constructor() {
        ...
        internal fun from(agentListPageResponse: AgentListPageResponse) = apply {
            ...
            firstId = agentListPageResponse.firstId
            hasMore = agentListPageResponse.hasMore
            lastId = agentListPageResponse.lastId
            object_ = agentListPageResponse.object_
    ...
    override fun toString() =
        "AgentListPageResponse{data=$data, firstId=$firstId, hasMore=$hasMore, lastId=$lastId, object_=$object_, additionalProperties=$additionalProperties}"
}
