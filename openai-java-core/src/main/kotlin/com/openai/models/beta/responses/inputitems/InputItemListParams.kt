...
private constructor(
    ...
    class Builder internal constructor() {
        ...
        internal fun from(inputItemListParams: InputItemListParams) = apply {
            ...
            betas = inputItemListParams.betas?.toMutableList()
    ...
    override fun toString() =
        "InputItemListParams{responseId=$responseId, after=$after, include=$include, limit=$limit, order=$order, betas=$betas, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
