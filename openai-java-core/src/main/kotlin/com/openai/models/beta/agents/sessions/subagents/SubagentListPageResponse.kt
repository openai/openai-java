...
class SubagentListPageResponse
@JsonCreator(mode = JsonCreator.Mode.DISABLED)
private constructor(
    private val data: JsonField<List<Subagent>>,
    ...
    @JsonCreator
    private constructor(
        @JsonProperty("data") @ExcludeMissing data: JsonField<List<Subagent>> = JsonMissing.of(),
     ...
     */
    fun data(): List<Subagent> = data.getRequired("data")
     ...
     */
    @JsonProperty("data") @ExcludeMissing fun _data(): JsonField<List<Subagent>> = data
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [SubagentListPageResponse].
         *
    ...
    /** A builder for [SubagentListPageResponse]. */
    class Builder internal constructor() {

        private var data: JsonField<MutableList<Subagent>>? = null
        ...
        @JvmSynthetic
        internal fun from(subagentListPageResponse: SubagentListPageResponse) = apply {
            data = subagentListPageResponse.data.map { it.toMutableList() }
            firstId = subagentListPageResponse.firstId
            hasMore = subagentListPageResponse.hasMore
            lastId = subagentListPageResponse.lastId
            object_ = subagentListPageResponse.object_
            additionalProperties = subagentListPageResponse.additionalProperties.toMutableMap()
        }

        /** The resources returned in this page, in the requested sort order. */
        fun data(data: List<Subagent>) = data(JsonField.of(data))

        /**
         * Sets [Builder.data] to an arbitrary JSON value.
         *
         * You should usually call [Builder.data] with a well-typed `List<Subagent>` value instead.
         * This method is primarily for setting the field to an undocumented or not yet supported
         * value.
         */
        fun data(data: JsonField<List<Subagent>>) = apply {
            this.data = data.map { it.toMutableList() }
        }

        /**
         * Adds a single [Subagent] to [Builder.data].
         *
         * @throws IllegalStateException if the field was previously set to a non-list.
         */
        fun addData(data: Subagent) = apply {
            this.data =
        ...
        /**
         * Returns an immutable instance of [SubagentListPageResponse].
         *
         ...
         */
        fun build(): SubagentListPageResponse =
     ...
     *   expected type.
     */
    fun validate(): SubagentListPageResponse = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is SubagentListPageResponse &&
            data == other.data &&
    ...
    override fun toString() =
        "SubagentListPageResponse{data=$data, firstId=$firstId, hasMore=$hasMore, lastId=$lastId, object_=$object_, additionalProperties=$additionalProperties}"
}
