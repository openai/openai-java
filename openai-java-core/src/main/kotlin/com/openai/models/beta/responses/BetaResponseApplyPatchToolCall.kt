...
private constructor(
    ...
    ) : this(id, callId, operation, status, type, agent, caller, createdBy, mutableMapOf())
    ...
    /** A builder for [BetaResponseApplyPatchToolCall]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(betaResponseApplyPatchToolCall: BetaResponseApplyPatchToolCall) = apply {
            id = betaResponseApplyPatchToolCall.id
            callId = betaResponseApplyPatchToolCall.callId
            operation = betaResponseApplyPatchToolCall.operation
            status = betaResponseApplyPatchToolCall.status
            type = betaResponseApplyPatchToolCall.type
            agent = betaResponseApplyPatchToolCall.agent
            caller = betaResponseApplyPatchToolCall.caller
            createdBy = betaResponseApplyPatchToolCall.createdBy
            additionalProperties =
                betaResponseApplyPatchToolCall.additionalProperties.toMutableMap()
        }
         ...
         */
        fun build(): BetaResponseApplyPatchToolCall =
            BetaResponseApplyPatchToolCall(
                checkRequired("id", id),
     ...
     *   expected type.
     */
    fun validate(): BetaResponseApplyPatchToolCall = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is BetaResponseApplyPatchToolCall &&
            id == other.id &&
            callId == other.callId &&
    ...
    override fun toString() =
        "BetaResponseApplyPatchToolCall{id=$id, callId=$callId, operation=$operation, status=$status, type=$type, agent=$agent, caller=$caller, createdBy=$createdBy, additionalProperties=$additionalProperties}"
}
