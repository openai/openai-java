...
private constructor(
    ...
    /** A builder for [BetaResponseMcpCallFailedEvent]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(betaResponseMcpCallFailedEvent: BetaResponseMcpCallFailedEvent) = apply {
            itemId = betaResponseMcpCallFailedEvent.itemId
            outputIndex = betaResponseMcpCallFailedEvent.outputIndex
            sequenceNumber = betaResponseMcpCallFailedEvent.sequenceNumber
            type = betaResponseMcpCallFailedEvent.type
            agent = betaResponseMcpCallFailedEvent.agent
            additionalProperties =
                betaResponseMcpCallFailedEvent.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [BetaResponseMcpCallFailedEvent].
         *
         ...
         */
        fun build(): BetaResponseMcpCallFailedEvent =
            BetaResponseMcpCallFailedEvent(
     ...
     *   expected type.
     */
    fun validate(): BetaResponseMcpCallFailedEvent = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is BetaResponseMcpCallFailedEvent &&
            itemId == other.itemId &&
    ...
    override fun toString() =
        "BetaResponseMcpCallFailedEvent{itemId=$itemId, outputIndex=$outputIndex, sequenceNumber=$sequenceNumber, type=$type, agent=$agent, additionalProperties=$additionalProperties}"
}
