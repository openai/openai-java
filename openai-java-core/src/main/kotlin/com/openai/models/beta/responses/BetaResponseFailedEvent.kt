...
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [BetaResponseFailedEvent].
         *
    ...
    /** A builder for [BetaResponseFailedEvent]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(betaResponseFailedEvent: BetaResponseFailedEvent) = apply {
            response = betaResponseFailedEvent.response
            sequenceNumber = betaResponseFailedEvent.sequenceNumber
            type = betaResponseFailedEvent.type
            agent = betaResponseFailedEvent.agent
            additionalProperties = betaResponseFailedEvent.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [BetaResponseFailedEvent].
         *
         ...
         */
        fun build(): BetaResponseFailedEvent =
     ...
     *   expected type.
     */
    fun validate(): BetaResponseFailedEvent = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is BetaResponseFailedEvent &&
    ...
    override fun toString() =
        "BetaResponseFailedEvent{response=$response, sequenceNumber=$sequenceNumber, type=$type, agent=$agent, additionalProperties=$additionalProperties}"
}
