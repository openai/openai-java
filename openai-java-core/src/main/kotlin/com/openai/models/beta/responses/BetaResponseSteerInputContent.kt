...
@JsonDeserialize(using = BetaResponseSteerInputContent.Deserializer::class)
@JsonSerialize(using = BetaResponseSteerInputContent.Serializer::class)
class BetaResponseSteerInputContent
private constructor(
     ...
     * import java.util.Optional;
     *
     * Optional<String> result = betaResponseSteerInputContent.accept(new BetaResponseSteerInputContent.Visitor<Optional<String>>() {
     *     @Override
     ...
     *   expected type.
     */
    fun validate(): BetaResponseSteerInputContent = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is BetaResponseSteerInputContent &&
    ...
    override fun toString(): String =
        when {
            inputText != null -> "BetaResponseSteerInputContent{inputText=$inputText}"
            inputImage != null -> "BetaResponseSteerInputContent{inputImage=$inputImage}"
            inputFile != null -> "BetaResponseSteerInputContent{inputFile=$inputFile}"
            _json != null -> "BetaResponseSteerInputContent{_unknown=$_json}"
            else -> throw IllegalStateException("Invalid BetaResponseSteerInputContent")
        }
    ...
    companion object {
        ...
        fun ofInputText(inputText: BetaResponseInputTextContent) =
            BetaResponseSteerInputContent(inputText = inputText)
        ...
        fun ofInputImage(inputImage: BetaResponseInputImageContent) =
            BetaResponseSteerInputContent(inputImage = inputImage)

        /** A file input to the model. */
        @JvmStatic
        fun ofInputFile(inputFile: BetaResponseInputFileContent) =
            BetaResponseSteerInputContent(inputFile = inputFile)
    }

    /**
     * An interface that defines how to map each variant of [BetaResponseSteerInputContent] to a
     * value of type [T].
     */
    interface Visitor<out T> {
        ...
        /**
         * Maps an unknown variant of [BetaResponseSteerInputContent] to a value of type [T].
         *
         * An instance of [BetaResponseSteerInputContent] can contain an unknown variant if it was
        ...
        fun unknown(json: JsonValue?): T {
            throw OpenAIInvalidDataException("Unknown BetaResponseSteerInputContent: $json")
        }
    }

    internal class Deserializer :
        BaseDeserializer<BetaResponseSteerInputContent>(BetaResponseSteerInputContent::class) {

        override fun ObjectCodec.deserialize(node: JsonNode): BetaResponseSteerInputContent {
            ...
            when (type) {
                "input_text" -> {
                    return tryDeserialize(node, jacksonTypeRef<BetaResponseInputTextContent>())
                        ?.let { BetaResponseSteerInputContent(inputText = it, _json = json) }
                        ?: BetaResponseSteerInputContent(_json = json)
                }
                "input_image" -> {
                    return tryDeserialize(node, jacksonTypeRef<BetaResponseInputImageContent>())
                        ?.let { BetaResponseSteerInputContent(inputImage = it, _json = json) }
                        ?: BetaResponseSteerInputContent(_json = json)
                }
                "input_file" -> {
                    return tryDeserialize(node, jacksonTypeRef<BetaResponseInputFileContent>())
                        ?.let { BetaResponseSteerInputContent(inputFile = it, _json = json) }
                        ?: BetaResponseSteerInputContent(_json = json)
                }
            }

            return BetaResponseSteerInputContent(_json = json)
        }
    }

    internal class Serializer :
        BaseSerializer<BetaResponseSteerInputContent>(BetaResponseSteerInputContent::class) {

        override fun serialize(
            value: BetaResponseSteerInputContent,
