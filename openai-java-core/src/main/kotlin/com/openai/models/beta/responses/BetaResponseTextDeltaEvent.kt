...
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [BetaResponseTextDeltaEvent].
         *
    ...
    /** A builder for [BetaResponseTextDeltaEvent]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(betaResponseTextDeltaEvent: BetaResponseTextDeltaEvent) = apply {
            contentIndex = betaResponseTextDeltaEvent.contentIndex
            delta = betaResponseTextDeltaEvent.delta
            itemId = betaResponseTextDeltaEvent.itemId
            logprobs = betaResponseTextDeltaEvent.logprobs.map { it.toMutableList() }
            outputIndex = betaResponseTextDeltaEvent.outputIndex
            sequenceNumber = betaResponseTextDeltaEvent.sequenceNumber
            type = betaResponseTextDeltaEvent.type
            agent = betaResponseTextDeltaEvent.agent
            additionalProperties = betaResponseTextDeltaEvent.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [BetaResponseTextDeltaEvent].
         *
         ...
         */
        fun build(): BetaResponseTextDeltaEvent =
     ...
     *   expected type.
     */
    fun validate(): BetaResponseTextDeltaEvent = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is BetaResponseTextDeltaEvent &&
    ...
    override fun toString() =
        "BetaResponseTextDeltaEvent{contentIndex=$contentIndex, delta=$delta, itemId=$itemId, logprobs=$logprobs, outputIndex=$outputIndex, sequenceNumber=$sequenceNumber, type=$type, agent=$agent, additionalProperties=$additionalProperties}"
}
