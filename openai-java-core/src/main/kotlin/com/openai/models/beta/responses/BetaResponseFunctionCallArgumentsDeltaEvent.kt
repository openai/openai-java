...
private constructor(
    ...
    ) : this(delta, itemId, outputIndex, sequenceNumber, type, agent, mutableMapOf())
    ...
    /** A builder for [BetaResponseFunctionCallArgumentsDeltaEvent]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(
            betaResponseFunctionCallArgumentsDeltaEvent: BetaResponseFunctionCallArgumentsDeltaEvent
        ) = apply {
            delta = betaResponseFunctionCallArgumentsDeltaEvent.delta
            itemId = betaResponseFunctionCallArgumentsDeltaEvent.itemId
            outputIndex = betaResponseFunctionCallArgumentsDeltaEvent.outputIndex
            sequenceNumber = betaResponseFunctionCallArgumentsDeltaEvent.sequenceNumber
            type = betaResponseFunctionCallArgumentsDeltaEvent.type
            agent = betaResponseFunctionCallArgumentsDeltaEvent.agent
            additionalProperties =
                betaResponseFunctionCallArgumentsDeltaEvent.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [BetaResponseFunctionCallArgumentsDeltaEvent].
         *
         ...
         */
        fun build(): BetaResponseFunctionCallArgumentsDeltaEvent =
            BetaResponseFunctionCallArgumentsDeltaEvent(
     ...
     *   expected type.
     */
    fun validate(): BetaResponseFunctionCallArgumentsDeltaEvent = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is BetaResponseFunctionCallArgumentsDeltaEvent &&
            delta == other.delta &&
            itemId == other.itemId &&
    ...
    private val hashCode: Int by lazy {
        Objects.hash(delta, itemId, outputIndex, sequenceNumber, type, agent, additionalProperties)
    }

    override fun hashCode(): Int = hashCode

    override fun toString() =
        "BetaResponseFunctionCallArgumentsDeltaEvent{delta=$delta, itemId=$itemId, outputIndex=$outputIndex, sequenceNumber=$sequenceNumber, type=$type, agent=$agent, additionalProperties=$additionalProperties}"
}
