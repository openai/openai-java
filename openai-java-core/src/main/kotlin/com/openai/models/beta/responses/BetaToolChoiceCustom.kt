...
private constructor(
    ...
    /** A builder for [BetaToolChoiceCustom]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(betaToolChoiceCustom: BetaToolChoiceCustom) = apply {
            name = betaToolChoiceCustom.name
            type = betaToolChoiceCustom.type
            additionalProperties = betaToolChoiceCustom.additionalProperties.toMutableMap()
        }
         ...
         */
        fun build(): BetaToolChoiceCustom =
     ...
     *   expected type.
     */
    fun validate(): BetaToolChoiceCustom = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is BetaToolChoiceCustom &&
            name == other.name &&
            type == other.type &&
    ...
    override fun toString() =
        "BetaToolChoiceCustom{name=$name, type=$type, additionalProperties=$additionalProperties}"
}
