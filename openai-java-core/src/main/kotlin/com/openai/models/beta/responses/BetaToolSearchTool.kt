...
private constructor(
     ...
     * ```java
     * MyClass myObject = betaToolSearchTool.parameters().convert(MyClass.class);
     * ```
     */
    ...
    /** A builder for [BetaToolSearchTool]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(betaToolSearchTool: BetaToolSearchTool) = apply {
            type = betaToolSearchTool.type
            description = betaToolSearchTool.description
            execution = betaToolSearchTool.execution
            parameters = betaToolSearchTool.parameters
            additionalProperties = betaToolSearchTool.additionalProperties.toMutableMap()
        }
     ...
     *   expected type.
     */
    fun validate(): BetaToolSearchTool = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is BetaToolSearchTool &&
            type == other.type &&
    ...
    override fun toString() =
        "BetaToolSearchTool{type=$type, description=$description, execution=$execution, parameters=$parameters, additionalProperties=$additionalProperties}"
}
