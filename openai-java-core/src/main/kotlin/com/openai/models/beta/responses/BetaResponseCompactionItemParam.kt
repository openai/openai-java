...
private constructor(
    ...
    ) : this(encryptedContent, type, id, agent, mutableMapOf())
    ...
    /** A builder for [BetaResponseCompactionItemParam]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(betaResponseCompactionItemParam: BetaResponseCompactionItemParam) =
            apply {
                encryptedContent = betaResponseCompactionItemParam.encryptedContent
                type = betaResponseCompactionItemParam.type
                id = betaResponseCompactionItemParam.id
                agent = betaResponseCompactionItemParam.agent
                additionalProperties =
                    betaResponseCompactionItemParam.additionalProperties.toMutableMap()
            }
         ...
         */
        fun build(): BetaResponseCompactionItemParam =
            BetaResponseCompactionItemParam(
     ...
     *   expected type.
     */
    fun validate(): BetaResponseCompactionItemParam = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is BetaResponseCompactionItemParam &&
    ...
    private val hashCode: Int by lazy {
        Objects.hash(encryptedContent, type, id, agent, additionalProperties)
    }

    override fun hashCode(): Int = hashCode

    override fun toString() =
        "BetaResponseCompactionItemParam{encryptedContent=$encryptedContent, type=$type, id=$id, agent=$agent, additionalProperties=$additionalProperties}"
}
