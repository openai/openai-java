...
private constructor(
        ...
        private constructor(
            ...
            private constructor(
                ...
                private constructor(
                     ...
                     *     @Override
                     *     public Optional<String> visitCodeInterpreter(CodeInterpreterTool codeInterpreter) {
                     *         return Optional.of(codeInterpreter.toString());
                     *     }
                     *
                     *     // ...
                     *
                    ...
                    interface Visitor<out T> {
                        ...
                        fun visitFileSearch(fileSearch: JsonValue): T =
                            unknown(JsonValue.from(fileSearch))
                ...
                private val hashCode: Int by lazy {
                    Objects.hash(fileId, tools, additionalProperties)
                }
            ...
            private constructor(
                ...
                private constructor(
                    ...
                    private constructor(
                         ...
                         * import java.util.Optional;
                         *
                         * Optional<String> result = chunkingStrategy.accept(new ChunkingStrategy.Visitor<Optional<String>>() {
                         *     @Override
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is ThreadCreateAndRunParams &&
            body == other.body &&
