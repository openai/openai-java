...
private constructor(
     ...
     * ```java
     * JsonValue.from("agent.session.artifact.deleted")
     * ```
     *
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [SessionArtifactDeleted].
         *
    ...
    /** A builder for [SessionArtifactDeleted]. */
    class Builder internal constructor() {

        private var id: JsonField<String>? = null
        private var deleted: JsonField<Boolean>? = null
        private var object_: JsonValue = JsonValue.from("agent.session.artifact.deleted")
        private var additionalProperties: MutableMap<String, JsonValue> = mutableMapOf()

        @JvmSynthetic
        internal fun from(sessionArtifactDeleted: SessionArtifactDeleted) = apply {
            id = sessionArtifactDeleted.id
            deleted = sessionArtifactDeleted.deleted
            object_ = sessionArtifactDeleted.object_
            additionalProperties = sessionArtifactDeleted.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [SessionArtifactDeleted].
         *
         ...
         */
        fun build(): SessionArtifactDeleted =
     ...
     *   expected type.
     */
    fun validate(): SessionArtifactDeleted = apply {
        if (validated) {
            return@apply
        }
        ...
        deleted()
        _object_().let {
            if (it != JsonValue.from("agent.session.artifact.deleted")) {
    ...
    internal fun validity(): Int =
        (if (id.asKnown().isPresent) 1 else 0) +
            ...
            object_.let { if (it == JsonValue.from("agent.session.artifact.deleted")) 1 else 0 }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is SessionArtifactDeleted &&
            id == other.id &&
    ...
    override fun toString() =
        "SessionArtifactDeleted{id=$id, deleted=$deleted, object_=$object_, additionalProperties=$additionalProperties}"
}
