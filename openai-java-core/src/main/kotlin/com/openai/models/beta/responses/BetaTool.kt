...
@JsonDeserialize(using = BetaTool.Deserializer::class)
@JsonSerialize(using = BetaTool.Serializer::class)
class BetaTool
private constructor(
    private val function: BetaFunctionTool? = null,
    private val fileSearch: BetaFileSearchTool? = null,
    private val computer: BetaComputerTool? = null,
    private val computerUsePreview: BetaComputerUsePreviewTool? = null,
    private val webSearch: BetaWebSearchTool? = null,
    ...
    private val shell: BetaFunctionShellTool? = null,
    private val custom: BetaCustomTool? = null,
    private val namespace: BetaNamespaceTool? = null,
    private val toolSearch: BetaToolSearchTool? = null,
    private val webSearchPreview: BetaWebSearchPreviewTool? = null,
    private val applyPatch: BetaApplyPatchTool? = null,
    ...
    fun shell(): Optional<BetaFunctionShellTool> = Optional.ofNullable(shell)
    ...
    fun namespace(): Optional<BetaNamespaceTool> = Optional.ofNullable(namespace)

    /** Hosted or BYOT tool search configuration for deferred tools. */
    fun toolSearch(): Optional<BetaToolSearchTool> = Optional.ofNullable(toolSearch)
    ...
    fun applyPatch(): Optional<BetaApplyPatchTool> = Optional.ofNullable(applyPatch)
    ...
    /** A tool that allows the model to execute shell commands. */
    fun asShell(): BetaFunctionShellTool = shell.getOrThrow("shell")
    ...
    /** Groups function/custom tools under a shared namespace. */
    fun asNamespace(): BetaNamespaceTool = namespace.getOrThrow("namespace")

    /** Hosted or BYOT tool search configuration for deferred tools. */
    fun asToolSearch(): BetaToolSearchTool = toolSearch.getOrThrow("toolSearch")
    ...
    /** Allows the assistant to create, delete, or update files using unified diffs. */
    fun asApplyPatch(): BetaApplyPatchTool = applyPatch.getOrThrow("applyPatch")
     ...
     * import java.util.Optional;
     *
     * Optional<String> result = betaTool.accept(new BetaTool.Visitor<Optional<String>>() {
     *     @Override
     *     public Optional<String> visitFunction(BetaFunctionTool function) {
    ...
    fun validate(): BetaTool = apply {
        ...
        accept(
            object : Visitor<Unit> {
                override fun visitFunction(function: BetaFunctionTool) {
                    function.validate()
                }

                override fun visitFileSearch(fileSearch: BetaFileSearchTool) {
                    fileSearch.validate()
                }

                override fun visitComputer(computer: BetaComputerTool) {
                    computer.validate()
                }

                override fun visitComputerUsePreview(
                    computerUsePreview: BetaComputerUsePreviewTool
                ) {
                    computerUsePreview.validate()
                }

                override fun visitWebSearch(webSearch: BetaWebSearchTool) {
                    webSearch.validate()
                }
                ...
                override fun visitShell(shell: BetaFunctionShellTool) {
                    shell.validate()
                }

                override fun visitCustom(custom: BetaCustomTool) {
                    custom.validate()
                }

                override fun visitNamespace(namespace: BetaNamespaceTool) {
                    namespace.validate()
                }

                override fun visitToolSearch(toolSearch: BetaToolSearchTool) {
                    toolSearch.validate()
                }

                override fun visitWebSearchPreview(webSearchPreview: BetaWebSearchPreviewTool) {
                    webSearchPreview.validate()
                }

                override fun visitApplyPatch(applyPatch: BetaApplyPatchTool) {
                    applyPatch.validate()
                }
            }
        )
    ...
    internal fun validity(): Int =
        accept(
            object : Visitor<Int> {
                override fun visitFunction(function: BetaFunctionTool) = function.validity()

                override fun visitFileSearch(fileSearch: BetaFileSearchTool) = fileSearch.validity()

                override fun visitComputer(computer: BetaComputerTool) = computer.validity()

                override fun visitComputerUsePreview(
                    computerUsePreview: BetaComputerUsePreviewTool
                ) = computerUsePreview.validity()

                override fun visitWebSearch(webSearch: BetaWebSearchTool) = webSearch.validity()
                ...
                override fun visitShell(shell: BetaFunctionShellTool) = shell.validity()

                override fun visitCustom(custom: BetaCustomTool) = custom.validity()

                override fun visitNamespace(namespace: BetaNamespaceTool) = namespace.validity()

                override fun visitToolSearch(toolSearch: BetaToolSearchTool) = toolSearch.validity()

                override fun visitWebSearchPreview(webSearchPreview: BetaWebSearchPreviewTool) =
                    webSearchPreview.validity()

                override fun visitApplyPatch(applyPatch: BetaApplyPatchTool) = applyPatch.validity()
    ...
    override fun toString(): String =
        when {
            function != null -> "BetaTool{function=$function}"
            fileSearch != null -> "BetaTool{fileSearch=$fileSearch}"
            computer != null -> "BetaTool{computer=$computer}"
            computerUsePreview != null -> "BetaTool{computerUsePreview=$computerUsePreview}"
            webSearch != null -> "BetaTool{webSearch=$webSearch}"
            mcp != null -> "BetaTool{mcp=$mcp}"
            codeInterpreter != null -> "BetaTool{codeInterpreter=$codeInterpreter}"
            programmaticToolCalling != null ->
                "BetaTool{programmaticToolCalling=$programmaticToolCalling}"
            imageGeneration != null -> "BetaTool{imageGeneration=$imageGeneration}"
            localShell != null -> "BetaTool{localShell=$localShell}"
            shell != null -> "BetaTool{shell=$shell}"
            custom != null -> "BetaTool{custom=$custom}"
            namespace != null -> "BetaTool{namespace=$namespace}"
            toolSearch != null -> "BetaTool{toolSearch=$toolSearch}"
            webSearchPreview != null -> "BetaTool{webSearchPreview=$webSearchPreview}"
            applyPatch != null -> "BetaTool{applyPatch=$applyPatch}"
            _json != null -> "BetaTool{_unknown=$_json}"
            else -> throw IllegalStateException("Invalid BetaTool")
        }
    ...
    companion object {
        ...
        fun ofComputerUsePreview(computerUsePreview: BetaComputerUsePreviewTool) =
            BetaTool(computerUsePreview = computerUsePreview)
        ...
        fun ofCodeInterpreter(codeInterpreter: CodeInterpreter) =
            BetaTool(codeInterpreter = codeInterpreter)
        ...
        /** A tool that allows the model to execute shell commands in a local environment. */
        @JvmStatic
        fun ofLocalShell() = BetaTool(localShell = JsonValue.from(mapOf("type" to "local_shell")))

        /** A tool that allows the model to execute shell commands. */
        @JvmStatic fun ofShell(shell: BetaFunctionShellTool) = BetaTool(shell = shell)
        ...
        /** Groups function/custom tools under a shared namespace. */
        @JvmStatic fun ofNamespace(namespace: BetaNamespaceTool) = BetaTool(namespace = namespace)

        /** Hosted or BYOT tool search configuration for deferred tools. */
        @JvmStatic
        fun ofToolSearch(toolSearch: BetaToolSearchTool) = BetaTool(toolSearch = toolSearch)
        ...
        fun ofWebSearchPreview(webSearchPreview: BetaWebSearchPreviewTool) =
            BetaTool(webSearchPreview = webSearchPreview)

        /** Allows the assistant to create, delete, or update files using unified diffs. */
        @JvmStatic
        fun ofApplyPatch(applyPatch: BetaApplyPatchTool) = BetaTool(applyPatch = applyPatch)
    }

    /** An interface that defines how to map each variant of [BetaTool] to a value of type [T]. */
    interface Visitor<out T> {
         ...
         * [function calling](https://developers.openai.com/api/docs/guides/function-calling).
         */
        fun visitFunction(function: BetaFunctionTool): T = unknown(JsonValue.from(function))

        /**
         * A tool that searches for relevant content from uploaded files. Learn more about the
         * [file search tool](https://developers.openai.com/api/docs/guides/tools-file-search).
         */
        fun visitFileSearch(fileSearch: BetaFileSearchTool): T = unknown(JsonValue.from(fileSearch))

        /**
         * A tool that controls a virtual computer. Learn more about the
         * [computer tool](https://developers.openai.com/api/docs/guides/tools-computer-use).
         */
        fun visitComputer(computer: BetaComputerTool): T = unknown(JsonValue.from(computer))
         ...
         * [web search tool](https://developers.openai.com/api/docs/guides/tools-web-search).
         */
        fun visitWebSearch(webSearch: BetaWebSearchTool): T = unknown(JsonValue.from(webSearch))
        ...
        /** A tool that allows the model to execute shell commands. */
        fun visitShell(shell: BetaFunctionShellTool): T = unknown(JsonValue.from(shell))

        /**
         * A custom tool that processes input using a specified format. Learn more about
         * [custom tools](https://developers.openai.com/api/docs/guides/function-calling#custom-tools)
         */
        fun visitCustom(custom: BetaCustomTool): T = unknown(JsonValue.from(custom))

        /** Groups function/custom tools under a shared namespace. */
        fun visitNamespace(namespace: BetaNamespaceTool): T = unknown(JsonValue.from(namespace))

        /** Hosted or BYOT tool search configuration for deferred tools. */
        fun visitToolSearch(toolSearch: BetaToolSearchTool): T = unknown(JsonValue.from(toolSearch))
        ...
        /** Allows the assistant to create, delete, or update files using unified diffs. */
        fun visitApplyPatch(applyPatch: BetaApplyPatchTool): T = unknown(JsonValue.from(applyPatch))

        /**
         * Maps an unknown variant of [BetaTool] to a value of type [T].
         *
         * An instance of [BetaTool] can contain an unknown variant if it was deserialized from data
    ...
    internal class Deserializer : BaseDeserializer<BetaTool>(BetaTool::class) {

        override fun ObjectCodec.deserialize(node: JsonNode): BetaTool {
            val json = JsonValue.fromJsonNode(node)
            val type = json.asObject().getOrNull()?.get("type")?.asString()?.getOrNull()

            when (type) {
                "function" -> {
                    return tryDeserialize(node, jacksonTypeRef<BetaFunctionTool>())?.let {
                        BetaTool(function = it, _json = json)
                    } ?: BetaTool(_json = json)
                }
                "file_search" -> {
                    return tryDeserialize(node, jacksonTypeRef<BetaFileSearchTool>())?.let {
                        BetaTool(fileSearch = it, _json = json)
                    } ?: BetaTool(_json = json)
                }
                "computer" -> {
                    return tryDeserialize(node, jacksonTypeRef<BetaComputerTool>())?.let {
                        BetaTool(computer = it, _json = json)
                    } ?: BetaTool(_json = json)
                }
                "computer_use_preview" -> {
                    return tryDeserialize(node, jacksonTypeRef<BetaComputerUsePreviewTool>())?.let {
                        BetaTool(computerUsePreview = it, _json = json)
                    } ?: BetaTool(_json = json)
                }
                "mcp" -> {
                    return tryDeserialize(node, jacksonTypeRef<Mcp>())?.let {
                        BetaTool(mcp = it, _json = json)
                    } ?: BetaTool(_json = json)
                }
                "code_interpreter" -> {
                    return tryDeserialize(node, jacksonTypeRef<CodeInterpreter>())?.let {
                        BetaTool(codeInterpreter = it, _json = json)
                    } ?: BetaTool(_json = json)
                }
                "programmatic_tool_calling" -> {
                    return tryDeserialize(node, jacksonTypeRef<JsonValue>())
                        ?.let { BetaTool(programmaticToolCalling = it, _json = json) }
                        ?.takeIf { it.isValid() } ?: BetaTool(_json = json)
                }
                "image_generation" -> {
                    return tryDeserialize(node, jacksonTypeRef<ImageGeneration>())?.let {
                        BetaTool(imageGeneration = it, _json = json)
                    } ?: BetaTool(_json = json)
                }
                "local_shell" -> {
                    return tryDeserialize(node, jacksonTypeRef<JsonValue>())
                        ?.let { BetaTool(localShell = it, _json = json) }
                        ?.takeIf { it.isValid() } ?: BetaTool(_json = json)
                }
                "shell" -> {
                    return tryDeserialize(node, jacksonTypeRef<BetaFunctionShellTool>())?.let {
                        BetaTool(shell = it, _json = json)
                    } ?: BetaTool(_json = json)
                }
                "custom" -> {
                    return tryDeserialize(node, jacksonTypeRef<BetaCustomTool>())?.let {
                        BetaTool(custom = it, _json = json)
                    } ?: BetaTool(_json = json)
                }
                "namespace" -> {
                    return tryDeserialize(node, jacksonTypeRef<BetaNamespaceTool>())?.let {
                        BetaTool(namespace = it, _json = json)
                    } ?: BetaTool(_json = json)
                }
                "tool_search" -> {
                    return tryDeserialize(node, jacksonTypeRef<BetaToolSearchTool>())?.let {
                        BetaTool(toolSearch = it, _json = json)
                    } ?: BetaTool(_json = json)
                }
                "apply_patch" -> {
                    return tryDeserialize(node, jacksonTypeRef<BetaApplyPatchTool>())?.let {
                        BetaTool(applyPatch = it, _json = json)
                    } ?: BetaTool(_json = json)
                }
            }
            ...
            val bestMatches =
                sequenceOf(
                        tryDeserialize(node, jacksonTypeRef<BetaWebSearchTool>())?.let {
                            BetaTool(webSearch = it, _json = json)
                        },
                        tryDeserialize(node, jacksonTypeRef<BetaWebSearchPreviewTool>())?.let {
                            BetaTool(webSearchPreview = it, _json = json)
                        },
                    )
                    .filterNotNull()
    ...
    internal class Serializer : BaseSerializer<BetaTool>(BetaTool::class) {
        ...
        private constructor(
            ...
            private constructor(
                ...
                class Builder internal constructor() {
                     ...
                     */
                    fun networkPolicy(disabled: BetaContainerNetworkPolicyDisabled) =
                     ...
                     */
                    fun networkPolicy(allowlist: BetaContainerNetworkPolicyAllowlist) =
                ...
                class NetworkPolicy
                private constructor(
                    private val disabled: BetaContainerNetworkPolicyDisabled? = null,
                    private val allowlist: BetaContainerNetworkPolicyAllowlist? = null,
                    private val _json: JsonValue? = null,
                ) {

                    fun disabled(): Optional<BetaContainerNetworkPolicyDisabled> =
                        Optional.ofNullable(disabled)

                    fun allowlist(): Optional<BetaContainerNetworkPolicyAllowlist> =
                    ...
                    fun asDisabled(): BetaContainerNetworkPolicyDisabled =
                        disabled.getOrThrow("disabled")

                    fun asAllowlist(): BetaContainerNetworkPolicyAllowlist =
                     ...
                     *     @Override
                     *     public Optional<String> visitDisabled(BetaContainerNetworkPolicyDisabled disabled) {
                        ...
                        accept(
                            object : Visitor<Unit> {
                                override fun visitDisabled(
                                    disabled: BetaContainerNetworkPolicyDisabled
                                ) {
                                    disabled.validate()
                                }

                                override fun visitAllowlist(
                                    allowlist: BetaContainerNetworkPolicyAllowlist
                                ) {
                                    allowlist.validate()
                                }
                            }
                    ...
                    companion object {
                        ...
                        @JvmStatic
                        fun ofDisabled(disabled: BetaContainerNetworkPolicyDisabled) =
                            NetworkPolicy(disabled = disabled)

                        @JvmStatic
                        fun ofAllowlist(allowlist: BetaContainerNetworkPolicyAllowlist) =
