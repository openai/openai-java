...
private constructor(
    ...
    /** A builder for [BetaResponseCodeInterpreterCallInterpretingEvent]. */
    class Builder internal constructor() {
        ...
        internal fun from(
            ...
            itemId = betaResponseCodeInterpreterCallInterpretingEvent.itemId
            outputIndex = betaResponseCodeInterpreterCallInterpretingEvent.outputIndex
            sequenceNumber = betaResponseCodeInterpreterCallInterpretingEvent.sequenceNumber
            type = betaResponseCodeInterpreterCallInterpretingEvent.type
            agent = betaResponseCodeInterpreterCallInterpretingEvent.agent
            additionalProperties =
                betaResponseCodeInterpreterCallInterpretingEvent.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [BetaResponseCodeInterpreterCallInterpretingEvent].
         *
         ...
         */
        fun build(): BetaResponseCodeInterpreterCallInterpretingEvent =
            BetaResponseCodeInterpreterCallInterpretingEvent(
     ...
     *   expected type.
     */
    fun validate(): BetaResponseCodeInterpreterCallInterpretingEvent = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is BetaResponseCodeInterpreterCallInterpretingEvent &&
            itemId == other.itemId &&
    ...
    override fun toString() =
        "BetaResponseCodeInterpreterCallInterpretingEvent{itemId=$itemId, outputIndex=$outputIndex, sequenceNumber=$sequenceNumber, type=$type, agent=$agent, additionalProperties=$additionalProperties}"
}
