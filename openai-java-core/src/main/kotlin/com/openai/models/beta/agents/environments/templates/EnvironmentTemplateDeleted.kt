...
private constructor(
     ...
     * ```java
     * JsonValue.from("agent.environment.template.deleted")
     * ```
     *
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [EnvironmentTemplateDeleted].
         *
    ...
    /** A builder for [EnvironmentTemplateDeleted]. */
    class Builder internal constructor() {

        private var id: JsonField<String>? = null
        private var deleted: JsonField<Boolean>? = null
        private var object_: JsonValue = JsonValue.from("agent.environment.template.deleted")
        private var additionalProperties: MutableMap<String, JsonValue> = mutableMapOf()

        @JvmSynthetic
        internal fun from(environmentTemplateDeleted: EnvironmentTemplateDeleted) = apply {
            id = environmentTemplateDeleted.id
            deleted = environmentTemplateDeleted.deleted
            object_ = environmentTemplateDeleted.object_
            additionalProperties = environmentTemplateDeleted.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [EnvironmentTemplateDeleted].
         *
         ...
         */
        fun build(): EnvironmentTemplateDeleted =
     ...
     *   expected type.
     */
    fun validate(): EnvironmentTemplateDeleted = apply {
        if (validated) {
            return@apply
        }
        ...
        deleted()
        _object_().let {
            if (it != JsonValue.from("agent.environment.template.deleted")) {
    ...
    internal fun validity(): Int =
        (if (id.asKnown().isPresent) 1 else 0) +
            ...
            object_.let { if (it == JsonValue.from("agent.environment.template.deleted")) 1 else 0 }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is EnvironmentTemplateDeleted &&
            id == other.id &&
    ...
    override fun toString() =
        "EnvironmentTemplateDeleted{id=$id, deleted=$deleted, object_=$object_, additionalProperties=$additionalProperties}"
}
