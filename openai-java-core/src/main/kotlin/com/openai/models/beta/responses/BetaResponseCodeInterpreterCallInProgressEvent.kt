...
private constructor(
    ...
    /** A builder for [BetaResponseCodeInterpreterCallInProgressEvent]. */
    class Builder internal constructor() {
        ...
        internal fun from(
            ...
            itemId = betaResponseCodeInterpreterCallInProgressEvent.itemId
            outputIndex = betaResponseCodeInterpreterCallInProgressEvent.outputIndex
            sequenceNumber = betaResponseCodeInterpreterCallInProgressEvent.sequenceNumber
            type = betaResponseCodeInterpreterCallInProgressEvent.type
            agent = betaResponseCodeInterpreterCallInProgressEvent.agent
            additionalProperties =
                betaResponseCodeInterpreterCallInProgressEvent.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [BetaResponseCodeInterpreterCallInProgressEvent].
         *
         ...
         */
        fun build(): BetaResponseCodeInterpreterCallInProgressEvent =
            BetaResponseCodeInterpreterCallInProgressEvent(
     ...
     *   expected type.
     */
    fun validate(): BetaResponseCodeInterpreterCallInProgressEvent = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is BetaResponseCodeInterpreterCallInProgressEvent &&
            itemId == other.itemId &&
    ...
    override fun toString() =
        "BetaResponseCodeInterpreterCallInProgressEvent{itemId=$itemId, outputIndex=$outputIndex, sequenceNumber=$sequenceNumber, type=$type, agent=$agent, additionalProperties=$additionalProperties}"
}
