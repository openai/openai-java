...
private constructor(
     ...
     * ```java
     * JsonValue.from("agent.session.turn.output_text.done")
     * ```
     *
    ...
    /** A builder for [AgentSessionTurnOutputTextDoneEvent]. */
    class Builder internal constructor() {
        ...
        private var type: JsonValue = JsonValue.from("agent.session.turn.output_text.done")
        private var additionalProperties: MutableMap<String, JsonValue> = mutableMapOf()

        @JvmSynthetic
        internal fun from(
            agentSessionTurnOutputTextDoneEvent: AgentSessionTurnOutputTextDoneEvent
        ) = apply {
            contentIndex = agentSessionTurnOutputTextDoneEvent.contentIndex
            eventId = agentSessionTurnOutputTextDoneEvent.eventId
            itemId = agentSessionTurnOutputTextDoneEvent.itemId
            outputIndex = agentSessionTurnOutputTextDoneEvent.outputIndex
            sessionId = agentSessionTurnOutputTextDoneEvent.sessionId
            text = agentSessionTurnOutputTextDoneEvent.text
            turnId = agentSessionTurnOutputTextDoneEvent.turnId
            type = agentSessionTurnOutputTextDoneEvent.type
            additionalProperties =
                agentSessionTurnOutputTextDoneEvent.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [AgentSessionTurnOutputTextDoneEvent].
         *
         ...
         */
        fun build(): AgentSessionTurnOutputTextDoneEvent =
            AgentSessionTurnOutputTextDoneEvent(
     ...
     *   expected type.
     */
    fun validate(): AgentSessionTurnOutputTextDoneEvent = apply {
        if (validated) {
            return@apply
        }
        ...
        turnId()
        _type().let {
            if (it != JsonValue.from("agent.session.turn.output_text.done")) {
    ...
    internal fun validity(): Int =
        (if (contentIndex.asKnown().isPresent) 1 else 0) +
            ...
            type.let { if (it == JsonValue.from("agent.session.turn.output_text.done")) 1 else 0 }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is AgentSessionTurnOutputTextDoneEvent &&
    ...
    override fun toString() =
        "AgentSessionTurnOutputTextDoneEvent{contentIndex=$contentIndex, eventId=$eventId, itemId=$itemId, outputIndex=$outputIndex, sessionId=$sessionId, text=$text, turnId=$turnId, type=$type, additionalProperties=$additionalProperties}"
}
