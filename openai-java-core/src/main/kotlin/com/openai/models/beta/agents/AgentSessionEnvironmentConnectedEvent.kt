...
private constructor(
     ...
     * ```java
     * JsonValue.from("agent.session.environment.connected")
     * ```
     *
    ...
    /** A builder for [AgentSessionEnvironmentConnectedEvent]. */
    class Builder internal constructor() {
        ...
        private var type: JsonValue = JsonValue.from("agent.session.environment.connected")
        private var additionalProperties: MutableMap<String, JsonValue> = mutableMapOf()

        @JvmSynthetic
        internal fun from(
            agentSessionEnvironmentConnectedEvent: AgentSessionEnvironmentConnectedEvent
        ) = apply {
            environment = agentSessionEnvironmentConnectedEvent.environment
            eventId = agentSessionEnvironmentConnectedEvent.eventId
            sessionId = agentSessionEnvironmentConnectedEvent.sessionId
            turnId = agentSessionEnvironmentConnectedEvent.turnId
            type = agentSessionEnvironmentConnectedEvent.type
            additionalProperties =
                agentSessionEnvironmentConnectedEvent.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [AgentSessionEnvironmentConnectedEvent].
         *
         ...
         */
        fun build(): AgentSessionEnvironmentConnectedEvent =
            AgentSessionEnvironmentConnectedEvent(
     ...
     *   expected type.
     */
    fun validate(): AgentSessionEnvironmentConnectedEvent = apply {
        if (validated) {
            return@apply
        }
        ...
        turnId()
        _type().let {
            if (it != JsonValue.from("agent.session.environment.connected")) {
    ...
    internal fun validity(): Int =
        (environment.asKnown().getOrNull()?.validity() ?: 0) +
            ...
            type.let { if (it == JsonValue.from("agent.session.environment.connected")) 1 else 0 }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is AgentSessionEnvironmentConnectedEvent &&
    ...
    override fun toString() =
        "AgentSessionEnvironmentConnectedEvent{environment=$environment, eventId=$eventId, sessionId=$sessionId, turnId=$turnId, type=$type, additionalProperties=$additionalProperties}"
}
