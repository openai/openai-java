...
private constructor(
    ...
    ) : this(id, error, status, type, mutableMapOf())
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [AgentSessionEnvironmentState].
         *
    ...
    /** A builder for [AgentSessionEnvironmentState]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(agentSessionEnvironmentState: AgentSessionEnvironmentState) = apply {
            id = agentSessionEnvironmentState.id
            error = agentSessionEnvironmentState.error
            status = agentSessionEnvironmentState.status
            type = agentSessionEnvironmentState.type
            additionalProperties = agentSessionEnvironmentState.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [AgentSessionEnvironmentState].
         *
         ...
         */
        fun build(): AgentSessionEnvironmentState =
     ...
     *   expected type.
     */
    fun validate(): AgentSessionEnvironmentState = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is AgentSessionEnvironmentState &&
            id == other.id &&
            error == other.error &&
            status == other.status &&
            type == other.type &&
    ...
    private val hashCode: Int by lazy {
        Objects.hash(id, error, status, type, additionalProperties)
    }

    override fun hashCode(): Int = hashCode

    override fun toString() =
        "AgentSessionEnvironmentState{id=$id, error=$error, status=$status, type=$type, additionalProperties=$additionalProperties}"
}
