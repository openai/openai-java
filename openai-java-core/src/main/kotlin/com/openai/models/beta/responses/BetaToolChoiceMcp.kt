...
private constructor(
    ...
    /** A builder for [BetaToolChoiceMcp]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(betaToolChoiceMcp: BetaToolChoiceMcp) = apply {
            serverLabel = betaToolChoiceMcp.serverLabel
            type = betaToolChoiceMcp.type
            name = betaToolChoiceMcp.name
            additionalProperties = betaToolChoiceMcp.additionalProperties.toMutableMap()
        }
     ...
     *   expected type.
     */
    fun validate(): BetaToolChoiceMcp = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is BetaToolChoiceMcp &&
    ...
    override fun toString() =
        "BetaToolChoiceMcp{serverLabel=$serverLabel, type=$type, name=$name, additionalProperties=$additionalProperties}"
}
