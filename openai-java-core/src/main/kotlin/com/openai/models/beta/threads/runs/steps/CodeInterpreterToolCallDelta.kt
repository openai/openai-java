...
private constructor(
    ...
    private constructor(
        ...
        private constructor(
             ...
             *     @Override
             *     public Optional<String> visitLogs(CodeInterpreterLogs logs) {
            ...
            interface Visitor<out T> {
                ...
                /** Text output from the Code Interpreter tool call as part of a run step. */
                fun visitLogs(logs: CodeInterpreterLogs): T = unknown(JsonValue.from(logs))

                fun visitImage(image: CodeInterpreterOutputImage): T =
                    unknown(JsonValue.from(image))
