...
private constructor(
    ...
    companion object {
        ...
        @JvmStatic fun none(): SubagentListParams = builder().build()

        /** Returns a mutable builder for constructing an instance of [SubagentListParams]. */
        @JvmStatic fun builder() = Builder()
    }

    /** A builder for [SubagentListParams]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(subagentListParams: SubagentListParams) = apply {
            sessionId = subagentListParams.sessionId
            after = subagentListParams.after
            limit = subagentListParams.limit
            order = subagentListParams.order
            additionalHeaders = subagentListParams.additionalHeaders.toBuilder()
            additionalQueryParams = subagentListParams.additionalQueryParams.toBuilder()
        }
        ...
        /**
         * Returns an immutable instance of [SubagentListParams].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): SubagentListParams =
            SubagentListParams(
                sessionId,
                after,
                limit,
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is SubagentListParams &&
    ...
    override fun toString() =
        "SubagentListParams{sessionId=$sessionId, after=$after, limit=$limit, order=$order, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
