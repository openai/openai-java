...
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [BetaResponseInputText].
         *
    ...
    /** A builder for [BetaResponseInputText]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(betaResponseInputText: BetaResponseInputText) = apply {
            text = betaResponseInputText.text
            type = betaResponseInputText.type
            promptCacheBreakpoint = betaResponseInputText.promptCacheBreakpoint
            additionalProperties = betaResponseInputText.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [BetaResponseInputText].
         *
         ...
         */
        fun build(): BetaResponseInputText =
     ...
     *   expected type.
     */
    fun validate(): BetaResponseInputText = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is BetaResponseInputText &&
            text == other.text &&
            type == other.type &&
    ...
    override fun toString() =
        "BetaResponseInputText{text=$text, type=$type, promptCacheBreakpoint=$promptCacheBreakpoint, additionalProperties=$additionalProperties}"
}
