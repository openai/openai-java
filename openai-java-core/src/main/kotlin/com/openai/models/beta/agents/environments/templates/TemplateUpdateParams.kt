...
private constructor(
    ...
    class Builder internal constructor() {
        ...
        internal fun from(templateUpdateParams: TemplateUpdateParams) = apply {
            environmentTemplateId = templateUpdateParams.environmentTemplateId
    ...
    override fun hashCode(): Int =
        Objects.hash(environmentTemplateId, body, additionalHeaders, additionalQueryParams)

    override fun toString() =
        "TemplateUpdateParams{environmentTemplateId=$environmentTemplateId, body=$body, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
