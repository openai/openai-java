...
private constructor(
     ...
     * ```java
     * JsonValue.from("resume_subagent_call")
     * ```
     *
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [AgentResumeSubagentCallItem].
         *
    ...
    /** A builder for [AgentResumeSubagentCallItem]. */
    class Builder internal constructor() {
        ...
        private var type: JsonValue = JsonValue.from("resume_subagent_call")
        private var additionalProperties: MutableMap<String, JsonValue> = mutableMapOf()

        @JvmSynthetic
        internal fun from(agentResumeSubagentCallItem: AgentResumeSubagentCallItem) = apply {
            id = agentResumeSubagentCallItem.id
            recipientAgentId = agentResumeSubagentCallItem.recipientAgentId
            senderAgentId = agentResumeSubagentCallItem.senderAgentId
            status = agentResumeSubagentCallItem.status
            turnId = agentResumeSubagentCallItem.turnId
            type = agentResumeSubagentCallItem.type
            additionalProperties = agentResumeSubagentCallItem.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [AgentResumeSubagentCallItem].
         *
         ...
         */
        fun build(): AgentResumeSubagentCallItem =
     ...
     *   expected type.
     */
    fun validate(): AgentResumeSubagentCallItem = apply {
        if (validated) {
            return@apply
        }
        ...
        turnId()
        _type().let {
            if (it != JsonValue.from("resume_subagent_call")) {
    ...
    internal fun validity(): Int =
        (if (id.asKnown().isPresent) 1 else 0) +
            ...
            type.let { if (it == JsonValue.from("resume_subagent_call")) 1 else 0 }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is AgentResumeSubagentCallItem &&
            id == other.id &&
    ...
    override fun toString() =
        "AgentResumeSubagentCallItem{id=$id, recipientAgentId=$recipientAgentId, senderAgentId=$senderAgentId, status=$status, turnId=$turnId, type=$type, additionalProperties=$additionalProperties}"
}
