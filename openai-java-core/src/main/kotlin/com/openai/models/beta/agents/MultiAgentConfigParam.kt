...
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [MultiAgentConfigParam].
         *
    ...
    /** A builder for [MultiAgentConfigParam]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(multiAgentConfigParam: MultiAgentConfigParam) = apply {
            enabled = multiAgentConfigParam.enabled
            maxConcurrentSubagents = multiAgentConfigParam.maxConcurrentSubagents
            additionalProperties = multiAgentConfigParam.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [MultiAgentConfigParam].
         *
         ...
         */
        fun build(): MultiAgentConfigParam =
     ...
     *   expected type.
     */
    fun validate(): MultiAgentConfigParam = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is MultiAgentConfigParam &&
    ...
    override fun toString() =
        "MultiAgentConfigParam{enabled=$enabled, maxConcurrentSubagents=$maxConcurrentSubagents, additionalProperties=$additionalProperties}"
}
