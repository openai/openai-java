...
private constructor(
    ...
    /** A builder for [BetaResponseFileSearchCallInProgressEvent]. */
    class Builder internal constructor() {
        ...
        internal fun from(
            ...
            itemId = betaResponseFileSearchCallInProgressEvent.itemId
            outputIndex = betaResponseFileSearchCallInProgressEvent.outputIndex
            sequenceNumber = betaResponseFileSearchCallInProgressEvent.sequenceNumber
            type = betaResponseFileSearchCallInProgressEvent.type
            agent = betaResponseFileSearchCallInProgressEvent.agent
            additionalProperties =
                betaResponseFileSearchCallInProgressEvent.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [BetaResponseFileSearchCallInProgressEvent].
         *
         ...
         */
        fun build(): BetaResponseFileSearchCallInProgressEvent =
            BetaResponseFileSearchCallInProgressEvent(
     ...
     *   expected type.
     */
    fun validate(): BetaResponseFileSearchCallInProgressEvent = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is BetaResponseFileSearchCallInProgressEvent &&
            itemId == other.itemId &&
    ...
    override fun toString() =
        "BetaResponseFileSearchCallInProgressEvent{itemId=$itemId, outputIndex=$outputIndex, sequenceNumber=$sequenceNumber, type=$type, agent=$agent, additionalProperties=$additionalProperties}"
}
