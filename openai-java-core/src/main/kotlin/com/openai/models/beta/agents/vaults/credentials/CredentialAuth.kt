...
private constructor(
    ...
    interface Visitor<out T> {
         ...
         * Public metadata for an OAuth credential; tokens and client secrets are never returned.
         */
        fun visitMcpO(mcpO: McpOAuth): T = unknown(JsonValue.from(mcpO))
    ...
    private constructor(
        ...
        override fun toString() =
            "EnvironmentVariable{networking=$networking, secretName=$secretName, type=$type, additionalProperties=$additionalProperties}"
    }
}
