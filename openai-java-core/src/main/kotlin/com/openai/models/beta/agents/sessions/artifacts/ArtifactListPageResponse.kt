...
class ArtifactListPageResponse
@JsonCreator(mode = JsonCreator.Mode.DISABLED)
private constructor(
    private val data: JsonField<List<SessionArtifact>>,
    ...
    private constructor(
        @JsonProperty("data")
        @ExcludeMissing
        data: JsonField<List<SessionArtifact>> = JsonMissing.of(),
     ...
     */
    fun data(): List<SessionArtifact> = data.getRequired("data")
     ...
     */
    @JsonProperty("data") @ExcludeMissing fun _data(): JsonField<List<SessionArtifact>> = data
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [ArtifactListPageResponse].
         *
    ...
    /** A builder for [ArtifactListPageResponse]. */
    class Builder internal constructor() {

        private var data: JsonField<MutableList<SessionArtifact>>? = null
        ...
        @JvmSynthetic
        internal fun from(artifactListPageResponse: ArtifactListPageResponse) = apply {
            data = artifactListPageResponse.data.map { it.toMutableList() }
            firstId = artifactListPageResponse.firstId
            hasMore = artifactListPageResponse.hasMore
            lastId = artifactListPageResponse.lastId
            object_ = artifactListPageResponse.object_
            additionalProperties = artifactListPageResponse.additionalProperties.toMutableMap()
        }

        /** The resources returned in this page, in the requested sort order. */
        fun data(data: List<SessionArtifact>) = data(JsonField.of(data))

        /**
         * Sets [Builder.data] to an arbitrary JSON value.
         *
         * You should usually call [Builder.data] with a well-typed `List<SessionArtifact>` value
         * instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun data(data: JsonField<List<SessionArtifact>>) = apply {
            this.data = data.map { it.toMutableList() }
        }

        /**
         * Adds a single [SessionArtifact] to [Builder.data].
         *
         * @throws IllegalStateException if the field was previously set to a non-list.
         */
        fun addData(data: SessionArtifact) = apply {
            this.data =
        ...
        /**
         * Returns an immutable instance of [ArtifactListPageResponse].
         *
         ...
         */
        fun build(): ArtifactListPageResponse =
     ...
     *   expected type.
     */
    fun validate(): ArtifactListPageResponse = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is ArtifactListPageResponse &&
            data == other.data &&
    ...
    override fun toString() =
        "ArtifactListPageResponse{data=$data, firstId=$firstId, hasMore=$hasMore, lastId=$lastId, object_=$object_, additionalProperties=$additionalProperties}"
}
