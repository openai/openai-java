 ...
 * content.
 */
class BetaResponseCompactionCompactingEvent
...
private constructor(
    ...
    ) : this(itemId, outputIndex, sequenceNumber, type, agent, mutableMapOf())
     ...
     * ```java
     * JsonValue.from("response.compaction.compacting")
     * ```
     *
    ...
    /** A builder for [BetaResponseCompactionCompactingEvent]. */
    class Builder internal constructor() {

        private var itemId: JsonField<String>? = null
        private var outputIndex: JsonField<Long>? = null
        private var sequenceNumber: JsonField<Long>? = null
        private var type: JsonValue = JsonValue.from("response.compaction.compacting")
        private var agent: JsonField<Agent> = JsonMissing.of()
        private var additionalProperties: MutableMap<String, JsonValue> = mutableMapOf()

        @JvmSynthetic
        internal fun from(
            betaResponseCompactionCompactingEvent: BetaResponseCompactionCompactingEvent
        ) = apply {
            itemId = betaResponseCompactionCompactingEvent.itemId
            outputIndex = betaResponseCompactionCompactingEvent.outputIndex
            sequenceNumber = betaResponseCompactionCompactingEvent.sequenceNumber
            type = betaResponseCompactionCompactingEvent.type
            agent = betaResponseCompactionCompactingEvent.agent
            additionalProperties =
                betaResponseCompactionCompactingEvent.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [BetaResponseCompactionCompactingEvent].
         *
         ...
         */
        fun build(): BetaResponseCompactionCompactingEvent =
            BetaResponseCompactionCompactingEvent(
     ...
     *   expected type.
     */
    fun validate(): BetaResponseCompactionCompactingEvent = apply {
        if (validated) {
            return@apply
        }
        ...
        sequenceNumber()
        _type().let {
            if (it != JsonValue.from("response.compaction.compacting")) {
    ...
    internal fun validity(): Int =
        (if (itemId.asKnown().isPresent) 1 else 0) +
            ...
            type.let { if (it == JsonValue.from("response.compaction.compacting")) 1 else 0 } +
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is BetaResponseCompactionCompactingEvent &&
            itemId == other.itemId &&
    ...
    private val hashCode: Int by lazy {
        Objects.hash(itemId, outputIndex, sequenceNumber, type, agent, additionalProperties)
    }

    override fun hashCode(): Int = hashCode

    override fun toString() =
        "BetaResponseCompactionCompactingEvent{itemId=$itemId, outputIndex=$outputIndex, sequenceNumber=$sequenceNumber, type=$type, agent=$agent, additionalProperties=$additionalProperties}"
}
