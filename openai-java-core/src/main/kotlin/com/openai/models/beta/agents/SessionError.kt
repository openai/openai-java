...
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [SessionError].
         *
    ...
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(sessionError: SessionError) = apply {
            code = sessionError.code
            message = sessionError.message
            param = sessionError.param
            type = sessionError.type
            additionalProperties = sessionError.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [SessionError].
         *
     ...
     *   expected type.
     */
    fun validate(): SessionError = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun toString() =
        "SessionError{code=$code, message=$message, param=$param, type=$type, additionalProperties=$additionalProperties}"
}
