...
private constructor(
     ...
     * ```java
     * JsonValue.from("agent.session.turn.cancelled")
     * ```
     *
    ...
    /** A builder for [AgentSessionTurnCancelledEvent]. */
    class Builder internal constructor() {
        ...
        private var type: JsonValue = JsonValue.from("agent.session.turn.cancelled")
        private var usage: JsonField<TokenUsage>? = null
        private var additionalProperties: MutableMap<String, JsonValue> = mutableMapOf()

        @JvmSynthetic
        internal fun from(agentSessionTurnCancelledEvent: AgentSessionTurnCancelledEvent) = apply {
            eventId = agentSessionTurnCancelledEvent.eventId
            sessionId = agentSessionTurnCancelledEvent.sessionId
            turn = agentSessionTurnCancelledEvent.turn
            turnId = agentSessionTurnCancelledEvent.turnId
            type = agentSessionTurnCancelledEvent.type
            usage = agentSessionTurnCancelledEvent.usage
            additionalProperties =
                agentSessionTurnCancelledEvent.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [AgentSessionTurnCancelledEvent].
         *
         ...
         */
        fun build(): AgentSessionTurnCancelledEvent =
            AgentSessionTurnCancelledEvent(
     ...
     *   expected type.
     */
    fun validate(): AgentSessionTurnCancelledEvent = apply {
        if (validated) {
            return@apply
        }
        ...
        turnId()
        _type().let {
            if (it != JsonValue.from("agent.session.turn.cancelled")) {
    ...
    internal fun validity(): Int =
        (if (eventId.asKnown().isPresent) 1 else 0) +
            ...
            type.let { if (it == JsonValue.from("agent.session.turn.cancelled")) 1 else 0 } +
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is AgentSessionTurnCancelledEvent &&
    ...
    override fun toString() =
        "AgentSessionTurnCancelledEvent{eventId=$eventId, sessionId=$sessionId, turn=$turn, turnId=$turnId, type=$type, usage=$usage, additionalProperties=$additionalProperties}"
}
