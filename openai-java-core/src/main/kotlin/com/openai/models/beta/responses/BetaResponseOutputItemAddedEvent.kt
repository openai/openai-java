...
private constructor(
    ...
    /** A builder for [BetaResponseOutputItemAddedEvent]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(betaResponseOutputItemAddedEvent: BetaResponseOutputItemAddedEvent) =
            apply {
                item = betaResponseOutputItemAddedEvent.item
                outputIndex = betaResponseOutputItemAddedEvent.outputIndex
                sequenceNumber = betaResponseOutputItemAddedEvent.sequenceNumber
                type = betaResponseOutputItemAddedEvent.type
                agent = betaResponseOutputItemAddedEvent.agent
         ...
         */
        fun build(): BetaResponseOutputItemAddedEvent =
            BetaResponseOutputItemAddedEvent(
     ...
     *   expected type.
     */
    fun validate(): BetaResponseOutputItemAddedEvent = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is BetaResponseOutputItemAddedEvent &&
            item == other.item &&
    ...
    override fun toString() =
        "BetaResponseOutputItemAddedEvent{item=$item, outputIndex=$outputIndex, sequenceNumber=$sequenceNumber, type=$type, agent=$agent, additionalProperties=$additionalProperties}"
}
