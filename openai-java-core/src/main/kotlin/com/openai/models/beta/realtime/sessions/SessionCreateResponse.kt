...
private constructor(
     ...
     * audio directly. Transcription runs asynchronously and should be treated as rough guidance
    ...
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(sessionCreateResponse: SessionCreateResponse) = apply {
            clientSecret = sessionCreateResponse.clientSecret
            inputAudioFormat = sessionCreateResponse.inputAudioFormat
            inputAudioTranscription = sessionCreateResponse.inputAudioTranscription
            instructions = sessionCreateResponse.instructions
            maxResponseOutputTokens = sessionCreateResponse.maxResponseOutputTokens
            modalities = sessionCreateResponse.modalities.map { it.toMutableList() }
            outputAudioFormat = sessionCreateResponse.outputAudioFormat
            speed = sessionCreateResponse.speed
            temperature = sessionCreateResponse.temperature
            toolChoice = sessionCreateResponse.toolChoice
            tools = sessionCreateResponse.tools.map { it.toMutableList() }
            tracing = sessionCreateResponse.tracing
            turnDetection = sessionCreateResponse.turnDetection
            voice = sessionCreateResponse.voice
            additionalProperties = sessionCreateResponse.additionalProperties.toMutableMap()
        }
         ...
         * consumes audio directly. Transcription runs asynchronously and should be treated as rough
         ...
         */
        fun build(): SessionCreateResponse =
    ...
    fun validate(): SessionCreateResponse = apply {
        if (validated) {
            return@apply
        }
    ...
    private constructor(
        ...
        class Builder internal constructor() {
            ...
            fun build(): InputAudioTranscription =
                InputAudioTranscription(model, additionalProperties.toMutableMap())
        }
        ...
        override fun equals(other: Any?): Boolean {
            ...
            return /* spotless:off */ other is InputAudioTranscription && model == other.model && additionalProperties == other.additionalProperties /* spotless:on */
        }
        ...
        override fun toString() =
            "InputAudioTranscription{model=$model, additionalProperties=$additionalProperties}"
    }
