...
private constructor(
    ...
    /** A builder for [BetaWebSearchTool]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(betaWebSearchTool: BetaWebSearchTool) = apply {
            type = betaWebSearchTool.type
            externalWebAccess = betaWebSearchTool.externalWebAccess
            filters = betaWebSearchTool.filters
            searchContextSize = betaWebSearchTool.searchContextSize
            userLocation = betaWebSearchTool.userLocation
            additionalProperties = betaWebSearchTool.additionalProperties.toMutableMap()
        }
     ...
     *   expected type.
     */
    fun validate(): BetaWebSearchTool = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is BetaWebSearchTool &&
            type == other.type &&
    ...
    override fun toString() =
        "BetaWebSearchTool{type=$type, externalWebAccess=$externalWebAccess, filters=$filters, searchContextSize=$searchContextSize, userLocation=$userLocation, additionalProperties=$additionalProperties}"
}
