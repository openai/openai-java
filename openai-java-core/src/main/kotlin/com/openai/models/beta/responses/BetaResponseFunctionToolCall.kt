...
private constructor(
    ...
    ) : this(arguments, callId, name, type, id, agent, caller, namespace, status, mutableMapOf())
    ...
    /** A builder for [BetaResponseFunctionToolCall]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(betaResponseFunctionToolCall: BetaResponseFunctionToolCall) = apply {
            arguments = betaResponseFunctionToolCall.arguments
            callId = betaResponseFunctionToolCall.callId
            name = betaResponseFunctionToolCall.name
            type = betaResponseFunctionToolCall.type
            id = betaResponseFunctionToolCall.id
            agent = betaResponseFunctionToolCall.agent
            caller = betaResponseFunctionToolCall.caller
            namespace = betaResponseFunctionToolCall.namespace
            status = betaResponseFunctionToolCall.status
            additionalProperties = betaResponseFunctionToolCall.additionalProperties.toMutableMap()
        }
         ...
         */
        fun build(): BetaResponseFunctionToolCall =
     ...
     *   expected type.
     */
    fun validate(): BetaResponseFunctionToolCall = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is BetaResponseFunctionToolCall &&
    ...
    override fun toString() =
        "BetaResponseFunctionToolCall{arguments=$arguments, callId=$callId, name=$name, type=$type, id=$id, agent=$agent, caller=$caller, namespace=$namespace, status=$status, additionalProperties=$additionalProperties}"
}
