...
private constructor(
    ...
    /** A builder for [BetaResponseImageGenCallCompletedEvent]. */
    class Builder internal constructor() {
        ...
        internal fun from(
            ...
            itemId = betaResponseImageGenCallCompletedEvent.itemId
            outputIndex = betaResponseImageGenCallCompletedEvent.outputIndex
            sequenceNumber = betaResponseImageGenCallCompletedEvent.sequenceNumber
            type = betaResponseImageGenCallCompletedEvent.type
            agent = betaResponseImageGenCallCompletedEvent.agent
            additionalProperties =
                betaResponseImageGenCallCompletedEvent.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [BetaResponseImageGenCallCompletedEvent].
         *
         ...
         */
        fun build(): BetaResponseImageGenCallCompletedEvent =
            BetaResponseImageGenCallCompletedEvent(
     ...
     *   expected type.
     */
    fun validate(): BetaResponseImageGenCallCompletedEvent = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is BetaResponseImageGenCallCompletedEvent &&
            itemId == other.itemId &&
    ...
    override fun toString() =
        "BetaResponseImageGenCallCompletedEvent{itemId=$itemId, outputIndex=$outputIndex, sequenceNumber=$sequenceNumber, type=$type, agent=$agent, additionalProperties=$additionalProperties}"
}
