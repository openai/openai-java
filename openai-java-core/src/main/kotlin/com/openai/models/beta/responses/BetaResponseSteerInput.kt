 ...
 */
@JsonDeserialize(using = BetaResponseSteerInput.Deserializer::class)
@JsonSerialize(using = BetaResponseSteerInput.Serializer::class)
class BetaResponseSteerInput
private constructor(
    private val text: String? = null,
    private val responseSteerInputItemList: List<ResponseSteerInputItem>? = null,
    ...
    fun responseSteerInputItemList(): Optional<List<ResponseSteerInputItem>> =
        Optional.ofNullable(responseSteerInputItemList)

    fun isText(): Boolean = text != null

    fun isResponseSteerInputItemList(): Boolean = responseSteerInputItemList != null

    /** A text input, equivalent to a message with the `user` role. */
    fun asText(): String = text.getOrThrow("text")

    /** A non-empty list of message inputs to queue for the response. */
    fun asResponseSteerInputItemList(): List<ResponseSteerInputItem> =
        responseSteerInputItemList.getOrThrow("responseSteerInputItemList")
     ...
     * import java.util.Optional;
     *
     * Optional<String> result = betaResponseSteerInput.accept(new BetaResponseSteerInput.Visitor<Optional<String>>() {
     *     @Override
    ...
    fun <T> accept(visitor: Visitor<T>): T =
        when {
            ...
            responseSteerInputItemList != null ->
                visitor.visitResponseSteerInputItemList(responseSteerInputItemList)
     ...
     *   expected type.
     */
    fun validate(): BetaResponseSteerInput = apply {
        if (validated) {
            return@apply
        }
        ...
        accept(
            object : Visitor<Unit> {
                ...
                override fun visitResponseSteerInputItemList(
                    responseSteerInputItemList: List<ResponseSteerInputItem>
                ) {
                    responseSteerInputItemList.forEach { it.validate() }
                }
            }
        )
        validated = true
    ...
    internal fun validity(): Int =
        accept(
            object : Visitor<Int> {
                ...
                override fun visitResponseSteerInputItemList(
                    responseSteerInputItemList: List<ResponseSteerInputItem>
                ) = responseSteerInputItemList.sumOf { it.validity().toInt() }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is BetaResponseSteerInput &&
            text == other.text &&
            responseSteerInputItemList == other.responseSteerInputItemList
    }

    override fun hashCode(): Int = Objects.hash(text, responseSteerInputItemList)

    override fun toString(): String =
        when {
            text != null -> "BetaResponseSteerInput{text=$text}"
            responseSteerInputItemList != null ->
                "BetaResponseSteerInput{responseSteerInputItemList=$responseSteerInputItemList}"
            _json != null -> "BetaResponseSteerInput{_unknown=$_json}"
            else -> throw IllegalStateException("Invalid BetaResponseSteerInput")
        }

    companion object {

        /** A text input, equivalent to a message with the `user` role. */
        @JvmStatic fun ofText(text: String) = BetaResponseSteerInput(text = text)

        /** A non-empty list of message inputs to queue for the response. */
        @JvmStatic
        fun ofResponseSteerInputItemList(responseSteerInputItemList: List<ResponseSteerInputItem>) =
            BetaResponseSteerInput(
                responseSteerInputItemList = responseSteerInputItemList.toImmutable()
            )
    }

    /**
     * An interface that defines how to map each variant of [BetaResponseSteerInput] to a value of
     * type [T].
     */
    interface Visitor<out T> {
        ...
        /** A non-empty list of message inputs to queue for the response. */
        fun visitResponseSteerInputItemList(
            responseSteerInputItemList: List<ResponseSteerInputItem>
        ): T = unknown(JsonValue.from(responseSteerInputItemList))

        /**
         * Maps an unknown variant of [BetaResponseSteerInput] to a value of type [T].
         *
         * An instance of [BetaResponseSteerInput] can contain an unknown variant if it was
        ...
        fun unknown(json: JsonValue?): T {
            throw OpenAIInvalidDataException("Unknown BetaResponseSteerInput: $json")
        }
    }

    internal class Deserializer :
        BaseDeserializer<BetaResponseSteerInput>(BetaResponseSteerInput::class) {

        override fun ObjectCodec.deserialize(node: JsonNode): BetaResponseSteerInput {
            val json = JsonValue.fromJsonNode(node)

            val bestMatches =
                sequenceOf(
                        tryDeserialize(node, jacksonTypeRef<String>())?.let {
                            BetaResponseSteerInput(text = it, _json = json)
                        },
                        tryDeserialize(node, jacksonTypeRef<List<ResponseSteerInputItem>>())?.let {
                            BetaResponseSteerInput(responseSteerInputItemList = it, _json = json)
                        },
                    )
                    .filterNotNull()
            ...
            return when (bestMatches.size) {
                ...
                0 -> BetaResponseSteerInput(_json = json)
    ...
    internal class Serializer :
        BaseSerializer<BetaResponseSteerInput>(BetaResponseSteerInput::class) {

        override fun serialize(
            value: BetaResponseSteerInput,
            generator: JsonGenerator,
            provider: SerializerProvider,
        ) {
            when {
                value.text != null -> generator.writeObject(value.text)
                value.responseSteerInputItemList != null ->
                    generator.writeObject(value.responseSteerInputItemList)
    ...
    private constructor(
        ...
        private constructor(
            ...
            ) : this(content, role, type, id, agent, status, mutableMapOf())
            ...
            class Builder internal constructor() {
                 ...
                 * `Content.ofBetaResponseSteerInputContents(betaResponseSteerInputContents)`.
                 */
                fun contentOfBetaResponseSteerInputContents(
                    betaResponseSteerInputContents: List<BetaResponseSteerInputContent>
                ) =
                    content(
                        Content.ofBetaResponseSteerInputContents(betaResponseSteerInputContents)
                    )
                 ...
                 *
                 * You should usually call [Builder.agent] with a well-typed [Agent] value instead.
                 * This method is primarily for setting the field to an undocumented or not yet
                 * supported value.
                 */
            ...
            class Content
            private constructor(
                private val betaResponseSteerInputContents: List<BetaResponseSteerInputContent>? =
                    null,
                private val string: String? = null,
                private val _json: JsonValue? = null,
            ) {

                fun betaResponseSteerInputContents():
                    Optional<List<BetaResponseSteerInputContent>> =
                    Optional.ofNullable(betaResponseSteerInputContents)

                /** The message content, as a single string. */
                fun string(): Optional<String> = Optional.ofNullable(string)

                fun isBetaResponseSteerInputContents(): Boolean =
                    betaResponseSteerInputContents != null

                fun isString(): Boolean = string != null

                fun asBetaResponseSteerInputContents(): List<BetaResponseSteerInputContent> =
                    betaResponseSteerInputContents.getOrThrow("betaResponseSteerInputContents")
                 ...
                 *     @Override
                 *     public Optional<String> visitBetaResponseSteerInputContents(List<BetaResponseSteerInputContent> betaResponseSteerInputContents) {
                 *         return Optional.of(betaResponseSteerInputContents.toString());
                 *     }
                 *
                 *     // ...
                 *
                ...
                fun <T> accept(visitor: Visitor<T>): T =
                    when {
                        betaResponseSteerInputContents != null ->
                            visitor.visitBetaResponseSteerInputContents(
                ...
                fun validate(): Content = apply {
                    ...
                    accept(
                        object : Visitor<Unit> {
                            override fun visitBetaResponseSteerInputContents(
                                betaResponseSteerInputContents: List<BetaResponseSteerInputContent>
                            ) {
                                betaResponseSteerInputContents.forEach { it.validate() }
                            }
                ...
                internal fun validity(): Int =
                    accept(
                        object : Visitor<Int> {
                            override fun visitBetaResponseSteerInputContents(
                                betaResponseSteerInputContents: List<BetaResponseSteerInputContent>
                            ) = betaResponseSteerInputContents.sumOf { it.validity().toInt() }
                ...
                override fun equals(other: Any?): Boolean {
                    ...
                    return other is Content &&
                        betaResponseSteerInputContents == other.betaResponseSteerInputContents &&
                        string == other.string
                }

                override fun hashCode(): Int = Objects.hash(betaResponseSteerInputContents, string)

                override fun toString(): String =
                    when {
                        betaResponseSteerInputContents != null ->
                            "Content{betaResponseSteerInputContents=$betaResponseSteerInputContents}"
                ...
                companion object {
                    ...
                    @JvmStatic
                    fun ofBetaResponseSteerInputContents(
                        betaResponseSteerInputContents: List<BetaResponseSteerInputContent>
                    ) =
                        Content(
                            betaResponseSteerInputContents =
                                betaResponseSteerInputContents.toImmutable()
                        )
                ...
                interface Visitor<out T> {
                    ...
                    fun visitBetaResponseSteerInputContents(
                        betaResponseSteerInputContents: List<BetaResponseSteerInputContent>
                    ): T = unknown(JsonValue.from(betaResponseSteerInputContents))
                    ...
                    override fun ObjectCodec.deserialize(node: JsonNode): Content {
                        ...
                        val bestMatches =
                            sequenceOf(
                                    ...
                                    tryDeserialize(
                                            node,
                                            jacksonTypeRef<List<BetaResponseSteerInputContent>>(),
                                        )
                                        ?.let {
                                            Content(
                                                betaResponseSteerInputContents = it,
                                                _json = json,
                                            )
                                        },
                                )
                ...
                internal class Serializer : BaseSerializer<Content>(Content::class) {
                    ...
                    override fun serialize(
                        ...
                        when {
                            value.betaResponseSteerInputContents != null ->
                                generator.writeObject(value.betaResponseSteerInputContents)
            ...
            private val hashCode: Int by lazy {
                Objects.hash(content, role, type, id, agent, status, additionalProperties)
            }

            override fun hashCode(): Int = hashCode

            override fun toString() =
                "Message{content=$content, role=$role, type=$type, id=$id, agent=$agent, status=$status, additionalProperties=$additionalProperties}"
        }
        ...
        private constructor(
            ...
            class Builder internal constructor() {
                 ...
                 * `Output.ofBetaResponseFunctionCallOutputItemList(betaResponseFunctionCallOutputItemList)`.
                 */
                fun outputOfBetaResponseFunctionCallOutputItemList(
                    betaResponseFunctionCallOutputItemList: List<BetaResponseFunctionCallOutputItem>
                ) =
                    output(
                        Output.ofBetaResponseFunctionCallOutputItemList(
            ...
            private constructor(
                private val string: String? = null,
                private val betaResponseFunctionCallOutputItemList:
                ...
                fun betaResponseFunctionCallOutputItemList():
                    Optional<List<BetaResponseFunctionCallOutputItem>> =
                    Optional.ofNullable(betaResponseFunctionCallOutputItemList)

                fun isString(): Boolean = string != null

                fun isBetaResponseFunctionCallOutputItemList(): Boolean =
                    betaResponseFunctionCallOutputItemList != null

                /** A JSON string of the output of the function tool call. */
                fun asString(): String = string.getOrThrow("string")

                /** An array of content outputs (text, image, file) for the function tool call. */
                fun asBetaResponseFunctionCallOutputItemList():
                    List<BetaResponseFunctionCallOutputItem> =
                    betaResponseFunctionCallOutputItemList.getOrThrow(
                        "betaResponseFunctionCallOutputItemList"
                    )
                ...
                fun <T> accept(visitor: Visitor<T>): T =
                    when {
                        string != null -> visitor.visitString(string)
                        betaResponseFunctionCallOutputItemList != null ->
                            visitor.visitBetaResponseFunctionCallOutputItemList(
                                betaResponseFunctionCallOutputItemList
                            )
                        else -> visitor.unknown(_json)
                    }
                ...
                fun validate(): Output = apply {
                    ...
                    accept(
                        object : Visitor<Unit> {
                            ...
                            override fun visitBetaResponseFunctionCallOutputItemList(
                                betaResponseFunctionCallOutputItemList:
                                    List<BetaResponseFunctionCallOutputItem>
                            ) {
                                betaResponseFunctionCallOutputItemList.forEach { it.validate() }
                            }
                        }
                    )
                    validated = true
                    ...
                    accept(
                        object : Visitor<Int> {
                            ...
                            override fun visitBetaResponseFunctionCallOutputItemList(
                                ...
                                betaResponseFunctionCallOutputItemList.sumOf {
                                    it.validity().toInt()
                                }
                ...
                override fun equals(other: Any?): Boolean {
                    ...
                    return other is Output &&
                        string == other.string &&
                        betaResponseFunctionCallOutputItemList ==
                            other.betaResponseFunctionCallOutputItemList
                }

                override fun hashCode(): Int =
                    Objects.hash(string, betaResponseFunctionCallOutputItemList)

                override fun toString(): String =
                    when {
                        string != null -> "Output{string=$string}"
                        betaResponseFunctionCallOutputItemList != null ->
                            "Output{betaResponseFunctionCallOutputItemList=$betaResponseFunctionCallOutputItemList}"
                ...
                companion object {
                     ...
                     */
                    @JvmStatic
                    fun ofBetaResponseFunctionCallOutputItemList(
                        betaResponseFunctionCallOutputItemList:
                            List<BetaResponseFunctionCallOutputItem>
                    ) =
                        Output(
                            betaResponseFunctionCallOutputItemList =
                                betaResponseFunctionCallOutputItemList.toImmutable()
                        )
                }
                ...
                interface Visitor<out T> {
                     ...
                     * An array of content outputs (text, image, file) for the function tool call.
                     */
                    fun visitBetaResponseFunctionCallOutputItemList(
                        betaResponseFunctionCallOutputItemList:
                            List<BetaResponseFunctionCallOutputItem>
                    ): T = unknown(JsonValue.from(betaResponseFunctionCallOutputItemList))
                        ...
                        val bestMatches =
                            sequenceOf(
                                    ...
                                    tryDeserialize(
                                        ...
                                        ?.let {
                                            Output(
                                                betaResponseFunctionCallOutputItemList = it,
                                                _json = json,
                                            )
                                        },
                                )
                ...
                internal class Serializer : BaseSerializer<Output>(Output::class) {
                    ...
                    override fun serialize(
                        ...
                        when {
                            value.string != null -> generator.writeObject(value.string)
                            value.betaResponseFunctionCallOutputItemList != null ->
                                generator.writeObject(value.betaResponseFunctionCallOutputItemList)
                            value._json != null -> generator.writeObject(value._json)
                            else -> throw IllegalStateException("Invalid Output")
                        }
                    }
            ...
            override fun toString() =
                "FunctionCallOutput{output=$output, type=$type, id=$id, agent=$agent, callId=$callId, caller=$caller, name=$name, namespace=$namespace, status=$status, additionalProperties=$additionalProperties}"
        }
    }
}
