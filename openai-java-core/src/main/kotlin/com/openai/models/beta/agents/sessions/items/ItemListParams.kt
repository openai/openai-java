...
/**
 * Lists items produced by the session's root agent, including its interactions with subagents. Each
 * subagent has its own item history. See
...
private constructor(
    ...
    class Builder internal constructor() {
        ...
        internal fun from(itemListParams: ItemListParams) = apply {
            sessionId = itemListParams.sessionId
    ...
    override fun toString() =
        "ItemListParams{sessionId=$sessionId, after=$after, limit=$limit, order=$order, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
