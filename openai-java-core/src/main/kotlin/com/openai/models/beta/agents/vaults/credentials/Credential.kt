...
private constructor(
    ...
    private val auth: JsonField<CredentialAuth>,
    ...
    private constructor(
        ...
        @JsonProperty("auth") @ExcludeMissing auth: JsonField<CredentialAuth> = JsonMissing.of(),
    ...
    ) : this(id, auth, createdAt, name, object_, updatedAt, vaultId, mutableMapOf())
     ...
     *   unexpectedly missing or null (e.g. if the server responded with an unexpected value).
     */
    fun auth(): CredentialAuth = auth.getRequired("auth")
     ...
     * ```java
     * JsonValue.from("vault.credential")
     * ```
     *
     ...
     */
    @JsonProperty("auth") @ExcludeMissing fun _auth(): JsonField<CredentialAuth> = auth
    ...
    class Builder internal constructor() {
        ...
        private var auth: JsonField<CredentialAuth>? = null
        private var createdAt: JsonField<Long>? = null
        private var name: JsonField<String>? = null
        private var object_: JsonValue = JsonValue.from("vault.credential")
         ...
         *
         * You should usually call [Builder.auth] with a well-typed [CredentialAuth] value instead.
         * This method is primarily for setting the field to an undocumented or not yet supported
         * value.
         */
        fun auth(auth: JsonField<CredentialAuth>) = apply { this.auth = auth }

        /** Alias for calling [auth] with `CredentialAuth.ofMcpO(mcpO)`. */
        fun auth(mcpO: CredentialAuth.McpOAuth) = auth(CredentialAuth.ofMcpO(mcpO))

        /** Alias for calling [auth] with `CredentialAuth.ofStaticBearer(staticBearer)`. */
        fun auth(staticBearer: CredentialAuth.StaticBearer) =
            auth(CredentialAuth.ofStaticBearer(staticBearer))
    ...
    fun validate(): Credential = apply {
        ...
        name()
        _object_().let {
            if (it != JsonValue.from("vault.credential")) {
    ...
    internal fun validity(): Int =
        (if (id.asKnown().isPresent) 1 else 0) +
            ...
            object_.let { if (it == JsonValue.from("vault.credential")) 1 else 0 } +
    ...
    private val hashCode: Int by lazy {
        Objects.hash(id, auth, createdAt, name, object_, updatedAt, vaultId, additionalProperties)
    }

    override fun hashCode(): Int = hashCode

    override fun toString() =
        "Credential{id=$id, auth=$auth, createdAt=$createdAt, name=$name, object_=$object_, updatedAt=$updatedAt, vaultId=$vaultId, additionalProperties=$additionalProperties}"
}
