...
private constructor(
    ...
    ) : this(id, auth, createdAt, metadata, name, object_, updatedAt, vaultId, mutableMapOf())
    ...
    override fun toString() =
        "Credential{id=$id, auth=$auth, createdAt=$createdAt, metadata=$metadata, name=$name, object_=$object_, updatedAt=$updatedAt, vaultId=$vaultId, additionalProperties=$additionalProperties}"
}
