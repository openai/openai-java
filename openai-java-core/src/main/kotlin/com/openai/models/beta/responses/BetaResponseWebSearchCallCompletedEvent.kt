...
private constructor(
    ...
    /** A builder for [BetaResponseWebSearchCallCompletedEvent]. */
    class Builder internal constructor() {
        ...
        internal fun from(
            ...
            itemId = betaResponseWebSearchCallCompletedEvent.itemId
            outputIndex = betaResponseWebSearchCallCompletedEvent.outputIndex
            sequenceNumber = betaResponseWebSearchCallCompletedEvent.sequenceNumber
            type = betaResponseWebSearchCallCompletedEvent.type
            agent = betaResponseWebSearchCallCompletedEvent.agent
            additionalProperties =
                betaResponseWebSearchCallCompletedEvent.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [BetaResponseWebSearchCallCompletedEvent].
         *
         ...
         */
        fun build(): BetaResponseWebSearchCallCompletedEvent =
            BetaResponseWebSearchCallCompletedEvent(
     ...
     *   expected type.
     */
    fun validate(): BetaResponseWebSearchCallCompletedEvent = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is BetaResponseWebSearchCallCompletedEvent &&
            itemId == other.itemId &&
    ...
    override fun toString() =
        "BetaResponseWebSearchCallCompletedEvent{itemId=$itemId, outputIndex=$outputIndex, sequenceNumber=$sequenceNumber, type=$type, agent=$agent, additionalProperties=$additionalProperties}"
}
