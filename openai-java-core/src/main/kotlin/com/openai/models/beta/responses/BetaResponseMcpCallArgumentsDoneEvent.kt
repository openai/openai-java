...
private constructor(
    ...
    ) : this(arguments, itemId, outputIndex, sequenceNumber, type, agent, mutableMapOf())
    ...
    /** A builder for [BetaResponseMcpCallArgumentsDoneEvent]. */
    class Builder internal constructor() {
        ...
        internal fun from(
            ...
            arguments = betaResponseMcpCallArgumentsDoneEvent.arguments
            itemId = betaResponseMcpCallArgumentsDoneEvent.itemId
            outputIndex = betaResponseMcpCallArgumentsDoneEvent.outputIndex
            sequenceNumber = betaResponseMcpCallArgumentsDoneEvent.sequenceNumber
            type = betaResponseMcpCallArgumentsDoneEvent.type
            agent = betaResponseMcpCallArgumentsDoneEvent.agent
            additionalProperties =
                betaResponseMcpCallArgumentsDoneEvent.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [BetaResponseMcpCallArgumentsDoneEvent].
         *
         ...
         */
        fun build(): BetaResponseMcpCallArgumentsDoneEvent =
            BetaResponseMcpCallArgumentsDoneEvent(
     ...
     *   expected type.
     */
    fun validate(): BetaResponseMcpCallArgumentsDoneEvent = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is BetaResponseMcpCallArgumentsDoneEvent &&
    ...
    override fun toString() =
        "BetaResponseMcpCallArgumentsDoneEvent{arguments=$arguments, itemId=$itemId, outputIndex=$outputIndex, sequenceNumber=$sequenceNumber, type=$type, agent=$agent, additionalProperties=$additionalProperties}"
}
