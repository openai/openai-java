...
private constructor(
    ...
    /** A builder for [BetaResponseMcpListToolsFailedEvent]. */
    class Builder internal constructor() {
        ...
        internal fun from(
            ...
            itemId = betaResponseMcpListToolsFailedEvent.itemId
            outputIndex = betaResponseMcpListToolsFailedEvent.outputIndex
            sequenceNumber = betaResponseMcpListToolsFailedEvent.sequenceNumber
            type = betaResponseMcpListToolsFailedEvent.type
            agent = betaResponseMcpListToolsFailedEvent.agent
            additionalProperties =
                betaResponseMcpListToolsFailedEvent.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [BetaResponseMcpListToolsFailedEvent].
         *
         ...
         */
        fun build(): BetaResponseMcpListToolsFailedEvent =
            BetaResponseMcpListToolsFailedEvent(
     ...
     *   expected type.
     */
    fun validate(): BetaResponseMcpListToolsFailedEvent = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is BetaResponseMcpListToolsFailedEvent &&
            itemId == other.itemId &&
    ...
    override fun toString() =
        "BetaResponseMcpListToolsFailedEvent{itemId=$itemId, outputIndex=$outputIndex, sequenceNumber=$sequenceNumber, type=$type, agent=$agent, additionalProperties=$additionalProperties}"
}
