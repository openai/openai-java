...
private constructor(
    ...
    ) : this(contentIndex, delta, itemId, outputIndex, sequenceNumber, type, agent, mutableMapOf())
    ...
    /** A builder for [BetaResponseRefusalDeltaEvent]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(betaResponseRefusalDeltaEvent: BetaResponseRefusalDeltaEvent) = apply {
            contentIndex = betaResponseRefusalDeltaEvent.contentIndex
            delta = betaResponseRefusalDeltaEvent.delta
            itemId = betaResponseRefusalDeltaEvent.itemId
            outputIndex = betaResponseRefusalDeltaEvent.outputIndex
            sequenceNumber = betaResponseRefusalDeltaEvent.sequenceNumber
            type = betaResponseRefusalDeltaEvent.type
            agent = betaResponseRefusalDeltaEvent.agent
            additionalProperties = betaResponseRefusalDeltaEvent.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [BetaResponseRefusalDeltaEvent].
         *
         ...
         */
        fun build(): BetaResponseRefusalDeltaEvent =
            BetaResponseRefusalDeltaEvent(
     ...
     *   expected type.
     */
    fun validate(): BetaResponseRefusalDeltaEvent = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is BetaResponseRefusalDeltaEvent &&
    ...
    override fun toString() =
        "BetaResponseRefusalDeltaEvent{contentIndex=$contentIndex, delta=$delta, itemId=$itemId, outputIndex=$outputIndex, sequenceNumber=$sequenceNumber, type=$type, agent=$agent, additionalProperties=$additionalProperties}"
}
