...
private constructor(
    ...
    /** A builder for [BetaResponseCodeInterpreterCallCodeDeltaEvent]. */
    class Builder internal constructor() {
        ...
        internal fun from(
            ...
            delta = betaResponseCodeInterpreterCallCodeDeltaEvent.delta
            itemId = betaResponseCodeInterpreterCallCodeDeltaEvent.itemId
            outputIndex = betaResponseCodeInterpreterCallCodeDeltaEvent.outputIndex
            sequenceNumber = betaResponseCodeInterpreterCallCodeDeltaEvent.sequenceNumber
            type = betaResponseCodeInterpreterCallCodeDeltaEvent.type
            agent = betaResponseCodeInterpreterCallCodeDeltaEvent.agent
            additionalProperties =
                betaResponseCodeInterpreterCallCodeDeltaEvent.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [BetaResponseCodeInterpreterCallCodeDeltaEvent].
         *
         ...
         */
        fun build(): BetaResponseCodeInterpreterCallCodeDeltaEvent =
            BetaResponseCodeInterpreterCallCodeDeltaEvent(
     ...
     *   expected type.
     */
    fun validate(): BetaResponseCodeInterpreterCallCodeDeltaEvent = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is BetaResponseCodeInterpreterCallCodeDeltaEvent &&
            delta == other.delta &&
            itemId == other.itemId &&
    ...
    override fun toString() =
        "BetaResponseCodeInterpreterCallCodeDeltaEvent{delta=$delta, itemId=$itemId, outputIndex=$outputIndex, sequenceNumber=$sequenceNumber, type=$type, agent=$agent, additionalProperties=$additionalProperties}"
}
