...
private constructor(
     ...
     * import java.util.Optional;
     *
     * Optional<String> result = runStepStreamEvent.accept(new RunStepStreamEvent.Visitor<Optional<String>>() {
     *     @Override
     *     public Optional<String> visitThreadRunStepCreated(ThreadRunStepCreated threadRunStepCreated) {
     *         return Optional.of(threadRunStepCreated.toString());
     *     }
     *
     *     // ...
     *
    ...
    interface Visitor<out T> {
        ...
        fun unknown(json: JsonValue?): T {
            throw OpenAIInvalidDataException("Unknown RunStepStreamEvent")
        }
    }
