...
private constructor(
    ...
    /** A builder for [BetaNamespaceTool]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(betaNamespaceTool: BetaNamespaceTool) = apply {
            description = betaNamespaceTool.description
            name = betaNamespaceTool.name
            tools = betaNamespaceTool.tools.map { it.toMutableList() }
            type = betaNamespaceTool.type
            additionalProperties = betaNamespaceTool.additionalProperties.toMutableMap()
        }
     ...
     *   expected type.
     */
    fun validate(): BetaNamespaceTool = apply {
        if (validated) {
            return@apply
        }
    ...
    private constructor(
        ...
        companion object {
             ...
             * [custom tools](https://developers.openai.com/api/docs/guides/function-calling#custom-tools)
             */
            @JvmStatic fun ofCustom(custom: BetaCustomTool) = Tool(custom = custom)
        }
        ...
        private constructor(
            ...
            /**
             * Whether the tool response can be returned asynchronously versus immediately returned
             * on next response creation.
             *
             * @throws OpenAIInvalidDataException if the JSON field has an unexpected type (e.g. if
             *   the server responded with an unexpected value).
             */
            ...
            override fun toString() =
                "Function{name=$name, type=$type, allowedCallers=$allowedCallers, async=$async, deferLoading=$deferLoading, description=$description, outputSchema=$outputSchema, parameters=$parameters, strict=$strict, additionalProperties=$additionalProperties}"
        }
    }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is BetaNamespaceTool &&
            description == other.description &&
            name == other.name &&
            tools == other.tools &&
            type == other.type &&
    ...
    override fun toString() =
        "BetaNamespaceTool{description=$description, name=$name, tools=$tools, type=$type, additionalProperties=$additionalProperties}"
}
