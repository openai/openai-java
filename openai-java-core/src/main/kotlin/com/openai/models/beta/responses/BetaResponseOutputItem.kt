...
private constructor(
    ...
    private constructor(
        ...
        ) : this(id, result, status, type, agent, quality, size, mutableMapOf())
        ...
        private val hashCode: Int by lazy {
            Objects.hash(id, result, status, type, agent, quality, size, additionalProperties)
        }

        override fun hashCode(): Int = hashCode

        override fun toString() =
            "ImageGenerationCall{id=$id, result=$result, status=$status, type=$type, agent=$agent, quality=$quality, size=$size, additionalProperties=$additionalProperties}"
    }
