...
@JsonDeserialize(using = BetaResponseOutputItem.Deserializer::class)
@JsonSerialize(using = BetaResponseOutputItem.Serializer::class)
class BetaResponseOutputItem
private constructor(
    private val message: BetaResponseOutputMessage? = null,
    private val fileSearchCall: BetaResponseFileSearchToolCall? = null,
    private val functionCall: BetaResponseFunctionToolCall? = null,
    ...
    private val customToolCall: BetaResponseCustomToolCall? = null,
    private val customToolCallOutput: BetaResponseCustomToolCallOutputItem? = null,
    private val _json: JsonValue? = null,
) {

    /** An output message from the model. */
    fun message(): Optional<BetaResponseOutputMessage> = Optional.ofNullable(message)
     ...
     * more information.
     */
    fun functionCall(): Optional<BetaResponseFunctionToolCall> = Optional.ofNullable(functionCall)
    ...
    fun customToolCall(): Optional<BetaResponseCustomToolCall> = Optional.ofNullable(customToolCall)
    ...
    /** An output message from the model. */
    fun asMessage(): BetaResponseOutputMessage = message.getOrThrow("message")
     ...
     * more information.
     */
    fun asFunctionCall(): BetaResponseFunctionToolCall = functionCall.getOrThrow("functionCall")
    ...
    /** A call to a custom tool created by the model. */
    fun asCustomToolCall(): BetaResponseCustomToolCall = customToolCall.getOrThrow("customToolCall")
     ...
     * import java.util.Optional;
     *
     * Optional<String> result = betaResponseOutputItem.accept(new BetaResponseOutputItem.Visitor<Optional<String>>() {
     *     @Override
     *     public Optional<String> visitMessage(BetaResponseOutputMessage message) {
     ...
     *   expected type.
     */
    fun validate(): BetaResponseOutputItem = apply {
        if (validated) {
            return@apply
        }
        ...
        accept(
            object : Visitor<Unit> {
                override fun visitMessage(message: BetaResponseOutputMessage) {
                    message.validate()
                }
                ...
                override fun visitFunctionCall(functionCall: BetaResponseFunctionToolCall) {
                ...
                override fun visitCustomToolCall(customToolCall: BetaResponseCustomToolCall) {
    ...
    internal fun validity(): Int =
        accept(
            object : Visitor<Int> {
                override fun visitMessage(message: BetaResponseOutputMessage) = message.validity()
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is BetaResponseOutputItem &&
    ...
    override fun toString(): String =
        when {
            message != null -> "BetaResponseOutputItem{message=$message}"
            fileSearchCall != null -> "BetaResponseOutputItem{fileSearchCall=$fileSearchCall}"
            functionCall != null -> "BetaResponseOutputItem{functionCall=$functionCall}"
            functionCallOutput != null ->
                "BetaResponseOutputItem{functionCallOutput=$functionCallOutput}"
            agentMessage != null -> "BetaResponseOutputItem{agentMessage=$agentMessage}"
            multiAgentCall != null -> "BetaResponseOutputItem{multiAgentCall=$multiAgentCall}"
            multiAgentCallOutput != null ->
                "BetaResponseOutputItem{multiAgentCallOutput=$multiAgentCallOutput}"
            webSearchCall != null -> "BetaResponseOutputItem{webSearchCall=$webSearchCall}"
            computerCall != null -> "BetaResponseOutputItem{computerCall=$computerCall}"
            computerCallOutput != null ->
                "BetaResponseOutputItem{computerCallOutput=$computerCallOutput}"
            reasoning != null -> "BetaResponseOutputItem{reasoning=$reasoning}"
            program != null -> "BetaResponseOutputItem{program=$program}"
            programOutput != null -> "BetaResponseOutputItem{programOutput=$programOutput}"
            toolSearchCall != null -> "BetaResponseOutputItem{toolSearchCall=$toolSearchCall}"
            toolSearchOutput != null -> "BetaResponseOutputItem{toolSearchOutput=$toolSearchOutput}"
            additionalTools != null -> "BetaResponseOutputItem{additionalTools=$additionalTools}"
            compaction != null -> "BetaResponseOutputItem{compaction=$compaction}"
            imageGenerationCall != null ->
                "BetaResponseOutputItem{imageGenerationCall=$imageGenerationCall}"
            codeInterpreterCall != null ->
                "BetaResponseOutputItem{codeInterpreterCall=$codeInterpreterCall}"
            localShellCall != null -> "BetaResponseOutputItem{localShellCall=$localShellCall}"
            localShellCallOutput != null ->
                "BetaResponseOutputItem{localShellCallOutput=$localShellCallOutput}"
            shellCall != null -> "BetaResponseOutputItem{shellCall=$shellCall}"
            shellCallOutput != null -> "BetaResponseOutputItem{shellCallOutput=$shellCallOutput}"
            applyPatchCall != null -> "BetaResponseOutputItem{applyPatchCall=$applyPatchCall}"
            applyPatchCallOutput != null ->
                "BetaResponseOutputItem{applyPatchCallOutput=$applyPatchCallOutput}"
            mcpCall != null -> "BetaResponseOutputItem{mcpCall=$mcpCall}"
            mcpListTools != null -> "BetaResponseOutputItem{mcpListTools=$mcpListTools}"
            mcpApprovalRequest != null ->
                "BetaResponseOutputItem{mcpApprovalRequest=$mcpApprovalRequest}"
            mcpApprovalResponse != null ->
                "BetaResponseOutputItem{mcpApprovalResponse=$mcpApprovalResponse}"
            customToolCall != null -> "BetaResponseOutputItem{customToolCall=$customToolCall}"
            customToolCallOutput != null ->
                "BetaResponseOutputItem{customToolCallOutput=$customToolCallOutput}"
            _json != null -> "BetaResponseOutputItem{_unknown=$_json}"
            else -> throw IllegalStateException("Invalid BetaResponseOutputItem")
        }
    ...
    companion object {
        ...
        /** An output message from the model. */
        @JvmStatic
        fun ofMessage(message: BetaResponseOutputMessage) =
            BetaResponseOutputItem(message = message)
        ...
        fun ofFileSearchCall(fileSearchCall: BetaResponseFileSearchToolCall) =
            BetaResponseOutputItem(fileSearchCall = fileSearchCall)
         ...
         */
        @JvmStatic
        fun ofFunctionCall(functionCall: BetaResponseFunctionToolCall) =
            BetaResponseOutputItem(functionCall = functionCall)
        ...
        fun ofAgentMessage(agentMessage: AgentMessage) =
            BetaResponseOutputItem(agentMessage = agentMessage)

        @JvmStatic
        fun ofMultiAgentCall(multiAgentCall: MultiAgentCall) =
            BetaResponseOutputItem(multiAgentCall = multiAgentCall)
        ...
        fun ofWebSearchCall(webSearchCall: BetaResponseFunctionWebSearch) =
            BetaResponseOutputItem(webSearchCall = webSearchCall)
        ...
        fun ofComputerCall(computerCall: BetaResponseComputerToolCall) =
            BetaResponseOutputItem(computerCall = computerCall)
        ...
        fun ofReasoning(reasoning: BetaResponseReasoningItem) =
            BetaResponseOutputItem(reasoning = reasoning)

        @JvmStatic fun ofProgram(program: Program) = BetaResponseOutputItem(program = program)

        @JvmStatic
        fun ofProgramOutput(programOutput: ProgramOutput) =
            BetaResponseOutputItem(programOutput = programOutput)

        @JvmStatic
        fun ofToolSearchCall(toolSearchCall: BetaResponseToolSearchCall) =
            BetaResponseOutputItem(toolSearchCall = toolSearchCall)

        @JvmStatic
        fun ofToolSearchOutput(toolSearchOutput: BetaResponseToolSearchOutputItem) =
            BetaResponseOutputItem(toolSearchOutput = toolSearchOutput)

        @JvmStatic
        fun ofAdditionalTools(additionalTools: AdditionalTools) =
            BetaResponseOutputItem(additionalTools = additionalTools)
        ...
        fun ofCompaction(compaction: BetaResponseCompactionItem) =
            BetaResponseOutputItem(compaction = compaction)
        ...
        fun ofLocalShellCall(localShellCall: LocalShellCall) =
            BetaResponseOutputItem(localShellCall = localShellCall)
        ...
        fun ofShellCall(shellCall: BetaResponseFunctionShellToolCall) =
            BetaResponseOutputItem(shellCall = shellCall)

        /** The output of a shell tool call that was emitted. */
        @JvmStatic
        fun ofShellCallOutput(shellCallOutput: BetaResponseFunctionShellToolCallOutput) =
            BetaResponseOutputItem(shellCallOutput = shellCallOutput)

        /** A tool call that applies file diffs by creating, deleting, or updating files. */
        @JvmStatic
        fun ofApplyPatchCall(applyPatchCall: BetaResponseApplyPatchToolCall) =
            BetaResponseOutputItem(applyPatchCall = applyPatchCall)
        ...
        /** An invocation of a tool on an MCP server. */
        @JvmStatic fun ofMcpCall(mcpCall: McpCall) = BetaResponseOutputItem(mcpCall = mcpCall)

        /** A list of tools available on an MCP server. */
        @JvmStatic
        fun ofMcpListTools(mcpListTools: McpListTools) =
            BetaResponseOutputItem(mcpListTools = mcpListTools)
        ...
        /** A call to a custom tool created by the model. */
        @JvmStatic
        fun ofCustomToolCall(customToolCall: BetaResponseCustomToolCall) =
            BetaResponseOutputItem(customToolCall = customToolCall)
    ...
    /**
     * An interface that defines how to map each variant of [BetaResponseOutputItem] to a value of
     * type [T].
     */
    interface Visitor<out T> {

        /** An output message from the model. */
        fun visitMessage(message: BetaResponseOutputMessage): T = unknown(JsonValue.from(message))
         ...
         * for more information.
         */
        fun visitFunctionCall(functionCall: BetaResponseFunctionToolCall): T =
        ...
        fun visitAgentMessage(agentMessage: AgentMessage): T = unknown(JsonValue.from(agentMessage))

        fun visitMultiAgentCall(multiAgentCall: MultiAgentCall): T =
            unknown(JsonValue.from(multiAgentCall))

        fun visitMultiAgentCallOutput(multiAgentCallOutput: MultiAgentCallOutput): T =
            unknown(JsonValue.from(multiAgentCallOutput))
        ...
        fun visitReasoning(reasoning: BetaResponseReasoningItem): T =
            unknown(JsonValue.from(reasoning))
        ...
        /** The output emitted by an apply patch tool call. */
        fun visitApplyPatchCallOutput(
            applyPatchCallOutput: BetaResponseApplyPatchToolCallOutput
        ): T = unknown(JsonValue.from(applyPatchCallOutput))
        ...
        /** A call to a custom tool created by the model. */
        fun visitCustomToolCall(customToolCall: BetaResponseCustomToolCall): T =
            unknown(JsonValue.from(customToolCall))

        /** The output of a custom tool call from your code, being sent back to the model. */
        fun visitCustomToolCallOutput(
            customToolCallOutput: BetaResponseCustomToolCallOutputItem
        ): T = unknown(JsonValue.from(customToolCallOutput))

        /**
         * Maps an unknown variant of [BetaResponseOutputItem] to a value of type [T].
         *
         * An instance of [BetaResponseOutputItem] can contain an unknown variant if it was
        ...
        fun unknown(json: JsonValue?): T {
            throw OpenAIInvalidDataException("Unknown BetaResponseOutputItem: $json")
        }
    }

    internal class Deserializer :
        BaseDeserializer<BetaResponseOutputItem>(BetaResponseOutputItem::class) {

        override fun ObjectCodec.deserialize(node: JsonNode): BetaResponseOutputItem {
            val json = JsonValue.fromJsonNode(node)
            val type = json.asObject().getOrNull()?.get("type")?.asString()?.getOrNull()

            when (type) {
                "message" -> {
                    return tryDeserialize(node, jacksonTypeRef<BetaResponseOutputMessage>())?.let {
                        BetaResponseOutputItem(message = it, _json = json)
                    } ?: BetaResponseOutputItem(_json = json)
                }
                "file_search_call" -> {
                    return tryDeserialize(node, jacksonTypeRef<BetaResponseFileSearchToolCall>())
                        ?.let { BetaResponseOutputItem(fileSearchCall = it, _json = json) }
                        ?: BetaResponseOutputItem(_json = json)
                }
                "function_call" -> {
                    return tryDeserialize(node, jacksonTypeRef<BetaResponseFunctionToolCall>())
                        ?.let { BetaResponseOutputItem(functionCall = it, _json = json) }
                        ?: BetaResponseOutputItem(_json = json)
                }
                ...
                "code_interpreter_call" -> {
                    return tryDeserialize(
                        ...
                        ?.let { BetaResponseOutputItem(codeInterpreterCall = it, _json = json) }
                        ?: BetaResponseOutputItem(_json = json)
                }
                "local_shell_call" -> {
                    return tryDeserialize(node, jacksonTypeRef<LocalShellCall>())?.let {
                        BetaResponseOutputItem(localShellCall = it, _json = json)
                    } ?: BetaResponseOutputItem(_json = json)
                }
                "local_shell_call_output" -> {
                    return tryDeserialize(node, jacksonTypeRef<LocalShellCallOutput>())?.let {
                        BetaResponseOutputItem(localShellCallOutput = it, _json = json)
                    } ?: BetaResponseOutputItem(_json = json)
                }
                "shell_call" -> {
                    return tryDeserialize(node, jacksonTypeRef<BetaResponseFunctionShellToolCall>())
                        ?.let { BetaResponseOutputItem(shellCall = it, _json = json) }
                        ?: BetaResponseOutputItem(_json = json)
                }
                "shell_call_output" -> {
                    return tryDeserialize(
                        ...
                        ?.let { BetaResponseOutputItem(shellCallOutput = it, _json = json) }
                        ?: BetaResponseOutputItem(_json = json)
                }
                "apply_patch_call" -> {
                    return tryDeserialize(node, jacksonTypeRef<BetaResponseApplyPatchToolCall>())
                        ?.let { BetaResponseOutputItem(applyPatchCall = it, _json = json) }
                        ?: BetaResponseOutputItem(_json = json)
                }
                "apply_patch_call_output" -> {
                    return tryDeserialize(
                        ...
                        ?.let { BetaResponseOutputItem(applyPatchCallOutput = it, _json = json) }
                        ?: BetaResponseOutputItem(_json = json)
                }
                "mcp_call" -> {
                    return tryDeserialize(node, jacksonTypeRef<McpCall>())?.let {
                        BetaResponseOutputItem(mcpCall = it, _json = json)
                    } ?: BetaResponseOutputItem(_json = json)
                }
                "mcp_list_tools" -> {
                    return tryDeserialize(node, jacksonTypeRef<McpListTools>())?.let {
                        BetaResponseOutputItem(mcpListTools = it, _json = json)
                    } ?: BetaResponseOutputItem(_json = json)
                }
                "mcp_approval_request" -> {
                    return tryDeserialize(node, jacksonTypeRef<McpApprovalRequest>())?.let {
                        BetaResponseOutputItem(mcpApprovalRequest = it, _json = json)
                    } ?: BetaResponseOutputItem(_json = json)
                }
                "mcp_approval_response" -> {
                    return tryDeserialize(node, jacksonTypeRef<McpApprovalResponse>())?.let {
                        BetaResponseOutputItem(mcpApprovalResponse = it, _json = json)
                    } ?: BetaResponseOutputItem(_json = json)
                }
                "custom_tool_call" -> {
                    return tryDeserialize(node, jacksonTypeRef<BetaResponseCustomToolCall>())?.let {
                        BetaResponseOutputItem(customToolCall = it, _json = json)
                    } ?: BetaResponseOutputItem(_json = json)
                }
                "custom_tool_call_output" -> {
                    return tryDeserialize(
                        ...
                        ?.let { BetaResponseOutputItem(customToolCallOutput = it, _json = json) }
                        ?: BetaResponseOutputItem(_json = json)
                }
            }

            return BetaResponseOutputItem(_json = json)
        }
    }

    internal class Serializer :
        BaseSerializer<BetaResponseOutputItem>(BetaResponseOutputItem::class) {

        override fun serialize(
            value: BetaResponseOutputItem,
        ...
        private constructor(
            ...
            interface Visitor<out T> {
                ...
                fun visitInputText(inputText: BetaResponseInputText): T =
                    unknown(JsonValue.from(inputText))
                ...
                /** A text content. */
                fun visitText(text: Text): T = unknown(JsonValue.from(text))
                ...
                fun visitInputFile(inputFile: BetaResponseInputFile): T =
                    unknown(JsonValue.from(inputFile))
                ...
                fun visitEncrypted(encrypted: EncryptedContent): T =
                    unknown(JsonValue.from(encrypted))
    ...
    private constructor(
         ...
         *
         * Unlike [revisedPrompt], this method doesn't throw if the JSON field has an unexpected
         * type.
         */
        @JsonProperty("revised_prompt")
        @ExcludeMissing
        ...
        class Builder internal constructor() {
            ...
            internal fun from(imageGenerationCall: ImageGenerationCall) = apply {
                ...
                action = imageGenerationCall.action
                agent = imageGenerationCall.agent
                background = imageGenerationCall.background
                outputFormat = imageGenerationCall.outputFormat
                quality = imageGenerationCall.quality
                revisedPrompt = imageGenerationCall.revisedPrompt
            ...
            /** The action used for image generation. */
            fun action(action: Action?) = action(JsonField.ofNullable(action))
             ...
             *
             * You should usually call [Builder.revisedPrompt] with a well-typed [String] value
             * instead. This method is primarily for setting the field to an undocumented or not yet
             * supported value.
             */
        ...
        override fun toString() =
            "ImageGenerationCall{id=$id, result=$result, status=$status, type=$type, action=$action, agent=$agent, background=$background, outputFormat=$outputFormat, quality=$quality, revisedPrompt=$revisedPrompt, size=$size, additionalProperties=$additionalProperties}"
    }
