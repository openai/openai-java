...
private constructor(
    ...
    interface Visitor<out T> {
        ...
        /** An output message from the model. */
        fun visitMessage(message: BetaResponseOutputMessage): T
    ...
    private constructor(
        ...
        private constructor(
            ...
            @JsonProperty("agent") @ExcludeMissing agent: JsonField<Agent> = JsonMissing.of(),
            @JsonProperty("status") @ExcludeMissing status: JsonField<Status> = JsonMissing.of(),
        ) : this(id, callId, output, type, agent, status, mutableMapOf())
        ...
        class Builder internal constructor() {
            ...
            internal fun from(localShellCallOutput: LocalShellCallOutput) = apply {
                ...
                callId = localShellCallOutput.callId
        ...
        private val hashCode: Int by lazy {
            Objects.hash(id, callId, output, type, agent, status, additionalProperties)
        }

        override fun hashCode(): Int = hashCode

        override fun toString() =
            "LocalShellCallOutput{id=$id, callId=$callId, output=$output, type=$type, agent=$agent, status=$status, additionalProperties=$additionalProperties}"
    }
