...
private constructor(
    ...
    /** A builder for [BetaResponseFileSearchCallCompletedEvent]. */
    class Builder internal constructor() {
        ...
        internal fun from(
            ...
            itemId = betaResponseFileSearchCallCompletedEvent.itemId
            outputIndex = betaResponseFileSearchCallCompletedEvent.outputIndex
            sequenceNumber = betaResponseFileSearchCallCompletedEvent.sequenceNumber
            type = betaResponseFileSearchCallCompletedEvent.type
            agent = betaResponseFileSearchCallCompletedEvent.agent
            additionalProperties =
                betaResponseFileSearchCallCompletedEvent.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [BetaResponseFileSearchCallCompletedEvent].
         *
         ...
         */
        fun build(): BetaResponseFileSearchCallCompletedEvent =
            BetaResponseFileSearchCallCompletedEvent(
     ...
     *   expected type.
     */
    fun validate(): BetaResponseFileSearchCallCompletedEvent = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is BetaResponseFileSearchCallCompletedEvent &&
            itemId == other.itemId &&
    ...
    override fun toString() =
        "BetaResponseFileSearchCallCompletedEvent{itemId=$itemId, outputIndex=$outputIndex, sequenceNumber=$sequenceNumber, type=$type, agent=$agent, additionalProperties=$additionalProperties}"
}
