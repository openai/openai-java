...
private constructor(
     ...
     * ```java
     * JsonValue.from("agent.session.turn.reasoning_summary_text.done")
     * ```
     *
    ...
    /** A builder for [AgentSessionTurnReasoningSummaryTextDoneEvent]. */
    class Builder internal constructor() {
        ...
        internal fun from(
            ...
            eventId = agentSessionTurnReasoningSummaryTextDoneEvent.eventId
            itemId = agentSessionTurnReasoningSummaryTextDoneEvent.itemId
            outputIndex = agentSessionTurnReasoningSummaryTextDoneEvent.outputIndex
            sessionId = agentSessionTurnReasoningSummaryTextDoneEvent.sessionId
            summaryIndex = agentSessionTurnReasoningSummaryTextDoneEvent.summaryIndex
            text = agentSessionTurnReasoningSummaryTextDoneEvent.text
            turnId = agentSessionTurnReasoningSummaryTextDoneEvent.turnId
            type = agentSessionTurnReasoningSummaryTextDoneEvent.type
            additionalProperties =
                agentSessionTurnReasoningSummaryTextDoneEvent.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [AgentSessionTurnReasoningSummaryTextDoneEvent].
         *
         ...
         */
        fun build(): AgentSessionTurnReasoningSummaryTextDoneEvent =
            AgentSessionTurnReasoningSummaryTextDoneEvent(
     ...
     *   expected type.
     */
    fun validate(): AgentSessionTurnReasoningSummaryTextDoneEvent = apply {
        if (validated) {
            return@apply
        }
        ...
        turnId()
        _type().let {
            if (it != JsonValue.from("agent.session.turn.reasoning_summary_text.done")) {
    ...
    internal fun validity(): Int =
        (if (eventId.asKnown().isPresent) 1 else 0) +
            ...
            type.let {
                if (it == JsonValue.from("agent.session.turn.reasoning_summary_text.done")) 1 else 0
            }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is AgentSessionTurnReasoningSummaryTextDoneEvent &&
    ...
    override fun toString() =
        "AgentSessionTurnReasoningSummaryTextDoneEvent{eventId=$eventId, itemId=$itemId, outputIndex=$outputIndex, sessionId=$sessionId, summaryIndex=$summaryIndex, text=$text, turnId=$turnId, type=$type, additionalProperties=$additionalProperties}"
}
