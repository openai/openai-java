...
private constructor(
    ...
    /** A builder for [BetaResponseFunctionShellToolCall]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(betaResponseFunctionShellToolCall: BetaResponseFunctionShellToolCall) =
            apply {
                id = betaResponseFunctionShellToolCall.id
                action = betaResponseFunctionShellToolCall.action
                callId = betaResponseFunctionShellToolCall.callId
                environment = betaResponseFunctionShellToolCall.environment
                status = betaResponseFunctionShellToolCall.status
                type = betaResponseFunctionShellToolCall.type
                agent = betaResponseFunctionShellToolCall.agent
                caller = betaResponseFunctionShellToolCall.caller
                createdBy = betaResponseFunctionShellToolCall.createdBy
                additionalProperties =
                    betaResponseFunctionShellToolCall.additionalProperties.toMutableMap()
            }
        ...
        fun environment(local: BetaResponseLocalEnvironment) =
            environment(Environment.ofLocal(local))

        /**
         * Alias for calling [environment] with
         * `Environment.ofContainerReference(containerReference)`.
         */
        fun environment(containerReference: BetaResponseContainerReference) =
            environment(Environment.ofContainerReference(containerReference))

        /**
         * Alias for calling [environment] with the following:
         * ```java
         * BetaResponseContainerReference.builder()
         *     .containerId(containerId)
         *     .build()
         * ```
         */
        fun containerReferenceEnvironment(containerId: String) =
            environment(BetaResponseContainerReference.builder().containerId(containerId).build())
         ...
         */
        fun build(): BetaResponseFunctionShellToolCall =
            BetaResponseFunctionShellToolCall(
                checkRequired("id", id),
     ...
     *   expected type.
     */
    fun validate(): BetaResponseFunctionShellToolCall = apply {
        if (validated) {
            return@apply
        }
    ...
    class Environment
    private constructor(
        private val local: BetaResponseLocalEnvironment? = null,
        private val containerReference: BetaResponseContainerReference? = null,
        private val _json: JsonValue? = null,
    ) {

        /** Represents the use of a local environment to perform shell actions. */
        fun local(): Optional<BetaResponseLocalEnvironment> = Optional.ofNullable(local)

        /** Represents a container created with /v1/containers. */
        fun containerReference(): Optional<BetaResponseContainerReference> =
        ...
        /** Represents the use of a local environment to perform shell actions. */
        fun asLocal(): BetaResponseLocalEnvironment = local.getOrThrow("local")

        /** Represents a container created with /v1/containers. */
        fun asContainerReference(): BetaResponseContainerReference =
         ...
         *     @Override
         *     public Optional<String> visitLocal(BetaResponseLocalEnvironment local) {
        ...
        fun validate(): Environment = apply {
            ...
            accept(
                object : Visitor<Unit> {
                    override fun visitLocal(local: BetaResponseLocalEnvironment) {
                        local.validate()
                    }

                    override fun visitContainerReference(
                        containerReference: BetaResponseContainerReference
                    ) {
        ...
        internal fun validity(): Int =
            accept(
                object : Visitor<Int> {
                    override fun visitLocal(local: BetaResponseLocalEnvironment) = local.validity()
        ...
        companion object {
            ...
            /** Represents the use of a local environment to perform shell actions. */
            @JvmStatic fun ofLocal(local: BetaResponseLocalEnvironment) = Environment(local = local)

            /** Represents a container created with /v1/containers. */
            @JvmStatic
            fun ofContainerReference(containerReference: BetaResponseContainerReference) =
        ...
        internal class Deserializer : BaseDeserializer<Environment>(Environment::class) {
            ...
            override fun ObjectCodec.deserialize(node: JsonNode): Environment {
                ...
                when (type) {
                    "local" -> {
                        return tryDeserialize(node, jacksonTypeRef<BetaResponseLocalEnvironment>())
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is BetaResponseFunctionShellToolCall &&
            id == other.id &&
            action == other.action &&
            callId == other.callId &&
    ...
    override fun toString() =
        "BetaResponseFunctionShellToolCall{id=$id, action=$action, callId=$callId, environment=$environment, status=$status, type=$type, agent=$agent, caller=$caller, createdBy=$createdBy, additionalProperties=$additionalProperties}"
}
