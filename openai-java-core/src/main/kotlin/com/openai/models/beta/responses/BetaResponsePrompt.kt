...
private constructor(
    ...
    /** A builder for [BetaResponsePrompt]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(betaResponsePrompt: BetaResponsePrompt) = apply {
            id = betaResponsePrompt.id
            variables = betaResponsePrompt.variables
            version = betaResponsePrompt.version
            additionalProperties = betaResponsePrompt.additionalProperties.toMutableMap()
        }
     ...
     *   expected type.
     */
    fun validate(): BetaResponsePrompt = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is BetaResponsePrompt &&
            id == other.id &&
    ...
    override fun toString() =
        "BetaResponsePrompt{id=$id, variables=$variables, version=$version, additionalProperties=$additionalProperties}"
}
