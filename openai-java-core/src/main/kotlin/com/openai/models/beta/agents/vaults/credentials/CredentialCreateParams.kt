...
private constructor(
     ...
     */
    fun auth(): CredentialAuthCreateParam = body.auth()
     ...
     */
    fun _auth(): JsonField<CredentialAuthCreateParam> = body._auth()
    ...
    class Builder internal constructor() {
         ...
         *
         * You should usually call [Builder.auth] with a well-typed [CredentialAuthCreateParam]
         * value instead. This method is primarily for setting the field to an undocumented or not
         * yet supported value.
         */
        fun auth(auth: JsonField<CredentialAuthCreateParam>) = apply { body.auth(auth) }

        /** Alias for calling [auth] with `CredentialAuthCreateParam.ofMcpOAuth(mcpOauth)`. */
        fun auth(mcpOauth: CredentialAuthCreateParam.McpOAuth) = apply { body.auth(mcpOauth) }

        /**
         * Alias for calling [auth] with `CredentialAuthCreateParam.ofStaticBearer(staticBearer)`.
         */
    ...
    private constructor(
         ...
         *   unexpectedly missing or null (e.g. if the server responded with an unexpected value).
         */
        fun auth(): CredentialAuthCreateParam = auth.getRequired("auth")
        ...
        @JsonProperty("auth")
        @ExcludeMissing
        fun _auth(): JsonField<CredentialAuthCreateParam> = auth
        ...
        class Builder internal constructor() {
             ...
             */
            fun auth(auth: JsonField<CredentialAuthCreateParam>) = apply { this.auth = auth }

            /** Alias for calling [auth] with `CredentialAuthCreateParam.ofMcpOAuth(mcpOauth)`. */
            fun auth(mcpOauth: CredentialAuthCreateParam.McpOAuth) =
                auth(CredentialAuthCreateParam.ofMcpOAuth(mcpOauth))

            /**
             * Alias for calling [auth] with
             * `CredentialAuthCreateParam.ofStaticBearer(staticBearer)`.
             */
    ...
    override fun hashCode(): Int =
        Objects.hash(vaultId, body, additionalHeaders, additionalQueryParams)

    override fun toString() =
        "CredentialCreateParams{vaultId=$vaultId, body=$body, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
