...
private constructor(
    ...
    /** A builder for [BetaResponseReasoningTextDeltaEvent]. */
    class Builder internal constructor() {
        ...
        internal fun from(
            ...
            contentIndex = betaResponseReasoningTextDeltaEvent.contentIndex
            delta = betaResponseReasoningTextDeltaEvent.delta
            itemId = betaResponseReasoningTextDeltaEvent.itemId
            outputIndex = betaResponseReasoningTextDeltaEvent.outputIndex
            sequenceNumber = betaResponseReasoningTextDeltaEvent.sequenceNumber
            type = betaResponseReasoningTextDeltaEvent.type
            agent = betaResponseReasoningTextDeltaEvent.agent
            additionalProperties =
                betaResponseReasoningTextDeltaEvent.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [BetaResponseReasoningTextDeltaEvent].
         *
         ...
         */
        fun build(): BetaResponseReasoningTextDeltaEvent =
            BetaResponseReasoningTextDeltaEvent(
     ...
     *   expected type.
     */
    fun validate(): BetaResponseReasoningTextDeltaEvent = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is BetaResponseReasoningTextDeltaEvent &&
    ...
    override fun toString() =
        "BetaResponseReasoningTextDeltaEvent{contentIndex=$contentIndex, delta=$delta, itemId=$itemId, outputIndex=$outputIndex, sequenceNumber=$sequenceNumber, type=$type, agent=$agent, additionalProperties=$additionalProperties}"
}
