 ...
 */
@JsonDeserialize(using = BetaResponseFormatTextConfig.Deserializer::class)
@JsonSerialize(using = BetaResponseFormatTextConfig.Serializer::class)
class BetaResponseFormatTextConfig
private constructor(
    private val text: JsonValue? = null,
    private val jsonSchema: BetaResponseFormatTextJsonSchemaConfig? = null,
     ...
     * import java.util.Optional;
     *
     * Optional<String> result = betaResponseFormatTextConfig.accept(new BetaResponseFormatTextConfig.Visitor<Optional<String>>() {
     *     @Override
     ...
     *   expected type.
     */
    fun validate(): BetaResponseFormatTextConfig = apply {
        if (validated) {
            return@apply
        }
        ...
        accept(
            object : Visitor<Unit> {
                ...
                override fun visitJsonSchema(jsonSchema: BetaResponseFormatTextJsonSchemaConfig) {
                    jsonSchema.validate()
                }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is BetaResponseFormatTextConfig &&
            text == other.text &&
    ...
    override fun toString(): String =
        when {
            text != null -> "BetaResponseFormatTextConfig{text=$text}"
            jsonSchema != null -> "BetaResponseFormatTextConfig{jsonSchema=$jsonSchema}"
            jsonObject != null -> "BetaResponseFormatTextConfig{jsonObject=$jsonObject}"
            _json != null -> "BetaResponseFormatTextConfig{_unknown=$_json}"
            else -> throw IllegalStateException("Invalid BetaResponseFormatTextConfig")
        }
    ...
    companion object {
        ...
        /** Default response format. Used to generate text responses. */
        @JvmStatic
        fun ofText() = BetaResponseFormatTextConfig(text = JsonValue.from(mapOf("type" to "text")))
        ...
        fun ofJsonSchema(jsonSchema: BetaResponseFormatTextJsonSchemaConfig) =
            BetaResponseFormatTextConfig(jsonSchema = jsonSchema)
        ...
        fun ofJsonObject() =
            BetaResponseFormatTextConfig(
                jsonObject = JsonValue.from(mapOf("type" to "json_object"))
            )
    }

    /**
     * An interface that defines how to map each variant of [BetaResponseFormatTextConfig] to a
     * value of type [T].
     */
    interface Visitor<out T> {
         ...
         *
         * An instance of [BetaResponseFormatTextConfig] can contain an unknown variant if it was
        ...
        fun unknown(json: JsonValue?): T {
            throw OpenAIInvalidDataException("Unknown BetaResponseFormatTextConfig: $json")
        }
    }

    internal class Deserializer :
        BaseDeserializer<BetaResponseFormatTextConfig>(BetaResponseFormatTextConfig::class) {

        override fun ObjectCodec.deserialize(node: JsonNode): BetaResponseFormatTextConfig {
            ...
            when (type) {
                "text" -> {
                    return tryDeserialize(node, jacksonTypeRef<JsonValue>())
                        ?.let { BetaResponseFormatTextConfig(text = it, _json = json) }
                        ?.takeIf { it.isValid() } ?: BetaResponseFormatTextConfig(_json = json)
                }
                "json_schema" -> {
                    return tryDeserialize(
                        ...
                        ?.let { BetaResponseFormatTextConfig(jsonSchema = it, _json = json) }
                        ?: BetaResponseFormatTextConfig(_json = json)
                }
                "json_object" -> {
                    return tryDeserialize(node, jacksonTypeRef<JsonValue>())
                        ?.let { BetaResponseFormatTextConfig(jsonObject = it, _json = json) }
                        ?.takeIf { it.isValid() } ?: BetaResponseFormatTextConfig(_json = json)
                }
            }

            return BetaResponseFormatTextConfig(_json = json)
        }
    }

    internal class Serializer :
        BaseSerializer<BetaResponseFormatTextConfig>(BetaResponseFormatTextConfig::class) {

        override fun serialize(
            value: BetaResponseFormatTextConfig,
