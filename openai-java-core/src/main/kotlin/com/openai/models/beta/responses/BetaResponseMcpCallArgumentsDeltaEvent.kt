...
private constructor(
    ...
    /** A builder for [BetaResponseMcpCallArgumentsDeltaEvent]. */
    class Builder internal constructor() {
        ...
        internal fun from(
            ...
            delta = betaResponseMcpCallArgumentsDeltaEvent.delta
            itemId = betaResponseMcpCallArgumentsDeltaEvent.itemId
            outputIndex = betaResponseMcpCallArgumentsDeltaEvent.outputIndex
            sequenceNumber = betaResponseMcpCallArgumentsDeltaEvent.sequenceNumber
            type = betaResponseMcpCallArgumentsDeltaEvent.type
            agent = betaResponseMcpCallArgumentsDeltaEvent.agent
            additionalProperties =
                betaResponseMcpCallArgumentsDeltaEvent.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [BetaResponseMcpCallArgumentsDeltaEvent].
         *
         ...
         */
        fun build(): BetaResponseMcpCallArgumentsDeltaEvent =
            BetaResponseMcpCallArgumentsDeltaEvent(
     ...
     *   expected type.
     */
    fun validate(): BetaResponseMcpCallArgumentsDeltaEvent = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is BetaResponseMcpCallArgumentsDeltaEvent &&
            delta == other.delta &&
            itemId == other.itemId &&
    ...
    override fun toString() =
        "BetaResponseMcpCallArgumentsDeltaEvent{delta=$delta, itemId=$itemId, outputIndex=$outputIndex, sequenceNumber=$sequenceNumber, type=$type, agent=$agent, additionalProperties=$additionalProperties}"
}
