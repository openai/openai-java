...
private constructor(
    ...
    /** A builder for [BetaResponseOutputRefusal]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(betaResponseOutputRefusal: BetaResponseOutputRefusal) = apply {
            refusal = betaResponseOutputRefusal.refusal
            type = betaResponseOutputRefusal.type
            additionalProperties = betaResponseOutputRefusal.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [BetaResponseOutputRefusal].
         *
         ...
         */
        fun build(): BetaResponseOutputRefusal =
     ...
     *   expected type.
     */
    fun validate(): BetaResponseOutputRefusal = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is BetaResponseOutputRefusal &&
    ...
    override fun toString() =
        "BetaResponseOutputRefusal{refusal=$refusal, type=$type, additionalProperties=$additionalProperties}"
}
