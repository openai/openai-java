...
private constructor(
    ...
    class Builder internal constructor() {
        ...
        internal fun from(fileListParams: FileListParams) = apply {
            environmentId = fileListParams.environmentId
    ...
    override fun toString() =
        "FileListParams{environmentId=$environmentId, limit=$limit, order=$order, page=$page, path=$path, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
