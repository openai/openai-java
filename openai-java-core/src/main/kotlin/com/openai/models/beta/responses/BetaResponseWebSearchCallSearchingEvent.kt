...
private constructor(
    ...
    /** A builder for [BetaResponseWebSearchCallSearchingEvent]. */
    class Builder internal constructor() {
        ...
        internal fun from(
            ...
            itemId = betaResponseWebSearchCallSearchingEvent.itemId
            outputIndex = betaResponseWebSearchCallSearchingEvent.outputIndex
            sequenceNumber = betaResponseWebSearchCallSearchingEvent.sequenceNumber
            type = betaResponseWebSearchCallSearchingEvent.type
            agent = betaResponseWebSearchCallSearchingEvent.agent
            additionalProperties =
                betaResponseWebSearchCallSearchingEvent.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [BetaResponseWebSearchCallSearchingEvent].
         *
         ...
         */
        fun build(): BetaResponseWebSearchCallSearchingEvent =
            BetaResponseWebSearchCallSearchingEvent(
     ...
     *   expected type.
     */
    fun validate(): BetaResponseWebSearchCallSearchingEvent = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is BetaResponseWebSearchCallSearchingEvent &&
            itemId == other.itemId &&
    ...
    override fun toString() =
        "BetaResponseWebSearchCallSearchingEvent{itemId=$itemId, outputIndex=$outputIndex, sequenceNumber=$sequenceNumber, type=$type, agent=$agent, additionalProperties=$additionalProperties}"
}
