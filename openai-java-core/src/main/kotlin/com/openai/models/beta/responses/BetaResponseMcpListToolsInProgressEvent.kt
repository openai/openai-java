...
private constructor(
    ...
    /** A builder for [BetaResponseMcpListToolsInProgressEvent]. */
    class Builder internal constructor() {
        ...
        internal fun from(
            ...
            itemId = betaResponseMcpListToolsInProgressEvent.itemId
            outputIndex = betaResponseMcpListToolsInProgressEvent.outputIndex
            sequenceNumber = betaResponseMcpListToolsInProgressEvent.sequenceNumber
            type = betaResponseMcpListToolsInProgressEvent.type
            agent = betaResponseMcpListToolsInProgressEvent.agent
            additionalProperties =
                betaResponseMcpListToolsInProgressEvent.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [BetaResponseMcpListToolsInProgressEvent].
         *
         ...
         */
        fun build(): BetaResponseMcpListToolsInProgressEvent =
            BetaResponseMcpListToolsInProgressEvent(
     ...
     *   expected type.
     */
    fun validate(): BetaResponseMcpListToolsInProgressEvent = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is BetaResponseMcpListToolsInProgressEvent &&
            itemId == other.itemId &&
    ...
    override fun toString() =
        "BetaResponseMcpListToolsInProgressEvent{itemId=$itemId, outputIndex=$outputIndex, sequenceNumber=$sequenceNumber, type=$type, agent=$agent, additionalProperties=$additionalProperties}"
}
