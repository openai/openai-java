...
private constructor(
    ...
    companion object {
        ...
        /** Returns a mutable builder for constructing an instance of [BetaContainerAuto]. */
        @JvmStatic fun builder() = Builder()
    }

    /** A builder for [BetaContainerAuto]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(betaContainerAuto: BetaContainerAuto) = apply {
            type = betaContainerAuto.type
            fileIds = betaContainerAuto.fileIds.map { it.toMutableList() }
            memoryLimit = betaContainerAuto.memoryLimit
            networkPolicy = betaContainerAuto.networkPolicy
            skills = betaContainerAuto.skills.map { it.toMutableList() }
            additionalProperties = betaContainerAuto.additionalProperties.toMutableMap()
        }
        ...
        fun allowlistNetworkPolicy(allowedDomains: List<String>) =
            networkPolicy(
                BetaContainerNetworkPolicyAllowlist.builder().allowedDomains(allowedDomains).build()
            )
        ...
        fun addSkill(reference: BetaSkillReference) = addSkill(Skill.ofReference(reference))

        /**
         * Alias for calling [addSkill] with the following:
         * ```java
         * BetaSkillReference.builder()
         *     .skillId(skillId)
         *     .build()
         * ```
         */
        fun addReferenceSkill(skillId: String) =
            addSkill(BetaSkillReference.builder().skillId(skillId).build())

        /** Alias for calling [addSkill] with `Skill.ofInline(inline)`. */
        fun addSkill(inline: BetaInlineSkill) = addSkill(Skill.ofInline(inline))
        ...
        /**
         * Returns an immutable instance of [BetaContainerAuto].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): BetaContainerAuto =
            BetaContainerAuto(
                type,
     ...
     *   expected type.
     */
    fun validate(): BetaContainerAuto = apply {
        if (validated) {
            return@apply
        }
    ...
    private constructor(
        ...
        fun disabled(): Optional<BetaContainerNetworkPolicyDisabled> = Optional.ofNullable(disabled)
        ...
        fun asDisabled(): BetaContainerNetworkPolicyDisabled = disabled.getOrThrow("disabled")

        fun asAllowlist(): BetaContainerNetworkPolicyAllowlist = allowlist.getOrThrow("allowlist")
        ...
        fun validate(): NetworkPolicy = apply {
            ...
            accept(
                object : Visitor<Unit> {
                    override fun visitDisabled(disabled: BetaContainerNetworkPolicyDisabled) {
                        disabled.validate()
                    }

                    override fun visitAllowlist(allowlist: BetaContainerNetworkPolicyAllowlist) {
                        allowlist.validate()
                    }
                }
            )
    ...
    class Skill
    private constructor(
        private val reference: BetaSkillReference? = null,
        private val inline: BetaInlineSkill? = null,
        private val _json: JsonValue? = null,
    ) {

        fun reference(): Optional<BetaSkillReference> = Optional.ofNullable(reference)

        fun inline(): Optional<BetaInlineSkill> = Optional.ofNullable(inline)

        fun isReference(): Boolean = reference != null

        fun isInline(): Boolean = inline != null

        fun asReference(): BetaSkillReference = reference.getOrThrow("reference")

        fun asInline(): BetaInlineSkill = inline.getOrThrow("inline")
         ...
         *     @Override
         *     public Optional<String> visitReference(BetaSkillReference reference) {
        ...
        fun validate(): Skill = apply {
            ...
            accept(
                object : Visitor<Unit> {
                    override fun visitReference(reference: BetaSkillReference) {
                        reference.validate()
                    }

                    override fun visitInline(inline: BetaInlineSkill) {
                        inline.validate()
                    }
                }
            )
        ...
        internal fun validity(): Int =
            accept(
                object : Visitor<Int> {
                    ...
                    override fun visitInline(inline: BetaInlineSkill) = inline.validity()
        ...
        companion object {
            ...
            @JvmStatic fun ofReference(reference: BetaSkillReference) = Skill(reference = reference)

            @JvmStatic fun ofInline(inline: BetaInlineSkill) = Skill(inline = inline)
        }
        ...
        internal class Deserializer : BaseDeserializer<Skill>(Skill::class) {
            ...
            override fun ObjectCodec.deserialize(node: JsonNode): Skill {
                ...
                when (type) {
                    "skill_reference" -> {
                        return tryDeserialize(node, jacksonTypeRef<BetaSkillReference>())?.let {
                            Skill(reference = it, _json = json)
                        } ?: Skill(_json = json)
                    }
                    "inline" -> {
                        return tryDeserialize(node, jacksonTypeRef<BetaInlineSkill>())?.let {
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is BetaContainerAuto &&
            type == other.type &&
    ...
    override fun toString() =
        "BetaContainerAuto{type=$type, fileIds=$fileIds, memoryLimit=$memoryLimit, networkPolicy=$networkPolicy, skills=$skills, additionalProperties=$additionalProperties}"
}
