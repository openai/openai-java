...
private constructor(
    ...
    ) : this(type, detail, fileId, imageUrl, promptCacheBreakpoint, mutableMapOf())
    ...
    /** A builder for [BetaResponseInputImageContent]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(betaResponseInputImageContent: BetaResponseInputImageContent) = apply {
            type = betaResponseInputImageContent.type
            detail = betaResponseInputImageContent.detail
            fileId = betaResponseInputImageContent.fileId
            imageUrl = betaResponseInputImageContent.imageUrl
            promptCacheBreakpoint = betaResponseInputImageContent.promptCacheBreakpoint
            additionalProperties = betaResponseInputImageContent.additionalProperties.toMutableMap()
        }
         ...
         */
        fun build(): BetaResponseInputImageContent =
            BetaResponseInputImageContent(
                type,
                detail,
                fileId,
     ...
     *   expected type.
     */
    fun validate(): BetaResponseInputImageContent = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is BetaResponseInputImageContent &&
            type == other.type &&
            detail == other.detail &&
            fileId == other.fileId &&
    ...
    private val hashCode: Int by lazy {
        Objects.hash(type, detail, fileId, imageUrl, promptCacheBreakpoint, additionalProperties)
    }

    override fun hashCode(): Int = hashCode

    override fun toString() =
        "BetaResponseInputImageContent{type=$type, detail=$detail, fileId=$fileId, imageUrl=$imageUrl, promptCacheBreakpoint=$promptCacheBreakpoint, additionalProperties=$additionalProperties}"
}
