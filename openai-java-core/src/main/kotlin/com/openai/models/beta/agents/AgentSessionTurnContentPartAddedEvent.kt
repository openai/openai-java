...
private constructor(
    ...
    private val part: JsonField<OutputText>,
    ...
    private constructor(
        ...
        @JsonProperty("part") @ExcludeMissing part: JsonField<OutputText> = JsonMissing.of(),
     ...
     *   unexpectedly missing or null (e.g. if the server responded with an unexpected value).
     */
    fun part(): OutputText = part.getRequired("part")
     ...
     * ```java
     * JsonValue.from("agent.session.turn.content_part.added")
     * ```
     *
     ...
     */
    @JsonProperty("part") @ExcludeMissing fun _part(): JsonField<OutputText> = part
    ...
    /** A builder for [AgentSessionTurnContentPartAddedEvent]. */
    class Builder internal constructor() {
        ...
        private var part: JsonField<OutputText>? = null
        private var sessionId: JsonField<String>? = null
        private var turnId: JsonField<String>? = null
        private var type: JsonValue = JsonValue.from("agent.session.turn.content_part.added")
        private var additionalProperties: MutableMap<String, JsonValue> = mutableMapOf()

        @JvmSynthetic
        internal fun from(
            agentSessionTurnContentPartAddedEvent: AgentSessionTurnContentPartAddedEvent
        ) = apply {
            contentIndex = agentSessionTurnContentPartAddedEvent.contentIndex
            eventId = agentSessionTurnContentPartAddedEvent.eventId
            itemId = agentSessionTurnContentPartAddedEvent.itemId
            outputIndex = agentSessionTurnContentPartAddedEvent.outputIndex
            part = agentSessionTurnContentPartAddedEvent.part
            sessionId = agentSessionTurnContentPartAddedEvent.sessionId
            turnId = agentSessionTurnContentPartAddedEvent.turnId
            type = agentSessionTurnContentPartAddedEvent.type
            additionalProperties =
                agentSessionTurnContentPartAddedEvent.additionalProperties.toMutableMap()
        }
        ...
        /** The initial content part. */
        fun part(part: OutputText) = part(JsonField.of(part))

        /**
         * Sets [Builder.part] to an arbitrary JSON value.
         *
         * You should usually call [Builder.part] with a well-typed [OutputText] value instead. This
         * method is primarily for setting the field to an undocumented or not yet supported value.
         */
        fun part(part: JsonField<OutputText>) = apply { this.part = part }
        ...
        /**
         * Returns an immutable instance of [AgentSessionTurnContentPartAddedEvent].
         *
         ...
         */
        fun build(): AgentSessionTurnContentPartAddedEvent =
            AgentSessionTurnContentPartAddedEvent(
     ...
     *   expected type.
     */
    fun validate(): AgentSessionTurnContentPartAddedEvent = apply {
        if (validated) {
            return@apply
        }
        ...
        turnId()
        _type().let {
            if (it != JsonValue.from("agent.session.turn.content_part.added")) {
    ...
    internal fun validity(): Int =
        (if (contentIndex.asKnown().isPresent) 1 else 0) +
            ...
            type.let { if (it == JsonValue.from("agent.session.turn.content_part.added")) 1 else 0 }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is AgentSessionTurnContentPartAddedEvent &&
    ...
    override fun toString() =
        "AgentSessionTurnContentPartAddedEvent{contentIndex=$contentIndex, eventId=$eventId, itemId=$itemId, outputIndex=$outputIndex, part=$part, sessionId=$sessionId, turnId=$turnId, type=$type, additionalProperties=$additionalProperties}"
}
