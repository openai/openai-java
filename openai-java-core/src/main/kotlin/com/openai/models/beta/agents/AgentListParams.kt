...
private constructor(
    ...
    class Builder internal constructor() {
        ...
        internal fun from(agentListParams: AgentListParams) = apply {
            after = agentListParams.after
            limit = agentListParams.limit
            order = agentListParams.order
    ...
    override fun toString() =
        "AgentListParams{after=$after, limit=$limit, order=$order, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
