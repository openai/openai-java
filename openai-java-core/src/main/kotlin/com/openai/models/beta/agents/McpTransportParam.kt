...
@JsonDeserialize(using = McpTransportParam.Deserializer::class)
@JsonSerialize(using = McpTransportParam.Serializer::class)
class McpTransportParam
private constructor(
     ...
     * import java.util.Optional;
     *
     * Optional<String> result = mcpTransportParam.accept(new McpTransportParam.Visitor<Optional<String>>() {
     *     @Override
     ...
     *   expected type.
     */
    fun validate(): McpTransportParam = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is McpTransportParam && http == other.http && stdio == other.stdio
    }
    ...
    override fun toString(): String =
        when {
            http != null -> "McpTransportParam{http=$http}"
            stdio != null -> "McpTransportParam{stdio=$stdio}"
            _json != null -> "McpTransportParam{_unknown=$_json}"
            else -> throw IllegalStateException("Invalid McpTransportParam")
        }

    companion object {

        /** Connects to an MCP server over HTTP. */
        @JvmStatic fun ofHttp(http: Http) = McpTransportParam(http = http)

        /** Starts an MCP server as a local process. */
        @JvmStatic fun ofStdio(stdio: Stdio) = McpTransportParam(stdio = stdio)
    }

    /**
     * An interface that defines how to map each variant of [McpTransportParam] to a value of type
     * [T].
     */
    interface Visitor<out T> {

        /** Connects to an MCP server over HTTP. */
        fun visitHttp(http: Http): T = unknown(JsonValue.from(http))

        /** Starts an MCP server as a local process. */
        fun visitStdio(stdio: Stdio): T = unknown(JsonValue.from(stdio))

        /**
         * Maps an unknown variant of [McpTransportParam] to a value of type [T].
         *
         * An instance of [McpTransportParam] can contain an unknown variant if it was deserialized
        ...
        fun unknown(json: JsonValue?): T {
            throw OpenAIInvalidDataException("Unknown McpTransportParam: $json")
        }
    }

    internal class Deserializer : BaseDeserializer<McpTransportParam>(McpTransportParam::class) {

        override fun ObjectCodec.deserialize(node: JsonNode): McpTransportParam {
            ...
            when (type) {
                "http" -> {
                    return tryDeserialize(node, jacksonTypeRef<Http>())?.let {
                        McpTransportParam(http = it, _json = json)
                    } ?: McpTransportParam(_json = json)
                }
                "stdio" -> {
                    return tryDeserialize(node, jacksonTypeRef<Stdio>())?.let {
                        McpTransportParam(stdio = it, _json = json)
                    } ?: McpTransportParam(_json = json)
                }
            }

            return McpTransportParam(_json = json)
        }
    }

    internal class Serializer : BaseSerializer<McpTransportParam>(McpTransportParam::class) {

        override fun serialize(
            value: McpTransportParam,
    ...
    private constructor(
        ...
        ) : this(serverUrl, type, authorization, headers, mutableMapOf())
        ...
        class Builder internal constructor() {
            ...
            /** Alias for calling [Builder.authorization] with `authorization.orElse(null)`. */
            fun authorization(authorization: Optional<String>) =
                authorization(authorization.getOrNull())
        ...
        private val hashCode: Int by lazy {
            Objects.hash(serverUrl, type, authorization, headers, additionalProperties)
        }

        override fun hashCode(): Int = hashCode

        override fun toString() =
            "Http{serverUrl=$serverUrl, type=$type, authorization=$authorization, headers=$headers, additionalProperties=$additionalProperties}"
    }
    ...
    private constructor(
        ...
        ) : this(command, cwd, type, args, env, envVars, mutableMapOf())
        ...
        private val hashCode: Int by lazy {
            Objects.hash(command, cwd, type, args, env, envVars, additionalProperties)
        }

        override fun hashCode(): Int = hashCode

        override fun toString() =
            "Stdio{command=$command, cwd=$cwd, type=$type, args=$args, env=$env, envVars=$envVars, additionalProperties=$additionalProperties}"
    }
}
