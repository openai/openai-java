...
private constructor(
     ...
     *   server responded with an unexpected value).
     */
    fun truncationStrategy(): Optional<TruncationObject> = body.truncationStrategy()
     ...
     * type.
     */
    fun _truncationStrategy(): JsonField<TruncationObject> = body._truncationStrategy()
    ...
    class Builder internal constructor() {
         ...
         */
        fun truncationStrategy(truncationStrategy: TruncationObject?) = apply {
         ...
         */
        fun truncationStrategy(truncationStrategy: Optional<TruncationObject>) =
            truncationStrategy(truncationStrategy.getOrNull())

        /**
         * Sets [Builder.truncationStrategy] to an arbitrary JSON value.
         *
         * You should usually call [Builder.truncationStrategy] with a well-typed [TruncationObject]
         * value instead. This method is primarily for setting the field to an undocumented or not
         * yet supported value.
         */
        fun truncationStrategy(truncationStrategy: JsonField<TruncationObject>) = apply {
            body.truncationStrategy(truncationStrategy)
        }
    ...
    private constructor(
        ...
        private val truncationStrategy: JsonField<TruncationObject>,
        ...
        private constructor(
            ...
            @ExcludeMissing
            truncationStrategy: JsonField<TruncationObject> = JsonMissing.of(),
        ) : this(
            assistantId,
            additionalInstructions,
            additionalMessages,
         ...
         *   server responded with an unexpected value).
         */
        fun truncationStrategy(): Optional<TruncationObject> =
        ...
        @JsonProperty("truncation_strategy")
        @ExcludeMissing
        fun _truncationStrategy(): JsonField<TruncationObject> = truncationStrategy
        ...
        class Builder internal constructor() {
            ...
            private var truncationStrategy: JsonField<TruncationObject> = JsonMissing.of()
             ...
             * intial context window of the run.
             */
            fun truncationStrategy(truncationStrategy: TruncationObject?) =
             ...
             * [TruncationObject] value instead. This method is primarily for setting the field to
