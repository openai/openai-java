...
private constructor(
     ...
     * import java.util.Optional;
     *
     * Optional<String> result = messageContent.accept(new MessageContent.Visitor<Optional<String>>() {
     *     @Override
    ...
    override fun hashCode(): Int = Objects.hash(imageFile, imageUrl, text, refusal)
    ...
    interface Visitor<out T> {
        ...
        /** The text content that is part of a message. */
        fun visitText(text: TextContentBlock): T = unknown(JsonValue.from(text))

        /** The refusal content generated by the assistant. */
        fun visitRefusal(refusal: RefusalContentBlock): T = unknown(JsonValue.from(refusal))
