 ...
 */
@JsonDeserialize(using = BetaResponseSteerRequiredInput.Deserializer::class)
@JsonSerialize(using = BetaResponseSteerRequiredInput.Serializer::class)
class BetaResponseSteerRequiredInput
private constructor(
     ...
     * import java.util.Optional;
     *
     * Optional<String> result = betaResponseSteerRequiredInput.accept(new BetaResponseSteerRequiredInput.Visitor<Optional<String>>() {
     *     @Override
     ...
     *   expected type.
     */
    fun validate(): BetaResponseSteerRequiredInput = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is BetaResponseSteerRequiredInput &&
    ...
    override fun toString(): String =
        when {
            functionCallOutput != null ->
                "BetaResponseSteerRequiredInput{functionCallOutput=$functionCallOutput}"
            customToolCallOutput != null ->
                "BetaResponseSteerRequiredInput{customToolCallOutput=$customToolCallOutput}"
            computerCallOutput != null ->
                "BetaResponseSteerRequiredInput{computerCallOutput=$computerCallOutput}"
            shellCallOutput != null ->
                "BetaResponseSteerRequiredInput{shellCallOutput=$shellCallOutput}"
            applyPatchCallOutput != null ->
                "BetaResponseSteerRequiredInput{applyPatchCallOutput=$applyPatchCallOutput}"
            toolSearchOutput != null ->
                "BetaResponseSteerRequiredInput{toolSearchOutput=$toolSearchOutput}"
            mcpApprovalResponse != null ->
                "BetaResponseSteerRequiredInput{mcpApprovalResponse=$mcpApprovalResponse}"
            _json != null -> "BetaResponseSteerRequiredInput{_unknown=$_json}"
            else -> throw IllegalStateException("Invalid BetaResponseSteerRequiredInput")
        }
    ...
    /**
     * An interface that defines how to map each variant of [BetaResponseSteerRequiredInput] to a
     * value of type [T].
     */
    interface Visitor<out T> {
        ...
        /**
         * Maps an unknown variant of [BetaResponseSteerRequiredInput] to a value of type [T].
         *
         * An instance of [BetaResponseSteerRequiredInput] can contain an unknown variant if it was
        ...
        fun unknown(json: JsonValue?): T {
            throw OpenAIInvalidDataException("Unknown BetaResponseSteerRequiredInput: $json")
        }
    }

    internal class Deserializer :
        BaseDeserializer<BetaResponseSteerRequiredInput>(BetaResponseSteerRequiredInput::class) {

        override fun ObjectCodec.deserialize(node: JsonNode): BetaResponseSteerRequiredInput {
            ...
            when (type) {
                "function_call_output" -> {
                    return tryDeserialize(node, jacksonTypeRef<FunctionCallOutput>())?.let {
                        BetaResponseSteerRequiredInput(functionCallOutput = it, _json = json)
                    } ?: BetaResponseSteerRequiredInput(_json = json)
                }
                "custom_tool_call_output" -> {
                    return tryDeserialize(node, jacksonTypeRef<CustomToolCallOutput>())?.let {
                        BetaResponseSteerRequiredInput(customToolCallOutput = it, _json = json)
                    } ?: BetaResponseSteerRequiredInput(_json = json)
                }
                "computer_call_output" -> {
                    return tryDeserialize(node, jacksonTypeRef<ComputerCallOutput>())?.let {
                        BetaResponseSteerRequiredInput(computerCallOutput = it, _json = json)
                    } ?: BetaResponseSteerRequiredInput(_json = json)
                }
                "shell_call_output" -> {
                    return tryDeserialize(node, jacksonTypeRef<ShellCallOutput>())?.let {
                        BetaResponseSteerRequiredInput(shellCallOutput = it, _json = json)
                    } ?: BetaResponseSteerRequiredInput(_json = json)
                }
                "apply_patch_call_output" -> {
                    return tryDeserialize(node, jacksonTypeRef<ApplyPatchCallOutput>())?.let {
                        BetaResponseSteerRequiredInput(applyPatchCallOutput = it, _json = json)
                    } ?: BetaResponseSteerRequiredInput(_json = json)
                }
                "tool_search_output" -> {
                    return tryDeserialize(node, jacksonTypeRef<ToolSearchOutput>())?.let {
                        BetaResponseSteerRequiredInput(toolSearchOutput = it, _json = json)
                    } ?: BetaResponseSteerRequiredInput(_json = json)
                }
                "mcp_approval_response" -> {
                    return tryDeserialize(node, jacksonTypeRef<McpApprovalResponse>())?.let {
                        BetaResponseSteerRequiredInput(mcpApprovalResponse = it, _json = json)
                    } ?: BetaResponseSteerRequiredInput(_json = json)
                }
            }

            return BetaResponseSteerRequiredInput(_json = json)
        }
    }

    internal class Serializer :
        BaseSerializer<BetaResponseSteerRequiredInput>(BetaResponseSteerRequiredInput::class) {

        override fun serialize(
            value: BetaResponseSteerRequiredInput,
