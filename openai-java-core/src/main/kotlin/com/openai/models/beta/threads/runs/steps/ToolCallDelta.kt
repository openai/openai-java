...
private constructor(
     ...
     * import java.util.Optional;
     *
     * Optional<String> result = toolCallDelta.accept(new ToolCallDelta.Visitor<Optional<String>>() {
     *     @Override
     *     public Optional<String> visitCodeInterpreter(CodeInterpreterToolCallDelta codeInterpreter) {
    ...
    interface Visitor<out T> {
        ...
        fun visitFunction(function: FunctionToolCallDelta): T = unknown(JsonValue.from(function))
