...
private constructor(
     ...
     * ```java
     * JsonValue.from("agent.session.turn.created")
     * ```
     *
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [AgentSessionTurnCreatedEvent].
         *
    ...
    /** A builder for [AgentSessionTurnCreatedEvent]. */
    class Builder internal constructor() {
        ...
        private var type: JsonValue = JsonValue.from("agent.session.turn.created")
        private var additionalProperties: MutableMap<String, JsonValue> = mutableMapOf()

        @JvmSynthetic
        internal fun from(agentSessionTurnCreatedEvent: AgentSessionTurnCreatedEvent) = apply {
            eventId = agentSessionTurnCreatedEvent.eventId
            sessionId = agentSessionTurnCreatedEvent.sessionId
            turn = agentSessionTurnCreatedEvent.turn
            turnId = agentSessionTurnCreatedEvent.turnId
            type = agentSessionTurnCreatedEvent.type
            additionalProperties = agentSessionTurnCreatedEvent.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [AgentSessionTurnCreatedEvent].
         *
         ...
         */
        fun build(): AgentSessionTurnCreatedEvent =
     ...
     *   expected type.
     */
    fun validate(): AgentSessionTurnCreatedEvent = apply {
        if (validated) {
            return@apply
        }
        ...
        turnId()
        _type().let {
            if (it != JsonValue.from("agent.session.turn.created")) {
    ...
    internal fun validity(): Int =
        (if (eventId.asKnown().isPresent) 1 else 0) +
            ...
            type.let { if (it == JsonValue.from("agent.session.turn.created")) 1 else 0 }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is AgentSessionTurnCreatedEvent &&
    ...
    override fun toString() =
        "AgentSessionTurnCreatedEvent{eventId=$eventId, sessionId=$sessionId, turn=$turn, turnId=$turnId, type=$type, additionalProperties=$additionalProperties}"
}
