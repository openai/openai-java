...
private constructor(
    ...
    /** A builder for [BetaResponseContentPartAddedEvent]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(betaResponseContentPartAddedEvent: BetaResponseContentPartAddedEvent) =
            apply {
                contentIndex = betaResponseContentPartAddedEvent.contentIndex
                itemId = betaResponseContentPartAddedEvent.itemId
                outputIndex = betaResponseContentPartAddedEvent.outputIndex
                part = betaResponseContentPartAddedEvent.part
                sequenceNumber = betaResponseContentPartAddedEvent.sequenceNumber
                type = betaResponseContentPartAddedEvent.type
                agent = betaResponseContentPartAddedEvent.agent
                additionalProperties =
                    betaResponseContentPartAddedEvent.additionalProperties.toMutableMap()
            }
        ...
        /**
         * Returns an immutable instance of [BetaResponseContentPartAddedEvent].
         *
         ...
         */
        fun build(): BetaResponseContentPartAddedEvent =
            BetaResponseContentPartAddedEvent(
     ...
     *   expected type.
     */
    fun validate(): BetaResponseContentPartAddedEvent = apply {
        if (validated) {
            return@apply
        }
    ...
    private constructor(
        ...
        interface Visitor<out T> {
            ...
            fun unknown(json: JsonValue?): T {
                throw OpenAIInvalidDataException("Unknown Part")
            }
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is BetaResponseContentPartAddedEvent &&
    ...
    override fun toString() =
        "BetaResponseContentPartAddedEvent{contentIndex=$contentIndex, itemId=$itemId, outputIndex=$outputIndex, part=$part, sequenceNumber=$sequenceNumber, type=$type, agent=$agent, additionalProperties=$additionalProperties}"
}
