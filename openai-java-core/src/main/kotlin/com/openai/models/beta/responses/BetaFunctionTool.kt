...
private constructor(
    ...
    override fun toString() =
        "BetaFunctionTool{name=$name, parameters=$parameters, strict=$strict, type=$type, allowedCallers=$allowedCallers, async=$async, deferLoading=$deferLoading, description=$description, outputSchema=$outputSchema, additionalProperties=$additionalProperties}"
}
