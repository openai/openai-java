...
private constructor(
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return /* spotless:off */ other is ContainerCreateResponse && id == other.id && createdAt == other.createdAt && name == other.name && object_ == other.object_ && status == other.status && expiresAfter == other.expiresAfter && additionalProperties == other.additionalProperties /* spotless:on */
    }
