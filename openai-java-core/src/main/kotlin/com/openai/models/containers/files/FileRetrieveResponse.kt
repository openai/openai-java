...
private constructor(
    ...
    class Builder internal constructor() {
        ...
        internal fun from(fileRetrieveResponse: FileRetrieveResponse) = apply {
            ...
            bytes = fileRetrieveResponse.bytes
            containerId = fileRetrieveResponse.containerId
            createdAt = fileRetrieveResponse.createdAt
            object_ = fileRetrieveResponse.object_
            path = fileRetrieveResponse.path
            source = fileRetrieveResponse.source
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return /* spotless:off */ other is FileRetrieveResponse && id == other.id && bytes == other.bytes && containerId == other.containerId && createdAt == other.createdAt && object_ == other.object_ && path == other.path && source == other.source && additionalProperties == other.additionalProperties /* spotless:on */
    }
    ...
    override fun toString() =
        "FileRetrieveResponse{id=$id, bytes=$bytes, containerId=$containerId, createdAt=$createdAt, object_=$object_, path=$path, source=$source, additionalProperties=$additionalProperties}"
}
