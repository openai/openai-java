...
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [ContainerRetrieveResponse].
         *
    ...
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(containerRetrieveResponse: ContainerRetrieveResponse) = apply {
            id = containerRetrieveResponse.id
            createdAt = containerRetrieveResponse.createdAt
            name = containerRetrieveResponse.name
         ...
         */
        fun build(): ContainerRetrieveResponse =
    ...
    fun validate(): ContainerRetrieveResponse = apply {
        if (validated) {
            return@apply
        }
