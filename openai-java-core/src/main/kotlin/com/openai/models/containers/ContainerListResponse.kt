...
private constructor(
    ...
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(containerListResponse: ContainerListResponse) = apply {
            id = containerListResponse.id
            createdAt = containerListResponse.createdAt
            name = containerListResponse.name
         ...
         */
        fun build(): ContainerListResponse =
    ...
    fun validate(): ContainerListResponse = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return /* spotless:off */ other is ContainerListResponse && id == other.id && createdAt == other.createdAt && name == other.name && object_ == other.object_ && status == other.status && expiresAfter == other.expiresAfter && additionalProperties == other.additionalProperties /* spotless:on */
    }
