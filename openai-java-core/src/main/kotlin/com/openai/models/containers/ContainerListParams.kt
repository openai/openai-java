...
private constructor(
    ...
    companion object {
        ...
        @JvmStatic fun none(): ContainerListParams = builder().build()

        /** Returns a mutable builder for constructing an instance of [ContainerListParams]. */
    ...
    class Builder internal constructor() {
        ...
        /**
         * Returns an immutable instance of [ContainerListParams].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): ContainerListParams =
            ContainerListParams(
                after,
                limit,
                order,
