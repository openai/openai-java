...
private constructor(
    ...
    class Builder internal constructor() {
        ...
        internal fun from(fileListResponse: FileListResponse) = apply {
            ...
            bytes = fileListResponse.bytes
            containerId = fileListResponse.containerId
            createdAt = fileListResponse.createdAt
            object_ = fileListResponse.object_
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return /* spotless:off */ other is FileListResponse && id == other.id && bytes == other.bytes && containerId == other.containerId && createdAt == other.createdAt && object_ == other.object_ && path == other.path && source == other.source && additionalProperties == other.additionalProperties /* spotless:on */
    }
    ...
    override fun toString() =
        "FileListResponse{id=$id, bytes=$bytes, containerId=$containerId, createdAt=$createdAt, object_=$object_, path=$path, source=$source, additionalProperties=$additionalProperties}"
}
