...
private constructor(
    ...
    ) : this(code, message, param, type, misalignment, mutableMapOf())
    ...
    private val hashCode: Int by lazy {
        Objects.hash(code, message, param, type, misalignment, additionalProperties)
    }

    override fun hashCode(): Int = hashCode

    override fun toString() =
        "ErrorObject{code=$code, message=$message, param=$param, type=$type, misalignment=$misalignment, additionalProperties=$additionalProperties}"
}
