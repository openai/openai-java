...
private constructor(
    ...
    fun validate(): RealtimeToolsConfigUnion = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is RealtimeToolsConfigUnion && function == other.function && mcp == other.mcp
    }

    override fun hashCode(): Int = Objects.hash(function, mcp)

    override fun toString(): String =
        when {
            function != null -> "RealtimeToolsConfigUnion{function=$function}"
            mcp != null -> "RealtimeToolsConfigUnion{mcp=$mcp}"
            _json != null -> "RealtimeToolsConfigUnion{_unknown=$_json}"
            else -> throw IllegalStateException("Invalid RealtimeToolsConfigUnion")
        }

    companion object {

        @JvmStatic
        fun ofFunction(function: Function) = RealtimeToolsConfigUnion(function = function)
    ...
    /**
     * An interface that defines how to map each variant of [RealtimeToolsConfigUnion] to a value of
     * type [T].
     */
    interface Visitor<out T> {
         ...
         *
         * An instance of [RealtimeToolsConfigUnion] can contain an unknown variant if it was
    ...
    internal class Deserializer :
        BaseDeserializer<RealtimeToolsConfigUnion>(RealtimeToolsConfigUnion::class) {

        override fun ObjectCodec.deserialize(node: JsonNode): RealtimeToolsConfigUnion {
            ...
            when (type) {
                ...
                "mcp" -> {
                    return tryDeserialize(node, jacksonTypeRef<Mcp>())?.let {
                        RealtimeToolsConfigUnion(mcp = it, _json = json)
                    } ?: RealtimeToolsConfigUnion(_json = json)
                }
            }

            return RealtimeToolsConfigUnion(_json = json)
        }
    }

    internal class Serializer :
        BaseSerializer<RealtimeToolsConfigUnion>(RealtimeToolsConfigUnion::class) {

        override fun serialize(
            value: RealtimeToolsConfigUnion,
    ...
    private constructor(
        ...
        class Builder internal constructor() {
             ...
             */
            fun build(): Function =
                Function(description, name, parameters, type, additionalProperties.toMutableMap())
        }
        ...
        override fun toString() =
            "Function{description=$description, name=$name, parameters=$parameters, type=$type, additionalProperties=$additionalProperties}"
    }
