...
private constructor(
     ...
     * import java.util.Optional;
     *
     * Optional<String> result = realtimeAudioFormats.accept(new RealtimeAudioFormats.Visitor<Optional<String>>() {
     *     @Override
    ...
    interface Visitor<out T> {
        ...
        fun unknown(json: JsonValue?): T {
            throw OpenAIInvalidDataException("Unknown RealtimeAudioFormats")
        }
    }
