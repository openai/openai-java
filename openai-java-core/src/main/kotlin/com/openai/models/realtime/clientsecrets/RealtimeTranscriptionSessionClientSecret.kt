...
private constructor(
    ...
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(
            realtimeTranscriptionSessionClientSecret: RealtimeTranscriptionSessionClientSecret
        ) = apply {
            expiresAt = realtimeTranscriptionSessionClientSecret.expiresAt
            value = realtimeTranscriptionSessionClientSecret.value
            additionalProperties =
                realtimeTranscriptionSessionClientSecret.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [RealtimeTranscriptionSessionClientSecret].
         *
         ...
         */
        fun build(): RealtimeTranscriptionSessionClientSecret =
            RealtimeTranscriptionSessionClientSecret(
    ...
    fun validate(): RealtimeTranscriptionSessionClientSecret = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is RealtimeTranscriptionSessionClientSecret &&
    ...
    override fun toString() =
        "RealtimeTranscriptionSessionClientSecret{expiresAt=$expiresAt, value=$value, additionalProperties=$additionalProperties}"
}
