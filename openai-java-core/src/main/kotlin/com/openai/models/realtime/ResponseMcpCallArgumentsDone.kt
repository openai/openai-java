...
private constructor(
    ...
    ) : this(arguments, eventId, itemId, outputIndex, responseId, type, mutableMapOf())
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [ResponseMcpCallArgumentsDone].
         *
    ...
    class Builder internal constructor() {
        ...
        internal fun from(responseMcpCallArgumentsDone: ResponseMcpCallArgumentsDone) = apply {
            ...
            eventId = responseMcpCallArgumentsDone.eventId
            itemId = responseMcpCallArgumentsDone.itemId
            outputIndex = responseMcpCallArgumentsDone.outputIndex
            responseId = responseMcpCallArgumentsDone.responseId
            type = responseMcpCallArgumentsDone.type
            additionalProperties = responseMcpCallArgumentsDone.additionalProperties.toMutableMap()
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is ResponseMcpCallArgumentsDone &&
    ...
    override fun toString() =
        "ResponseMcpCallArgumentsDone{arguments=$arguments, eventId=$eventId, itemId=$itemId, outputIndex=$outputIndex, responseId=$responseId, type=$type, additionalProperties=$additionalProperties}"
}
