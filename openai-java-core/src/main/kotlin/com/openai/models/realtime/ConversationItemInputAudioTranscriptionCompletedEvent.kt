...
private constructor(
    ...
    private constructor(
         ...
         *     @Override
         *     public Optional<String> visitTranscriptTextUsageTokens(TranscriptTextUsageTokens transcriptTextUsageTokens) {
         *         return Optional.of(transcriptTextUsageTokens.toString());
         *     }
         *
         *     // ...
         *
        ...
        override fun hashCode(): Int =
            Objects.hash(transcriptTextUsageTokens, transcriptTextUsageDuration)
        ...
        interface Visitor<out T> {
            ...
            fun visitTranscriptTextUsageTokens(
                transcriptTextUsageTokens: TranscriptTextUsageTokens
            ): T = unknown(JsonValue.from(transcriptTextUsageTokens))

            /** Usage statistics for models billed by audio input duration. */
            fun visitTranscriptTextUsageDuration(
                transcriptTextUsageDuration: TranscriptTextUsageDuration
            ): T = unknown(JsonValue.from(transcriptTextUsageDuration))
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is ConversationItemInputAudioTranscriptionCompletedEvent &&
