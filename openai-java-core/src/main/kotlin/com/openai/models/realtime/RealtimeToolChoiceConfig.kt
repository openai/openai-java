...
private constructor(
     ...
     * import java.util.Optional;
     *
     * Optional<String> result = realtimeToolChoiceConfig.accept(new RealtimeToolChoiceConfig.Visitor<Optional<String>>() {
     *     @Override
     *     public Optional<String> visitToolChoiceOptions(ToolChoiceOptions toolChoiceOptions) {
     *         return Optional.of(toolChoiceOptions.toString());
     *     }
     *
     *     // ...
     *
    ...
    interface Visitor<out T> {
        ...
        fun unknown(json: JsonValue?): T {
            throw OpenAIInvalidDataException("Unknown RealtimeToolChoiceConfig")
        }
    }
