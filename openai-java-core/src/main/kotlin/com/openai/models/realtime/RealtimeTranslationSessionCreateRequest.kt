...
private constructor(
    ...
    /** A builder for [RealtimeTranslationSessionCreateRequest]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(
            realtimeTranslationSessionCreateRequest: RealtimeTranslationSessionCreateRequest
        ) = apply {
            model = realtimeTranslationSessionCreateRequest.model
            audio = realtimeTranslationSessionCreateRequest.audio
            additionalProperties =
                realtimeTranslationSessionCreateRequest.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [RealtimeTranslationSessionCreateRequest].
         *
         ...
         */
        fun build(): RealtimeTranslationSessionCreateRequest =
            RealtimeTranslationSessionCreateRequest(
     ...
     *   expected type.
     */
    fun validate(): RealtimeTranslationSessionCreateRequest = apply {
        if (validated) {
            return@apply
        }
    ...
    internal fun validity(): Int =
        (if (model.asKnown().isPresent) 1 else 0) + (audio.asKnown().getOrNull()?.validity() ?: 0)
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is RealtimeTranslationSessionCreateRequest &&
            model == other.model &&
            audio == other.audio &&
            additionalProperties == other.additionalProperties
    }

    private val hashCode: Int by lazy { Objects.hash(model, audio, additionalProperties) }

    override fun hashCode(): Int = hashCode

    override fun toString() =
        "RealtimeTranslationSessionCreateRequest{model=$model, audio=$audio, additionalProperties=$additionalProperties}"
}
