...
private constructor(
    ...
    override fun toString(): String =
        when {
            serverVad != null ->
                "RealtimeTranscriptionSessionAudioInputTurnDetection{serverVad=$serverVad}"
            semanticVad != null ->
                "RealtimeTranscriptionSessionAudioInputTurnDetection{semanticVad=$semanticVad}"
            _json != null -> "RealtimeTranscriptionSessionAudioInputTurnDetection{_unknown=$_json}"
            else ->
                throw IllegalStateException(
                    "Invalid RealtimeTranscriptionSessionAudioInputTurnDetection"
                )
        }
     ...
     * [RealtimeTranscriptionSessionAudioInputTurnDetection] to a value of type [T].
     */
    interface Visitor<out T> {
        ...
        /**
         * Maps an unknown variant of [RealtimeTranscriptionSessionAudioInputTurnDetection] to a
         * value of type [T].
         *
         * An instance of [RealtimeTranscriptionSessionAudioInputTurnDetection] can contain an
    ...
    internal class Deserializer :
        BaseDeserializer<RealtimeTranscriptionSessionAudioInputTurnDetection>(
            RealtimeTranscriptionSessionAudioInputTurnDetection::class
        ) {
        ...
        override fun ObjectCodec.deserialize(
            ...
            when (type) {
                "server_vad" -> {
                    ...
                    } ?: RealtimeTranscriptionSessionAudioInputTurnDetection(_json = json)
                }
                "semantic_vad" -> {
            ...
            return RealtimeTranscriptionSessionAudioInputTurnDetection(_json = json)
        }
    }

    internal class Serializer :
        BaseSerializer<RealtimeTranscriptionSessionAudioInputTurnDetection>(
            RealtimeTranscriptionSessionAudioInputTurnDetection::class
        ) {

        override fun serialize(
            value: RealtimeTranscriptionSessionAudioInputTurnDetection,
