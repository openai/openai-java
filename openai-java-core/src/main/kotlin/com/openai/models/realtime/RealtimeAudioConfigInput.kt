...
private constructor(
    ...
    private val turnDetection: JsonField<RealtimeAudioInputTurnDetection>,
    ...
    private constructor(
        ...
        @ExcludeMissing
        turnDetection: JsonField<RealtimeAudioInputTurnDetection> = JsonMissing.of(),
     ...
     *   server responded with an unexpected value).
     */
    fun turnDetection(): Optional<RealtimeAudioInputTurnDetection> =
    ...
    @JsonProperty("turn_detection")
    @ExcludeMissing
    fun _turnDetection(): JsonField<RealtimeAudioInputTurnDetection> = turnDetection
    ...
    companion object {
        ...
        /** Returns a mutable builder for constructing an instance of [RealtimeAudioConfigInput]. */
    ...
    class Builder internal constructor() {
        ...
        private var turnDetection: JsonField<RealtimeAudioInputTurnDetection> = JsonMissing.of()
        private var additionalProperties: MutableMap<String, JsonValue> = mutableMapOf()

        @JvmSynthetic
        internal fun from(realtimeAudioConfigInput: RealtimeAudioConfigInput) = apply {
            format = realtimeAudioConfigInput.format
            noiseReduction = realtimeAudioConfigInput.noiseReduction
            transcription = realtimeAudioConfigInput.transcription
            turnDetection = realtimeAudioConfigInput.turnDetection
            additionalProperties = realtimeAudioConfigInput.additionalProperties.toMutableMap()
        }
         ...
         * [RealtimeAudioInputTurnDetection] value instead. This method is primarily for setting the
         * field to an undocumented or not yet supported value.
         */
        fun turnDetection(turnDetection: JsonField<RealtimeAudioInputTurnDetection>) = apply {
         ...
         */
        fun build(): RealtimeAudioConfigInput =
    ...
    fun validate(): RealtimeAudioConfigInput = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is RealtimeAudioConfigInput &&
            format == other.format &&
    ...
    override fun toString() =
        "RealtimeAudioConfigInput{format=$format, noiseReduction=$noiseReduction, transcription=$transcription, turnDetection=$turnDetection, additionalProperties=$additionalProperties}"
}
