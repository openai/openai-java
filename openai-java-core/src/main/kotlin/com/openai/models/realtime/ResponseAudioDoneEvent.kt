...
private constructor(
     ...
     * ```java
     * JsonValue.from("response.output_audio.done")
     * ```
     *
    ...
    class Builder internal constructor() {
        ...
        private var type: JsonValue = JsonValue.from("response.output_audio.done")
    ...
    fun validate(): ResponseAudioDoneEvent = apply {
        ...
        responseId()
        _type().let {
            if (it != JsonValue.from("response.output_audio.done")) {
    ...
    internal fun validity(): Int =
        (if (contentIndex.asKnown().isPresent) 1 else 0) +
            ...
            type.let { if (it == JsonValue.from("response.output_audio.done")) 1 else 0 }
