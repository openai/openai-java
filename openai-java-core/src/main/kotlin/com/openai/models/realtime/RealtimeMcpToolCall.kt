...
private constructor(
    ...
    private constructor(
         ...
         *     @Override
         *     public Optional<String> visitProtocol(RealtimeMcpProtocolError protocol) {
