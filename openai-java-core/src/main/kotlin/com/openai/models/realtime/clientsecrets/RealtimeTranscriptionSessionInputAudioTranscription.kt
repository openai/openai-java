...
class RealtimeTranscriptionSessionInputAudioTranscription
private constructor(
    ...
    /** A builder for [RealtimeTranscriptionSessionInputAudioTranscription]. */
    class Builder internal constructor() {
        ...
        internal fun from(
            ...
            language = realtimeTranscriptionSessionInputAudioTranscription.language
            model = realtimeTranscriptionSessionInputAudioTranscription.model
            prompt = realtimeTranscriptionSessionInputAudioTranscription.prompt
            additionalProperties =
                realtimeTranscriptionSessionInputAudioTranscription.additionalProperties
                    .toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [RealtimeTranscriptionSessionInputAudioTranscription].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): RealtimeTranscriptionSessionInputAudioTranscription =
            RealtimeTranscriptionSessionInputAudioTranscription(
                language,
                model,
                prompt,
    ...
    fun validate(): RealtimeTranscriptionSessionInputAudioTranscription = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is RealtimeTranscriptionSessionInputAudioTranscription &&
    ...
    override fun toString() =
        "RealtimeTranscriptionSessionInputAudioTranscription{language=$language, model=$model, prompt=$prompt, additionalProperties=$additionalProperties}"
}
