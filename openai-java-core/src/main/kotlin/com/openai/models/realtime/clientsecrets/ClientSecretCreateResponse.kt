...
private constructor(
    ...
    private constructor(
        ...
        private constructor(
            ...
            @JsonProperty("include")
            @ExcludeMissing
            fun _include(): JsonField<List<Include>> = include
            ...
            class Builder internal constructor() {
                ...
                internal fun from(
                    ...
                    include =
                        realtimeTranscriptionSessionCreateResponse.include.map {
                            it.toMutableList()
                        }
                    object_ = realtimeTranscriptionSessionCreateResponse.object_
                    additionalProperties =
                        realtimeTranscriptionSessionCreateResponse.additionalProperties
                            .toMutableMap()
                }
            ...
            private constructor(
                ...
                private constructor(
                    ...
                    class Builder internal constructor() {
                         ...
                         * [Transcription] value instead. This method is primarily for setting the
                         * field to an undocumented or not yet supported value.
                         */
                         ...
                         * [TurnDetection] value instead. This method is primarily for setting the
                         * field to an undocumented or not yet supported value.
                         */
                    ...
                    private constructor(
                         ...
                         *
                         * Unlike [model], this method doesn't throw if the JSON field has an
                         * unexpected type.
                         */
                        @JsonProperty("model")
                        @ExcludeMissing
                        ...
                        class Builder internal constructor() {
                            ...
                            internal fun from(transcription: Transcription) = apply {
                                ...
                                additionalProperties =
                                    transcription.additionalProperties.toMutableMap()
                            }
                             ...
                             *
                             * You should usually call [Builder.model] with a well-typed [Model]
                             * value instead. This method is primarily for setting the field to an
                             * undocumented or not yet supported value.
                             */
                             ...
                             *
                             * You should usually call [Builder.prompt] with a well-typed [String]
                             * value instead. This method is primarily for setting the field to an
                             * undocumented or not yet supported value.
                             */
                        ...
                        private constructor(private val value: JsonField<String>) : Enum {
                             ...
                             * member.
                             *
                             * An instance of [Model] can contain an unknown value in a couple of
                             * cases:
                             * - It was deserialized from data that doesn't match any known member.
                             *   For example, if the SDK is on an older version than the API, then
                             *   the API may respond with new members that the SDK is unaware of.
                            ...
                            fun known(): Known =
                                when (this) {
                                    ...
                                    WHISPER_1 -> Known.WHISPER_1
                                        ...
                                        throw OpenAIInvalidDataException("Unknown Model: $value")
                                }
                    ...
                    private constructor(
                         ...
                         *
                         * Unlike [prefixPaddingMs], this method doesn't throw if the JSON field has
                         * an unexpected type.
                         */
                        @JsonProperty("prefix_padding_ms")
                        @ExcludeMissing
                         ...
                         *
                         * Unlike [silenceDurationMs], this method doesn't throw if the JSON field
                        ...
                        class Builder internal constructor() {
                            ...
                            internal fun from(turnDetection: TurnDetection) = apply {
                                ...
                                additionalProperties =
                                    turnDetection.additionalProperties.toMutableMap()
                            }
                             ...
                             *
                             * You should usually call [Builder.threshold] with a well-typed
            ...
            class Include @JsonCreator private constructor(private val value: JsonField<String>) :
                ...
                enum class Value {
                    ITEM_INPUT_AUDIO_TRANSCRIPTION_LOGPROBS,
                    /**
                     * An enum member indicating that [Include] was instantiated with an unknown
                     * value.
                     */
                    _UNKNOWN,
                }
            ...
            override fun toString() =
                "RealtimeTranscriptionSessionCreateResponse{id=$id, audio=$audio, expiresAt=$expiresAt, include=$include, object_=$object_, additionalProperties=$additionalProperties}"
        }
    }
