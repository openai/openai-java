...
private constructor(
    ...
    /** A builder for [RealtimeTranslationSessionCreatedEvent]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(
            realtimeTranslationSessionCreatedEvent: RealtimeTranslationSessionCreatedEvent
        ) = apply {
            eventId = realtimeTranslationSessionCreatedEvent.eventId
            session = realtimeTranslationSessionCreatedEvent.session
            type = realtimeTranslationSessionCreatedEvent.type
            additionalProperties =
                realtimeTranslationSessionCreatedEvent.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [RealtimeTranslationSessionCreatedEvent].
         *
         ...
         */
        fun build(): RealtimeTranslationSessionCreatedEvent =
            RealtimeTranslationSessionCreatedEvent(
     ...
     *   expected type.
     */
    fun validate(): RealtimeTranslationSessionCreatedEvent = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is RealtimeTranslationSessionCreatedEvent &&
    ...
    override fun toString() =
        "RealtimeTranslationSessionCreatedEvent{eventId=$eventId, session=$session, type=$type, additionalProperties=$additionalProperties}"
}
