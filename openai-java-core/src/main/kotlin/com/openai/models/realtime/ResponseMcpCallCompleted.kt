...
private constructor(
    ...
    class Builder internal constructor() {
        ...
        internal fun from(responseMcpCallCompleted: ResponseMcpCallCompleted) = apply {
            eventId = responseMcpCallCompleted.eventId
            itemId = responseMcpCallCompleted.itemId
            outputIndex = responseMcpCallCompleted.outputIndex
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is ResponseMcpCallCompleted &&
    ...
    override fun toString() =
        "ResponseMcpCallCompleted{eventId=$eventId, itemId=$itemId, outputIndex=$outputIndex, type=$type, additionalProperties=$additionalProperties}"
}
