...
private constructor(
    ...
    class Builder internal constructor() {
        ...
        internal fun from(responseMcpCallFailed: ResponseMcpCallFailed) = apply {
            eventId = responseMcpCallFailed.eventId
            itemId = responseMcpCallFailed.itemId
            outputIndex = responseMcpCallFailed.outputIndex
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is ResponseMcpCallFailed &&
    ...
    override fun toString() =
        "ResponseMcpCallFailed{eventId=$eventId, itemId=$itemId, outputIndex=$outputIndex, type=$type, additionalProperties=$additionalProperties}"
}
