...
private constructor(
     ...
     * import java.util.Optional;
     *
     * Optional<String> result = realtimeServerEvent.accept(new RealtimeServerEvent.Visitor<Optional<String>>() {
     *     @Override
     *     public Optional<String> visitConversationCreated(ConversationCreatedEvent conversationCreated) {
     *         return Optional.of(conversationCreated.toString());
     *     }
     *
     *     // ...
     *
    ...
    interface Visitor<out T> {
        ...
        fun unknown(json: JsonValue?): T {
            throw OpenAIInvalidDataException("Unknown RealtimeServerEvent")
        }
    }
