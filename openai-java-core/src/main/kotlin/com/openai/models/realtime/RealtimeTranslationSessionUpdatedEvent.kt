...
private constructor(
    ...
    /** A builder for [RealtimeTranslationSessionUpdatedEvent]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(
            realtimeTranslationSessionUpdatedEvent: RealtimeTranslationSessionUpdatedEvent
        ) = apply {
            eventId = realtimeTranslationSessionUpdatedEvent.eventId
            session = realtimeTranslationSessionUpdatedEvent.session
            type = realtimeTranslationSessionUpdatedEvent.type
            additionalProperties =
                realtimeTranslationSessionUpdatedEvent.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [RealtimeTranslationSessionUpdatedEvent].
         *
         ...
         */
        fun build(): RealtimeTranslationSessionUpdatedEvent =
            RealtimeTranslationSessionUpdatedEvent(
     ...
     *   expected type.
     */
    fun validate(): RealtimeTranslationSessionUpdatedEvent = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is RealtimeTranslationSessionUpdatedEvent &&
    ...
    override fun toString() =
        "RealtimeTranslationSessionUpdatedEvent{eventId=$eventId, session=$session, type=$type, additionalProperties=$additionalProperties}"
}
