...
private constructor(
     ...
     * ```java
     * JsonValue.from("response.output_audio_transcript.delta")
     * ```
     *
    ...
    class Builder internal constructor() {
        ...
        private var type: JsonValue = JsonValue.from("response.output_audio_transcript.delta")
    ...
    fun validate(): ResponseAudioTranscriptDeltaEvent = apply {
        ...
        responseId()
        _type().let {
            if (it != JsonValue.from("response.output_audio_transcript.delta")) {
    ...
    internal fun validity(): Int =
        (if (contentIndex.asKnown().isPresent) 1 else 0) +
            ...
            type.let {
                if (it == JsonValue.from("response.output_audio_transcript.delta")) 1 else 0
            }
