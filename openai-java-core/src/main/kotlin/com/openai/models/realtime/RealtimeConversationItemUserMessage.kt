...
private constructor(
    ...
    class Builder internal constructor() {
        ...
        internal fun from(
            ...
            content = realtimeConversationItemUserMessage.content.map { it.toMutableList() }
            role = realtimeConversationItemUserMessage.role
            type = realtimeConversationItemUserMessage.type
            id = realtimeConversationItemUserMessage.id
            object_ = realtimeConversationItemUserMessage.object_
            status = realtimeConversationItemUserMessage.status
            additionalProperties =
                realtimeConversationItemUserMessage.additionalProperties.toMutableMap()
        }
         ...
         */
        fun build(): RealtimeConversationItemUserMessage =
            RealtimeConversationItemUserMessage(
    ...
    fun validate(): RealtimeConversationItemUserMessage = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is RealtimeConversationItemUserMessage &&
    ...
    override fun toString() =
        "RealtimeConversationItemUserMessage{content=$content, role=$role, type=$type, id=$id, object_=$object_, status=$status, additionalProperties=$additionalProperties}"
}
