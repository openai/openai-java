...
private constructor(
    ...
    private constructor(
        ...
        ) : this(audio, detail, imageUrl, text, transcript, type, mutableMapOf())

        /**
         * Base64-encoded audio bytes (for `input_audio`), these will be parsed as the format
         * specified in the session input audio type configuration. This defaults to PCM 16-bit
        ...
        class Builder internal constructor() {
            ...
            /**
             * Base64-encoded image bytes (for `input_image`) as a data URI. For example
             * `data:image/png;base64,iVBORw0KGgoAAAANSUhEUgAA...`. Supported formats are PNG and
             * JPEG.
             */
            ...
            /**
             * Transcript of the audio (for `input_audio`). This is not sent to the model, but will
             * be attached to the message item for reference.
             */
        ...
        class Type @JsonCreator private constructor(private val value: JsonField<String>) : Enum {
            ...
            companion object {
                ...
                @JvmField val INPUT_IMAGE = of("input_image")
        ...
        override fun toString() =
            "Content{audio=$audio, detail=$detail, imageUrl=$imageUrl, text=$text, transcript=$transcript, type=$type, additionalProperties=$additionalProperties}"
    }
