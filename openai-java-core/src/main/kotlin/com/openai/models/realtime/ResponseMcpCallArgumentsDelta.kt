...
private constructor(
    ...
    ) : this(delta, eventId, itemId, outputIndex, responseId, type, obfuscation, mutableMapOf())
    ...
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(responseMcpCallArgumentsDelta: ResponseMcpCallArgumentsDelta) = apply {
            delta = responseMcpCallArgumentsDelta.delta
            eventId = responseMcpCallArgumentsDelta.eventId
            itemId = responseMcpCallArgumentsDelta.itemId
            outputIndex = responseMcpCallArgumentsDelta.outputIndex
            responseId = responseMcpCallArgumentsDelta.responseId
            type = responseMcpCallArgumentsDelta.type
            obfuscation = responseMcpCallArgumentsDelta.obfuscation
            additionalProperties = responseMcpCallArgumentsDelta.additionalProperties.toMutableMap()
        }
        ...
        /** If present, indicates the delta text was obfuscated. */
        fun obfuscation(obfuscation: String?) = obfuscation(JsonField.ofNullable(obfuscation))

        /** Alias for calling [Builder.obfuscation] with `obfuscation.orElse(null)`. */
        fun obfuscation(obfuscation: Optional<String>) = obfuscation(obfuscation.getOrNull())
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is ResponseMcpCallArgumentsDelta &&
            delta == other.delta &&
    ...
    override fun toString() =
        "ResponseMcpCallArgumentsDelta{delta=$delta, eventId=$eventId, itemId=$itemId, outputIndex=$outputIndex, responseId=$responseId, type=$type, obfuscation=$obfuscation, additionalProperties=$additionalProperties}"
}
