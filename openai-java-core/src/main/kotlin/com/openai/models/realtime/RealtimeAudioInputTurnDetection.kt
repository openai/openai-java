...
private constructor(
     ...
     * import java.util.Optional;
     *
     * Optional<String> result = realtimeAudioInputTurnDetection.accept(new RealtimeAudioInputTurnDetection.Visitor<Optional<String>>() {
     *     @Override
    ...
    interface Visitor<out T> {
        ...
        fun unknown(json: JsonValue?): T {
            throw OpenAIInvalidDataException("Unknown RealtimeAudioInputTurnDetection")
        }
    }
