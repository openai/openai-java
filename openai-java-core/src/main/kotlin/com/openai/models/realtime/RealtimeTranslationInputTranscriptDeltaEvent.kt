...
/**
 * Returned when optional source-language transcript text is available. This event is emitted only
 * when `audio.input.transcription` is configured.
 *
...
private constructor(
    ...
    /** A builder for [RealtimeTranslationInputTranscriptDeltaEvent]. */
    class Builder internal constructor() {
        ...
        internal fun from(
            ...
            delta = realtimeTranslationInputTranscriptDeltaEvent.delta
            eventId = realtimeTranslationInputTranscriptDeltaEvent.eventId
            type = realtimeTranslationInputTranscriptDeltaEvent.type
            elapsedMs = realtimeTranslationInputTranscriptDeltaEvent.elapsedMs
            additionalProperties =
                realtimeTranslationInputTranscriptDeltaEvent.additionalProperties.toMutableMap()
        }
         ...
         */
        fun build(): RealtimeTranslationInputTranscriptDeltaEvent =
            RealtimeTranslationInputTranscriptDeltaEvent(
     ...
     *   expected type.
     */
    fun validate(): RealtimeTranslationInputTranscriptDeltaEvent = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is RealtimeTranslationInputTranscriptDeltaEvent &&
            delta == other.delta &&
    ...
    override fun toString() =
        "RealtimeTranslationInputTranscriptDeltaEvent{delta=$delta, eventId=$eventId, type=$type, elapsedMs=$elapsedMs, additionalProperties=$additionalProperties}"
}
