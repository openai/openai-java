...
private constructor(
    ...
    class Builder internal constructor() {
        ...
        private var type: JsonValue = JsonValue.from("conversation.item.added")
        private var previousItemId: JsonField<String> = JsonMissing.of()
        private var additionalProperties: MutableMap<String, JsonValue> = mutableMapOf()

        @JvmSynthetic
        internal fun from(conversationItemAdded: ConversationItemAdded) = apply {
            eventId = conversationItemAdded.eventId
            item = conversationItemAdded.item
            type = conversationItemAdded.type
            previousItemId = conversationItemAdded.previousItemId
            additionalProperties = conversationItemAdded.additionalProperties.toMutableMap()
        }
         ...
         */
        fun build(): ConversationItemAdded =
    ...
    fun validate(): ConversationItemAdded = apply {
        if (validated) {
            return@apply
        }
        ...
        item().validate()
        _type().let {
            if (it != JsonValue.from("conversation.item.added")) {
    ...
    internal fun validity(): Int =
        (if (eventId.asKnown().isPresent) 1 else 0) +
            ...
            type.let { if (it == JsonValue.from("conversation.item.added")) 1 else 0 } +
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is ConversationItemAdded &&
    ...
    override fun toString() =
        "ConversationItemAdded{eventId=$eventId, item=$item, type=$type, previousItemId=$previousItemId, additionalProperties=$additionalProperties}"
}
