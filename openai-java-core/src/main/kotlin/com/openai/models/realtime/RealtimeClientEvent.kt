...
private constructor(
     ...
     * import java.util.Optional;
     *
     * Optional<String> result = realtimeClientEvent.accept(new RealtimeClientEvent.Visitor<Optional<String>>() {
     *     @Override
     *     public Optional<String> visitConversationItemCreate(ConversationItemCreateEvent conversationItemCreate) {
     *         return Optional.of(conversationItemCreate.toString());
     *     }
     *
     *     // ...
     *
