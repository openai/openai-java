...
private constructor(
    ...
    class Builder internal constructor() {
        ...
        private var type: JsonValue = JsonValue.from("eval.run.succeeded")
        private var object_: JsonField<Object> = JsonMissing.of()
        private var additionalProperties: MutableMap<String, JsonValue> = mutableMapOf()

        @JvmSynthetic
        internal fun from(evalRunSucceededWebhookEvent: EvalRunSucceededWebhookEvent) = apply {
            id = evalRunSucceededWebhookEvent.id
            createdAt = evalRunSucceededWebhookEvent.createdAt
            data = evalRunSucceededWebhookEvent.data
            type = evalRunSucceededWebhookEvent.type
            object_ = evalRunSucceededWebhookEvent.object_
            additionalProperties = evalRunSucceededWebhookEvent.additionalProperties.toMutableMap()
        }
         ...
         */
        fun build(): EvalRunSucceededWebhookEvent =
    ...
    fun validate(): EvalRunSucceededWebhookEvent = apply {
        if (validated) {
            return@apply
        }
        ...
        data().validate()
        _type().let {
            if (it != JsonValue.from("eval.run.succeeded")) {
    ...
    internal fun validity(): Int =
        (if (id.asKnown().isPresent) 1 else 0) +
            ...
            type.let { if (it == JsonValue.from("eval.run.succeeded")) 1 else 0 } +
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return /* spotless:off */ other is EvalRunSucceededWebhookEvent && id == other.id && createdAt == other.createdAt && data == other.data && type == other.type && object_ == other.object_ && additionalProperties == other.additionalProperties /* spotless:on */
    }
    ...
    override fun toString() =
        "EvalRunSucceededWebhookEvent{id=$id, createdAt=$createdAt, data=$data, type=$type, object_=$object_, additionalProperties=$additionalProperties}"
}
