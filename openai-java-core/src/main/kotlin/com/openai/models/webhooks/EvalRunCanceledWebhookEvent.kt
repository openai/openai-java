...
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [EvalRunCanceledWebhookEvent].
         *
    ...
    /** A builder for [EvalRunCanceledWebhookEvent]. */
    class Builder internal constructor() {

        private var id: JsonField<String>? = null
        private var createdAt: JsonField<Long>? = null
        private var data: JsonField<Data>? = null
        private var type: JsonValue = JsonValue.from("eval.run.canceled")
        private var object_: JsonField<Object> = JsonMissing.of()
        private var additionalProperties: MutableMap<String, JsonValue> = mutableMapOf()

        @JvmSynthetic
        internal fun from(evalRunCanceledWebhookEvent: EvalRunCanceledWebhookEvent) = apply {
            id = evalRunCanceledWebhookEvent.id
            createdAt = evalRunCanceledWebhookEvent.createdAt
            data = evalRunCanceledWebhookEvent.data
            type = evalRunCanceledWebhookEvent.type
            object_ = evalRunCanceledWebhookEvent.object_
            additionalProperties = evalRunCanceledWebhookEvent.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [EvalRunCanceledWebhookEvent].
         *
         ...
         */
        fun build(): EvalRunCanceledWebhookEvent =
    ...
    fun validate(): EvalRunCanceledWebhookEvent = apply {
        if (validated) {
            return@apply
        }
        ...
        data().validate()
        _type().let {
            if (it != JsonValue.from("eval.run.canceled")) {
    ...
    internal fun validity(): Int =
        (if (id.asKnown().isPresent) 1 else 0) +
            ...
            type.let { if (it == JsonValue.from("eval.run.canceled")) 1 else 0 } +
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return /* spotless:off */ other is EvalRunCanceledWebhookEvent && id == other.id && createdAt == other.createdAt && data == other.data && type == other.type && object_ == other.object_ && additionalProperties == other.additionalProperties /* spotless:on */
    }
    ...
    override fun toString() =
        "EvalRunCanceledWebhookEvent{id=$id, createdAt=$createdAt, data=$data, type=$type, object_=$object_, additionalProperties=$additionalProperties}"
}
