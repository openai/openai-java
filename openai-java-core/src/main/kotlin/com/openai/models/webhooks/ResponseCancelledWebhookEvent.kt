...
private constructor(
     ...
     * ```java
     * JsonValue.from("response.cancelled")
     * ```
     *
    ...
    /** A builder for [ResponseCancelledWebhookEvent]. */
    class Builder internal constructor() {

        private var id: JsonField<String>? = null
        private var createdAt: JsonField<Long>? = null
        private var data: JsonField<Data>? = null
        private var type: JsonValue = JsonValue.from("response.cancelled")
        private var object_: JsonField<Object> = JsonMissing.of()
        private var additionalProperties: MutableMap<String, JsonValue> = mutableMapOf()

        @JvmSynthetic
        internal fun from(responseCancelledWebhookEvent: ResponseCancelledWebhookEvent) = apply {
            id = responseCancelledWebhookEvent.id
            createdAt = responseCancelledWebhookEvent.createdAt
            data = responseCancelledWebhookEvent.data
            type = responseCancelledWebhookEvent.type
            object_ = responseCancelledWebhookEvent.object_
            additionalProperties = responseCancelledWebhookEvent.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [ResponseCancelledWebhookEvent].
         *
         ...
         */
        fun build(): ResponseCancelledWebhookEvent =
            ResponseCancelledWebhookEvent(
                checkRequired("id", id),
    ...
    fun validate(): ResponseCancelledWebhookEvent = apply {
        if (validated) {
            return@apply
        }
        ...
        data().validate()
        _type().let {
            if (it != JsonValue.from("response.cancelled")) {
    ...
    internal fun validity(): Int =
        (if (id.asKnown().isPresent) 1 else 0) +
            ...
            type.let { if (it == JsonValue.from("response.cancelled")) 1 else 0 } +
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return /* spotless:off */ other is ResponseCancelledWebhookEvent && id == other.id && createdAt == other.createdAt && data == other.data && type == other.type && object_ == other.object_ && additionalProperties == other.additionalProperties /* spotless:on */
    }
    ...
    override fun toString() =
        "ResponseCancelledWebhookEvent{id=$id, createdAt=$createdAt, data=$data, type=$type, object_=$object_, additionalProperties=$additionalProperties}"
}
