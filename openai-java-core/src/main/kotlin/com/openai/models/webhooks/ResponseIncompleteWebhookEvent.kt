...
private constructor(
    ...
    /** A builder for [ResponseIncompleteWebhookEvent]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(responseIncompleteWebhookEvent: ResponseIncompleteWebhookEvent) = apply {
            id = responseIncompleteWebhookEvent.id
            createdAt = responseIncompleteWebhookEvent.createdAt
            data = responseIncompleteWebhookEvent.data
            type = responseIncompleteWebhookEvent.type
            object_ = responseIncompleteWebhookEvent.object_
            additionalProperties =
                responseIncompleteWebhookEvent.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [ResponseIncompleteWebhookEvent].
         *
         ...
         */
        fun build(): ResponseIncompleteWebhookEvent =
            ResponseIncompleteWebhookEvent(
                checkRequired("id", id),
    ...
    fun validate(): ResponseIncompleteWebhookEvent = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return /* spotless:off */ other is ResponseIncompleteWebhookEvent && id == other.id && createdAt == other.createdAt && data == other.data && type == other.type && object_ == other.object_ && additionalProperties == other.additionalProperties /* spotless:on */
    }
    ...
    override fun toString() =
        "ResponseIncompleteWebhookEvent{id=$id, createdAt=$createdAt, data=$data, type=$type, object_=$object_, additionalProperties=$additionalProperties}"
}
