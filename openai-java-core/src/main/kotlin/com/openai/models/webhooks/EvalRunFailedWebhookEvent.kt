...
private constructor(
     ...
     * ```java
     * JsonValue.from("eval.run.failed")
     * ```
     *
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [EvalRunFailedWebhookEvent].
         *
    ...
    /** A builder for [EvalRunFailedWebhookEvent]. */
    class Builder internal constructor() {

        private var id: JsonField<String>? = null
        private var createdAt: JsonField<Long>? = null
        private var data: JsonField<Data>? = null
        private var type: JsonValue = JsonValue.from("eval.run.failed")
        private var object_: JsonField<Object> = JsonMissing.of()
        private var additionalProperties: MutableMap<String, JsonValue> = mutableMapOf()

        @JvmSynthetic
        internal fun from(evalRunFailedWebhookEvent: EvalRunFailedWebhookEvent) = apply {
            id = evalRunFailedWebhookEvent.id
            createdAt = evalRunFailedWebhookEvent.createdAt
            data = evalRunFailedWebhookEvent.data
            type = evalRunFailedWebhookEvent.type
            object_ = evalRunFailedWebhookEvent.object_
            additionalProperties = evalRunFailedWebhookEvent.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [EvalRunFailedWebhookEvent].
         *
         ...
         */
        fun build(): EvalRunFailedWebhookEvent =
    ...
    fun validate(): EvalRunFailedWebhookEvent = apply {
        if (validated) {
            return@apply
        }
        ...
        data().validate()
        _type().let {
            if (it != JsonValue.from("eval.run.failed")) {
    ...
    internal fun validity(): Int =
        (if (id.asKnown().isPresent) 1 else 0) +
            ...
            type.let { if (it == JsonValue.from("eval.run.failed")) 1 else 0 } +
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return /* spotless:off */ other is EvalRunFailedWebhookEvent && id == other.id && createdAt == other.createdAt && data == other.data && type == other.type && object_ == other.object_ && additionalProperties == other.additionalProperties /* spotless:on */
    }
    ...
    override fun toString() =
        "EvalRunFailedWebhookEvent{id=$id, createdAt=$createdAt, data=$data, type=$type, object_=$object_, additionalProperties=$additionalProperties}"
}
