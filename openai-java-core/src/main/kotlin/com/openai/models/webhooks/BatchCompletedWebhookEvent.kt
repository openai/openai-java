...
private constructor(
     ...
     * ```java
     * JsonValue.from("batch.completed")
     * ```
     *
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [BatchCompletedWebhookEvent].
         *
    ...
    /** A builder for [BatchCompletedWebhookEvent]. */
    class Builder internal constructor() {

        private var id: JsonField<String>? = null
        private var createdAt: JsonField<Long>? = null
        private var data: JsonField<Data>? = null
        private var type: JsonValue = JsonValue.from("batch.completed")
        private var object_: JsonField<Object> = JsonMissing.of()
        private var additionalProperties: MutableMap<String, JsonValue> = mutableMapOf()

        @JvmSynthetic
        internal fun from(batchCompletedWebhookEvent: BatchCompletedWebhookEvent) = apply {
            id = batchCompletedWebhookEvent.id
            createdAt = batchCompletedWebhookEvent.createdAt
            data = batchCompletedWebhookEvent.data
            type = batchCompletedWebhookEvent.type
            object_ = batchCompletedWebhookEvent.object_
            additionalProperties = batchCompletedWebhookEvent.additionalProperties.toMutableMap()
        }
         ...
         */
        fun build(): BatchCompletedWebhookEvent =
    ...
    fun validate(): BatchCompletedWebhookEvent = apply {
        if (validated) {
            return@apply
        }
        ...
        data().validate()
        _type().let {
            if (it != JsonValue.from("batch.completed")) {
    ...
    internal fun validity(): Int =
        (if (id.asKnown().isPresent) 1 else 0) +
            ...
            type.let { if (it == JsonValue.from("batch.completed")) 1 else 0 } +
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return /* spotless:off */ other is BatchCompletedWebhookEvent && id == other.id && createdAt == other.createdAt && data == other.data && type == other.type && object_ == other.object_ && additionalProperties == other.additionalProperties /* spotless:on */
    }
    ...
    override fun toString() =
        "BatchCompletedWebhookEvent{id=$id, createdAt=$createdAt, data=$data, type=$type, object_=$object_, additionalProperties=$additionalProperties}"
}
