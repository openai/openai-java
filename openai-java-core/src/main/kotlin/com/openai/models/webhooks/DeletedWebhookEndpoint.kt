...
private constructor(
     ...
     * ```java
     * JsonValue.from("webhook_endpoint.deleted")
     * ```
     *
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [DeletedWebhookEndpoint].
         *
    ...
    /** A builder for [DeletedWebhookEndpoint]. */
    class Builder internal constructor() {

        private var id: JsonField<String>? = null
        private var deleted: JsonField<Boolean>? = null
        private var object_: JsonValue = JsonValue.from("webhook_endpoint.deleted")
        private var additionalProperties: MutableMap<String, JsonValue> = mutableMapOf()

        @JvmSynthetic
        internal fun from(deletedWebhookEndpoint: DeletedWebhookEndpoint) = apply {
            id = deletedWebhookEndpoint.id
            deleted = deletedWebhookEndpoint.deleted
            object_ = deletedWebhookEndpoint.object_
            additionalProperties = deletedWebhookEndpoint.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [DeletedWebhookEndpoint].
         *
         ...
         */
        fun build(): DeletedWebhookEndpoint =
     ...
     *   expected type.
     */
    fun validate(): DeletedWebhookEndpoint = apply {
        if (validated) {
            return@apply
        }
        ...
        deleted()
        _object_().let {
            if (it != JsonValue.from("webhook_endpoint.deleted")) {
    ...
    internal fun validity(): Int =
        (if (id.asKnown().isPresent) 1 else 0) +
            ...
            object_.let { if (it == JsonValue.from("webhook_endpoint.deleted")) 1 else 0 }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is DeletedWebhookEndpoint &&
            id == other.id &&
    ...
    override fun toString() =
        "DeletedWebhookEndpoint{id=$id, deleted=$deleted, object_=$object_, additionalProperties=$additionalProperties}"
}
