...
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [ResponseFailedWebhookEvent].
         *
    ...
    /** A builder for [ResponseFailedWebhookEvent]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(responseFailedWebhookEvent: ResponseFailedWebhookEvent) = apply {
            id = responseFailedWebhookEvent.id
            createdAt = responseFailedWebhookEvent.createdAt
            data = responseFailedWebhookEvent.data
            type = responseFailedWebhookEvent.type
            object_ = responseFailedWebhookEvent.object_
            additionalProperties = responseFailedWebhookEvent.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [ResponseFailedWebhookEvent].
         *
         ...
         */
        fun build(): ResponseFailedWebhookEvent =
    ...
    fun validate(): ResponseFailedWebhookEvent = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return /* spotless:off */ other is ResponseFailedWebhookEvent && id == other.id && createdAt == other.createdAt && data == other.data && type == other.type && object_ == other.object_ && additionalProperties == other.additionalProperties /* spotless:on */
    }
    ...
    override fun toString() =
        "ResponseFailedWebhookEvent{id=$id, createdAt=$createdAt, data=$data, type=$type, object_=$object_, additionalProperties=$additionalProperties}"
}
