...
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [BatchExpiredWebhookEvent].
         *
    ...
    /** A builder for [BatchExpiredWebhookEvent]. */
    class Builder internal constructor() {

        private var id: JsonField<String>? = null
        private var createdAt: JsonField<Long>? = null
        private var data: JsonField<Data>? = null
        private var type: JsonValue = JsonValue.from("batch.expired")
        private var object_: JsonField<Object> = JsonMissing.of()
        private var additionalProperties: MutableMap<String, JsonValue> = mutableMapOf()

        @JvmSynthetic
        internal fun from(batchExpiredWebhookEvent: BatchExpiredWebhookEvent) = apply {
            id = batchExpiredWebhookEvent.id
            createdAt = batchExpiredWebhookEvent.createdAt
            data = batchExpiredWebhookEvent.data
            type = batchExpiredWebhookEvent.type
            object_ = batchExpiredWebhookEvent.object_
            additionalProperties = batchExpiredWebhookEvent.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [BatchExpiredWebhookEvent].
         *
         ...
         */
        fun build(): BatchExpiredWebhookEvent =
    ...
    fun validate(): BatchExpiredWebhookEvent = apply {
        if (validated) {
            return@apply
        }
        ...
        data().validate()
        _type().let {
            if (it != JsonValue.from("batch.expired")) {
    ...
    internal fun validity(): Int =
        (if (id.asKnown().isPresent) 1 else 0) +
            ...
            type.let { if (it == JsonValue.from("batch.expired")) 1 else 0 } +
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return /* spotless:off */ other is BatchExpiredWebhookEvent && id == other.id && createdAt == other.createdAt && data == other.data && type == other.type && object_ == other.object_ && additionalProperties == other.additionalProperties /* spotless:on */
    }
    ...
    override fun toString() =
        "BatchExpiredWebhookEvent{id=$id, createdAt=$createdAt, data=$data, type=$type, object_=$object_, additionalProperties=$additionalProperties}"
}
