 ...
 */
class LiveTransportIncomingWebhookEvent
...
private constructor(
     ...
     * ```java
     * JsonValue.from("live.transport.incoming")
     * ```
     *
    ...
    /** A builder for [LiveTransportIncomingWebhookEvent]. */
    class Builder internal constructor() {

        private var id: JsonField<String>? = null
        private var createdAt: JsonField<Long>? = null
        private var data: JsonField<Data>? = null
        private var type: JsonValue = JsonValue.from("live.transport.incoming")
        private var object_: JsonField<Object> = JsonMissing.of()
        private var additionalProperties: MutableMap<String, JsonValue> = mutableMapOf()

        @JvmSynthetic
        internal fun from(liveTransportIncomingWebhookEvent: LiveTransportIncomingWebhookEvent) =
            apply {
                id = liveTransportIncomingWebhookEvent.id
                createdAt = liveTransportIncomingWebhookEvent.createdAt
                data = liveTransportIncomingWebhookEvent.data
                type = liveTransportIncomingWebhookEvent.type
                object_ = liveTransportIncomingWebhookEvent.object_
                additionalProperties =
                    liveTransportIncomingWebhookEvent.additionalProperties.toMutableMap()
            }
        ...
        /**
         * Returns an immutable instance of [LiveTransportIncomingWebhookEvent].
         *
         ...
         */
        fun build(): LiveTransportIncomingWebhookEvent =
            LiveTransportIncomingWebhookEvent(
                checkRequired("id", id),
     ...
     *   expected type.
     */
    fun validate(): LiveTransportIncomingWebhookEvent = apply {
        if (validated) {
            return@apply
        }
        ...
        data().validate()
        _type().let {
            if (it != JsonValue.from("live.transport.incoming")) {
    ...
    internal fun validity(): Int =
        (if (id.asKnown().isPresent) 1 else 0) +
            ...
            type.let { if (it == JsonValue.from("live.transport.incoming")) 1 else 0 } +
    ...
    private constructor(
        ...
        ) : this(sessionId, sipHeaders, type, sipMediaSecurity, mutableMapOf())
        ...
        class Builder internal constructor() {
            ...
            private var type: JsonValue = JsonValue.from("sip")
        ...
        internal fun validity(): Int =
            (if (sessionId.asKnown().isPresent) 1 else 0) +
                ...
                type.let { if (it == JsonValue.from("sip")) 1 else 0 } +
        ...
        private val hashCode: Int by lazy {
            Objects.hash(sessionId, sipHeaders, type, sipMediaSecurity, additionalProperties)
        }

        override fun hashCode(): Int = hashCode

        override fun toString() =
            "Data{sessionId=$sessionId, sipHeaders=$sipHeaders, type=$type, sipMediaSecurity=$sipMediaSecurity, additionalProperties=$additionalProperties}"
    }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is LiveTransportIncomingWebhookEvent &&
            id == other.id &&
    ...
    override fun toString() =
        "LiveTransportIncomingWebhookEvent{id=$id, createdAt=$createdAt, data=$data, type=$type, object_=$object_, additionalProperties=$additionalProperties}"
}
