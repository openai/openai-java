...
private constructor(
    ...
    private constructor(
        ...
        private constructor(
            ...
            @JsonProperty("type") @ExcludeMissing type: JsonValue = JsonMissing.of(),
        ) : this(sessionId, sipHeaders, type, mutableMapOf())
        ...
        private val hashCode: Int by lazy {
            Objects.hash(sessionId, sipHeaders, type, additionalProperties)
        }

        override fun hashCode(): Int = hashCode

        override fun toString() =
            "Data{sessionId=$sessionId, sipHeaders=$sipHeaders, type=$type, additionalProperties=$additionalProperties}"
    }
