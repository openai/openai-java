...
private constructor(
    ...
    /** A builder for [ResponseCompletedWebhookEvent]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(responseCompletedWebhookEvent: ResponseCompletedWebhookEvent) = apply {
            id = responseCompletedWebhookEvent.id
            createdAt = responseCompletedWebhookEvent.createdAt
            data = responseCompletedWebhookEvent.data
            type = responseCompletedWebhookEvent.type
            object_ = responseCompletedWebhookEvent.object_
            additionalProperties = responseCompletedWebhookEvent.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [ResponseCompletedWebhookEvent].
         *
         ...
         */
        fun build(): ResponseCompletedWebhookEvent =
            ResponseCompletedWebhookEvent(
                checkRequired("id", id),
    ...
    fun validate(): ResponseCompletedWebhookEvent = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return /* spotless:off */ other is ResponseCompletedWebhookEvent && id == other.id && createdAt == other.createdAt && data == other.data && type == other.type && object_ == other.object_ && additionalProperties == other.additionalProperties /* spotless:on */
    }
    ...
    override fun toString() =
        "ResponseCompletedWebhookEvent{id=$id, createdAt=$createdAt, data=$data, type=$type, object_=$object_, additionalProperties=$additionalProperties}"
}
