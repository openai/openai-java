...
private constructor(
     ...
     * ```java
     * JsonValue.from("batch.cancelled")
     * ```
     *
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [BatchCancelledWebhookEvent].
         *
    ...
    /** A builder for [BatchCancelledWebhookEvent]. */
    class Builder internal constructor() {

        private var id: JsonField<String>? = null
        private var createdAt: JsonField<Long>? = null
        private var data: JsonField<Data>? = null
        private var type: JsonValue = JsonValue.from("batch.cancelled")
        private var object_: JsonField<Object> = JsonMissing.of()
        private var additionalProperties: MutableMap<String, JsonValue> = mutableMapOf()

        @JvmSynthetic
        internal fun from(batchCancelledWebhookEvent: BatchCancelledWebhookEvent) = apply {
            id = batchCancelledWebhookEvent.id
            createdAt = batchCancelledWebhookEvent.createdAt
            data = batchCancelledWebhookEvent.data
            type = batchCancelledWebhookEvent.type
            object_ = batchCancelledWebhookEvent.object_
            additionalProperties = batchCancelledWebhookEvent.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [BatchCancelledWebhookEvent].
         *
         ...
         */
        fun build(): BatchCancelledWebhookEvent =
    ...
    fun validate(): BatchCancelledWebhookEvent = apply {
        if (validated) {
            return@apply
        }
        ...
        data().validate()
        _type().let {
            if (it != JsonValue.from("batch.cancelled")) {
    ...
    internal fun validity(): Int =
        (if (id.asKnown().isPresent) 1 else 0) +
            ...
            type.let { if (it == JsonValue.from("batch.cancelled")) 1 else 0 } +
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return /* spotless:off */ other is BatchCancelledWebhookEvent && id == other.id && createdAt == other.createdAt && data == other.data && type == other.type && object_ == other.object_ && additionalProperties == other.additionalProperties /* spotless:on */
    }
    ...
    override fun toString() =
        "BatchCancelledWebhookEvent{id=$id, createdAt=$createdAt, data=$data, type=$type, object_=$object_, additionalProperties=$additionalProperties}"
}
