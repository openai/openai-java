...
private constructor(
     ...
     * ```java
     * JsonValue.from("fine_tuning.job.cancelled")
     * ```
     *
    ...
    /** A builder for [FineTuningJobCancelledWebhookEvent]. */
    class Builder internal constructor() {

        private var id: JsonField<String>? = null
        private var createdAt: JsonField<Long>? = null
        private var data: JsonField<Data>? = null
        private var type: JsonValue = JsonValue.from("fine_tuning.job.cancelled")
        private var object_: JsonField<Object> = JsonMissing.of()
        private var additionalProperties: MutableMap<String, JsonValue> = mutableMapOf()

        @JvmSynthetic
        internal fun from(fineTuningJobCancelledWebhookEvent: FineTuningJobCancelledWebhookEvent) =
            apply {
                id = fineTuningJobCancelledWebhookEvent.id
                createdAt = fineTuningJobCancelledWebhookEvent.createdAt
                data = fineTuningJobCancelledWebhookEvent.data
                type = fineTuningJobCancelledWebhookEvent.type
                object_ = fineTuningJobCancelledWebhookEvent.object_
                additionalProperties =
                    fineTuningJobCancelledWebhookEvent.additionalProperties.toMutableMap()
            }
         ...
         */
        fun build(): FineTuningJobCancelledWebhookEvent =
            FineTuningJobCancelledWebhookEvent(
                checkRequired("id", id),
    ...
    fun validate(): FineTuningJobCancelledWebhookEvent = apply {
        if (validated) {
            return@apply
        }
        ...
        data().validate()
        _type().let {
            if (it != JsonValue.from("fine_tuning.job.cancelled")) {
    ...
    internal fun validity(): Int =
        (if (id.asKnown().isPresent) 1 else 0) +
            ...
            type.let { if (it == JsonValue.from("fine_tuning.job.cancelled")) 1 else 0 } +
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return /* spotless:off */ other is FineTuningJobCancelledWebhookEvent && id == other.id && createdAt == other.createdAt && data == other.data && type == other.type && object_ == other.object_ && additionalProperties == other.additionalProperties /* spotless:on */
    }
    ...
    override fun toString() =
        "FineTuningJobCancelledWebhookEvent{id=$id, createdAt=$createdAt, data=$data, type=$type, object_=$object_, additionalProperties=$additionalProperties}"
}
