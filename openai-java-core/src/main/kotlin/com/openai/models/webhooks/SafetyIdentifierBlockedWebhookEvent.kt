...
private constructor(
     ...
     * ```java
     * JsonValue.from("safety_identifier.blocked")
     * ```
     *
    ...
    /** A builder for [SafetyIdentifierBlockedWebhookEvent]. */
    class Builder internal constructor() {

        private var id: JsonField<String>? = null
        private var createdAt: JsonField<Long>? = null
        private var data: JsonField<Data>? = null
        private var type: JsonValue = JsonValue.from("safety_identifier.blocked")
        private var object_: JsonField<Object> = JsonMissing.of()
        private var additionalProperties: MutableMap<String, JsonValue> = mutableMapOf()

        @JvmSynthetic
        internal fun from(
            safetyIdentifierBlockedWebhookEvent: SafetyIdentifierBlockedWebhookEvent
        ) = apply {
            id = safetyIdentifierBlockedWebhookEvent.id
            createdAt = safetyIdentifierBlockedWebhookEvent.createdAt
            data = safetyIdentifierBlockedWebhookEvent.data
            type = safetyIdentifierBlockedWebhookEvent.type
            object_ = safetyIdentifierBlockedWebhookEvent.object_
            additionalProperties =
                safetyIdentifierBlockedWebhookEvent.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [SafetyIdentifierBlockedWebhookEvent].
         *
         ...
         */
        fun build(): SafetyIdentifierBlockedWebhookEvent =
            SafetyIdentifierBlockedWebhookEvent(
                checkRequired("id", id),
     ...
     *   expected type.
     */
    fun validate(): SafetyIdentifierBlockedWebhookEvent = apply {
        if (validated) {
            return@apply
        }
        ...
        data().validate()
        _type().let {
            if (it != JsonValue.from("safety_identifier.blocked")) {
    ...
    internal fun validity(): Int =
        (if (id.asKnown().isPresent) 1 else 0) +
            ...
            type.let { if (it == JsonValue.from("safety_identifier.blocked")) 1 else 0 } +
    ...
    @JsonCreator(mode = JsonCreator.Mode.DISABLED)
    private constructor(
        private val safetyCategory: JsonField<String>,
        ...
        @JsonCreator
        private constructor(
            @JsonProperty("safety_category")
            @ExcludeMissing
            safetyCategory: JsonField<String> = JsonMissing.of(),
        ...
        ) : this(safetyCategory, safetyIdentifier, model, projectId, requestId, mutableMapOf())
         ...
         *   unexpectedly missing or null (e.g. if the server responded with an unexpected value).
         */
        fun safetyCategory(): String = safetyCategory.getRequired("safety_category")
         ...
         *   unexpectedly missing or null (e.g. if the server responded with an unexpected value).
         */
        fun safetyIdentifier(): String = safetyIdentifier.getRequired("safety_identifier")
         ...
         *
         * Unlike [safetyCategory], this method doesn't throw if the JSON field has an unexpected
         * type.
         */
        @JsonProperty("safety_category")
        @ExcludeMissing
        fun _safetyCategory(): JsonField<String> = safetyCategory
        ...
        class Builder internal constructor() {
            ...
            private var safetyCategory: JsonField<String>? = null
            private var safetyIdentifier: JsonField<String>? = null
            ...
            internal fun from(data: Data) = apply {
                ...
                safetyIdentifier = data.safetyIdentifier
                model = data.model
            ...
            /** The safety category that triggered the block, such as `bio` or `cyber`. */
            fun safetyCategory(safetyCategory: String) =
                safetyCategory(JsonField.of(safetyCategory))

            /**
             * Sets [Builder.safetyCategory] to an arbitrary JSON value.
             *
             * You should usually call [Builder.safetyCategory] with a well-typed [String] value
             * instead. This method is primarily for setting the field to an undocumented or not yet
             * supported value.
             */
            fun safetyCategory(safetyCategory: JsonField<String>) = apply {
            ...
            fun build(): Data =
                Data(
                    checkRequired("safetyCategory", safetyCategory),
                    checkRequired("safetyIdentifier", safetyIdentifier),
                    model,
                    projectId,
                    requestId,
                    additionalProperties.toMutableMap(),
        ...
        @JvmSynthetic
        internal fun validity(): Int =
            (if (safetyCategory.asKnown().isPresent) 1 else 0) +
        ...
        override fun equals(other: Any?): Boolean {
            ...
            return other is Data &&
                safetyCategory == other.safetyCategory &&
        ...
        override fun toString() =
            "Data{safetyCategory=$safetyCategory, safetyIdentifier=$safetyIdentifier, model=$model, projectId=$projectId, requestId=$requestId, additionalProperties=$additionalProperties}"
    }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is SafetyIdentifierBlockedWebhookEvent &&
            id == other.id &&
    ...
    override fun toString() =
        "SafetyIdentifierBlockedWebhookEvent{id=$id, createdAt=$createdAt, data=$data, type=$type, object_=$object_, additionalProperties=$additionalProperties}"
}
