...
private constructor(
    private val data: JsonField<List<WebhookEndpoint>>,
    ...
    private constructor(
        @JsonProperty("data")
        @ExcludeMissing
        data: JsonField<List<WebhookEndpoint>> = JsonMissing.of(),
     ...
     */
    fun data(): List<WebhookEndpoint> = data.getRequired("data")
     ...
     */
    @JsonProperty("data") @ExcludeMissing fun _data(): JsonField<List<WebhookEndpoint>> = data
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [WebhookEndpointList].
         *
    ...
    /** A builder for [WebhookEndpointList]. */
    class Builder internal constructor() {

        private var data: JsonField<MutableList<WebhookEndpoint>>? = null
        ...
        @JvmSynthetic
        internal fun from(webhookEndpointList: WebhookEndpointList) = apply {
            data = webhookEndpointList.data.map { it.toMutableList() }
            firstId = webhookEndpointList.firstId
            hasMore = webhookEndpointList.hasMore
            lastId = webhookEndpointList.lastId
            object_ = webhookEndpointList.object_
            additionalProperties = webhookEndpointList.additionalProperties.toMutableMap()
        }

        /** The webhook endpoints in this page. */
        fun data(data: List<WebhookEndpoint>) = data(JsonField.of(data))

        /**
         * Sets [Builder.data] to an arbitrary JSON value.
         *
         * You should usually call [Builder.data] with a well-typed `List<WebhookEndpoint>` value
         * instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun data(data: JsonField<List<WebhookEndpoint>>) = apply {
            this.data = data.map { it.toMutableList() }
        }

        /**
         * Adds a single [WebhookEndpoint] to [Builder.data].
         *
         * @throws IllegalStateException if the field was previously set to a non-list.
         */
        fun addData(data: WebhookEndpoint) = apply {
            this.data =
        ...
        /**
         * Returns an immutable instance of [WebhookEndpointList].
         *
     ...
     *   expected type.
     */
    fun validate(): WebhookEndpointList = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is WebhookEndpointList &&
            data == other.data &&
    ...
    override fun toString() =
        "WebhookEndpointList{data=$data, firstId=$firstId, hasMore=$hasMore, lastId=$lastId, object_=$object_, additionalProperties=$additionalProperties}"
}
