...
private constructor(
     ...
     * ```java
     * JsonValue.from("fine_tuning.job.failed")
     * ```
     *
    ...
    /** A builder for [FineTuningJobFailedWebhookEvent]. */
    class Builder internal constructor() {

        private var id: JsonField<String>? = null
        private var createdAt: JsonField<Long>? = null
        private var data: JsonField<Data>? = null
        private var type: JsonValue = JsonValue.from("fine_tuning.job.failed")
        private var object_: JsonField<Object> = JsonMissing.of()
        private var additionalProperties: MutableMap<String, JsonValue> = mutableMapOf()

        @JvmSynthetic
        internal fun from(fineTuningJobFailedWebhookEvent: FineTuningJobFailedWebhookEvent) =
            apply {
                id = fineTuningJobFailedWebhookEvent.id
                createdAt = fineTuningJobFailedWebhookEvent.createdAt
                data = fineTuningJobFailedWebhookEvent.data
                type = fineTuningJobFailedWebhookEvent.type
                object_ = fineTuningJobFailedWebhookEvent.object_
                additionalProperties =
                    fineTuningJobFailedWebhookEvent.additionalProperties.toMutableMap()
            }
        ...
        /**
         * Returns an immutable instance of [FineTuningJobFailedWebhookEvent].
         *
         ...
         */
        fun build(): FineTuningJobFailedWebhookEvent =
            FineTuningJobFailedWebhookEvent(
                checkRequired("id", id),
    ...
    fun validate(): FineTuningJobFailedWebhookEvent = apply {
        if (validated) {
            return@apply
        }
        ...
        data().validate()
        _type().let {
            if (it != JsonValue.from("fine_tuning.job.failed")) {
    ...
    internal fun validity(): Int =
        (if (id.asKnown().isPresent) 1 else 0) +
            ...
            type.let { if (it == JsonValue.from("fine_tuning.job.failed")) 1 else 0 } +
    ...
    override fun toString() =
        "FineTuningJobFailedWebhookEvent{id=$id, createdAt=$createdAt, data=$data, type=$type, object_=$object_, additionalProperties=$additionalProperties}"
}
