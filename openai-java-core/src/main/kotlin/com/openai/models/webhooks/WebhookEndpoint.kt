...
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [WebhookEndpoint].
         *
    ...
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(webhookEndpoint: WebhookEndpoint) = apply {
            id = webhookEndpoint.id
            createdAt = webhookEndpoint.createdAt
            eventTypes = webhookEndpoint.eventTypes.map { it.toMutableList() }
            name = webhookEndpoint.name
            object_ = webhookEndpoint.object_
            signingSecretHint = webhookEndpoint.signingSecretHint
            url = webhookEndpoint.url
            updatedAt = webhookEndpoint.updatedAt
            additionalProperties = webhookEndpoint.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [WebhookEndpoint].
         *
     ...
     *   expected type.
     */
    fun validate(): WebhookEndpoint = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun toString() =
        "WebhookEndpoint{id=$id, createdAt=$createdAt, eventTypes=$eventTypes, name=$name, object_=$object_, signingSecretHint=$signingSecretHint, url=$url, updatedAt=$updatedAt, additionalProperties=$additionalProperties}"
}
