...
private constructor(
    ...
    class Builder internal constructor() {
        ...
        private var type: JsonValue = JsonValue.from("fine_tuning.job.succeeded")
        private var object_: JsonField<Object> = JsonMissing.of()
        private var additionalProperties: MutableMap<String, JsonValue> = mutableMapOf()

        @JvmSynthetic
        internal fun from(fineTuningJobSucceededWebhookEvent: FineTuningJobSucceededWebhookEvent) =
            apply {
                id = fineTuningJobSucceededWebhookEvent.id
                createdAt = fineTuningJobSucceededWebhookEvent.createdAt
                data = fineTuningJobSucceededWebhookEvent.data
                type = fineTuningJobSucceededWebhookEvent.type
                object_ = fineTuningJobSucceededWebhookEvent.object_
                additionalProperties =
                    fineTuningJobSucceededWebhookEvent.additionalProperties.toMutableMap()
            }
        ...
        /**
         * Returns an immutable instance of [FineTuningJobSucceededWebhookEvent].
         *
         ...
         */
        fun build(): FineTuningJobSucceededWebhookEvent =
            FineTuningJobSucceededWebhookEvent(
                checkRequired("id", id),
    ...
    fun validate(): FineTuningJobSucceededWebhookEvent = apply {
        if (validated) {
            return@apply
        }
        ...
        data().validate()
        _type().let {
            if (it != JsonValue.from("fine_tuning.job.succeeded")) {
    ...
    internal fun validity(): Int =
        (if (id.asKnown().isPresent) 1 else 0) +
            ...
            type.let { if (it == JsonValue.from("fine_tuning.job.succeeded")) 1 else 0 } +
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return /* spotless:off */ other is FineTuningJobSucceededWebhookEvent && id == other.id && createdAt == other.createdAt && data == other.data && type == other.type && object_ == other.object_ && additionalProperties == other.additionalProperties /* spotless:on */
    }
    ...
    override fun toString() =
        "FineTuningJobSucceededWebhookEvent{id=$id, createdAt=$createdAt, data=$data, type=$type, object_=$object_, additionalProperties=$additionalProperties}"
}
