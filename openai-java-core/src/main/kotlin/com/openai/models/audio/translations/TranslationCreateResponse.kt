...
private constructor(
     ...
     *     @Override
     *     public Optional<String> visitTranslation(Translation translation) {
     *         return Optional.of(translation.toString());
     *     }
     *
     *     // ...
     *
    ...
    interface Visitor<out T> {
        ...
        fun visitTranslation(translation: Translation): T = unknown(JsonValue.from(translation))

        fun visitVerbose(verbose: TranslationVerbose): T = unknown(JsonValue.from(verbose))
