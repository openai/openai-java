...
private constructor(
    ...
    class Builder internal constructor() {
        ...
        internal fun from(certificateActivatePageResponse: CertificateActivatePageResponse) =
            apply {
                ...
                hasMore = certificateActivatePageResponse.hasMore
                object_ = certificateActivatePageResponse.object_
                firstId = certificateActivatePageResponse.firstId
                lastId = certificateActivatePageResponse.lastId
    ...
    override fun toString() =
        "CertificateActivatePageResponse{data=$data, hasMore=$hasMore, object_=$object_, firstId=$firstId, lastId=$lastId, additionalProperties=$additionalProperties}"
}
