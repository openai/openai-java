...
private constructor(
     ...
     * ```java
     * JsonValue.from("organization.project.api_key.deleted")
     * ```
     *
    ...
    class Builder internal constructor() {
        ...
        private var object_: JsonValue = JsonValue.from("organization.project.api_key.deleted")
        private var additionalProperties: MutableMap<String, JsonValue> = mutableMapOf()

        @JvmSynthetic
        internal fun from(apiKeyDeleteResponse: ApiKeyDeleteResponse) = apply {
            id = apiKeyDeleteResponse.id
            deleted = apiKeyDeleteResponse.deleted
            object_ = apiKeyDeleteResponse.object_
    ...
    fun validate(): ApiKeyDeleteResponse = apply {
        ...
        deleted()
        _object_().let {
            if (it != JsonValue.from("organization.project.api_key.deleted")) {
    ...
    internal fun validity(): Int =
        (if (id.asKnown().isPresent) 1 else 0) +
            ...
            object_.let {
                if (it == JsonValue.from("organization.project.api_key.deleted")) 1 else 0
            }
    ...
    override fun toString() =
        "ApiKeyDeleteResponse{id=$id, deleted=$deleted, object_=$object_, additionalProperties=$additionalProperties}"
}
