...
private constructor(
    private val data: JsonField<List<ProjectSpendAlert>>,
    ...
    private constructor(
        @JsonProperty("data")
        @ExcludeMissing
        data: JsonField<List<ProjectSpendAlert>> = JsonMissing.of(),
     ...
     */
    fun data(): List<ProjectSpendAlert> = data.getRequired("data")
     ...
     */
    @JsonProperty("data") @ExcludeMissing fun _data(): JsonField<List<ProjectSpendAlert>> = data
    ...
    class Builder internal constructor() {
        ...
        private var data: JsonField<MutableList<ProjectSpendAlert>>? = null
        ...
        /** Spend alerts returned in the current page. */
        fun data(data: List<ProjectSpendAlert>) = data(JsonField.of(data))

        /**
         * Sets [Builder.data] to an arbitrary JSON value.
         *
         * You should usually call [Builder.data] with a well-typed `List<ProjectSpendAlert>` value
         * instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun data(data: JsonField<List<ProjectSpendAlert>>) = apply {
            this.data = data.map { it.toMutableList() }
        }

        /**
         * Adds a single [ProjectSpendAlert] to [Builder.data].
         *
         * @throws IllegalStateException if the field was previously set to a non-list.
         */
        fun addData(data: ProjectSpendAlert) = apply {
            this.data =
