...
class RateLimitListRateLimitsPageResponse
@JsonCreator(mode = JsonCreator.Mode.DISABLED)
private constructor(
    private val data: JsonField<List<ProjectRateLimit>>,
    ...
    private constructor(
        @JsonProperty("data")
        @ExcludeMissing
        data: JsonField<List<ProjectRateLimit>> = JsonMissing.of(),
     ...
     */
    fun data(): List<ProjectRateLimit> = data.getRequired("data")
     ...
     */
    @JsonProperty("data") @ExcludeMissing fun _data(): JsonField<List<ProjectRateLimit>> = data
    ...
    companion object {
         ...
         * [RateLimitListRateLimitsPageResponse].
         *
    ...
    /** A builder for [RateLimitListRateLimitsPageResponse]. */
    class Builder internal constructor() {

        private var data: JsonField<MutableList<ProjectRateLimit>>? = null
        ...
        @JvmSynthetic
        internal fun from(
            rateLimitListRateLimitsPageResponse: RateLimitListRateLimitsPageResponse
        ) = apply {
            data = rateLimitListRateLimitsPageResponse.data.map { it.toMutableList() }
            hasMore = rateLimitListRateLimitsPageResponse.hasMore
            object_ = rateLimitListRateLimitsPageResponse.object_
            firstId = rateLimitListRateLimitsPageResponse.firstId
            lastId = rateLimitListRateLimitsPageResponse.lastId
            additionalProperties =
                rateLimitListRateLimitsPageResponse.additionalProperties.toMutableMap()
        }

        fun data(data: List<ProjectRateLimit>) = data(JsonField.of(data))

        /**
         * Sets [Builder.data] to an arbitrary JSON value.
         *
         * You should usually call [Builder.data] with a well-typed `List<ProjectRateLimit>` value
         * instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun data(data: JsonField<List<ProjectRateLimit>>) = apply {
            this.data = data.map { it.toMutableList() }
        }

        /**
         * Adds a single [ProjectRateLimit] to [Builder.data].
         *
         * @throws IllegalStateException if the field was previously set to a non-list.
         */
        fun addData(data: ProjectRateLimit) = apply {
            this.data =
        ...
        /**
         * Returns an immutable instance of [RateLimitListRateLimitsPageResponse].
         *
         ...
         */
        fun build(): RateLimitListRateLimitsPageResponse =
            RateLimitListRateLimitsPageResponse(
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is RateLimitListRateLimitsPageResponse &&
            data == other.data &&
    ...
    override fun toString() =
        "RateLimitListRateLimitsPageResponse{data=$data, hasMore=$hasMore, object_=$object_, firstId=$firstId, lastId=$lastId, additionalProperties=$additionalProperties}"
}
