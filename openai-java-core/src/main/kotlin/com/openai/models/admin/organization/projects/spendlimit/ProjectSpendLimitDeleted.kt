...
private constructor(
     ...
     * ```java
     * JsonValue.from("project.spend_limit.deleted")
     * ```
     *
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [ProjectSpendLimitDeleted].
         *
    ...
    /** A builder for [ProjectSpendLimitDeleted]. */
    class Builder internal constructor() {

        private var deleted: JsonField<Boolean>? = null
        private var object_: JsonValue = JsonValue.from("project.spend_limit.deleted")
        private var additionalProperties: MutableMap<String, JsonValue> = mutableMapOf()

        @JvmSynthetic
        internal fun from(projectSpendLimitDeleted: ProjectSpendLimitDeleted) = apply {
            deleted = projectSpendLimitDeleted.deleted
            object_ = projectSpendLimitDeleted.object_
            additionalProperties = projectSpendLimitDeleted.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [ProjectSpendLimitDeleted].
         *
         ...
         */
        fun build(): ProjectSpendLimitDeleted =
     ...
     *   expected type.
     */
    fun validate(): ProjectSpendLimitDeleted = apply {
        if (validated) {
            return@apply
        }
        ...
        deleted()
        _object_().let {
            if (it != JsonValue.from("project.spend_limit.deleted")) {
    ...
    internal fun validity(): Int =
        (if (deleted.asKnown().isPresent) 1 else 0) +
            object_.let { if (it == JsonValue.from("project.spend_limit.deleted")) 1 else 0 }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is ProjectSpendLimitDeleted &&
    ...
    override fun toString() =
        "ProjectSpendLimitDeleted{deleted=$deleted, object_=$object_, additionalProperties=$additionalProperties}"
}
