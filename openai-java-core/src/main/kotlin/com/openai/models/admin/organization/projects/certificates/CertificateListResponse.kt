...
private constructor(
    ...
    /** A builder for [CertificateListResponse]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(certificateListResponse: CertificateListResponse) = apply {
            id = certificateListResponse.id
            active = certificateListResponse.active
            certificateDetails = certificateListResponse.certificateDetails
            createdAt = certificateListResponse.createdAt
            name = certificateListResponse.name
            object_ = certificateListResponse.object_
            additionalProperties = certificateListResponse.additionalProperties.toMutableMap()
        }
         ...
         */
        fun build(): CertificateListResponse =
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is CertificateListResponse &&
            id == other.id &&
            active == other.active &&
    ...
    override fun toString() =
        "CertificateListResponse{id=$id, active=$active, certificateDetails=$certificateDetails, createdAt=$createdAt, name=$name, object_=$object_, additionalProperties=$additionalProperties}"
}
