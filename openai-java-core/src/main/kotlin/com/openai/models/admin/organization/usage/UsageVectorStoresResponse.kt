...
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [UsageVectorStoresResponse].
         *
    ...
    /** A builder for [UsageVectorStoresResponse]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(usageVectorStoresResponse: UsageVectorStoresResponse) = apply {
            data = usageVectorStoresResponse.data.map { it.toMutableList() }
            hasMore = usageVectorStoresResponse.hasMore
            nextPage = usageVectorStoresResponse.nextPage
            object_ = usageVectorStoresResponse.object_
            additionalProperties = usageVectorStoresResponse.additionalProperties.toMutableMap()
        }
         ...
         */
        fun build(): UsageVectorStoresResponse =
     ...
     *   expected type.
     */
    fun validate(): UsageVectorStoresResponse = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is UsageVectorStoresResponse &&
            data == other.data &&
    ...
    override fun toString() =
        "UsageVectorStoresResponse{data=$data, hasMore=$hasMore, nextPage=$nextPage, object_=$object_, additionalProperties=$additionalProperties}"
}
