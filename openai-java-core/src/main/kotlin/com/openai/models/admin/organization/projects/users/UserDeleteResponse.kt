...
private constructor(
     ...
     * ```java
     * JsonValue.from("organization.project.user.deleted")
     * ```
     *
    ...
    class Builder internal constructor() {
        ...
        private var object_: JsonValue = JsonValue.from("organization.project.user.deleted")
        private var additionalProperties: MutableMap<String, JsonValue> = mutableMapOf()

        @JvmSynthetic
        internal fun from(userDeleteResponse: UserDeleteResponse) = apply {
            id = userDeleteResponse.id
            deleted = userDeleteResponse.deleted
            object_ = userDeleteResponse.object_
    ...
    fun validate(): UserDeleteResponse = apply {
        ...
        deleted()
        _object_().let {
            if (it != JsonValue.from("organization.project.user.deleted")) {
    ...
    internal fun validity(): Int =
        (if (id.asKnown().isPresent) 1 else 0) +
            ...
            object_.let { if (it == JsonValue.from("organization.project.user.deleted")) 1 else 0 }
    ...
    override fun toString() =
        "UserDeleteResponse{id=$id, deleted=$deleted, object_=$object_, additionalProperties=$additionalProperties}"
}
