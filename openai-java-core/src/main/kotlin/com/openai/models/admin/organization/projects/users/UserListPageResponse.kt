...
private constructor(
    private val data: JsonField<List<ProjectUser>>,
    ...
    @JsonCreator
    private constructor(
        @JsonProperty("data") @ExcludeMissing data: JsonField<List<ProjectUser>> = JsonMissing.of(),
     ...
     */
    fun data(): List<ProjectUser> = data.getRequired("data")
     ...
     */
    @JsonProperty("data") @ExcludeMissing fun _data(): JsonField<List<ProjectUser>> = data
    ...
    class Builder internal constructor() {
        ...
        private var data: JsonField<MutableList<ProjectUser>>? = null
        ...
        internal fun from(userListPageResponse: UserListPageResponse) = apply {
            ...
            object_ = userListPageResponse.object_
        ...
        fun data(data: List<ProjectUser>) = data(JsonField.of(data))

        /**
         * Sets [Builder.data] to an arbitrary JSON value.
         *
         * You should usually call [Builder.data] with a well-typed `List<ProjectUser>` value
         * instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun data(data: JsonField<List<ProjectUser>>) = apply {
         ...
         */
        fun addData(data: ProjectUser) = apply {
            this.data =
    ...
    override fun toString() =
        "UserListPageResponse{data=$data, hasMore=$hasMore, object_=$object_, firstId=$firstId, lastId=$lastId, additionalProperties=$additionalProperties}"
}
