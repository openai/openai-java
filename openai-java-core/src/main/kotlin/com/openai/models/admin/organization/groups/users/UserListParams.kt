...
private constructor(
    ...
    /**
     * A cursor for use in pagination. Provide the ID of the last user from the previous list
     * response to retrieve the next page.
     */
    fun after(): Optional<String> = Optional.ofNullable(after)

    /**
     * A limit on the number of users to be returned. Limit can range between 0 and 1000, and the
     * default is 100.
     */
    ...
    class Builder internal constructor() {
        ...
        internal fun from(userListParams: UserListParams) = apply {
            groupId = userListParams.groupId
            after = userListParams.after
            limit = userListParams.limit
            order = userListParams.order
        ...
        /**
         * A limit on the number of users to be returned. Limit can range between 0 and 1000, and
         * the default is 100.
         */
    ...
    override fun hashCode(): Int =
        Objects.hash(groupId, after, limit, order, additionalHeaders, additionalQueryParams)

    override fun toString() =
        "UserListParams{groupId=$groupId, after=$after, limit=$limit, order=$order, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
