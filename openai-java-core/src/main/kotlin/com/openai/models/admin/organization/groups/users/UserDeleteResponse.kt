...
private constructor(
     ...
     * ```java
     * JsonValue.from("group.user.deleted")
     * ```
     *
    ...
    class Builder internal constructor() {
        ...
        private var object_: JsonValue = JsonValue.from("group.user.deleted")
    ...
    fun validate(): UserDeleteResponse = apply {
        ...
        deleted()
        _object_().let {
            if (it != JsonValue.from("group.user.deleted")) {
    ...
    internal fun validity(): Int =
        (if (deleted.asKnown().isPresent) 1 else 0) +
            object_.let { if (it == JsonValue.from("group.user.deleted")) 1 else 0 }
    ...
    override fun toString() =
        "UserDeleteResponse{deleted=$deleted, object_=$object_, additionalProperties=$additionalProperties}"
}
