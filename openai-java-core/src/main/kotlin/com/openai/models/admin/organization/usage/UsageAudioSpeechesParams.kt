...
class UsageAudioSpeechesParams
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [UsageAudioSpeechesParams].
         *
    ...
    /** A builder for [UsageAudioSpeechesParams]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(usageAudioSpeechesParams: UsageAudioSpeechesParams) = apply {
            startTime = usageAudioSpeechesParams.startTime
            apiKeyIds = usageAudioSpeechesParams.apiKeyIds?.toMutableList()
            bucketWidth = usageAudioSpeechesParams.bucketWidth
            endTime = usageAudioSpeechesParams.endTime
            groupBy = usageAudioSpeechesParams.groupBy?.toMutableList()
            limit = usageAudioSpeechesParams.limit
            models = usageAudioSpeechesParams.models?.toMutableList()
            page = usageAudioSpeechesParams.page
            projectIds = usageAudioSpeechesParams.projectIds?.toMutableList()
            userIds = usageAudioSpeechesParams.userIds?.toMutableList()
            additionalHeaders = usageAudioSpeechesParams.additionalHeaders.toBuilder()
            additionalQueryParams = usageAudioSpeechesParams.additionalQueryParams.toBuilder()
        }
        ...
        /**
         * Returns an immutable instance of [UsageAudioSpeechesParams].
         *
         ...
         */
        fun build(): UsageAudioSpeechesParams =
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is UsageAudioSpeechesParams &&
    ...
    override fun toString() =
        "UsageAudioSpeechesParams{startTime=$startTime, apiKeyIds=$apiKeyIds, bucketWidth=$bucketWidth, endTime=$endTime, groupBy=$groupBy, limit=$limit, models=$models, page=$page, projectIds=$projectIds, userIds=$userIds, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
