...
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [UsageModerationsResponse].
         *
    ...
    /** A builder for [UsageModerationsResponse]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(usageModerationsResponse: UsageModerationsResponse) = apply {
            data = usageModerationsResponse.data.map { it.toMutableList() }
            hasMore = usageModerationsResponse.hasMore
            nextPage = usageModerationsResponse.nextPage
            object_ = usageModerationsResponse.object_
            additionalProperties = usageModerationsResponse.additionalProperties.toMutableMap()
        }
         ...
         */
        fun build(): UsageModerationsResponse =
    ...
    fun validate(): UsageModerationsResponse = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is UsageModerationsResponse &&
            data == other.data &&
    ...
    override fun toString() =
        "UsageModerationsResponse{data=$data, hasMore=$hasMore, nextPage=$nextPage, object_=$object_, additionalProperties=$additionalProperties}"
}
