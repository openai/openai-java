...
private constructor(
     ...
     * continue listing organization roles.
     */
    ...
    class Builder internal constructor() {
        ...
        internal fun from(roleListParams: RoleListParams) = apply {
            groupId = roleListParams.groupId
            after = roleListParams.after
            limit = roleListParams.limit
            order = roleListParams.order
    ...
    override fun toString() =
        "RoleListParams{groupId=$groupId, after=$after, limit=$limit, order=$order, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
