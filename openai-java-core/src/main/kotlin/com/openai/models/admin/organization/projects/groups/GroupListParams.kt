...
private constructor(
    ...
    /**
     * Cursor for pagination. Provide the ID of the last group from the previous response to fetch
     * the next page.
     */
    ...
    class Builder internal constructor() {
        ...
        internal fun from(groupListParams: GroupListParams) = apply {
            projectId = groupListParams.projectId
        ...
        /**
         * Cursor for pagination. Provide the ID of the last group from the previous response to
         * fetch the next page.
         */
    ...
    override fun hashCode(): Int =
        Objects.hash(projectId, after, limit, order, additionalHeaders, additionalQueryParams)

    override fun toString() =
        "GroupListParams{projectId=$projectId, after=$after, limit=$limit, order=$order, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
