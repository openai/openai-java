...
private constructor(
     ...
     * ```java
     * JsonValue.from("organization.spend_limit")
     * ```
     *
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [OrganizationSpendLimit].
         *
    ...
    /** A builder for [OrganizationSpendLimit]. */
    class Builder internal constructor() {

        private var currency: JsonField<Currency>? = null
        private var enforcement: JsonField<Enforcement>? = null
        private var interval: JsonField<Interval>? = null
        private var object_: JsonValue = JsonValue.from("organization.spend_limit")
        private var thresholdAmount: JsonField<Long>? = null
        private var additionalProperties: MutableMap<String, JsonValue> = mutableMapOf()

        @JvmSynthetic
        internal fun from(organizationSpendLimit: OrganizationSpendLimit) = apply {
            currency = organizationSpendLimit.currency
            enforcement = organizationSpendLimit.enforcement
            interval = organizationSpendLimit.interval
            object_ = organizationSpendLimit.object_
            thresholdAmount = organizationSpendLimit.thresholdAmount
            additionalProperties = organizationSpendLimit.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [OrganizationSpendLimit].
         *
         ...
         */
        fun build(): OrganizationSpendLimit =
     ...
     *   expected type.
     */
    fun validate(): OrganizationSpendLimit = apply {
        if (validated) {
            return@apply
        }
        ...
        interval()
        _object_().let {
            if (it != JsonValue.from("organization.spend_limit")) {
    ...
    internal fun validity(): Int =
        (if (currency.asKnown().isPresent) 1 else 0) +
            ...
            object_.let { if (it == JsonValue.from("organization.spend_limit")) 1 else 0 } +
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is OrganizationSpendLimit &&
    ...
    override fun toString() =
        "OrganizationSpendLimit{currency=$currency, enforcement=$enforcement, interval=$interval, object_=$object_, thresholdAmount=$thresholdAmount, additionalProperties=$additionalProperties}"
}
