...
private constructor(
    ...
    class Builder internal constructor() {
        ...
        internal fun from(serviceAccountUpdateParams: ServiceAccountUpdateParams) = apply {
            projectId = serviceAccountUpdateParams.projectId
    ...
    private constructor(
        ...
        class Builder internal constructor() {
             ...
             * Further updates to this [Builder] will not mutate the returned instance.
             */
            fun build(): Body = Body(name, role, additionalProperties.toMutableMap())
        }
        ...
        internal fun validity(): Int =
            (if (name.asKnown().isPresent) 1 else 0) + (role.asKnown().getOrNull()?.validity() ?: 0)
        ...
        private val hashCode: Int by lazy { Objects.hash(name, role, additionalProperties) }

        override fun hashCode(): Int = hashCode

        override fun toString() =
            "Body{name=$name, role=$role, additionalProperties=$additionalProperties}"
    }
    ...
    override fun toString() =
        "ServiceAccountUpdateParams{projectId=$projectId, serviceAccountId=$serviceAccountId, body=$body, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
