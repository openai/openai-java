...
private constructor(
    private val data: JsonField<List<RoleListResponse>>,
    ...
    private constructor(
        @JsonProperty("data")
        @ExcludeMissing
        data: JsonField<List<RoleListResponse>> = JsonMissing.of(),
     ...
     */
    fun data(): List<RoleListResponse> = data.getRequired("data")
     ...
     */
    @JsonProperty("data") @ExcludeMissing fun _data(): JsonField<List<RoleListResponse>> = data
    ...
    class Builder internal constructor() {
        ...
        private var data: JsonField<MutableList<RoleListResponse>>? = null
        ...
        /** Role assignments returned in the current page. */
        fun data(data: List<RoleListResponse>) = data(JsonField.of(data))

        /**
         * Sets [Builder.data] to an arbitrary JSON value.
         *
         * You should usually call [Builder.data] with a well-typed `List<RoleListResponse>` value
         * instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun data(data: JsonField<List<RoleListResponse>>) = apply {
         ...
         */
        fun addData(data: RoleListResponse) = apply {
            this.data =
