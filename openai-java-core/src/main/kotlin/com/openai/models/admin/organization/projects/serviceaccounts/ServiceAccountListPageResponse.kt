...
private constructor(
    private val data: JsonField<List<ProjectServiceAccount>>,
    ...
    private constructor(
        @JsonProperty("data")
        @ExcludeMissing
        data: JsonField<List<ProjectServiceAccount>> = JsonMissing.of(),
     ...
     */
    fun data(): List<ProjectServiceAccount> = data.getRequired("data")
     ...
     */
    @JsonProperty("data") @ExcludeMissing fun _data(): JsonField<List<ProjectServiceAccount>> = data
    ...
    class Builder internal constructor() {
        ...
        private var data: JsonField<MutableList<ProjectServiceAccount>>? = null
        ...
        internal fun from(serviceAccountListPageResponse: ServiceAccountListPageResponse) = apply {
            data = serviceAccountListPageResponse.data.map { it.toMutableList() }
            hasMore = serviceAccountListPageResponse.hasMore
            object_ = serviceAccountListPageResponse.object_
            firstId = serviceAccountListPageResponse.firstId
            lastId = serviceAccountListPageResponse.lastId
            additionalProperties =
                serviceAccountListPageResponse.additionalProperties.toMutableMap()
        }

        fun data(data: List<ProjectServiceAccount>) = data(JsonField.of(data))

        /**
         * Sets [Builder.data] to an arbitrary JSON value.
         *
         * You should usually call [Builder.data] with a well-typed `List<ProjectServiceAccount>`
         * value instead. This method is primarily for setting the field to an undocumented or not
         * yet supported value.
         */
        fun data(data: JsonField<List<ProjectServiceAccount>>) = apply {
            this.data = data.map { it.toMutableList() }
        }

        /**
         * Adds a single [ProjectServiceAccount] to [Builder.data].
         *
         * @throws IllegalStateException if the field was previously set to a non-list.
         */
        fun addData(data: ProjectServiceAccount) = apply {
            this.data =
    ...
    override fun toString() =
        "ServiceAccountListPageResponse{data=$data, hasMore=$hasMore, object_=$object_, firstId=$firstId, lastId=$lastId, additionalProperties=$additionalProperties}"
}
