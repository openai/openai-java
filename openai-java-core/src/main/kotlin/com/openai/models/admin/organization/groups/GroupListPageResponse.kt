...
private constructor(
    private val data: JsonField<List<Group>>,
    ...
    @JsonCreator
    private constructor(
        @JsonProperty("data") @ExcludeMissing data: JsonField<List<Group>> = JsonMissing.of(),
     ...
     */
    fun data(): List<Group> = data.getRequired("data")
     ...
     */
    @JsonProperty("data") @ExcludeMissing fun _data(): JsonField<List<Group>> = data
    ...
    class Builder internal constructor() {
        ...
        private var data: JsonField<MutableList<Group>>? = null
        ...
        /** Groups returned in the current page. */
        fun data(data: List<Group>) = data(JsonField.of(data))

        /**
         * Sets [Builder.data] to an arbitrary JSON value.
         *
         * You should usually call [Builder.data] with a well-typed `List<Group>` value instead.
         * This method is primarily for setting the field to an undocumented or not yet supported
         * value.
         */
        fun data(data: JsonField<List<Group>>) = apply {
