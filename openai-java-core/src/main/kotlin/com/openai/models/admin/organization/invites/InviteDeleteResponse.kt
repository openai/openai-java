...
private constructor(
     ...
     * ```java
     * JsonValue.from("organization.invite.deleted")
     * ```
     *
    ...
    class Builder internal constructor() {
        ...
        private var object_: JsonValue = JsonValue.from("organization.invite.deleted")
        private var additionalProperties: MutableMap<String, JsonValue> = mutableMapOf()

        @JvmSynthetic
        internal fun from(inviteDeleteResponse: InviteDeleteResponse) = apply {
            id = inviteDeleteResponse.id
            deleted = inviteDeleteResponse.deleted
            object_ = inviteDeleteResponse.object_
    ...
    fun validate(): InviteDeleteResponse = apply {
        ...
        deleted()
        _object_().let {
            if (it != JsonValue.from("organization.invite.deleted")) {
    ...
    internal fun validity(): Int =
        (if (id.asKnown().isPresent) 1 else 0) +
            ...
            object_.let { if (it == JsonValue.from("organization.invite.deleted")) 1 else 0 }
    ...
    override fun toString() =
        "InviteDeleteResponse{id=$id, deleted=$deleted, object_=$object_, additionalProperties=$additionalProperties}"
}
