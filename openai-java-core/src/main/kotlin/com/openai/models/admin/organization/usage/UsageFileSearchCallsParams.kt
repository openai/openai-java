...
class UsageFileSearchCallsParams
private constructor(
    ...
    private val vectorStoreIds: List<String>?,
     ...
     * `api_key_id`, `vector_store_id` or any combination of them.
     */
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [UsageFileSearchCallsParams].
         *
    ...
    /** A builder for [UsageFileSearchCallsParams]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(usageFileSearchCallsParams: UsageFileSearchCallsParams) = apply {
            startTime = usageFileSearchCallsParams.startTime
            apiKeyIds = usageFileSearchCallsParams.apiKeyIds?.toMutableList()
            bucketWidth = usageFileSearchCallsParams.bucketWidth
            endTime = usageFileSearchCallsParams.endTime
            groupBy = usageFileSearchCallsParams.groupBy?.toMutableList()
            limit = usageFileSearchCallsParams.limit
            page = usageFileSearchCallsParams.page
            projectIds = usageFileSearchCallsParams.projectIds?.toMutableList()
            userIds = usageFileSearchCallsParams.userIds?.toMutableList()
            vectorStoreIds = usageFileSearchCallsParams.vectorStoreIds?.toMutableList()
            additionalHeaders = usageFileSearchCallsParams.additionalHeaders.toBuilder()
            additionalQueryParams = usageFileSearchCallsParams.additionalQueryParams.toBuilder()
        }
         ...
         * `user_id`, `api_key_id`, `vector_store_id` or any combination of them.
         */
        ...
        /** Alias for calling [Builder.vectorStoreIds] with `vectorStoreIds.orElse(null)`. */
        fun vectorStoreIds(vectorStoreIds: Optional<List<String>>) =
            vectorStoreIds(vectorStoreIds.getOrNull())
        ...
        fun addVectorStoreId(vectorStoreId: String) = apply {
            vectorStoreIds = (vectorStoreIds ?: mutableListOf()).apply { add(vectorStoreId) }
        }
        ...
        /**
         * Returns an immutable instance of [UsageFileSearchCallsParams].
         *
         ...
         */
        fun build(): UsageFileSearchCallsParams =
    ...
    override fun _queryParams(): QueryParams =
        QueryParams.builder()
            .apply {
                ...
                vectorStoreIds?.forEach { put("vector_store_ids[]", it) }
    ...
    class GroupBy @JsonCreator private constructor(private val value: JsonField<String>) : Enum {
        ...
        companion object {
            ...
            @JvmField val VECTOR_STORE_ID = of("vector_store_id")
        ...
        fun known(): Known =
            when (this) {
                ...
                VECTOR_STORE_ID -> Known.VECTOR_STORE_ID
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is UsageFileSearchCallsParams &&
    ...
    override fun toString() =
        "UsageFileSearchCallsParams{startTime=$startTime, apiKeyIds=$apiKeyIds, bucketWidth=$bucketWidth, endTime=$endTime, groupBy=$groupBy, limit=$limit, page=$page, projectIds=$projectIds, userIds=$userIds, vectorStoreIds=$vectorStoreIds, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
