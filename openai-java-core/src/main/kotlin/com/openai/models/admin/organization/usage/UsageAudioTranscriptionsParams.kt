...
class UsageAudioTranscriptionsParams
private constructor(
    ...
    /** A builder for [UsageAudioTranscriptionsParams]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(usageAudioTranscriptionsParams: UsageAudioTranscriptionsParams) = apply {
            startTime = usageAudioTranscriptionsParams.startTime
            apiKeyIds = usageAudioTranscriptionsParams.apiKeyIds?.toMutableList()
            bucketWidth = usageAudioTranscriptionsParams.bucketWidth
            endTime = usageAudioTranscriptionsParams.endTime
            groupBy = usageAudioTranscriptionsParams.groupBy?.toMutableList()
            limit = usageAudioTranscriptionsParams.limit
            models = usageAudioTranscriptionsParams.models?.toMutableList()
            page = usageAudioTranscriptionsParams.page
            projectIds = usageAudioTranscriptionsParams.projectIds?.toMutableList()
            userIds = usageAudioTranscriptionsParams.userIds?.toMutableList()
            additionalHeaders = usageAudioTranscriptionsParams.additionalHeaders.toBuilder()
            additionalQueryParams = usageAudioTranscriptionsParams.additionalQueryParams.toBuilder()
        }
         ...
         */
        fun build(): UsageAudioTranscriptionsParams =
            UsageAudioTranscriptionsParams(
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is UsageAudioTranscriptionsParams &&
    ...
    override fun toString() =
        "UsageAudioTranscriptionsParams{startTime=$startTime, apiKeyIds=$apiKeyIds, bucketWidth=$bucketWidth, endTime=$endTime, groupBy=$groupBy, limit=$limit, models=$models, page=$page, projectIds=$projectIds, userIds=$userIds, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
