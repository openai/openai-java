...
private constructor(
     ...
     *   unexpectedly missing or null (e.g. if the server responded with an unexpected value).
     */
    fun notificationChannel(): NotificationChannel = body.notificationChannel()
     ...
     * type.
     */
    fun _notificationChannel(): JsonField<NotificationChannel> = body._notificationChannel()
    ...
    /** A builder for [SpendAlertUpdateParams]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(spendAlertUpdateParams: SpendAlertUpdateParams) = apply {
            projectId = spendAlertUpdateParams.projectId
            alertId = spendAlertUpdateParams.alertId
            body = spendAlertUpdateParams.body.toBuilder()
            additionalHeaders = spendAlertUpdateParams.additionalHeaders.toBuilder()
            additionalQueryParams = spendAlertUpdateParams.additionalQueryParams.toBuilder()
        }
         ...
         */
        fun build(): SpendAlertUpdateParams =
    ...
    private constructor(
        ...
        ) : this(currency, interval, notificationChannel, thresholdAmount, mutableMapOf())
         ...
         * Returns the raw JSON value of [notificationChannel].
         *
         * Unlike [notificationChannel], this method doesn't throw if the JSON field has an
         * unexpected type.
         */
        @JsonProperty("notification_channel")
        @ExcludeMissing
        ...
        class Builder internal constructor() {
             ...
             *
             * You should usually call [Builder.notificationChannel] with a well-typed
             * [NotificationChannel] value instead. This method is primarily for setting the field
        ...
        override fun toString() =
            "Body{currency=$currency, interval=$interval, notificationChannel=$notificationChannel, thresholdAmount=$thresholdAmount, additionalProperties=$additionalProperties}"
    }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is SpendAlertUpdateParams &&
    ...
    override fun hashCode(): Int =
        Objects.hash(projectId, alertId, body, additionalHeaders, additionalQueryParams)

    override fun toString() =
        "SpendAlertUpdateParams{projectId=$projectId, alertId=$alertId, body=$body, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
