...
private constructor(
    ...
    /** A builder for [UsageCostsParams]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(usageCostsParams: UsageCostsParams) = apply {
            startTime = usageCostsParams.startTime
            apiKeyIds = usageCostsParams.apiKeyIds?.toMutableList()
            bucketWidth = usageCostsParams.bucketWidth
            ...
            additionalQueryParams = usageCostsParams.additionalQueryParams.toBuilder()
        }
        ...
        /**
         * A limit on the number of buckets to be returned. Limit can range between 1 and 180, and
         * the default is 7.
         */
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is UsageCostsParams &&
