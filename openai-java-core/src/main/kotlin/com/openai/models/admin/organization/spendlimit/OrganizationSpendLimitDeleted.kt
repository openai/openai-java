...
private constructor(
     ...
     * ```java
     * JsonValue.from("organization.spend_limit.deleted")
     * ```
     *
    ...
    /** A builder for [OrganizationSpendLimitDeleted]. */
    class Builder internal constructor() {

        private var deleted: JsonField<Boolean>? = null
        private var object_: JsonValue = JsonValue.from("organization.spend_limit.deleted")
        private var additionalProperties: MutableMap<String, JsonValue> = mutableMapOf()

        @JvmSynthetic
        internal fun from(organizationSpendLimitDeleted: OrganizationSpendLimitDeleted) = apply {
            deleted = organizationSpendLimitDeleted.deleted
            object_ = organizationSpendLimitDeleted.object_
            additionalProperties = organizationSpendLimitDeleted.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [OrganizationSpendLimitDeleted].
         *
         ...
         */
        fun build(): OrganizationSpendLimitDeleted =
            OrganizationSpendLimitDeleted(
     ...
     *   expected type.
     */
    fun validate(): OrganizationSpendLimitDeleted = apply {
        if (validated) {
            return@apply
        }
        ...
        deleted()
        _object_().let {
            if (it != JsonValue.from("organization.spend_limit.deleted")) {
    ...
    internal fun validity(): Int =
        (if (deleted.asKnown().isPresent) 1 else 0) +
            object_.let { if (it == JsonValue.from("organization.spend_limit.deleted")) 1 else 0 }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is OrganizationSpendLimitDeleted &&
    ...
    override fun toString() =
        "OrganizationSpendLimitDeleted{deleted=$deleted, object_=$object_, additionalProperties=$additionalProperties}"
}
