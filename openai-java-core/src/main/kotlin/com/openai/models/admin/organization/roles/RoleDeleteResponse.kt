...
private constructor(
    ...
    class Builder internal constructor() {
        ...
        private var object_: JsonValue = JsonValue.from("role.deleted")
        private var additionalProperties: MutableMap<String, JsonValue> = mutableMapOf()

        @JvmSynthetic
        internal fun from(roleDeleteResponse: RoleDeleteResponse) = apply {
            id = roleDeleteResponse.id
    ...
    fun validate(): RoleDeleteResponse = apply {
        ...
        deleted()
        _object_().let {
            if (it != JsonValue.from("role.deleted")) {
    ...
    internal fun validity(): Int =
        (if (id.asKnown().isPresent) 1 else 0) +
            ...
            object_.let { if (it == JsonValue.from("role.deleted")) 1 else 0 }
    ...
    override fun toString() =
        "RoleDeleteResponse{id=$id, deleted=$deleted, object_=$object_, additionalProperties=$additionalProperties}"
}
