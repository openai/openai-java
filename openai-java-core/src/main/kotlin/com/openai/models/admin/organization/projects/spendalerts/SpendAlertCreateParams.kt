...
private constructor(
    ...
    /** A builder for [SpendAlertCreateParams]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(spendAlertCreateParams: SpendAlertCreateParams) = apply {
            projectId = spendAlertCreateParams.projectId
            body = spendAlertCreateParams.body.toBuilder()
            additionalHeaders = spendAlertCreateParams.additionalHeaders.toBuilder()
            additionalQueryParams = spendAlertCreateParams.additionalQueryParams.toBuilder()
        }
         ...
         */
        fun build(): SpendAlertCreateParams =
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is SpendAlertCreateParams &&
    ...
    override fun toString() =
        "SpendAlertCreateParams{projectId=$projectId, body=$body, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
