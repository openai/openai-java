...
private constructor(
    ...
    /** A builder for [UsageCodeInterpreterSessionsParams]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(usageCodeInterpreterSessionsParams: UsageCodeInterpreterSessionsParams) =
            apply {
                startTime = usageCodeInterpreterSessionsParams.startTime
                bucketWidth = usageCodeInterpreterSessionsParams.bucketWidth
                endTime = usageCodeInterpreterSessionsParams.endTime
                groupBy = usageCodeInterpreterSessionsParams.groupBy?.toMutableList()
                limit = usageCodeInterpreterSessionsParams.limit
                page = usageCodeInterpreterSessionsParams.page
                projectIds = usageCodeInterpreterSessionsParams.projectIds?.toMutableList()
                additionalHeaders = usageCodeInterpreterSessionsParams.additionalHeaders.toBuilder()
                additionalQueryParams =
                    usageCodeInterpreterSessionsParams.additionalQueryParams.toBuilder()
            }
        ...
        /**
         * Returns an immutable instance of [UsageCodeInterpreterSessionsParams].
         *
         ...
         */
        fun build(): UsageCodeInterpreterSessionsParams =
            UsageCodeInterpreterSessionsParams(
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is UsageCodeInterpreterSessionsParams &&
    ...
    override fun toString() =
        "UsageCodeInterpreterSessionsParams{startTime=$startTime, bucketWidth=$bucketWidth, endTime=$endTime, groupBy=$groupBy, limit=$limit, page=$page, projectIds=$projectIds, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
