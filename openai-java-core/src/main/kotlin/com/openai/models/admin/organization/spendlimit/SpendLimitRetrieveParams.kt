...
private constructor(
    ...
    class Builder internal constructor() {
        ...
        fun build(): SpendLimitRetrieveParams =
            SpendLimitRetrieveParams(additionalHeaders.build(), additionalQueryParams.build())
    }
    ...
    override fun toString() =
        "SpendLimitRetrieveParams{additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
