...
class SpendAlertListPageResponse
@JsonCreator(mode = JsonCreator.Mode.DISABLED)
private constructor(
    private val data: JsonField<List<OrganizationSpendAlert>>,
    ...
    private constructor(
        @JsonProperty("data")
        @ExcludeMissing
        data: JsonField<List<OrganizationSpendAlert>> = JsonMissing.of(),
     ...
     */
    fun data(): List<OrganizationSpendAlert> = data.getRequired("data")
    ...
    @JsonProperty("data")
    @ExcludeMissing
    fun _data(): JsonField<List<OrganizationSpendAlert>> = data
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [SpendAlertListPageResponse].
         *
    ...
    /** A builder for [SpendAlertListPageResponse]. */
    class Builder internal constructor() {

        private var data: JsonField<MutableList<OrganizationSpendAlert>>? = null
        ...
        @JvmSynthetic
        internal fun from(spendAlertListPageResponse: SpendAlertListPageResponse) = apply {
            data = spendAlertListPageResponse.data.map { it.toMutableList() }
            firstId = spendAlertListPageResponse.firstId
            hasMore = spendAlertListPageResponse.hasMore
            lastId = spendAlertListPageResponse.lastId
            object_ = spendAlertListPageResponse.object_
            additionalProperties = spendAlertListPageResponse.additionalProperties.toMutableMap()
        }

        /** Spend alerts returned in the current page. */
        fun data(data: List<OrganizationSpendAlert>) = data(JsonField.of(data))

        /**
         * Sets [Builder.data] to an arbitrary JSON value.
         *
         * You should usually call [Builder.data] with a well-typed `List<OrganizationSpendAlert>`
         * value instead. This method is primarily for setting the field to an undocumented or not
         * yet supported value.
         */
        fun data(data: JsonField<List<OrganizationSpendAlert>>) = apply {
            this.data = data.map { it.toMutableList() }
        }

        /**
         * Adds a single [OrganizationSpendAlert] to [Builder.data].
         *
         * @throws IllegalStateException if the field was previously set to a non-list.
         */
        fun addData(data: OrganizationSpendAlert) = apply {
            this.data =
        ...
        /**
         * Returns an immutable instance of [SpendAlertListPageResponse].
         *
         ...
         */
        fun build(): SpendAlertListPageResponse =
            SpendAlertListPageResponse(
     ...
     *   expected type.
     */
    fun validate(): SpendAlertListPageResponse = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is SpendAlertListPageResponse &&
            data == other.data &&
    ...
    override fun toString() =
        "SpendAlertListPageResponse{data=$data, firstId=$firstId, hasMore=$hasMore, lastId=$lastId, object_=$object_, additionalProperties=$additionalProperties}"
}
