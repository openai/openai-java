 ...
 *
 * Returns confirmation of project user deletion, or an error if the project is archived (archived
 * projects have no users).
 */
...
private constructor(
    ...
    class Builder internal constructor() {
        ...
        internal fun from(userDeleteParams: UserDeleteParams) = apply {
            projectId = userDeleteParams.projectId
    ...
    override fun toString() =
        "UserDeleteParams{projectId=$projectId, userId=$userId, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams, additionalBodyProperties=$additionalBodyProperties}"
}
