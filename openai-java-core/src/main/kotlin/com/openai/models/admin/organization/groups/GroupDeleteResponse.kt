...
private constructor(
    ...
    class Builder internal constructor() {
        ...
        private var object_: JsonValue = JsonValue.from("group.deleted")
        private var additionalProperties: MutableMap<String, JsonValue> = mutableMapOf()

        @JvmSynthetic
        internal fun from(groupDeleteResponse: GroupDeleteResponse) = apply {
            id = groupDeleteResponse.id
    ...
    fun validate(): GroupDeleteResponse = apply {
        ...
        deleted()
        _object_().let {
            if (it != JsonValue.from("group.deleted")) {
    ...
    internal fun validity(): Int =
        (if (id.asKnown().isPresent) 1 else 0) +
            ...
            object_.let { if (it == JsonValue.from("group.deleted")) 1 else 0 }
    ...
    override fun toString() =
        "GroupDeleteResponse{id=$id, deleted=$deleted, object_=$object_, additionalProperties=$additionalProperties}"
}
