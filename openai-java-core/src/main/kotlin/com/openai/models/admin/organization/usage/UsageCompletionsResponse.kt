...
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [UsageCompletionsResponse].
         *
    ...
    /** A builder for [UsageCompletionsResponse]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(usageCompletionsResponse: UsageCompletionsResponse) = apply {
            data = usageCompletionsResponse.data.map { it.toMutableList() }
            hasMore = usageCompletionsResponse.hasMore
            nextPage = usageCompletionsResponse.nextPage
            object_ = usageCompletionsResponse.object_
            additionalProperties = usageCompletionsResponse.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [UsageCompletionsResponse].
         *
         ...
         */
        fun build(): UsageCompletionsResponse =
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is UsageCompletionsResponse &&
            data == other.data &&
    ...
    override fun toString() =
        "UsageCompletionsResponse{data=$data, hasMore=$hasMore, nextPage=$nextPage, object_=$object_, additionalProperties=$additionalProperties}"
}
