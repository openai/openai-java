...
private constructor(
    ...
    class Builder internal constructor() {
        ...
        internal fun from(auditLogListPageResponse: AuditLogListPageResponse) = apply {
            ...
            hasMore = auditLogListPageResponse.hasMore
            object_ = auditLogListPageResponse.object_
            firstId = auditLogListPageResponse.firstId
            lastId = auditLogListPageResponse.lastId
    ...
    override fun toString() =
        "AuditLogListPageResponse{data=$data, hasMore=$hasMore, object_=$object_, firstId=$firstId, lastId=$lastId, additionalProperties=$additionalProperties}"
}
