...
private constructor(
     ...
     * ```java
     * JsonValue.from("organization.project.certificate")
     * ```
     *
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [CertificateActivateResponse].
         *
    ...
    /** A builder for [CertificateActivateResponse]. */
    class Builder internal constructor() {
        ...
        private var object_: JsonValue = JsonValue.from("organization.project.certificate")
        private var additionalProperties: MutableMap<String, JsonValue> = mutableMapOf()

        @JvmSynthetic
        internal fun from(certificateActivateResponse: CertificateActivateResponse) = apply {
            id = certificateActivateResponse.id
            active = certificateActivateResponse.active
            certificateDetails = certificateActivateResponse.certificateDetails
            createdAt = certificateActivateResponse.createdAt
            name = certificateActivateResponse.name
            object_ = certificateActivateResponse.object_
            additionalProperties = certificateActivateResponse.additionalProperties.toMutableMap()
        }
         ...
         */
        fun build(): CertificateActivateResponse =
    ...
    fun validate(): CertificateActivateResponse = apply {
        ...
        name()
        _object_().let {
            if (it != JsonValue.from("organization.project.certificate")) {
    ...
    internal fun validity(): Int =
        (if (id.asKnown().isPresent) 1 else 0) +
            ...
            object_.let { if (it == JsonValue.from("organization.project.certificate")) 1 else 0 }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is CertificateActivateResponse &&
            id == other.id &&
            active == other.active &&
    ...
    override fun toString() =
        "CertificateActivateResponse{id=$id, active=$active, certificateDetails=$certificateDetails, createdAt=$createdAt, name=$name, object_=$object_, additionalProperties=$additionalProperties}"
}
