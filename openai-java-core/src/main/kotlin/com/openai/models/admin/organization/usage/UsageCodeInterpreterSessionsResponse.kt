...
private constructor(
    ...
    /** A builder for [UsageCodeInterpreterSessionsResponse]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(
            usageCodeInterpreterSessionsResponse: UsageCodeInterpreterSessionsResponse
        ) = apply {
            data = usageCodeInterpreterSessionsResponse.data.map { it.toMutableList() }
            hasMore = usageCodeInterpreterSessionsResponse.hasMore
            nextPage = usageCodeInterpreterSessionsResponse.nextPage
            object_ = usageCodeInterpreterSessionsResponse.object_
            additionalProperties =
                usageCodeInterpreterSessionsResponse.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [UsageCodeInterpreterSessionsResponse].
         *
         ...
         */
        fun build(): UsageCodeInterpreterSessionsResponse =
            UsageCodeInterpreterSessionsResponse(
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is UsageCodeInterpreterSessionsResponse &&
            data == other.data &&
    ...
    override fun toString() =
        "UsageCodeInterpreterSessionsResponse{data=$data, hasMore=$hasMore, nextPage=$nextPage, object_=$object_, additionalProperties=$additionalProperties}"
}
