...
private constructor(
    private val data: JsonField<List<Project>>,
    ...
    @JsonCreator
    private constructor(
        @JsonProperty("data") @ExcludeMissing data: JsonField<List<Project>> = JsonMissing.of(),
     ...
     */
    fun data(): List<Project> = data.getRequired("data")
     ...
     */
    @JsonProperty("data") @ExcludeMissing fun _data(): JsonField<List<Project>> = data
    ...
    class Builder internal constructor() {
        ...
        private var data: JsonField<MutableList<Project>>? = null
        ...
        internal fun from(projectListPageResponse: ProjectListPageResponse) = apply {
            data = projectListPageResponse.data.map { it.toMutableList() }
            hasMore = projectListPageResponse.hasMore
            object_ = projectListPageResponse.object_
            firstId = projectListPageResponse.firstId
            lastId = projectListPageResponse.lastId
            additionalProperties = projectListPageResponse.additionalProperties.toMutableMap()
        }

        fun data(data: List<Project>) = data(JsonField.of(data))

        /**
         * Sets [Builder.data] to an arbitrary JSON value.
         *
         * You should usually call [Builder.data] with a well-typed `List<Project>` value instead.
         * This method is primarily for setting the field to an undocumented or not yet supported
         * value.
         */
        fun data(data: JsonField<List<Project>>) = apply {
            this.data = data.map { it.toMutableList() }
        }

        /**
         * Adds a single [Project] to [Builder.data].
         *
         * @throws IllegalStateException if the field was previously set to a non-list.
         */
        fun addData(data: Project) = apply {
            this.data =
    ...
    override fun toString() =
        "ProjectListPageResponse{data=$data, hasMore=$hasMore, object_=$object_, firstId=$firstId, lastId=$lastId, additionalProperties=$additionalProperties}"
}
