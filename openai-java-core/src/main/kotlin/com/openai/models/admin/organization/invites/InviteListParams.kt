...
private constructor(
    ...
    class Builder internal constructor() {
        ...
        fun build(): InviteListParams =
            InviteListParams(after, limit, additionalHeaders.build(), additionalQueryParams.build())
    }
    ...
    override fun toString() =
        "InviteListParams{after=$after, limit=$limit, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
