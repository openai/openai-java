...
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [UsageImagesResponse].
         *
    ...
    /** A builder for [UsageImagesResponse]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(usageImagesResponse: UsageImagesResponse) = apply {
            data = usageImagesResponse.data.map { it.toMutableList() }
            hasMore = usageImagesResponse.hasMore
            nextPage = usageImagesResponse.nextPage
            object_ = usageImagesResponse.object_
            additionalProperties = usageImagesResponse.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [UsageImagesResponse].
         *
     ...
     *   expected type.
     */
    fun validate(): UsageImagesResponse = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is UsageImagesResponse &&
            data == other.data &&
    ...
    override fun toString() =
        "UsageImagesResponse{data=$data, hasMore=$hasMore, nextPage=$nextPage, object_=$object_, additionalProperties=$additionalProperties}"
}
