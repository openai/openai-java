...
private constructor(
     ...
     * ```java
     * JsonValue.from("project.model_permissions.deleted")
     * ```
     *
    ...
    /** A builder for [ProjectModelPermissionsDeleted]. */
    class Builder internal constructor() {

        private var deleted: JsonField<Boolean>? = null
        private var object_: JsonValue = JsonValue.from("project.model_permissions.deleted")
        private var additionalProperties: MutableMap<String, JsonValue> = mutableMapOf()

        @JvmSynthetic
        internal fun from(projectModelPermissionsDeleted: ProjectModelPermissionsDeleted) = apply {
            deleted = projectModelPermissionsDeleted.deleted
            object_ = projectModelPermissionsDeleted.object_
            additionalProperties =
                projectModelPermissionsDeleted.additionalProperties.toMutableMap()
        }
         ...
         */
        fun build(): ProjectModelPermissionsDeleted =
            ProjectModelPermissionsDeleted(
     ...
     *   expected type.
     */
    fun validate(): ProjectModelPermissionsDeleted = apply {
        if (validated) {
            return@apply
        }
        ...
        deleted()
        _object_().let {
            if (it != JsonValue.from("project.model_permissions.deleted")) {
    ...
    internal fun validity(): Int =
        (if (deleted.asKnown().isPresent) 1 else 0) +
            object_.let { if (it == JsonValue.from("project.model_permissions.deleted")) 1 else 0 }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is ProjectModelPermissionsDeleted &&
    ...
    override fun toString() =
        "ProjectModelPermissionsDeleted{deleted=$deleted, object_=$object_, additionalProperties=$additionalProperties}"
}
