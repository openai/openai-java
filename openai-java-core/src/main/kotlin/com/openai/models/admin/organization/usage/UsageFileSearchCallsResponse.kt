...
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [UsageFileSearchCallsResponse].
         *
    ...
    /** A builder for [UsageFileSearchCallsResponse]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(usageFileSearchCallsResponse: UsageFileSearchCallsResponse) = apply {
            data = usageFileSearchCallsResponse.data.map { it.toMutableList() }
            hasMore = usageFileSearchCallsResponse.hasMore
            nextPage = usageFileSearchCallsResponse.nextPage
            object_ = usageFileSearchCallsResponse.object_
            additionalProperties = usageFileSearchCallsResponse.additionalProperties.toMutableMap()
        }
         ...
         */
        fun build(): UsageFileSearchCallsResponse =
     ...
     *   expected type.
     */
    fun validate(): UsageFileSearchCallsResponse = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is UsageFileSearchCallsResponse &&
            data == other.data &&
    ...
    override fun toString() =
        "UsageFileSearchCallsResponse{data=$data, hasMore=$hasMore, nextPage=$nextPage, object_=$object_, additionalProperties=$additionalProperties}"
}
