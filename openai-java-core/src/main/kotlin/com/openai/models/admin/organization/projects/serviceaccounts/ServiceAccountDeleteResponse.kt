...
private constructor(
     ...
     * ```java
     * JsonValue.from("organization.project.service_account.deleted")
     * ```
     *
    ...
    class Builder internal constructor() {
        ...
        internal fun from(serviceAccountDeleteResponse: ServiceAccountDeleteResponse) = apply {
            ...
            deleted = serviceAccountDeleteResponse.deleted
            object_ = serviceAccountDeleteResponse.object_
    ...
    fun validate(): ServiceAccountDeleteResponse = apply {
        ...
        deleted()
        _object_().let {
            if (it != JsonValue.from("organization.project.service_account.deleted")) {
    ...
    internal fun validity(): Int =
        (if (id.asKnown().isPresent) 1 else 0) +
            ...
            object_.let {
                if (it == JsonValue.from("organization.project.service_account.deleted")) 1 else 0
            }
    ...
    override fun toString() =
        "ServiceAccountDeleteResponse{id=$id, deleted=$deleted, object_=$object_, additionalProperties=$additionalProperties}"
}
