...
private constructor(
     ...
     * ```java
     * JsonValue.from("organization.spend_alert.deleted")
     * ```
     *
    ...
    /** A builder for [OrganizationSpendAlertDeleted]. */
    class Builder internal constructor() {

        private var id: JsonField<String>? = null
        private var deleted: JsonField<Boolean>? = null
        private var object_: JsonValue = JsonValue.from("organization.spend_alert.deleted")
        private var additionalProperties: MutableMap<String, JsonValue> = mutableMapOf()

        @JvmSynthetic
        internal fun from(organizationSpendAlertDeleted: OrganizationSpendAlertDeleted) = apply {
            id = organizationSpendAlertDeleted.id
            deleted = organizationSpendAlertDeleted.deleted
            object_ = organizationSpendAlertDeleted.object_
            additionalProperties = organizationSpendAlertDeleted.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [OrganizationSpendAlertDeleted].
         *
         ...
         */
        fun build(): OrganizationSpendAlertDeleted =
            OrganizationSpendAlertDeleted(
                checkRequired("id", id),
     ...
     *   expected type.
     */
    fun validate(): OrganizationSpendAlertDeleted = apply {
        if (validated) {
            return@apply
        }
        ...
        deleted()
        _object_().let {
            if (it != JsonValue.from("organization.spend_alert.deleted")) {
    ...
    internal fun validity(): Int =
        (if (id.asKnown().isPresent) 1 else 0) +
            ...
            object_.let { if (it == JsonValue.from("organization.spend_alert.deleted")) 1 else 0 }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is OrganizationSpendAlertDeleted &&
            id == other.id &&
    ...
    override fun toString() =
        "OrganizationSpendAlertDeleted{id=$id, deleted=$deleted, object_=$object_, additionalProperties=$additionalProperties}"
}
