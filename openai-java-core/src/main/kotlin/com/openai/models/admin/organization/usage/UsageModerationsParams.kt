...
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [UsageModerationsParams].
         *
    ...
    /** A builder for [UsageModerationsParams]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(usageModerationsParams: UsageModerationsParams) = apply {
            startTime = usageModerationsParams.startTime
            apiKeyIds = usageModerationsParams.apiKeyIds?.toMutableList()
            bucketWidth = usageModerationsParams.bucketWidth
            endTime = usageModerationsParams.endTime
            groupBy = usageModerationsParams.groupBy?.toMutableList()
            limit = usageModerationsParams.limit
            models = usageModerationsParams.models?.toMutableList()
            page = usageModerationsParams.page
            projectIds = usageModerationsParams.projectIds?.toMutableList()
            userIds = usageModerationsParams.userIds?.toMutableList()
            additionalHeaders = usageModerationsParams.additionalHeaders.toBuilder()
            additionalQueryParams = usageModerationsParams.additionalQueryParams.toBuilder()
        }
        ...
        /**
         * Returns an immutable instance of [UsageModerationsParams].
         *
         ...
         */
        fun build(): UsageModerationsParams =
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is UsageModerationsParams &&
    ...
    override fun toString() =
        "UsageModerationsParams{startTime=$startTime, apiKeyIds=$apiKeyIds, bucketWidth=$bucketWidth, endTime=$endTime, groupBy=$groupBy, limit=$limit, models=$models, page=$page, projectIds=$projectIds, userIds=$userIds, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
