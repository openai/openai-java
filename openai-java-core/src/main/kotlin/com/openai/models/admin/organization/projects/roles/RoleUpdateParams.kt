...
private constructor(
    ...
    class Builder internal constructor() {
        ...
        internal fun from(roleUpdateParams: RoleUpdateParams) = apply {
            projectId = roleUpdateParams.projectId
    ...
    override fun hashCode(): Int =
        Objects.hash(projectId, roleId, body, additionalHeaders, additionalQueryParams)

    override fun toString() =
        "RoleUpdateParams{projectId=$projectId, roleId=$roleId, body=$body, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
