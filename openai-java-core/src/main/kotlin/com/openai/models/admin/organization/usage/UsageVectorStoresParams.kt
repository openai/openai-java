...
private constructor(
    ...
    /** A builder for [UsageVectorStoresParams]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(usageVectorStoresParams: UsageVectorStoresParams) = apply {
            startTime = usageVectorStoresParams.startTime
            bucketWidth = usageVectorStoresParams.bucketWidth
            endTime = usageVectorStoresParams.endTime
            groupBy = usageVectorStoresParams.groupBy?.toMutableList()
            limit = usageVectorStoresParams.limit
            page = usageVectorStoresParams.page
            projectIds = usageVectorStoresParams.projectIds?.toMutableList()
            additionalHeaders = usageVectorStoresParams.additionalHeaders.toBuilder()
            additionalQueryParams = usageVectorStoresParams.additionalQueryParams.toBuilder()
        }
        ...
        /**
         * Returns an immutable instance of [UsageVectorStoresParams].
         *
         ...
         */
        fun build(): UsageVectorStoresParams =
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is UsageVectorStoresParams &&
    ...
    override fun toString() =
        "UsageVectorStoresParams{startTime=$startTime, bucketWidth=$bucketWidth, endTime=$endTime, groupBy=$groupBy, limit=$limit, page=$page, projectIds=$projectIds, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
