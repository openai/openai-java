...
class AdminApiKeyListPageResponse
...
private constructor(
     ...
     */
    fun data(): Optional<List<AdminApiKey>> = data.getOptional("data")
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [AdminApiKeyListPageResponse].
         */
        @JvmStatic fun builder() = Builder()
    }

    /** A builder for [AdminApiKeyListPageResponse]. */
    class Builder internal constructor() {
        ...
        fun data(data: List<AdminApiKey>) = data(JsonField.of(data))

        /**
         * Sets [Builder.data] to an arbitrary JSON value.
         *
         * You should usually call [Builder.data] with a well-typed `List<AdminApiKey>` value
         * instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun data(data: JsonField<List<AdminApiKey>>) = apply {
            this.data = data.map { it.toMutableList() }
        }

        /**
         * Adds a single [AdminApiKey] to [Builder.data].
         *
         * @throws IllegalStateException if the field was previously set to a non-list.
         */
        fun addData(data: AdminApiKey) = apply {
            this.data =
        ...
        /**
         * Returns an immutable instance of [AdminApiKeyListPageResponse].
         *
