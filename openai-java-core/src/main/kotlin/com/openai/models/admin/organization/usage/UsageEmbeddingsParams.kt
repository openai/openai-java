...
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [UsageEmbeddingsParams].
         *
    ...
    /** A builder for [UsageEmbeddingsParams]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(usageEmbeddingsParams: UsageEmbeddingsParams) = apply {
            startTime = usageEmbeddingsParams.startTime
            apiKeyIds = usageEmbeddingsParams.apiKeyIds?.toMutableList()
            bucketWidth = usageEmbeddingsParams.bucketWidth
            endTime = usageEmbeddingsParams.endTime
            groupBy = usageEmbeddingsParams.groupBy?.toMutableList()
            limit = usageEmbeddingsParams.limit
            models = usageEmbeddingsParams.models?.toMutableList()
            page = usageEmbeddingsParams.page
            projectIds = usageEmbeddingsParams.projectIds?.toMutableList()
            userIds = usageEmbeddingsParams.userIds?.toMutableList()
            additionalHeaders = usageEmbeddingsParams.additionalHeaders.toBuilder()
            additionalQueryParams = usageEmbeddingsParams.additionalQueryParams.toBuilder()
        }
        ...
        /**
         * Returns an immutable instance of [UsageEmbeddingsParams].
         *
         ...
         */
        fun build(): UsageEmbeddingsParams =
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is UsageEmbeddingsParams &&
    ...
    override fun toString() =
        "UsageEmbeddingsParams{startTime=$startTime, apiKeyIds=$apiKeyIds, bucketWidth=$bucketWidth, endTime=$endTime, groupBy=$groupBy, limit=$limit, models=$models, page=$page, projectIds=$projectIds, userIds=$userIds, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
