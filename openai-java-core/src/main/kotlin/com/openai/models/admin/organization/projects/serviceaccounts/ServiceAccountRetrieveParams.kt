...
private constructor(
    ...
    class Builder internal constructor() {
        ...
        internal fun from(serviceAccountRetrieveParams: ServiceAccountRetrieveParams) = apply {
            projectId = serviceAccountRetrieveParams.projectId
    ...
    override fun hashCode(): Int =
        Objects.hash(projectId, serviceAccountId, additionalHeaders, additionalQueryParams)

    override fun toString() =
        "ServiceAccountRetrieveParams{projectId=$projectId, serviceAccountId=$serviceAccountId, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
