...
private constructor(
     ...
     * ```java
     * JsonValue.from("organization.user.deleted")
     * ```
     *
    ...
    class Builder internal constructor() {
        ...
        private var object_: JsonValue = JsonValue.from("organization.user.deleted")
    ...
    fun validate(): UserDeleteResponse = apply {
        ...
        deleted()
        _object_().let {
            if (it != JsonValue.from("organization.user.deleted")) {
    ...
    internal fun validity(): Int =
        (if (id.asKnown().isPresent) 1 else 0) +
            ...
            object_.let { if (it == JsonValue.from("organization.user.deleted")) 1 else 0 }
