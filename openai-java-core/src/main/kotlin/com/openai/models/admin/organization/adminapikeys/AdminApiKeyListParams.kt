...
private constructor(
    ...
    companion object {
        ...
        @JvmStatic fun none(): AdminApiKeyListParams = builder().build()

        /** Returns a mutable builder for constructing an instance of [AdminApiKeyListParams]. */
        @JvmStatic fun builder() = Builder()
    }

    /** A builder for [AdminApiKeyListParams]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(adminApiKeyListParams: AdminApiKeyListParams) = apply {
            after = adminApiKeyListParams.after
            limit = adminApiKeyListParams.limit
            order = adminApiKeyListParams.order
            additionalHeaders = adminApiKeyListParams.additionalHeaders.toBuilder()
            additionalQueryParams = adminApiKeyListParams.additionalQueryParams.toBuilder()
        }
        ...
        /**
         * Returns an immutable instance of [AdminApiKeyListParams].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): AdminApiKeyListParams =
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is AdminApiKeyListParams &&
            after == other.after &&
            limit == other.limit &&
            order == other.order &&
    ...
    override fun toString() =
        "AdminApiKeyListParams{after=$after, limit=$limit, order=$order, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
