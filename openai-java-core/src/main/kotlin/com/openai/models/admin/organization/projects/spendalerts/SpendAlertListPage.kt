...
private constructor(
     ...
     */
    fun data(): List<ProjectSpendAlert> =
    ...
    override fun items(): List<ProjectSpendAlert> = data()
    ...
    fun autoPager(): AutoPager<ProjectSpendAlert> = AutoPager.from(this)
