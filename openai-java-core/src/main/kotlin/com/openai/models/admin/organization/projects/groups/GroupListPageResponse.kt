...
private constructor(
    private val data: JsonField<List<ProjectGroup>>,
    ...
    private constructor(
        @JsonProperty("data")
        @ExcludeMissing
        data: JsonField<List<ProjectGroup>> = JsonMissing.of(),
     ...
     */
    fun data(): List<ProjectGroup> = data.getRequired("data")
     ...
     */
    @JsonProperty("data") @ExcludeMissing fun _data(): JsonField<List<ProjectGroup>> = data
    ...
    class Builder internal constructor() {
        ...
        private var data: JsonField<MutableList<ProjectGroup>>? = null
        ...
        internal fun from(groupListPageResponse: GroupListPageResponse) = apply {
            data = groupListPageResponse.data.map { it.toMutableList() }
            hasMore = groupListPageResponse.hasMore
            next = groupListPageResponse.next
            object_ = groupListPageResponse.object_
            additionalProperties = groupListPageResponse.additionalProperties.toMutableMap()
        }

        /** Project group memberships returned in the current page. */
        fun data(data: List<ProjectGroup>) = data(JsonField.of(data))

        /**
         * Sets [Builder.data] to an arbitrary JSON value.
         *
         * You should usually call [Builder.data] with a well-typed `List<ProjectGroup>` value
         * instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun data(data: JsonField<List<ProjectGroup>>) = apply {
            this.data = data.map { it.toMutableList() }
        }

        /**
         * Adds a single [ProjectGroup] to [Builder.data].
         *
         * @throws IllegalStateException if the field was previously set to a non-list.
         */
        fun addData(data: ProjectGroup) = apply {
            this.data =
    ...
    override fun toString() =
        "GroupListPageResponse{data=$data, hasMore=$hasMore, next=$next, object_=$object_, additionalProperties=$additionalProperties}"
}
