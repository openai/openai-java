...
private constructor(
    ...
    class Builder internal constructor() {
        ...
        fun data(data: List<Invite>) = data(JsonField.of(data))

        /**
         * Sets [Builder.data] to an arbitrary JSON value.
         *
         * You should usually call [Builder.data] with a well-typed `List<Invite>` value instead.
         * This method is primarily for setting the field to an undocumented or not yet supported
         * value.
         */
        fun data(data: JsonField<List<Invite>>) = apply {
            this.data = data.map { it.toMutableList() }
        }

        /**
         * Adds a single [Invite] to [Builder.data].
         *
         * @throws IllegalStateException if the field was previously set to a non-list.
         */
        fun addData(data: Invite) = apply {
            this.data =
