...
class ExternalStorageListPageResponse
@JsonCreator(mode = JsonCreator.Mode.DISABLED)
private constructor(
    private val data: JsonField<List<ExternalStorageConfiguration>>,
    ...
    private constructor(
        @JsonProperty("data")
        @ExcludeMissing
        data: JsonField<List<ExternalStorageConfiguration>> = JsonMissing.of(),
     ...
     */
    fun data(): List<ExternalStorageConfiguration> = data.getRequired("data")
    ...
    @JsonProperty("data")
    @ExcludeMissing
    fun _data(): JsonField<List<ExternalStorageConfiguration>> = data
    ...
    companion object {
         ...
         * [ExternalStorageListPageResponse].
         *
    ...
    /** A builder for [ExternalStorageListPageResponse]. */
    class Builder internal constructor() {

        private var data: JsonField<MutableList<ExternalStorageConfiguration>>? = null
        ...
        @JvmSynthetic
        internal fun from(externalStorageListPageResponse: ExternalStorageListPageResponse) =
            apply {
                data = externalStorageListPageResponse.data.map { it.toMutableList() }
                firstId = externalStorageListPageResponse.firstId
                hasMore = externalStorageListPageResponse.hasMore
                lastId = externalStorageListPageResponse.lastId
                object_ = externalStorageListPageResponse.object_
                additionalProperties =
                    externalStorageListPageResponse.additionalProperties.toMutableMap()
            }

        fun data(data: List<ExternalStorageConfiguration>) = data(JsonField.of(data))

        /**
         * Sets [Builder.data] to an arbitrary JSON value.
         *
         * You should usually call [Builder.data] with a well-typed
         * `List<ExternalStorageConfiguration>` value instead. This method is primarily for setting
         * the field to an undocumented or not yet supported value.
         */
        fun data(data: JsonField<List<ExternalStorageConfiguration>>) = apply {
            this.data = data.map { it.toMutableList() }
        }

        /**
         * Adds a single [ExternalStorageConfiguration] to [Builder.data].
         *
         * @throws IllegalStateException if the field was previously set to a non-list.
         */
        fun addData(data: ExternalStorageConfiguration) = apply {
            this.data =
        ...
        /**
         * Returns an immutable instance of [ExternalStorageListPageResponse].
         *
         ...
         */
        fun build(): ExternalStorageListPageResponse =
            ExternalStorageListPageResponse(
     ...
     *   expected type.
     */
    fun validate(): ExternalStorageListPageResponse = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is ExternalStorageListPageResponse &&
            data == other.data &&
    ...
    override fun toString() =
        "ExternalStorageListPageResponse{data=$data, firstId=$firstId, hasMore=$hasMore, lastId=$lastId, object_=$object_, additionalProperties=$additionalProperties}"
}
