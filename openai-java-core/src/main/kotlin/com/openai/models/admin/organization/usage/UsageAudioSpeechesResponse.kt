...
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [UsageAudioSpeechesResponse].
         *
    ...
    /** A builder for [UsageAudioSpeechesResponse]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(usageAudioSpeechesResponse: UsageAudioSpeechesResponse) = apply {
            data = usageAudioSpeechesResponse.data.map { it.toMutableList() }
            hasMore = usageAudioSpeechesResponse.hasMore
            nextPage = usageAudioSpeechesResponse.nextPage
            object_ = usageAudioSpeechesResponse.object_
            additionalProperties = usageAudioSpeechesResponse.additionalProperties.toMutableMap()
        }
         ...
         */
        fun build(): UsageAudioSpeechesResponse =
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is UsageAudioSpeechesResponse &&
            data == other.data &&
    ...
    override fun toString() =
        "UsageAudioSpeechesResponse{data=$data, hasMore=$hasMore, nextPage=$nextPage, object_=$object_, additionalProperties=$additionalProperties}"
}
