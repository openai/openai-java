...
private constructor(
    ...
    /** A builder for [CertificateUpdateParams]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(certificateUpdateParams: CertificateUpdateParams) = apply {
            certificateId = certificateUpdateParams.certificateId
            body = certificateUpdateParams.body.toBuilder()
            additionalHeaders = certificateUpdateParams.additionalHeaders.toBuilder()
            additionalQueryParams = certificateUpdateParams.additionalQueryParams.toBuilder()
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is CertificateUpdateParams &&
    ...
    override fun hashCode(): Int =
        Objects.hash(certificateId, body, additionalHeaders, additionalQueryParams)

    override fun toString() =
        "CertificateUpdateParams{certificateId=$certificateId, body=$body, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
