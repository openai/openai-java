...
private constructor(
     ...
     * ```java
     * JsonValue.from("organization.external_storage.deleted")
     * ```
     *
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [ExternalStorageDeleted].
         *
    ...
    /** A builder for [ExternalStorageDeleted]. */
    class Builder internal constructor() {

        private var id: JsonField<String>? = null
        private var deleted: JsonField<Boolean>? = null
        private var object_: JsonValue = JsonValue.from("organization.external_storage.deleted")
        private var additionalProperties: MutableMap<String, JsonValue> = mutableMapOf()

        @JvmSynthetic
        internal fun from(externalStorageDeleted: ExternalStorageDeleted) = apply {
            id = externalStorageDeleted.id
            deleted = externalStorageDeleted.deleted
            object_ = externalStorageDeleted.object_
            additionalProperties = externalStorageDeleted.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [ExternalStorageDeleted].
         *
         ...
         */
        fun build(): ExternalStorageDeleted =
     ...
     *   expected type.
     */
    fun validate(): ExternalStorageDeleted = apply {
        if (validated) {
            return@apply
        }
        ...
        deleted()
        _object_().let {
            if (it != JsonValue.from("organization.external_storage.deleted")) {
    ...
    internal fun validity(): Int =
        (if (id.asKnown().isPresent) 1 else 0) +
            ...
            object_.let {
                if (it == JsonValue.from("organization.external_storage.deleted")) 1 else 0
            }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is ExternalStorageDeleted &&
            id == other.id &&
    ...
    override fun toString() =
        "ExternalStorageDeleted{id=$id, deleted=$deleted, object_=$object_, additionalProperties=$additionalProperties}"
}
