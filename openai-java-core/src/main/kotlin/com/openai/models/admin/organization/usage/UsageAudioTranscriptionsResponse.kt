...
private constructor(
    ...
    /** A builder for [UsageAudioTranscriptionsResponse]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(usageAudioTranscriptionsResponse: UsageAudioTranscriptionsResponse) =
            apply {
                data = usageAudioTranscriptionsResponse.data.map { it.toMutableList() }
                hasMore = usageAudioTranscriptionsResponse.hasMore
                nextPage = usageAudioTranscriptionsResponse.nextPage
                object_ = usageAudioTranscriptionsResponse.object_
                additionalProperties =
                    usageAudioTranscriptionsResponse.additionalProperties.toMutableMap()
            }
        ...
        /**
         * Returns an immutable instance of [UsageAudioTranscriptionsResponse].
         *
         ...
         */
        fun build(): UsageAudioTranscriptionsResponse =
            UsageAudioTranscriptionsResponse(
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is UsageAudioTranscriptionsResponse &&
            data == other.data &&
    ...
    override fun toString() =
        "UsageAudioTranscriptionsResponse{data=$data, hasMore=$hasMore, nextPage=$nextPage, object_=$object_, additionalProperties=$additionalProperties}"
}
