...
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [UsageCostsResponse].
         *
    ...
    /** A builder for [UsageCostsResponse]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(usageCostsResponse: UsageCostsResponse) = apply {
            data = usageCostsResponse.data.map { it.toMutableList() }
            hasMore = usageCostsResponse.hasMore
            nextPage = usageCostsResponse.nextPage
            object_ = usageCostsResponse.object_
            additionalProperties = usageCostsResponse.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [UsageCostsResponse].
         *
     ...
     *   expected type.
     */
    fun validate(): UsageCostsResponse = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is UsageCostsResponse &&
            data == other.data &&
    ...
    override fun toString() =
        "UsageCostsResponse{data=$data, hasMore=$hasMore, nextPage=$nextPage, object_=$object_, additionalProperties=$additionalProperties}"
}
