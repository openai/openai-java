...
private constructor(
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is RoleRetrieveResponse &&
            id == other.id &&
    ...
    override fun toString() =
        "RoleRetrieveResponse{id=$id, assignmentSources=$assignmentSources, createdAt=$createdAt, createdBy=$createdBy, createdByUserObj=$createdByUserObj, description=$description, metadata=$metadata, name=$name, permissions=$permissions, predefinedRole=$predefinedRole, resourceType=$resourceType, updatedAt=$updatedAt, additionalProperties=$additionalProperties}"
}
