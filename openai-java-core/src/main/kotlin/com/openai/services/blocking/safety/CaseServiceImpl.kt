...
class CaseServiceImpl internal constructor(private val clientOptions: ClientOptions) : CaseService {
    ...
    override fun retrieve(params: CaseRetrieveParams, requestOptions: RequestOptions): SafetyCase =
        // get /safety/cases/{id}
    ...
    class WithRawResponseImpl internal constructor(private val clientOptions: ClientOptions) :
        ...
        private val retrieveHandler: Handler<SafetyCase> =
            jsonHandler<SafetyCase>(clientOptions.jsonMapper)
        ...
        override fun retrieve(
            ...
            val request =
                HttpRequest.builder()
                    ...
                    .addPathSegments("safety", "cases", params._pathParam(0))
                    .build()
                    .prepare(
                        clientOptions,
                        params,
