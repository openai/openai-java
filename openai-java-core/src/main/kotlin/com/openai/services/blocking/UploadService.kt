...
interface UploadService {
     ...
     * [Upload](https://developers.openai.com/api/reference/resources/uploads) object that you can
     * add [Parts](https://developers.openai.com/api/reference/resources/uploads/subresources/parts)
     * to. Currently, an Upload can accept at most 8 GB in total and expires after an hour after you
     * create it.
     *
     * Once you complete the Upload, we will create a
     * [File](https://developers.openai.com/api/reference/resources/files) object that contains all
     ...
     * [File](https://developers.openai.com/api/reference/resources/files) object that is ready to
