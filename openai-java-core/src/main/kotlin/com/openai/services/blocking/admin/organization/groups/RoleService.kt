...
interface RoleService {
    ...
    /** @see list */
    fun list(groupId: String, params: RoleListParams = RoleListParams.none()): RoleListPage =
    ...
    /** @see list */
    fun list(groupId: String, requestOptions: RequestOptions): RoleListPage =
        list(groupId, RoleListParams.none(), requestOptions)
    ...
    interface WithRawResponse {
        ...
        /**
         * Returns a raw HTTP response for `post /organization/groups/{group_id}/roles`, but is
         * otherwise the same as [RoleService.create].
         */
        @MustBeClosed
         ...
         * otherwise the same as [RoleService.list].
         */
        @MustBeClosed
        fun list(groupId: String): HttpResponseFor<RoleListPage> =
            list(groupId, RoleListParams.none())
        ...
        fun list(
            groupId: String,
            params: RoleListParams = RoleListParams.none(),
        ): HttpResponseFor<RoleListPage> = list(groupId, params, RequestOptions.none())
        ...
        /** @see list */
        @MustBeClosed
        fun list(groupId: String, requestOptions: RequestOptions): HttpResponseFor<RoleListPage> =
            list(groupId, RoleListParams.none(), requestOptions)

        /**
         * Returns a raw HTTP response for `delete /organization/groups/{group_id}/roles/{role_id}`,
         * but is otherwise the same as [RoleService.delete].
         */
        @MustBeClosed
