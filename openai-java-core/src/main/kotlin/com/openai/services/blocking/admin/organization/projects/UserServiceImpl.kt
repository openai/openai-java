...
import com.openai.models.admin.organization.projects.users.UserListPageResponse
...
import com.openai.services.blocking.admin.organization.projects.users.RoleServiceImpl
...
class UserServiceImpl internal constructor(private val clientOptions: ClientOptions) : UserService {
    ...
    override fun create(params: UserCreateParams, requestOptions: RequestOptions): ProjectUser =
        // post /organization/projects/{project_id}/users
        withRawResponse().create(params, requestOptions).parse()

    override fun retrieve(params: UserRetrieveParams, requestOptions: RequestOptions): ProjectUser =
        // get /organization/projects/{project_id}/users/{user_id}
        withRawResponse().retrieve(params, requestOptions).parse()

    override fun update(params: UserUpdateParams, requestOptions: RequestOptions): ProjectUser =
    ...
    class WithRawResponseImpl internal constructor(private val clientOptions: ClientOptions) :
        ...
        private val createHandler: Handler<ProjectUser> =
            jsonHandler<ProjectUser>(clientOptions.jsonMapper)
        ...
        override fun create(
            ...
            val request =
                HttpRequest.builder()
                    ...
                    .addPathSegments("organization", "projects", params._pathParam(0), "users")
        ...
        private val retrieveHandler: Handler<ProjectUser> =
            jsonHandler<ProjectUser>(clientOptions.jsonMapper)
        ...
        private val updateHandler: Handler<ProjectUser> =
            jsonHandler<ProjectUser>(clientOptions.jsonMapper)
