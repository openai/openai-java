...
package com.openai.services.async.skills.versions
...
interface ContentServiceAsync {
    ...
    interface WithRawResponse {
        ...
        /**
         * Returns a raw HTTP response for `get /skills/{skill_id}/versions/{version}/content`, but
         * is otherwise the same as [ContentServiceAsync.retrieve].
         */
        fun retrieve(
            version: String,
            params: ContentRetrieveParams,
        ): CompletableFuture<HttpResponse> = retrieve(version, params, RequestOptions.none())
