...
interface RoleServiceAsync {
    ...
    fun create(groupId: String, params: RoleCreateParams): CompletableFuture<RoleCreateResponse> =
    ...
    fun list(groupId: String): CompletableFuture<RoleListPageAsync> =
    ...
    fun list(
        groupId: String,
        params: RoleListParams = RoleListParams.none(),
    ): CompletableFuture<RoleListPageAsync> = list(groupId, params, RequestOptions.none())
    ...
    ): CompletableFuture<RoleListPageAsync> = list(groupId, RoleListParams.none(), requestOptions)
    ...
    interface WithRawResponse {
         ...
         * but is otherwise the same as [RoleServiceAsync.retrieve].
         */
        fun retrieve(
            roleId: String,
            params: RoleRetrieveParams,
         ...
         */
        fun list(groupId: String): CompletableFuture<HttpResponseFor<RoleListPageAsync>> =
            list(groupId, RoleListParams.none())
