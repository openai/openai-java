...
import com.openai.models.admin.organization.projects.groups.roles.RoleListPageAsync
...
interface RoleServiceAsync {
    ...
    fun list(groupId: String, params: RoleListParams): CompletableFuture<RoleListPageAsync> =
    ...
    interface WithRawResponse {
         ...
         * but is otherwise the same as [RoleServiceAsync.create].
         */
        fun create(
            groupId: String,
            params: RoleCreateParams,
