...
internal class SessionServiceTest {
    ...
    fun accept() {
        val client =
            OpenAIOkHttpClient.builder()
                ...
                .build()
        val sessionService = client.live().sessions()
    ...
    fun downloadRecording(wmRuntimeInfo: WireMockRuntimeInfo) {
        ...
        val response = sessionService.downloadRecording("live_SQ")
    ...
    fun hangup() {
        ...
        sessionService.hangup("session_id")
    }
