...
internal class SubagentServiceAsyncTest {
    ...
    fun retrieve() {
        val client =
            OpenAIOkHttpClientAsync.builder()
                ...
                .build()
        val subagentServiceAsync = client.beta().agents().sessions().subagents()
        ...
        val subagent = subagentFuture.get()
        subagent.validate()
    }
    ...
    fun list() {
        ...
        val pageFuture = subagentServiceAsync.list("session_id")
