...
internal class AgentSessionCreatedEventTest {

    @Test
    fun create() {
        val agentSessionCreatedEvent =
        ...
        assertThat(agentSessionCreatedEvent.eventId()).isEqualTo("event_id")
        assertThat(agentSessionCreatedEvent.session())
            .isEqualTo(
                AgentSession.builder()
                    .id("id")
                    .agent(
    ...
    fun roundtrip() {
        ...
        val roundtrippedAgentSessionCreatedEvent =
            jsonMapper.readValue(
                jsonMapper.writeValueAsString(agentSessionCreatedEvent),
                jacksonTypeRef<AgentSessionCreatedEvent>(),
            )

        assertThat(roundtrippedAgentSessionCreatedEvent).isEqualTo(agentSessionCreatedEvent)
    }
}
