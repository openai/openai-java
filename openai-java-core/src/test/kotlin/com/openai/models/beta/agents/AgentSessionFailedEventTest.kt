...
internal class AgentSessionFailedEventTest {

    @Test
    fun create() {
        val agentSessionFailedEvent =
        ...
        assertThat(agentSessionFailedEvent.eventId()).isEqualTo("event_id")
        assertThat(agentSessionFailedEvent.session())
            .isEqualTo(
                AgentSession.builder()
                    .id("id")
                    .agent(
    ...
    fun roundtrip() {
        ...
        val roundtrippedAgentSessionFailedEvent =
            jsonMapper.readValue(
                jsonMapper.writeValueAsString(agentSessionFailedEvent),
                jacksonTypeRef<AgentSessionFailedEvent>(),
            )

        assertThat(roundtrippedAgentSessionFailedEvent).isEqualTo(agentSessionFailedEvent)
    }
}
