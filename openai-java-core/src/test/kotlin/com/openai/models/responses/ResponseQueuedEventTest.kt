...
internal class ResponseQueuedEventTest {

    @Test
    fun create() {
        val responseQueuedEvent =
        ...
        assertThat(responseQueuedEvent.response())
            .isEqualTo(
                Response.builder()
                    .id("id")
                    .createdAt(0.0)
        ...
        assertThat(responseQueuedEvent.sequenceNumber()).isEqualTo(0L)
    }
    ...
    fun roundtrip() {
        ...
        val roundtrippedResponseQueuedEvent =
            jsonMapper.readValue(
                jsonMapper.writeValueAsString(responseQueuedEvent),
                jacksonTypeRef<ResponseQueuedEvent>(),
            )

        assertThat(roundtrippedResponseQueuedEvent).isEqualTo(responseQueuedEvent)
    }
}
