...
internal class ResponseInputTextContentTest {
    ...
    fun create() {
        ...
        assertThat(responseInputTextContent.promptCacheBreakpoint())
            .contains(ResponseInputTextContent.PromptCacheBreakpoint.builder().build())
    }
