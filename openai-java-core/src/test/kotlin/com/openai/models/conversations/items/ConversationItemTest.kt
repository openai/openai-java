...
internal class ConversationItemTest {
    ...
    fun ofToolSearchCall() {
        ...
        val conversationItem = ConversationItem.ofToolSearchCall(toolSearchCall)
    ...
    fun ofToolSearchCallRoundtrip() {
        val jsonMapper = jsonMapper()
        val conversationItem =
            ConversationItem.ofToolSearchCall(
                ResponseToolSearchCall.builder()
                    .id("id")
                    .arguments(JsonValue.from(mapOf<String, Any>()))
                    .callId("call_id")
    ...
    fun ofToolSearchOutput() {
        ...
        val conversationItem = ConversationItem.ofToolSearchOutput(toolSearchOutput)
    ...
    fun ofToolSearchOutputRoundtrip() {
        val jsonMapper = jsonMapper()
        val conversationItem =
            ConversationItem.ofToolSearchOutput(
                ResponseToolSearchOutputItem.builder()
                    .id("id")
                    .callId("call_id")
                    .execution(ResponseToolSearchOutputItem.Execution.SERVER)
    ...
    fun ofProgram() {
        val program =
            ConversationItem.Program.builder()
                .id("id")
                .callId("call_id")
                .code("code")
        ...
        val conversationItem = ConversationItem.ofProgram(program)
    ...
    fun ofProgramOutput() {
        val programOutput =
            ConversationItem.ProgramOutput.builder()
                .id("id")
                .callId("call_id")
                .result("result")
                .status(ConversationItem.ProgramOutput.Status.COMPLETED)
                .build()

        val conversationItem = ConversationItem.ofProgramOutput(programOutput)
    ...
    fun ofProgramOutputRoundtrip() {
        val jsonMapper = jsonMapper()
        val conversationItem =
            ConversationItem.ofProgramOutput(
                ConversationItem.ProgramOutput.builder()
                    .id("id")
                    .callId("call_id")
                    .result("result")
    ...
    fun ofCompaction() {
        ...
        val conversationItem = ConversationItem.ofCompaction(compaction)
