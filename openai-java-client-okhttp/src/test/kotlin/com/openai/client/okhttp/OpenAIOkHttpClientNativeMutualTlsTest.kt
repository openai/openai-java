...
internal class OpenAIOkHttpClientNativeMutualTlsTest {
    ...
    fun publicX509ClientBuildersRejectExplicitAndAmbientAzureEndpoints() {
        val workloadIdentity =
            WorkloadIdentity.x509Builder()
                .identityProviderId("idp_test")
                .serviceAccountId("svc_acct_test")
    ...
    fun x509WorkloadIdentityUsesSameFullChainTransportForExchangeAndApi() {
        mutuallyAuthenticatedServer().use { fixture ->
            ...
            val client =
                OpenAIClientImpl(
                    ClientOptions.builder()
                        ...
                        .putHeader("X-Request-Metadata", "api-only-metadata")
                        .workloadIdentity(
                            WorkloadIdentity.x509Builder()
                                .identityProviderId("idp_test")
                                .serviceAccountId("svc_acct_test")
            ...
            assertThat(exchange.getHeader("X-Request-Metadata")).isNull()
            ...
            assertThat(api.getHeader("X-Request-Metadata")).isEqualTo("api-only-metadata")
